...
float param_1=(*sc_set2.UserUniforms).lineWeight;
Output_N11=param_1;
float Output_N3=0.0;
Output_N3=Output_N11+1.0;
float3 Output_N8=float3(0.0);
Output_N8=(Position_N5*float3(Output_N3))+float3((*sc_set2.UserUniforms).Port_Input2_N008);
float3 VectorOut_N1=float3(0.0);
VectorOut_N1=((*sc_set2.UserUniforms).sc_ModelMatrix*float4(Output_N8,1.0)).xyz;
...
float4 param=(*sc_set2.UserUniforms).lineColor;
Output_N12=param;
...
{
param_2=float4(param_2.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_11=param_2;
...
float3 param_3=in.varPos;
float4 param_4=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_3,param_4,in.varStereoViewID,(*sc_set2.UserUniforms));
