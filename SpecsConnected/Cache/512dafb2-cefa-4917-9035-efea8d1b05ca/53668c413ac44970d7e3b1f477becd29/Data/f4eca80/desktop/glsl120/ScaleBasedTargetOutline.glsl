...
#endif
l9_15=sc_SampleView(sc_ScreenTextureDims.xy,l9_19,sc_ScreenTextureLayout,l9_20,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_21;
...
{
vec4 l9_22=l9_15;
l9_22.x=l9_15.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_21=l9_22;
}
#else
{
...
#endif
vec3 l9_23=mix(l9_21.xyz,definedBlend(l9_21.xyz,lineColor.xyz).xyz,vec3(lineColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),lineColor.xyz,vec3(lineColor.w)),lineColor.w);
}
#else
{
vec4 l9_26;
...
{
l9_27=clamp(lineColor.w,0.0,1.0);
}
#else
{
l9_27=lineColor.w;
...
#endif
l9_26=vec4(lineColor.xyz*l9_27,l9_27);
}
#else
{
l9_26=lineColor;
...
{
l9_30=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_30=vec4(0.0);
...
vec4 l9_32=outputMotionVectorsIfNeeded(varPos,max(l9_31,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_34-0.0039215689)),min(1.0,l9_34+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_36=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_35).xy);
float l9_37=packValue(l9_36);
int l9_44=int(l9_33.w*255.0);
float l9_45=packValue(l9_44);
sc_writeFragData0(vec4(packValue(l9_36),packValue(l9_36),packValue(l9_36),packValue(l9_36)));
...
if (l9_53==0)
{
l9_56=texture2D(sc_OITAlpha0,l9_48);
l9_55=texture2D(sc_OITDepthLow0,l9_48);
l9_54=texture2D(sc_OITDepthHigh0,l9_48);
}
else
{
l9_56=vec4(0.0);
...
if (l9_53==1)
{
l9_59=texture2D(sc_OITAlpha1,l9_48);
l9_58=texture2D(sc_OITDepthLow1,l9_48);
l9_57=texture2D(sc_OITDepthHigh1,l9_48);
}
else
{
l9_59=l9_56;
...
vec4 l9_74=texture2D(sc_OITFilteredDepthBoundsTexture,l9_48);
vec2 l9_75=l9_74.xy;
int l9_76;
#if (sc_SkinBonesCount>0)
{
