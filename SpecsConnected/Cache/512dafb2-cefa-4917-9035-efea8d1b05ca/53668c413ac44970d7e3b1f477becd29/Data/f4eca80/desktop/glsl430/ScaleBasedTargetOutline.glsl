...
l9_33=varTangent.xyz;
l9_32=l9_30;
l9_31=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(lineWeight+1.0))+vec3(Port_Input2_N008),1.0)).xyz;
}
varPos=l9_31;
...
{
if (lineColor.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (lineColor.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_2=clamp(lineColor.w*2.0,0.0,1.0);
}
#else
{
float l9_3;
...
{
l9_3=clamp(dot(lineColor.xyz,vec3(lineColor.w)),0.0,1.0);
}
#else
{
float l9_4;
...
{
l9_5=(1.0-dot(lineColor.xyz,vec3(0.33333001)))*lineColor.w;
}
#else
{
float l9_6;
...
{
l9_6=(1.0-clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0))*lineColor.w;
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0)*lineColor.w;
}
#else
{
float l9_8;
#if (sc_BlendMode_Add)
{
l9_8=clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_9;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_9=clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0)*lineColor.w;
}
#else
{
float l9_10;
...
{
l9_10=dot(lineColor.xyz,vec3(0.33333001))*lineColor.w;
}
#else
{
float l9_11;
#if (sc_BlendMode_Min)
{
l9_11=1.0-clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_Max)
{
l9_12=clamp(dot(lineColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_12=1.0;
...
#endif
l9_0=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*lineColor.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_1);
}
#else
{
vec4 l9_13;
...
#if (sc_FramebufferFetch)
{
vec4 l9_16=sc_readFragData0_Platform();
vec4 l9_17;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_18=l9_16;
l9_18.x=l9_16.x+_sc_framebufferFetchMarker;
l9_17=l9_18;
}
#else
{
...
{
l9_21=sc_SampleView(sc_ScreenTextureDims.xy,l9_19,sc_ScreenTextureLayout,l9_20,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_21=sc_SampleView(sc_ScreenTextureDims.xy,l9_19,sc_ScreenTextureLayout,l9_20,0.0,sc_ScreenTexture);
}
#endif
l9_15=l9_21;
}
...
{
vec4 l9_23=l9_15;
l9_23.x=l9_15.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_22=l9_23;
}
#else
{
...
#endif
vec3 l9_24=mix(l9_22.xyz,definedBlend(l9_22.xyz,lineColor.xyz).xyz,vec3(lineColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_26=vec4(mix(vec3(1.0),lineColor.xyz,vec3(lineColor.w)),lineColor.w);
}
#else
{
vec4 l9_27;
...
{
l9_28=clamp(lineColor.w,0.0,1.0);
}
#else
{
l9_28=lineColor.w;
...
#endif
l9_27=vec4(lineColor.xyz*l9_28,l9_28);
}
#else
{
l9_27=lineColor;
...
{
l9_31=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_31=vec4(0.0);
...
vec4 l9_33=outputMotionVectorsIfNeeded(varPos,max(l9_32,vec4(0.0)));
vec4 l9_34=clamp(l9_33,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_35=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_35-0.0039215689)),min(1.0,l9_35+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_36).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_37=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_36).xy);
float l9_38=packValue(l9_37);
int l9_45=int(l9_34.w*255.0);
float l9_46=packValue(l9_45);
sc_writeFragData0(vec4(packValue(l9_37),packValue(l9_37),packValue(l9_37),packValue(l9_37)));
sc_writeFragData1(vec4(l9_38,packValue(l9_37),packValue(l9_37),packValue(l9_37)));
sc_writeFragData2(vec4(l9_46,packValue(l9_45),packValue(l9_45),packValue(l9_45)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_49).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_54==0)
{
l9_57=texture(sc_OITAlpha0,l9_49);
l9_56=texture(sc_OITDepthLow0,l9_49);
l9_55=texture(sc_OITDepthHigh0,l9_49);
}
else
{
l9_57=vec4(0.0);
...
if (l9_54==1)
{
l9_60=texture(sc_OITAlpha1,l9_49);
l9_59=texture(sc_OITDepthLow1,l9_49);
l9_58=texture(sc_OITDepthHigh1,l9_49);
}
else
{
l9_60=l9_57;
...
if (any(notEqual(l9_58,vec4(0.0)))||any(notEqual(l9_59,vec4(0.0))))
{
int l9_61[8]=l9_50;
unpackValues(l9_58.w,l9_54,l9_61);
unpackValues(l9_58.z,l9_54,l9_61);
unpackValues(l9_58.y,l9_54,l9_61);
unpackValues(l9_58.x,l9_54,l9_61);
unpackValues(l9_59.w,l9_54,l9_61);
unpackValues(l9_59.z,l9_54,l9_61);
unpackValues(l9_59.y,l9_54,l9_61);
unpackValues(l9_59.x,l9_54,l9_61);
int l9_70[8]=l9_51;
unpackValues(l9_60.w,l9_54,l9_70);
unpackValues(l9_60.z,l9_54,l9_70);
unpackValues(l9_60.y,l9_54,l9_70);
unpackValues(l9_60.x,l9_54,l9_70);
}
l9_54++;
continue;
}
...
vec4 l9_75=texture(sc_OITFilteredDepthBoundsTexture,l9_49);
vec2 l9_76=l9_75.xy;
int l9_77;
#if (sc_SkinBonesCount>0)
{
l9_77=encodeDepth(((1.0-l9_75.x)*1000.0)+getDepthOrderingEpsilon(),l9_76);
}
#else
{
l9_77=0;
...
#endif
int l9_78=encodeDepth(viewSpaceDepth(),l9_76);
vec4 l9_79;
l9_79=l9_34*l9_34.w;
vec4 l9_80;
int l9_81=0;
...
if (l9_81<8)
{
int l9_82=l9_50[l9_81];
int l9_83=l9_78-l9_77;
bool l9_84=l9_82<l9_83;
bool l9_85;
if (l9_84)
{
l9_85=l9_50[l9_81]>0;
...
if (l9_85)
{
vec3 l9_86=l9_79.xyz*(1.0-(float(l9_51[l9_81])/255.0));
l9_80=vec4(l9_86.x,l9_86.y,l9_86.z,l9_79.w);
}
else
{
l9_80=l9_79;
