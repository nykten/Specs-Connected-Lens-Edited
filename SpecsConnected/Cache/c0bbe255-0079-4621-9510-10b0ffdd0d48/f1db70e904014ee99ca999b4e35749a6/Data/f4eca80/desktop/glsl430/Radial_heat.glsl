...
//sampler sampler Tweak_N16SmpSC 2:16
...
//texture texture2D Tweak_N16 2:0:2:16
...
//texture texture2DArray Tweak_N16ArrSC 2:25:2:16
//texture texture2DArray intensityTextureArrSC 2:26:2:17
//texture texture2DArray sc_ScreenTextureArrSC 2:29:2:22
//SG_REFLECTION_END
...
uniform vec4 Tweak_N16Size;
uniform vec4 Tweak_N16View;
uniform mat3 Tweak_N16Transform;
uniform vec4 Tweak_N16UvMinMax;
uniform vec4 Tweak_N16BorderColor;
uniform float Port_Input0_N003;
uniform float Port_Input1_N003;
uniform vec2 Port_Input1_N002;
uniform vec4 Port_Value0_N009;
uniform float Port_Position1_N009;
uniform vec4 Port_Value1_N009;
uniform vec4 Port_Value2_N009;
uniform float Port_Multiplier_N007;
...
uniform vec2 Port_Import_N023;
uniform vec2 Port_Direction_N001;
uniform float Port_Speed_N001;
uniform vec2 Port_Scale_N008;
uniform vec2 Port_Center_N008;
uniform float Port_Input1_N024;
uniform float Port_Input1_N025;
uniform float Port_Input0_N018;
...
l9_33=varTangent.xyz;
l9_32=l9_30;
l9_31=(sc_ModelMatrix*vec4((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(heating*Port_Input1_N019),1.0)).xyz;
}
varPos=l9_31;
varNormal=normalize(l9_32);
vec3 l9_34=normalize(l9_33);
varTangent=vec4(l9_34.x,l9_34.y,l9_34.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_35=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_36;
#if (sc_RenderingSpace==2)
{
l9_36=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_37;
#if (sc_RenderingSpace==1)
{
l9_37=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_37=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_39=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_40;
...
#endif
vec4 l9_43=sc_ProjectorMatrix*l9_42;
varShadowTex=((l9_43.xy/vec2(l9_43.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_44;
...
{
vec4 l9_46=l9_38;
l9_46.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_38.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_38.w;
l9_45=l9_46;
}
else
{
...
{
float l9_47=dot(l9_44,sc_StereoClipPlanes[sc_StereoViewID]);
...
#endif
#ifndef Tweak_N16HasSwappedViews
#define Tweak_N16HasSwappedViews 0
#elif Tweak_N16HasSwappedViews==1
#undef Tweak_N16HasSwappedViews
#define Tweak_N16HasSwappedViews 1
#endif
#ifndef Tweak_N16Layout
#define Tweak_N16Layout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N16
#define SC_USE_UV_TRANSFORM_Tweak_N16 0
#elif SC_USE_UV_TRANSFORM_Tweak_N16==1
#undef SC_USE_UV_TRANSFORM_Tweak_N16
#define SC_USE_UV_TRANSFORM_Tweak_N16 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N16
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N16 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N16
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N16 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N16
#define SC_USE_UV_MIN_MAX_Tweak_N16 0
#elif SC_USE_UV_MIN_MAX_Tweak_N16==1
#undef SC_USE_UV_MIN_MAX_Tweak_N16
#define SC_USE_UV_MIN_MAX_Tweak_N16 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N16
#define SC_USE_CLAMP_TO_BORDER_Tweak_N16 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N16==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N16
#define SC_USE_CLAMP_TO_BORDER_Tweak_N16 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform float Port_Input1_N019;
uniform vec2 Port_Import_N031;
uniform sampler2D Tweak_N16;
uniform sampler2DArray Tweak_N16ArrSC;
...
int Tweak_N16GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N16HasSwappedViews)
{
...
float l9_2=smoothstep(Port_Input0_N003,Port_Input1_N003,distance(varPackedTex.xy,Port_Input1_N002));
float l9_3=clamp(l9_2,0.0,1.0);
vec4 l9_4;
if (l9_3<Port_Position1_N009)
{
l9_4=mix(Port_Value0_N009,Port_Value1_N009,vec4(clamp(l9_3/Port_Position1_N009,0.0,1.0)));
}
else
{
l9_4=mix(Port_Value1_N009,Port_Value2_N009,vec4(clamp((l9_3-Port_Position1_N009)/(1.0-Port_Position1_N009),0.0,1.0)));
}
...
{
l9_8=PreviewVertexColor;
l9_7=l9_0;
}
float l9_10=l9_1*Port_Multiplier_N007;
float l9_11=radians(l9_10*Port_Input1_N026);
float l9_12=sin(l9_11);
float l9_13=cos(l9_11);
vec2 l9_14=varPackedTex.xy-Port_Center_N014;
float l9_15=radians(Port_Import_N029);
float l9_16=sin(l9_15);
float l9_17=cos(l9_15);
vec2 l9_18=(vec2(dot(vec2(l9_13,l9_12),l9_14),dot(vec2(-l9_12,l9_13),l9_14))+Port_Center_N014)-Port_Import_N023;
vec2 l9_19=((vec2(dot(vec2(l9_17,l9_16),l9_18),dot(vec2(-l9_16,l9_17),l9_18))*(Port_Import_N030*2.0))+Port_Import_N023)-Port_Import_N023;
float l9_20=l9_19.x;
float l9_21=l9_19.y;
float l9_22=(l9_20*l9_20)+(l9_21*l9_21);
float l9_23;
if (l9_22<=0.0)
{
l9_23=0.0;
...
{
l9_24=atan(l9_21,l9_20);
}
float l9_25=l9_24-(-3.1415927);
vec2 l9_26=vec2(l9_23,0.0+((l9_25*1.0)/(3.1415927-(-3.1415927))));
float l9_27=l9_1*Port_Speed_N001;
vec2 l9_28=(((l9_26+(Port_Direction_N001*l9_27))-Port_Center_N008)*Port_Scale_N008)+Port_Center_N008;
vec4 l9_29;
#if (Tweak_N16Layout==2)
{
l9_29=sc_SampleTextureBiasOrLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_28,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,0.0,Tweak_N16ArrSC);
}
#else
{
l9_29=sc_SampleTextureBiasOrLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_28,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,0.0,Tweak_N16);
}
#endif
float l9_30;
if (l9_29.x<=0.0)
...
{
l9_30=pow(l9_29.x,Port_Input1_N024);
}
float l9_31=(1.0-l9_2)*l9_30;
float l9_32;
if (l9_31<=0.0)
{
l9_32=0.0;
...
{
l9_32=pow(l9_31,Port_Input1_N025);
}
vec4 l9_33=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_33.w=l9_32*min(smoothstep(Port_Input0_N018,Port_Input1_N018,heating),smoothstep(Port_Input0_N035,Port_Input1_N035,heating));
vec4 l9_34=l9_33*vec4(Port_Input1_N037);
float l9_35=l9_34.w;
...
{
l9_39=clamp(dot(l9_34.xyz,vec3(l9_35)),0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_41=(1.0-dot(l9_34.xyz,vec3(0.33333001)))*l9_35;
}
#else
{
float l9_42;
...
{
l9_42=(1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0))*l9_35;
}
#else
{
float l9_43;
...
{
l9_43=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_35;
}
#else
{
float l9_44;
#if (sc_BlendMode_Add)
{
l9_44=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=dot(l9_34.xyz,vec3(0.33333001))*l9_35;
}
#else
{
float l9_47;
#if (sc_BlendMode_Min)
{
l9_47=1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_48;
#if (sc_BlendMode_Max)
{
l9_48=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_48=1.0;
...
#endif
l9_36=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_34.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_37);
}
#else
{
vec4 l9_49;
...
{
l9_57=sc_SampleView(sc_ScreenTextureDims.xy,l9_55,sc_ScreenTextureLayout,l9_56,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_57=sc_SampleView(sc_ScreenTextureDims.xy,l9_55,sc_ScreenTextureLayout,l9_56,0.0,sc_ScreenTexture);
}
#endif
l9_51=l9_57;
}
...
{
vec4 l9_59=l9_51;
l9_59.x=l9_51.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_58=l9_59;
}
#else
{
...
#endif
vec3 l9_60=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_34.xyz).xyz,vec3(l9_35));
vec4 l9_61=vec4(l9_60.x,l9_60.y,l9_60.z,vec4(0.0).w);
l9_61.w=1.0;
l9_50=l9_61;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_62=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_63;
...
#endif
l9_63=vec4(l9_34.xyz*l9_64,l9_64);
}
#else
{
l9_63=l9_34;
...
{
l9_67=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_67=vec4(0.0);
...
vec4 l9_69=outputMotionVectorsIfNeeded(varPos,max(l9_68,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_71-0.0039215689)),min(1.0,l9_71+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_73=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_72).xy);
float l9_74=packValue(l9_73);
int l9_81=int(l9_70.w*255.0);
float l9_82=packValue(l9_81);
sc_writeFragData0(vec4(packValue(l9_73),packValue(l9_73),packValue(l9_73),packValue(l9_73)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_85=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_90==0)
{
l9_93=texture(sc_OITAlpha0,l9_85);
l9_92=texture(sc_OITDepthLow0,l9_85);
l9_91=texture(sc_OITDepthHigh0,l9_85);
}
else
{
l9_93=vec4(0.0);
...
if (l9_90==1)
{
l9_96=texture(sc_OITAlpha1,l9_85);
l9_95=texture(sc_OITDepthLow1,l9_85);
l9_94=texture(sc_OITDepthHigh1,l9_85);
}
else
{
l9_96=l9_93;
...
vec4 l9_111=texture(sc_OITFilteredDepthBoundsTexture,l9_85);
