...
//}
//ubo int UserUniforms 2:37:4912 {
...
//float4 Port_Value0_N016 4608
//float Port_Position1_N016 4624
//float4 Port_Value1_N016 4640
//float Port_Position2_N016 4656
//float4 Port_Value2_N016 4672
//float Port_Position3_N016 4688
//float4 Port_Value3_N016 4704
//float4 Port_Value4_N016 4720
//float4 Port_Input1_N050 4736
//float4 Port_Input0_N048 4752
//float3 Port_Normal_N023 4768
//float Port_Exponent_N023 4784
//float Port_Intensity_N023 4788
//float4 Port_Input0_N020 4800
//float4 Port_Input1_N020 4816
//float2 Port_Scale_N019 4832
//float2 Port_Center_N019 4840
//float Port_Rotation_N035 4848
//float2 Port_Center_N035 4856
//float Port_Value0_N030 4864
//float Port_Position1_N030 4868
//float Port_Value1_N030 4872
//float Port_Position2_N030 4876
//float Port_Value2_N030 4880
//float Port_Position3_N030 4884
//float Port_Value3_N030 4888
//float Port_Value4_N030 4892
//float depthRef 4896
//}
...
float4 Port_Value0_N016;
float Port_Position1_N016;
float4 Port_Value1_N016;
float Port_Position2_N016;
float4 Port_Value2_N016;
float Port_Position3_N016;
float4 Port_Value3_N016;
float4 Port_Value4_N016;
float4 Port_Input1_N050;
float4 Port_Input0_N048;
float3 Port_Normal_N023;
float Port_Exponent_N023;
float Port_Intensity_N023;
float4 Port_Input0_N020;
float4 Port_Input1_N020;
float2 Port_Scale_N019;
float2 Port_Center_N019;
float Port_Rotation_N035;
float2 Port_Center_N035;
float Port_Value0_N030;
float Port_Position1_N030;
float Port_Value1_N030;
float Port_Position2_N030;
float Port_Value2_N030;
float Port_Position3_N030;
float Port_Value3_N030;
float Port_Value4_N030;
float depthRef;
};
struct sc_Bone_t
{
...
float param_37=Export_N55.x;
float4 param_38=(*sc_set2.UserUniforms).Port_Value0_N016;
float param_39=(*sc_set2.UserUniforms).Port_Position1_N016;
float4 param_40=(*sc_set2.UserUniforms).Port_Value1_N016;
float param_41=(*sc_set2.UserUniforms).Port_Position2_N016;
float4 param_42=(*sc_set2.UserUniforms).Port_Value2_N016;
float param_43=(*sc_set2.UserUniforms).Port_Position3_N016;
float4 param_44=(*sc_set2.UserUniforms).Port_Value3_N016;
float4 param_45=(*sc_set2.UserUniforms).Port_Value4_N016;
...
Value_N16=param_46;
float Rim_N23=0.0;
float3 param_47=(*sc_set2.UserUniforms).Port_Normal_N023;
float param_48=(*sc_set2.UserUniforms).Port_Exponent_N023;
float param_49=(*sc_set2.UserUniforms).Port_Intensity_N023;
...
float l9_257=abs(dot(-param_51.ViewDirWS,param_47));
float param_50=pow(1.0-l9_257,param_48);
param_50=fast::max(param_50,0.0);
param_50*=param_49;
Rim_N23=param_50;
float2 UVCoord_N17=float2(0.0);
UVCoord_N17=Globals.Surface_UVCoord0;
float2 CoordsOut_N19=float2(0.0);
CoordsOut_N19=((UVCoord_N17-(*sc_set2.UserUniforms).Port_Center_N019)*(*sc_set2.UserUniforms).Port_Scale_N019)+(*sc_set2.UserUniforms).Port_Center_N019;
...
int l9_263=l9_258;
int param_52=capsule_btn_refl_tex_1Layout_tmp;
int param_53=l9_263;
float2 param_54=CoordsOut_N19;
bool param_55=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1_tmp)!=0);
float3x3 param_56=(*sc_set2.UserUniforms).capsule_btn_refl_tex_1Transform;
int2 param_57=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1_tmp);
bool param_58=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_59=(*sc_set2.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_60=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_61=(*sc_set2.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_62=0.0;
bool l9_264=param_60&&(!param_58);
float l9_265=1.0;
float l9_266=param_54.x;
int l9_267=param_57.x;
if (l9_267==1)
{
l9_266=fract(l9_266);
}
...
param_54.x=l9_266;
float l9_271=param_54.y;
int l9_272=param_57.y;
if (l9_272==1)
{
l9_271=fract(l9_271);
}
...
float l9_278=param_54.x;
float l9_279=param_59.x;
float l9_280=param_59.z;
bool l9_281=l9_277;
float l9_282=l9_265;
...
float l9_287=param_54.y;
float l9_288=param_59.y;
float l9_289=param_59.w;
bool l9_290=l9_286;
float l9_291=l9_265;
...
float2 l9_294=param_54;
bool l9_295=param_55;
float3x3 l9_296=param_56;
if (l9_295)
{
l9_294=float2((l9_296*float3(l9_294,1.0)).xy);
}
float2 l9_297=l9_294;
float2 l9_298=l9_297;
float2 l9_299=l9_298;
param_54=l9_299;
float l9_300=param_54.x;
int l9_301=param_57.x;
bool l9_302=l9_264;
float l9_303=l9_265;
...
param_54.x=l9_300;
l9_265=l9_303;
float l9_311=param_54.y;
int l9_312=param_57.y;
bool l9_313=l9_264;
float l9_314=l9_265;
...
param_54.y=l9_311;
l9_265=l9_314;
float2 l9_322=param_54;
int l9_323=param_52;
int l9_324=param_53;
float l9_325=param_62;
...
float2 l9_332=l9_331.xy;
float l9_333=l9_325;
float4 l9_334=sc_set2.capsule_btn_refl_tex_1.sample(sc_set2.capsule_btn_refl_tex_1SmpSC,l9_332,bias(l9_333));
float4 l9_335=l9_334;
float4 l9_336=l9_335;
if (param_60)
{
l9_336=mix(param_61,l9_336,float4(l9_265));
}
float4 l9_337=l9_336;
Color_N0=l9_337;
float4 Output_N20=float4(0.0);
Output_N20=smoothstep((*sc_set2.UserUniforms).Port_Input0_N020,(*sc_set2.UserUniforms).Port_Input1_N020,Color_N0);
float4 Output_N48=float4(0.0);
Output_N48=mix((*sc_set2.UserUniforms).Port_Input0_N048,float4(Rim_N23),Output_N20);
float4 Output_N50=float4(0.0);
Output_N50=mix(Value_N16,(*sc_set2.UserUniforms).Port_Input1_N050,Output_N48);
float2 CoordsOut_N35=float2(0.0);
float2 param_63=CoordsOut_N19;
float param_64=(*sc_set2.UserUniforms).Port_Rotation_N035;
float2 param_65=(*sc_set2.UserUniforms).Port_Center_N035;
float l9_338=sin(radians(param_64));
float l9_339=cos(radians(param_64));
float2 param_66=param_63-param_65;
param_66=float2(dot(float2(l9_339,l9_338),param_66),dot(float2(-l9_338,l9_339),param_66))+param_65;
CoordsOut_N35=param_66;
float Value_N30=0.0;
float param_67=CoordsOut_N35.x;
float param_68=(*sc_set2.UserUniforms).Port_Value0_N030;
float param_69=(*sc_set2.UserUniforms).Port_Position1_N030;
float param_70=(*sc_set2.UserUniforms).Port_Value1_N030;
float param_71=(*sc_set2.UserUniforms).Port_Position2_N030;
float param_72=(*sc_set2.UserUniforms).Port_Value2_N030;
float param_73=(*sc_set2.UserUniforms).Port_Position3_N030;
float param_74=(*sc_set2.UserUniforms).Port_Value3_N030;
float param_75=(*sc_set2.UserUniforms).Port_Value4_N030;
param_67=fast::clamp(param_67,0.0,1.0);
float param_76;
if (param_67<param_69)
{
param_76=mix(param_68,param_70,fast::clamp(param_67/param_69,0.0,1.0));
}
else
{
if (param_67<param_71)
{
param_76=mix(param_70,param_72,fast::clamp((param_67-param_69)/(param_71-param_69),0.0,1.0));
}
else
{
if (param_67<param_73)
{
param_76=mix(param_72,param_74,fast::clamp((param_67-param_71)/(param_73-param_71),0.0,1.0));
}
else
{
param_76=mix(param_74,param_75,fast::clamp((param_67-param_73)/(1.0-param_73),0.0,1.0));
}
}
}
Value_N30=param_76;
float4 Value_N18=float4(0.0);
Value_N18=float4(Output_N50.xyz.x,Output_N50.xyz.y,Output_N50.xyz.z,Value_N18.w);
Value_N18.w=Value_N30;
float4 Output_N100=float4(0.0);
Output_N100=Output_N2+Value_N18;
FinalColor=Output_N100;
float param_77=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_77<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_341=floor(mod(l9_340.xy,float2(4.0)));
float l9_342=(mod(dot(l9_341,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_77<l9_342)
{
discard_fragment();
}
}
bool l9_343=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_343)
{
...
float4 l9_344=fast::max(param_78,float4(0.0));
float4 param_79=l9_344;
out.FragColor0=param_79;
return out;
}
float4 param_80=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_345=param_80;
...
{
l9_347=fast::clamp(l9_346.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_347=fast::clamp(dot(l9_346.xyz,float3(l9_346.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_347=(1.0-dot(l9_346.xyz,float3(0.33333001)))*l9_346.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_347=(1.0-fast::clamp(dot(l9_346.xyz,float3(1.0)),0.0,1.0))*l9_346.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_347=fast::clamp(dot(l9_346.xyz,float3(1.0)),0.0,1.0)*l9_346.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_347=fast::clamp(dot(l9_346.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_347=dot(l9_346.xyz,float3(0.33333001))*l9_346.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_347=1.0-fast::clamp(dot(l9_346.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_348=l9_347;
float l9_349=l9_348;
float l9_350=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_349;
float3 l9_351=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_345.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_352=float4(l9_351.x,l9_351.y,l9_351.z,l9_350);
param_80=l9_352;
}
else
{
...
{
param_80=float4(param_80.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_353=param_80;
float4 l9_354=float4(0.0);
float4 l9_355=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_356=out.FragColor0;
float4 l9_357=l9_356;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_357.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_360=(l9_359.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_365=l9_364;
int l9_366=l9_365;
float3 l9_367=float3(l9_361,0.0);
int l9_368=l9_363;
int l9_369=l9_366;
if (l9_368==1)
{
l9_367.y=((2.0*l9_367.y)+float(l9_369))-1.0;
}
float2 l9_370=l9_367.xy;
l9_362=l9_370;
}
else
{
...
int l9_379=l9_374;
float2 l9_380=l9_373;
int l9_381=l9_379;
float2 l9_382=l9_380;
int l9_383=l9_381;
float l9_384=0.0;
float4 l9_385=float4(0.0);
float2 l9_386=l9_382;
int l9_387=sc_ScreenTextureLayout_tmp;
int l9_388=l9_383;
float l9_389=l9_384;
...
float l9_397=l9_389;
float4 l9_398=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_396,bias(l9_397));
float4 l9_399=l9_398;
l9_385=l9_399;
float4 l9_400=l9_385;
float4 l9_401=l9_400;
float4 l9_402=l9_401;
l9_355=l9_402;
}
float4 l9_403=l9_355;
float4 l9_404=l9_403;
float3 l9_405=l9_404.xyz;
float3 l9_406=l9_405;
float3 l9_407=l9_353.xyz;
float3 l9_408=definedBlend(l9_406,l9_407,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_354=float4(l9_408.x,l9_408.y,l9_408.z,l9_354.w);
float3 l9_409=mix(l9_405,l9_354.xyz,float3(l9_353.w));
l9_354=float4(l9_409.x,l9_409.y,l9_409.z,l9_354.w);
l9_354.w=1.0;
float4 l9_410=l9_354;
param_80=l9_410;
}
else
{
float4 l9_411=param_80;
float4 l9_412=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_412=float4(mix(float3(1.0),l9_411.xyz,float3(l9_411.w)),l9_411.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_413=l9_411.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_413=fast::clamp(l9_413,0.0,1.0);
}
l9_412=float4(l9_411.xyz*l9_413,l9_413);
}
else
{
l9_412=l9_411;
...
float4 l9_414=l9_412;
param_80=l9_414;
}
}
}
float4 l9_415=param_80;
FinalColor=l9_415;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_416=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_416=float4(0.0);
...
float3 param_81=in.varPos;
float4 param_82=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_81,param_82,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_83=FinalColor;
float4 l9_418=param_83;
out.FragColor0=l9_418;
return out;
}
} // FRAGMENT SHADER
