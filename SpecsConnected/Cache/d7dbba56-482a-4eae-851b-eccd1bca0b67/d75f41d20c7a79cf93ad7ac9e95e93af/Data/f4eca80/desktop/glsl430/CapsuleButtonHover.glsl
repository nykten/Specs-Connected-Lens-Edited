...
vec4 l9_29;
if (l9_28<Port_Position1_N016)
{
l9_29=mix(Port_Value0_N016,Port_Value1_N016,vec4(clamp(l9_28/Port_Position1_N016,0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_28<Port_Position2_N016)
{
l9_30=mix(Port_Value1_N016,Port_Value2_N016,vec4(clamp((l9_28-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_28<Port_Position3_N016)
{
l9_31=mix(Port_Value2_N016,Port_Value3_N016,vec4(clamp((l9_28-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0)));
}
else
{
l9_31=mix(Port_Value3_N016,Port_Value4_N016,vec4(clamp((l9_28-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0)));
}
l9_30=l9_31;
}
l9_29=l9_30;
...
vec3 l9_32=-l9_4;
vec2 l9_33=l9_3-Port_Center_N019;
vec2 l9_34=(l9_33*Port_Scale_N019)+Port_Center_N019;
vec4 l9_35;
#if (capsule_btn_refl_tex_1Layout==2)
{
l9_35=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_34,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1ArrSC);
}
#else
{
l9_35=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_34,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1);
...
#endif
vec4 l9_36=smoothstep(Port_Input0_N020,Port_Input1_N020,l9_35);
vec4 l9_37=mix(l9_29,Port_Input1_N050,mix(Port_Input0_N048,vec4(max(pow(1.0-abs(dot(l9_32,l9_11*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023),l9_36));
float l9_38=radians(Port_Rotation_N035);
float l9_39=clamp((vec2(dot(vec2(cos(l9_38),sin(l9_38)),l9_34-Port_Center_N035),0.0)+Port_Center_N035).x,0.0,1.0);
float l9_40;
if (l9_39<Port_Position1_N030)
{
l9_40=mix(Port_Value0_N030,Port_Value1_N030,clamp(l9_39/Port_Position1_N030,0.0,1.0));
}
else
{
float l9_41;
if (l9_39<Port_Position2_N030)
{
l9_41=mix(Port_Value1_N030,Port_Value2_N030,clamp((l9_39-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0));
}
else
{
float l9_42;
if (l9_39<Port_Position3_N030)
{
l9_42=mix(Port_Value2_N030,Port_Value3_N030,clamp((l9_39-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0));
}
else
{
l9_42=mix(Port_Value3_N030,Port_Value4_N030,clamp((l9_39-Port_Position3_N030)/(1.0-Port_Position3_N030),0.0,1.0));
}
l9_41=l9_42;
}
l9_40=l9_41;
}
vec4 l9_43=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_43.w=l9_40;
vec4 l9_44=l9_20+l9_43;
float l9_45=l9_44.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_45<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_45<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_46,vec4(0.0)));
return;
}
vec4 l9_48;
...
{
l9_51=clamp(dot(l9_44.xyz,vec3(l9_45)),0.0,1.0);
}
#else
{
float l9_52;
...
{
l9_53=(1.0-dot(l9_44.xyz,vec3(0.33333001)))*l9_45;
}
#else
{
float l9_54;
...
{
l9_54=(1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0))*l9_45;
}
#else
{
float l9_55;
...
{
l9_55=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_45;
}
#else
{
float l9_56;
#if (sc_BlendMode_Add)
{
l9_56=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_57=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_45;
}
#else
{
float l9_58;
...
{
l9_58=dot(l9_44.xyz,vec3(0.33333001))*l9_45;
}
#else
{
float l9_59;
#if (sc_BlendMode_Min)
{
l9_59=1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
#if (sc_BlendMode_Max)
{
l9_60=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_60=1.0;
...
#endif
l9_48=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_44.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_49);
}
#else
{
vec4 l9_61;
...
{
l9_69=sc_SampleView(sc_ScreenTextureDims.xy,l9_67,sc_ScreenTextureLayout,l9_68,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_69=sc_SampleView(sc_ScreenTextureDims.xy,l9_67,sc_ScreenTextureLayout,l9_68,0.0,sc_ScreenTexture);
}
#endif
l9_63=l9_69;
}
...
{
vec4 l9_71=l9_63;
l9_71.x=l9_63.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_70=l9_71;
}
#else
{
...
#endif
vec3 l9_72=mix(l9_70.xyz,definedBlend(l9_70.xyz,l9_44.xyz).xyz,vec3(l9_45));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_74=vec4(mix(vec3(1.0),l9_44.xyz,vec3(l9_45)),l9_45);
}
#else
{
vec4 l9_75;
...
#endif
l9_75=vec4(l9_44.xyz*l9_76,l9_76);
}
#else
{
l9_75=l9_44;
...
{
l9_79=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_79=vec4(0.0);
...
vec4 l9_81=outputMotionVectorsIfNeeded(varPos,max(l9_80,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_83-0.0039215689)),min(1.0,l9_83+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_85),packValue(l9_85),packValue(l9_85),packValue(l9_85)));
