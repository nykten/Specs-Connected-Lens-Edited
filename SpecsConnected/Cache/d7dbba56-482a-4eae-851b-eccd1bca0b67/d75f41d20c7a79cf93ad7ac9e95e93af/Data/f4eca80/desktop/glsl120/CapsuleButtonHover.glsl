...
vec4 l9_14=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_11*l9_13,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045)).xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1);
float l9_15=clamp((vec4(Port_Import_N027)*l9_14).x,0.0,1.0);
vec4 l9_16;
if (l9_15<Port_Position1_N016)
{
l9_16=mix(Port_Value0_N016,Port_Value1_N016,vec4(clamp(l9_15/Port_Position1_N016,0.0,1.0)));
}
else
{
vec4 l9_17;
if (l9_15<Port_Position2_N016)
{
l9_17=mix(Port_Value1_N016,Port_Value2_N016,vec4(clamp((l9_15-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0)));
}
else
{
vec4 l9_18;
if (l9_15<Port_Position3_N016)
{
l9_18=mix(Port_Value2_N016,Port_Value3_N016,vec4(clamp((l9_15-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0)));
}
else
{
l9_18=mix(Port_Value3_N016,Port_Value4_N016,vec4(clamp((l9_15-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0)));
}
l9_17=l9_18;
}
l9_16=l9_17;
}
vec2 l9_19=((varPackedTex.xy-Port_Center_N019)*Port_Scale_N019)+Port_Center_N019;
vec4 l9_20=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1);
vec4 l9_21=mix(l9_16,Port_Input1_N050,mix(Port_Input0_N048,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023),smoothstep(Port_Input0_N020,Port_Input1_N020,l9_20)));
float l9_22=radians(Port_Rotation_N035);
float l9_23=clamp((vec2(dot(vec2(cos(l9_22),sin(l9_22)),l9_19-Port_Center_N035),0.0)+Port_Center_N035).x,0.0,1.0);
float l9_24;
if (l9_23<Port_Position1_N030)
{
l9_24=mix(Port_Value0_N030,Port_Value1_N030,clamp(l9_23/Port_Position1_N030,0.0,1.0));
}
else
{
float l9_25;
if (l9_23<Port_Position2_N030)
{
l9_25=mix(Port_Value1_N030,Port_Value2_N030,clamp((l9_23-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0));
}
else
{
float l9_26;
if (l9_23<Port_Position3_N030)
{
l9_26=mix(Port_Value2_N030,Port_Value3_N030,clamp((l9_23-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0));
}
else
{
l9_26=mix(Port_Value3_N030,Port_Value4_N030,clamp((l9_23-Port_Position3_N030)/(1.0-Port_Position3_N030),0.0,1.0));
}
l9_25=l9_26;
}
l9_24=l9_25;
}
vec4 l9_27=vec4(l9_21.x,l9_21.y,l9_21.z,vec4(0.0).w);
l9_27.w=l9_24;
vec4 l9_28=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_27;
float l9_29=l9_28.w;
...
{
l9_33=clamp(dot(l9_28.xyz,vec3(l9_29)),0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_35=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*l9_29;
}
#else
{
float l9_36;
...
{
l9_36=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*l9_29;
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_38;
#if (sc_BlendMode_Add)
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_39=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_40;
...
{
l9_40=dot(l9_28.xyz,vec3(0.33333001))*l9_29;
}
#else
{
float l9_41;
#if (sc_BlendMode_Min)
{
l9_41=1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
#if (sc_BlendMode_Max)
{
l9_42=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_42=1.0;
...
#endif
l9_30=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_28.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_31);
}
#else
{
vec4 l9_43;
...
#if (sc_FramebufferFetch)
{
vec4 l9_46=sc_readFragData0_Platform();
vec4 l9_47;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_48=l9_46;
l9_48.x=l9_46.x+_sc_framebufferFetchMarker;
l9_47=l9_48;
}
#else
{
...
#else
{
vec2 l9_49=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_50;
...
#endif
l9_45=sc_SampleView(sc_ScreenTextureDims.xy,l9_49,sc_ScreenTextureLayout,l9_50,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_51;
...
{
vec4 l9_52=l9_45;
l9_52.x=l9_45.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_51=l9_52;
}
#else
{
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_28.xyz).xyz,vec3(l9_29));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_29)),l9_29);
}
#else
{
vec4 l9_56;
...
{
l9_60=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_60=vec4(0.0);
...
vec4 l9_62=outputMotionVectorsIfNeeded(varPos,max(l9_61,vec4(0.0)));
vec4 l9_63=clamp(l9_62,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_64=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_64-0.0039215689)),min(1.0,l9_64+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_65).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_66=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_65).xy);
float l9_67=packValue(l9_66);
int l9_74=int(l9_63.w*255.0);
float l9_75=packValue(l9_74);
sc_writeFragData0(vec4(packValue(l9_66),packValue(l9_66),packValue(l9_66),packValue(l9_66)));
sc_writeFragData1(vec4(l9_67,packValue(l9_66),packValue(l9_66),packValue(l9_66)));
sc_writeFragData2(vec4(l9_75,packValue(l9_74),packValue(l9_74),packValue(l9_74)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_78=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_78).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_83==0)
{
l9_86=texture2D(sc_OITAlpha0,l9_78);
l9_85=texture2D(sc_OITDepthLow0,l9_78);
l9_84=texture2D(sc_OITDepthHigh0,l9_78);
}
else
{
l9_86=vec4(0.0);
...
if (l9_83==1)
{
l9_89=texture2D(sc_OITAlpha1,l9_78);
l9_88=texture2D(sc_OITDepthLow1,l9_78);
l9_87=texture2D(sc_OITDepthHigh1,l9_78);
}
else
{
l9_89=l9_86;
...
if (any(notEqual(l9_87,vec4(0.0)))||any(notEqual(l9_88,vec4(0.0))))
{
int l9_90[8]=l9_79;
unpackValues(l9_87.w,l9_83,l9_90);
unpackValues(l9_87.z,l9_83,l9_90);
unpackValues(l9_87.y,l9_83,l9_90);
unpackValues(l9_87.x,l9_83,l9_90);
unpackValues(l9_88.w,l9_83,l9_90);
unpackValues(l9_88.z,l9_83,l9_90);
unpackValues(l9_88.y,l9_83,l9_90);
unpackValues(l9_88.x,l9_83,l9_90);
int l9_99[8]=l9_80;
unpackValues(l9_89.w,l9_83,l9_99);
unpackValues(l9_89.z,l9_83,l9_99);
unpackValues(l9_89.y,l9_83,l9_99);
unpackValues(l9_89.x,l9_83,l9_99);
}
l9_83++;
continue;
}
...
vec4 l9_104=texture2D(sc_OITFilteredDepthBoundsTexture,l9_78);
vec2 l9_105=l9_104.xy;
int l9_106;
#if (sc_SkinBonesCount>0)
{
l9_106=encodeDepth(((1.0-l9_104.x)*1000.0)+getDepthOrderingEpsilon(),l9_105);
}
#else
{
l9_106=0;
...
#endif
int l9_107=encodeDepth(viewSpaceDepth(),l9_105);
vec4 l9_108;
l9_108=l9_63*l9_63.w;
vec4 l9_109;
int l9_110=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_110<8)
{
int l9_111=l9_79[l9_110];
int l9_112=l9_107-l9_106;
bool l9_113=l9_111<l9_112;
bool l9_114;
if (l9_113)
{
l9_114=l9_79[l9_110]>0;
}
else
{
l9_114=l9_113;
...
if (l9_114)
{
vec3 l9_115=l9_108.xyz*(1.0-(float(l9_80[l9_110])/255.0));
l9_109=vec4(l9_115.x,l9_115.y,l9_115.z,l9_108.w);
}
else
{
l9_109=l9_108;
