...
vec4 l9_6;
if (l9_5<Port_Position1_N005)
{
l9_6=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_5/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_7;
if (l9_5<Port_Position2_N005)
{
l9_7=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_5-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_7=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_5-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_6=l9_7;
}
