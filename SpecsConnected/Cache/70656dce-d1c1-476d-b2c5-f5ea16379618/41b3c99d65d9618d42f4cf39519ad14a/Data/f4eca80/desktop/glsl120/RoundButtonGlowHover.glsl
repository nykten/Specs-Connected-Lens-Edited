...
//sampler sampler glow_mapSmpSC 2:16
...
//texture texture2D glow_map 2:0:2:16
...
uniform vec4 glow_mapSize;
uniform vec4 glow_mapView;
uniform mat3 glow_mapTransform;
uniform vec4 glow_mapUvMinMax;
uniform vec4 glow_mapBorderColor;
uniform vec2 Port_Offset_N009;
...
#endif
#ifndef glow_mapHasSwappedViews
#define glow_mapHasSwappedViews 0
#elif glow_mapHasSwappedViews==1
#undef glow_mapHasSwappedViews
#define glow_mapHasSwappedViews 1
#endif
#ifndef glow_mapLayout
#define glow_mapLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_glow_map
#define SC_USE_UV_TRANSFORM_glow_map 0
#elif SC_USE_UV_TRANSFORM_glow_map==1
#undef SC_USE_UV_TRANSFORM_glow_map
#define SC_USE_UV_TRANSFORM_glow_map 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_glow_map
#define SC_SOFTWARE_WRAP_MODE_U_glow_map -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_glow_map
#define SC_SOFTWARE_WRAP_MODE_V_glow_map -1
#endif
#ifndef SC_USE_UV_MIN_MAX_glow_map
#define SC_USE_UV_MIN_MAX_glow_map 0
#elif SC_USE_UV_MIN_MAX_glow_map==1
#undef SC_USE_UV_MIN_MAX_glow_map
#define SC_USE_UV_MIN_MAX_glow_map 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_glow_map
#define SC_USE_CLAMP_TO_BORDER_glow_map 0
#elif SC_USE_CLAMP_TO_BORDER_glow_map==1
#undef SC_USE_CLAMP_TO_BORDER_glow_map
#define SC_USE_CLAMP_TO_BORDER_glow_map 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
#endif
vec4 l9_2=sc_SampleTextureBiasOrLevel(glow_mapDims.xy,glow_mapLayout,l9_1,varPackedTex.xy+Port_Offset_N009,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map),(int(SC_USE_UV_MIN_MAX_glow_map)!=0),glow_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0),glow_mapBorderColor,0.0,glow_map);
float l9_3=clamp(l9_2.x,0.0,1.0);
vec4 l9_4;
if (l9_3<Port_Position1_N005)
{
l9_4=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_3/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_5;
if (l9_3<Port_Position2_N005)
{
l9_5=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_3-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_5=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_3-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_4=l9_5;
}
...
if (l9_4.x<float(l9_4.x<Port_Input1_N003))
{
discard;
}
...
{
l9_13=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_16=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_19;
#if (sc_BlendMode_Add)
{
l9_19=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_22;
#if (sc_BlendMode_Min)
{
l9_22=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_23;
#if (sc_BlendMode_Max)
{
l9_23=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_23=1.0;
...
#endif
l9_11=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_12);
}
#else
{
vec4 l9_24;
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_37;
...
#endif
l9_37=vec4(l9_4.xyz*l9_38,l9_38);
}
#else
{
l9_37=l9_4;
