...
//float4 Port_Value0_N005 4288
//float Port_Position1_N005 4304
//float4 Port_Value1_N005 4320
//float Port_Position2_N005 4336
//float4 Port_Value2_N005 4352
//float4 Port_Value3_N005 4368
...
float4 param_12=(*sc_set2.UserUniforms).Port_Value0_N005;
float param_13=(*sc_set2.UserUniforms).Port_Position1_N005;
float4 param_14=(*sc_set2.UserUniforms).Port_Value1_N005;
float param_15=(*sc_set2.UserUniforms).Port_Position2_N005;
float4 param_16=(*sc_set2.UserUniforms).Port_Value2_N005;
float4 param_17=(*sc_set2.UserUniforms).Port_Value3_N005;
...
if (l9_88)
{
l9_89=5==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_89=l9_88;
...
Output_N3=float4(float(Value_N5.x<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N5.y<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N5.z<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N5.w<(*sc_set2.UserUniforms).Port_Input1_N003));
float4 Output_N2=float4(0.0);
float4 param_19=Value_N5;
