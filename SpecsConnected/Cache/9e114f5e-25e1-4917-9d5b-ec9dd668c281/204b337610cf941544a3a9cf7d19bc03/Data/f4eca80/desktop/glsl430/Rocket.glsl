...
//sampler sampler Tweak_N25SmpSC 2:23
//sampler sampler Tweak_N6SmpSC 2:24
//sampler sampler intensityTextureSmpSC 2:25
//sampler sampler planet_refl_mapSmpSC 2:26
...
//texture texture2D Tweak_N25 2:3:2:23
//texture texture2D Tweak_N6 2:4:2:24
//texture texture2D intensityTexture 2:5:2:25
//texture texture2D planet_refl_map 2:6:2:26
...
//texture texture2DArray Tweak_N25ArrSC 2:36:2:23
//texture texture2DArray Tweak_N6ArrSC 2:37:2:24
//texture texture2DArray intensityTextureArrSC 2:38:2:25
//texture texture2DArray planet_refl_mapArrSC 2:39:2:26
...
uniform vec4 Tweak_N25Size;
uniform vec4 Tweak_N25View;
uniform mat3 Tweak_N25Transform;
uniform vec4 Tweak_N25UvMinMax;
uniform vec4 Tweak_N25BorderColor;
uniform float Tweak_N66;
uniform float Tweak_N64;
...
uniform vec2 Port_Offset_N062;
uniform vec2 Port_Center_N060;
uniform float Port_Value2_N053;
...
#endif
#ifndef Tweak_N25HasSwappedViews
#define Tweak_N25HasSwappedViews 0
#elif Tweak_N25HasSwappedViews==1
#undef Tweak_N25HasSwappedViews
#define Tweak_N25HasSwappedViews 1
#endif
#ifndef Tweak_N25Layout
#define Tweak_N25Layout 0
#endif
...
#ifndef SC_USE_UV_TRANSFORM_Tweak_N25
#define SC_USE_UV_TRANSFORM_Tweak_N25 0
#elif SC_USE_UV_TRANSFORM_Tweak_N25==1
#undef SC_USE_UV_TRANSFORM_Tweak_N25
#define SC_USE_UV_TRANSFORM_Tweak_N25 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N25
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N25
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N25
#define SC_USE_UV_MIN_MAX_Tweak_N25 0
#elif SC_USE_UV_MIN_MAX_Tweak_N25==1
#undef SC_USE_UV_MIN_MAX_Tweak_N25
#define SC_USE_UV_MIN_MAX_Tweak_N25 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N25
#define SC_USE_CLAMP_TO_BORDER_Tweak_N25 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N25==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N25
#define SC_USE_CLAMP_TO_BORDER_Tweak_N25 1
#endif
#ifndef sc_DepthOnly
...
uniform sampler2D Tweak_N25;
uniform sampler2DArray Tweak_N25ArrSC;
...
int Tweak_N25GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N25HasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
ssGlobals l9_16=ssGlobals(l9_1,l9_2,0.0,l9_9,l9_8,l9_7,l9_6,l9_5,l9_4,l9_3);
mat3 l9_17=mat3(l9_8,l9_7,l9_9);
vec3 l9_18=-l9_6;
vec3 l9_19=normalize(l9_18);
vec3 l9_20=normalize(cross(l9_19,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_21=cross(l9_20,l9_19);
vec2 l9_22=((mat3(vec3(l9_20.x,l9_21.x,l9_19.x),vec3(l9_20.y,l9_21.y,l9_19.y),vec3(l9_20.z,l9_21.z,l9_19.z))*normalize(l9_17*Port_Import_N013)).xy*0.5)+vec2(0.5);
vec4 l9_23;
#if (planet_refl_mapLayout==2)
{
l9_23=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_22,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_mapArrSC);
}
#else
{
...
#endif
vec4 l9_24=vec4(reflIntensity)*l9_23;
vec4 l9_25;
#if (Tweak_N37)
{
vec2 l9_26;
Node3_Rotate_Coords(l9_4,Port_Rotation_N003,Port_Center_N003,l9_26,l9_16);
vec4 l9_27;
Node0_Gradient(l9_26.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_27,l9_16);
vec4 l9_28=l9_27;
vec2 l9_29=l9_4+Port_Offset_N062;
vec2 l9_30=((l9_29-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060;
vec4 l9_31;
#if (Tweak_N25Layout==2)
{
l9_31=sc_SampleTextureBiasOrLevel(Tweak_N25Dims.xy,Tweak_N25Layout,Tweak_N25GetStereoViewIndex(),l9_30,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25),(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0),Tweak_N25UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0),Tweak_N25BorderColor,0.0,Tweak_N25ArrSC);
}
#else
{
l9_31=sc_SampleTextureBiasOrLevel(Tweak_N25Dims.xy,Tweak_N25Layout,Tweak_N25GetStereoViewIndex(),l9_30,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25),(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0),Tweak_N25UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0),Tweak_N25BorderColor,0.0,Tweak_N25);
}
#endif
l9_25=vec4(mix(l9_28.xyz,l9_31.xyz,vec3(l9_31.w)),0.0);
}
#else
{
vec2 l9_32;
Node3_Rotate_Coords(l9_4,Port_Rotation_N003,Port_Center_N003,l9_32,l9_16);
vec4 l9_33;
Node0_Gradient(l9_32.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_33,l9_16);
l9_25=l9_33;
}
#endif
vec4 l9_34=l9_24+l9_25;
vec4 l9_35;
#if (Tweak_N6Layout==2)
{
l9_35=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6ArrSC);
}
#else
{
l9_35=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
...
#endif
vec3 l9_36=l9_34.xyz;
vec3 l9_37=mix(l9_36,(l9_35.xyz*l9_36).xyz,vec3(l9_35.w));
vec4 l9_38=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_38.w=Port_Value2_N053;
#if (sc_BlendMode_AlphaTest)
{
if (Port_Value2_N053<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Value2_N053<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_43=clamp(Port_Value2_N053*2.0,0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_44=clamp(dot(l9_38.xyz,vec3(Port_Value2_N053)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*Port_Value2_N053;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N053;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_49;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_38.xyz,vec3(0.33333001))*Port_Value2_N053;
}
#else
{
float l9_52;
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_38.xyz).xyz,vec3(Port_Value2_N053));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_38.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_68;
...
{
l9_69=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_69=Port_Value2_N053;
}
#endif
