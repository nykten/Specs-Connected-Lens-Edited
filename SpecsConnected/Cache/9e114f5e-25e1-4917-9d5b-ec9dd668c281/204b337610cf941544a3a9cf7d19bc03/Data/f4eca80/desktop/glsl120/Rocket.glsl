...
//sampler sampler Tweak_N25SmpSC 2:18
//sampler sampler Tweak_N6SmpSC 2:19
//sampler sampler intensityTextureSmpSC 2:20
//sampler sampler planet_refl_mapSmpSC 2:21
//sampler sampler sc_OITCommonSampler 2:24
//sampler sampler sc_ScreenTextureSmpSC 2:26
//texture texture2D Tweak_N25 2:0:2:18
//texture texture2D Tweak_N6 2:1:2:19
//texture texture2D intensityTexture 2:2:2:20
//texture texture2D planet_refl_map 2:3:2:21
...
ssGlobals l9_7=ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6,varPos,varPackedTex.xy,varPackedTex.zw);
vec3 l9_8=normalize(-l9_6);
vec3 l9_9=normalize(cross(l9_8,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_10=cross(l9_9,l9_8);
int l9_11;
...
#endif
vec4 l9_12=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,l9_11,((mat3(vec3(l9_9.x,l9_10.x,l9_8.x),vec3(l9_9.y,l9_10.y,l9_8.y),vec3(l9_9.z,l9_10.z,l9_8.z))*normalize(mat3(l9_4,l9_5,l9_3)*Port_Import_N013)).xy*0.5)+vec2(0.5),(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map);
vec4 l9_13;
#if (Tweak_N37)
{
vec2 l9_14;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_14,l9_7);
vec4 l9_15;
Node0_Gradient(l9_14.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_15,l9_7);
vec4 l9_16=l9_15;
int l9_17;
...
#endif
vec4 l9_18=sc_SampleTextureBiasOrLevel(Tweak_N25Dims.xy,Tweak_N25Layout,l9_17,(((varPackedTex.xy+Port_Offset_N062)-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25),(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0),Tweak_N25UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0),Tweak_N25BorderColor,0.0,Tweak_N25);
l9_13=vec4(mix(l9_16.xyz,l9_18.xyz,vec3(l9_18.w)),0.0);
}
#else
{
vec2 l9_19;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_19,l9_7);
vec4 l9_20;
Node0_Gradient(l9_19.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_20,l9_7);
l9_13=l9_20;
}
#endif
vec4 l9_21=(vec4(reflIntensity)*l9_12)+l9_13;
int l9_22;
...
#endif
vec4 l9_23=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,l9_22,varPackedTex.zw,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
vec3 l9_24=l9_21.xyz;
vec3 l9_25=mix(l9_24,(l9_23.xyz*l9_24).xyz,vec3(l9_23.w));
vec4 l9_26=vec4(l9_25.x,l9_25.y,l9_25.z,vec4(0.0).w);
l9_26.w=Port_Value2_N053;
...
{
l9_29=clamp(Port_Value2_N053*2.0,0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(Port_Value2_N053)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*Port_Value2_N053;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N053;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_35;
#if (sc_BlendMode_Add)
{
l9_35=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*Port_Value2_N053;
}
#else
{
float l9_38;
#if (sc_BlendMode_Min)
{
l9_38=1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_Max)
{
l9_39=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_39=1.0;
...
#endif
l9_27=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_26.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_28);
}
#else
{
vec4 l9_40;
...
#endif
l9_42=sc_SampleView(sc_ScreenTextureDims.xy,l9_46,sc_ScreenTextureLayout,l9_47,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_48;
...
{
vec4 l9_49=l9_42;
l9_49.x=l9_42.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_48=l9_49;
}
#else
{
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_26.xyz).xyz,vec3(Port_Value2_N053));
vec4 l9_51=vec4(l9_50.x,l9_50.y,l9_50.z,vec4(0.0).w);
l9_51.w=1.0;
l9_41=l9_51;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_26.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_53;
...
{
l9_54=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_54=Port_Value2_N053;
}
#endif
l9_53=vec4(l9_26.xyz*l9_54,l9_54);
}
#else
{
l9_53=l9_26;
...
{
l9_57=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_57=vec4(0.0);
...
vec4 l9_59=outputMotionVectorsIfNeeded(varPos,max(l9_58,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_62=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
