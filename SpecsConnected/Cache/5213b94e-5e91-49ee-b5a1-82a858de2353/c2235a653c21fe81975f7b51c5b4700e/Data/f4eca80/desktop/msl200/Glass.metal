...
//float2 Port_Scale_N025 4496
//float2 Port_Center_N025 4504
//float Port_Rotation_N003 4512
//float2 Port_Center_N003 4520
//float4 Port_Input1_N029 4528
//float4 Port_Import_N038 4544
//float4 Port_Import_N031 4560
//float Port_Input0_N066 4576
//float Port_Input1_N066 4580
//float Port_RangeMinA_N033 4584
//float Port_RangeMaxA_N033 4588
//float Port_RangeMinB_N033 4592
//float Port_RangeMaxB_N033 4596
//float2 Port_Import_N032 4600
//float2 Port_Center_N047 4608
//float2 Port_Import_N058 4616
//float2 Port_Import_N060 4624
//float Port_Input1_N065 4632
//float Port_Input2_N065 4636
//float depthRef 4640
//}
...
//spec_const bool Tweak_N37 1040
//spec_const bool Tweak_N6HasSwappedViews 1041
//spec_const bool UseViewSpaceDepthVariant 1042
//spec_const bool intensityTextureHasSwappedViews 1043
//spec_const bool planet_refl_mapHasSwappedViews 1044
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 1075
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1076
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 1077
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 1078
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1079
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 1080
//spec_const int Tweak_N6Layout 1081
//spec_const int intensityTextureLayout 1082
//spec_const int planet_refl_mapLayout 1083
...
constant bool Tweak_N37 [[function_constant(1040)]];
constant bool Tweak_N37_tmp = is_function_constant_defined(Tweak_N37) ? Tweak_N37 : false;
constant bool Tweak_N6HasSwappedViews [[function_constant(1041)]];
...
constant bool planet_refl_mapHasSwappedViews [[function_constant(1044)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(1075)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map [[function_constant(1077)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(1078)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map [[function_constant(1080)]];
...
constant int Tweak_N6Layout [[function_constant(1081)]];
...
constant int planet_refl_mapLayout [[function_constant(1083)]];
...
{
float l9_7=0.0;
float l9_8=(*sc_set2.UserUniforms).reflIntensity;
l9_7=l9_8;
float l9_9=0.0;
l9_9=l9_7;
float l9_10=0.0;
...
l9_11=(*sc_set2.UserUniforms).Port_Import_N013;
...
int l9_26=l9_25;
float3 l9_27=(*sc_set2.UserUniforms).sc_ViewMatrixInverseArray[l9_26][1].xyz;
...
float3x3 l9_42=(*sc_set2.UserUniforms).planet_refl_mapTransform;
...
float4 l9_45=(*sc_set2.UserUniforms).planet_refl_mapUvMinMax;
bool l9_46=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map_tmp)!=0);
float4 l9_47=(*sc_set2.UserUniforms).planet_refl_mapBorderColor;
float l9_48=0.0;
...
float l9_118=l9_110;
float4 l9_119=sc_set2.planet_refl_map.sample(sc_set2.planet_refl_mapSmpSC,l9_117,bias(l9_118));
float4 l9_120=l9_119;
...
l9_126=((l9_125-(*sc_set2.UserUniforms).Port_Center_N025)*(*sc_set2.UserUniforms).Port_Scale_N025)+(*sc_set2.UserUniforms).Port_Center_N025;
float2 l9_127=float2(0.0);
float2 l9_128=l9_126;
float l9_129=(*sc_set2.UserUniforms).Port_Rotation_N003;
float2 l9_130=(*sc_set2.UserUniforms).Port_Center_N003;
...
float4 l9_135=(*sc_set2.UserUniforms).Tweak_N2;
l9_134=l9_135;
float l9_136=0.0;
float l9_137=(*sc_set2.UserUniforms).colorRatio;
l9_136=l9_137;
float4 l9_138=float4(0.0);
float4 l9_139=(*sc_set2.UserUniforms).Tweak_N8;
l9_138=l9_139;
float4 l9_140=float4(0.0);
float4 l9_141=(*sc_set2.UserUniforms).Tweak_N9;
l9_140=l9_141;
...
bool l9_149=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_150;
if (l9_149)
{
...
if (l9_150)
{
l9_151=0==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_151=l9_150;
...
l9_158=(*sc_set2.UserUniforms).Port_Import_N038;
float4 l9_159=float4(0.0);
l9_159=(*sc_set2.UserUniforms).Port_Import_N031;
float2 l9_160=float2(0.0);
l9_160=param_3.Surface_UVCoord0;
float2 l9_161=float2(0.0);
l9_161=(((l9_160-float2((*sc_set2.UserUniforms).Port_RangeMinA_N033))/float2((*sc_set2.UserUniforms).Port_RangeMaxA_N033-(*sc_set2.UserUniforms).Port_RangeMinA_N033))*((*sc_set2.UserUniforms).Port_RangeMaxB_N033-(*sc_set2.UserUniforms).Port_RangeMinB_N033))+float2((*sc_set2.UserUniforms).Port_RangeMinB_N033);
float2 l9_162=float2(0.0);
l9_162=l9_125;
float2 l9_163=float2(0.0);
l9_163=((l9_161-(*sc_set2.UserUniforms).Port_Center_N047)*l9_162)+(*sc_set2.UserUniforms).Port_Center_N047;
float2 l9_164=float2(0.0);
l9_164=(*sc_set2.UserUniforms).Port_Import_N058;
float2 l9_165=float2(0.0);
l9_165=l9_163-l9_164;
float2 l9_166=float2(0.0);
l9_166=(*sc_set2.UserUniforms).Port_Import_N060;
...
float l9_171=0.0;
l9_171=fast::clamp(l9_170+0.001,(*sc_set2.UserUniforms).Port_Input1_N065+0.001,(*sc_set2.UserUniforms).Port_Input2_N065+0.001)-0.001;
float l9_172=0.0;
l9_172=smoothstep((*sc_set2.UserUniforms).Port_Input0_N066,(*sc_set2.UserUniforms).Port_Input1_N066,l9_171);
float4 l9_173=float4(0.0);
l9_173=mix(l9_158,l9_159,float4(l9_172));
float4 l9_174=float4(0.0);
l9_174=l9_173;
float4 l9_175=float4(0.0);
l9_175=mix(float4(l9_154),(*sc_set2.UserUniforms).Port_Input1_N029,l9_174);
...
{
float l9_177=0.0;
float l9_178=(*sc_set2.UserUniforms).reflIntensity;
l9_177=l9_178;
float l9_179=0.0;
l9_179=l9_177;
float l9_180=0.0;
...
l9_181=(*sc_set2.UserUniforms).Port_Import_N013;
...
int l9_196=l9_195;
float3 l9_197=(*sc_set2.UserUniforms).sc_ViewMatrixInverseArray[l9_196][1].xyz;
...
float3x3 l9_212=(*sc_set2.UserUniforms).planet_refl_mapTransform;
...
float4 l9_215=(*sc_set2.UserUniforms).planet_refl_mapUvMinMax;
bool l9_216=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map_tmp)!=0);
float4 l9_217=(*sc_set2.UserUniforms).planet_refl_mapBorderColor;
float l9_218=0.0;
...
float l9_288=l9_280;
float4 l9_289=sc_set2.planet_refl_map.sample(sc_set2.planet_refl_mapSmpSC,l9_287,bias(l9_288));
...
l9_296=((l9_295-(*sc_set2.UserUniforms).Port_Center_N025)*(*sc_set2.UserUniforms).Port_Scale_N025)+(*sc_set2.UserUniforms).Port_Center_N025;
float2 l9_297=float2(0.0);
float2 l9_298=l9_296;
float l9_299=(*sc_set2.UserUniforms).Port_Rotation_N003;
float2 l9_300=(*sc_set2.UserUniforms).Port_Center_N003;
...
float4 l9_305=(*sc_set2.UserUniforms).Tweak_N2;
l9_304=l9_305;
float l9_306=0.0;
float l9_307=(*sc_set2.UserUniforms).colorRatio;
l9_306=l9_307;
float4 l9_308=float4(0.0);
float4 l9_309=(*sc_set2.UserUniforms).Tweak_N8;
l9_308=l9_309;
float4 l9_310=float4(0.0);
float4 l9_311=(*sc_set2.UserUniforms).Tweak_N9;
l9_310=l9_311;
...
bool l9_319=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_320;
if (l9_319)
{
...
if (l9_320)
{
l9_321=0==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_321=l9_320;
...
float3x3 param_8=(*sc_set2.UserUniforms).Tweak_N6Transform;
...
float4 param_11=(*sc_set2.UserUniforms).Tweak_N6UvMinMax;
bool param_12=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_13=(*sc_set2.UserUniforms).Tweak_N6BorderColor;
float param_14=0.0;
...
float l9_398=l9_390;
float4 l9_399=sc_set2.Tweak_N6.sample(sc_set2.Tweak_N6SmpSC,l9_397,bias(l9_398));
...
bool l9_408=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_408)
{
...
float l9_413=l9_412;
float l9_414=l9_413;
float l9_415=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_414;
float3 l9_416=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_410.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
...
{
l9_422.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_425=(l9_424.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
float l9_462=l9_454;
float4 l9_463=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_461,bias(l9_462));
...
float3 l9_473=definedBlend(l9_471,l9_472,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
...
{
l9_481=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_481=float4(0.0);
