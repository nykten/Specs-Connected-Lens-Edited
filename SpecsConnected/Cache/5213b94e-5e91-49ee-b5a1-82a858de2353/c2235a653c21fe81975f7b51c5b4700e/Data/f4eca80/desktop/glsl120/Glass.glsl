...
vec4 l9_5=(vec4(reflIntensity)*sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),N15_ReflectionUV,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map))+param_22;
vec2 l9_6=Port_Import_N060-Port_Import_N058;
vec4 l9_7=vec4(l9_5.x,l9_5.y,l9_5.z,vec4(0.0).w);
l9_7.w=mix(vec4(l9_5.w),Port_Input1_N029,mix(Port_Import_N038,Port_Import_N031,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Globals.Surface_UVCoord0)+Port_Center_N047)-Port_Import_N058,l9_6)/dot(l9_6,l9_6))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).x;
Value1=l9_7;
Result=Value1;
}
#else
...
N15_NormalSpace=1;
N15_Normal=Port_Import_N013;
vec3 l9_8=N15_Normal;
vec3 l9_9;
if (N15_NormalSpace==1)
{
l9_9=normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_8);
}
else
{
l9_9=l9_8;
}
vec3 l9_10=normalize(-Globals.ViewDirWS);
vec3 l9_11=normalize(cross(l9_10,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_12=cross(l9_11,l9_10);
N15_ReflectionUV=((mat3(vec3(l9_11.x,l9_12.x,l9_10.x),vec3(l9_11.y,l9_12.y,l9_10.y),vec3(l9_11.z,l9_12.z,l9_10.z))*l9_9).xy*0.5)+vec2(0.5);
vec2 param_39;
Node3_Rotate_Coords(((Globals.Surface_UVCoord0-Port_Center_N025)*Port_Scale_N025)+Port_Center_N025,Port_Rotation_N003,Port_Center_N003,param_39,Globals);
vec4 param_46;
Node0_Gradient(param_39.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,param_46,Globals);
Default=(vec4(reflIntensity)*sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),N15_ReflectionUV,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map))+param_46;
Result=Default;
}
#endif
}
...
vec4 param_3;
Node55_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,cross(l9_3,l9_4)*varTangent.w,normalize(sc_Camera.position-varPos),varPos,varPackedTex.xy,varPackedTex.zw));
vec4 l9_5=param_3;
int l9_6;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,l9_6,varPackedTex.zw,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
vec3 l9_8=mix(l9_5.xyz,(l9_7.xyz*l9_5.xyz).xyz,vec3(l9_7.w));
vec4 l9_9=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_9.w=l9_5.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_5.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_5.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_12=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_9.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_9.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_18;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_9.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_21;
...
#endif
vec3 l9_33=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_9.xyz).xyz,vec3(l9_5.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_9.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_36;
...
#endif
l9_36=vec4(l9_9.xyz*l9_37,l9_37);
}
#else
{
l9_36=l9_9;
...
{
l9_40=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_40=vec4(0.0);
...
vec4 l9_42=outputMotionVectorsIfNeeded(varPos,max(l9_41,vec4(0.0)));
vec4 l9_43=clamp(l9_42,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_44=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_44-0.0039215689)),min(1.0,l9_44+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_46=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_45).xy);
float l9_47=packValue(l9_46);
int l9_54=int(l9_43.w*255.0);
float l9_55=packValue(l9_54);
sc_writeFragData0(vec4(packValue(l9_46),packValue(l9_46),packValue(l9_46),packValue(l9_46)));
sc_writeFragData1(vec4(l9_47,packValue(l9_46),packValue(l9_46),packValue(l9_46)));
sc_writeFragData2(vec4(l9_55,packValue(l9_54),packValue(l9_54),packValue(l9_54)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_58).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_63==0)
{
l9_66=texture2D(sc_OITAlpha0,l9_58);
l9_65=texture2D(sc_OITDepthLow0,l9_58);
l9_64=texture2D(sc_OITDepthHigh0,l9_58);
}
else
{
l9_66=vec4(0.0);
...
if (l9_63==1)
{
l9_69=texture2D(sc_OITAlpha1,l9_58);
l9_68=texture2D(sc_OITDepthLow1,l9_58);
l9_67=texture2D(sc_OITDepthHigh1,l9_58);
}
else
{
l9_69=l9_66;
...
if (any(notEqual(l9_67,vec4(0.0)))||any(notEqual(l9_68,vec4(0.0))))
{
int l9_70[8]=l9_59;
unpackValues(l9_67.w,l9_63,l9_70);
unpackValues(l9_67.z,l9_63,l9_70);
unpackValues(l9_67.y,l9_63,l9_70);
unpackValues(l9_67.x,l9_63,l9_70);
unpackValues(l9_68.w,l9_63,l9_70);
unpackValues(l9_68.z,l9_63,l9_70);
unpackValues(l9_68.y,l9_63,l9_70);
unpackValues(l9_68.x,l9_63,l9_70);
int l9_79[8]=l9_60;
unpackValues(l9_69.w,l9_63,l9_79);
unpackValues(l9_69.z,l9_63,l9_79);
unpackValues(l9_69.y,l9_63,l9_79);
unpackValues(l9_69.x,l9_63,l9_79);
}
l9_63++;
continue;
}
...
vec4 l9_84=texture2D(sc_OITFilteredDepthBoundsTexture,l9_58);
vec2 l9_85=l9_84.xy;
int l9_86;
#if (sc_SkinBonesCount>0)
{
l9_86=encodeDepth(((1.0-l9_84.x)*1000.0)+getDepthOrderingEpsilon(),l9_85);
}
#else
{
l9_86=0;
...
#endif
int l9_87=encodeDepth(viewSpaceDepth(),l9_85);
vec4 l9_88;
l9_88=l9_43*l9_43.w;
vec4 l9_89;
int l9_90=0;
...
if (l9_90<8)
{
int l9_91=l9_59[l9_90];
int l9_92=l9_87-l9_86;
bool l9_93=l9_91<l9_92;
bool l9_94;
if (l9_93)
{
l9_94=l9_59[l9_90]>0;
...
if (l9_94)
{
vec3 l9_95=l9_88.xyz*(1.0-(float(l9_60[l9_90])/255.0));
l9_89=vec4(l9_95.x,l9_95.y,l9_95.z,l9_88.w);
}
else
{
l9_89=l9_88;
