...
//sampler sampler Tweak_N6SmpSC 2:22
//sampler sampler intensityTextureSmpSC 2:23
//sampler sampler planet_refl_mapSmpSC 2:24
...
//texture texture2D Tweak_N6 2:3:2:22
//texture texture2D intensityTexture 2:4:2:23
//texture texture2D planet_refl_map 2:5:2:24
...
//texture texture2DArray Tweak_N6ArrSC 2:34:2:22
//texture texture2DArray intensityTextureArrSC 2:35:2:23
//texture texture2DArray planet_refl_mapArrSC 2:36:2:24
...
uniform vec4 planet_refl_mapDims;
uniform vec4 Tweak_N6Dims;
...
uniform vec4 planet_refl_mapSize;
uniform vec4 planet_refl_mapView;
...
uniform vec4 Tweak_N6Size;
uniform vec4 Tweak_N6View;
...
{
l9_6=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_mapArrSC);
}
#else
{
l9_6=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map);
}
#endif
vec2 param_27;
Node3_Rotate_Coords(((Globals.Surface_UVCoord0-Port_Center_N025)*Port_Scale_N025)+Port_Center_N025,Port_Rotation_N003,Port_Center_N003,param_27,Globals);
vec4 param_34;
Node0_Gradient(param_27.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,param_34,Globals);
vec4 l9_7=(vec4(reflIntensity)*l9_6)+param_34;
vec2 l9_8=Port_Import_N060-Port_Import_N058;
vec4 l9_9=vec4(l9_7.x,l9_7.y,l9_7.z,vec4(0.0).w);
l9_9.w=mix(vec4(l9_7.w),Port_Input1_N029,mix(Port_Import_N038,Port_Import_N031,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Globals.Surface_UVCoord0)+Port_Center_N047)-Port_Import_N058,l9_8)/dot(l9_8,l9_8))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).x;
Value1=l9_9;
Result=Value1;
}
#else
...
N15_NormalSpace=1;
N15_Normal=Port_Import_N013;
vec3 l9_10=N15_Normal;
vec3 l9_11;
if (N15_NormalSpace==1)
{
l9_11=normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_10);
}
else
{
l9_11=l9_10;
}
vec3 l9_12=normalize(-Globals.ViewDirWS);
vec3 l9_13=normalize(cross(l9_12,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_14=cross(l9_13,l9_12);
N15_ReflectionUV=((mat3(vec3(l9_13.x,l9_14.x,l9_12.x),vec3(l9_13.y,l9_14.y,l9_12.y),vec3(l9_13.z,l9_14.z,l9_12.z))*l9_11).xy*0.5)+vec2(0.5);
vec2 l9_15=N15_ReflectionUV;
vec4 l9_16;
#if (planet_refl_mapLayout==2)
{
l9_16=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_15,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_mapArrSC);
}
#else
{
l9_16=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_15,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map);
...
#endif
vec2 param_63;
Node3_Rotate_Coords(((Globals.Surface_UVCoord0-Port_Center_N025)*Port_Scale_N025)+Port_Center_N025,Port_Rotation_N003,Port_Center_N003,param_63,Globals);
vec4 param_70;
Node0_Gradient(param_63.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,param_70,Globals);
Default=(vec4(reflIntensity)*l9_16)+param_70;
Result=Default;
}
#endif
}
...
if (isProxyMode)
{
RayHitPayload l9_10=GetHitData(ivec2(gl_FragCoord.xy));
vec3 l9_11=l9_10.normalWS;
vec4 l9_12=l9_10.tangentWS;
if (noEarlyZ)
{
if (l9_10.id.x!=uint(instance_id))
{
return;
}
}
...
l9_9=l9_11;
l9_8=l9_13;
l9_7=cross(l9_11,l9_13)*l9_12.w;
l9_6=l9_10.viewDirWS;
l9_5=l9_10.positionWS;
l9_4=l9_10.uv0;
l9_3=l9_10.uv1;
}
else
{
vec3 l9_14=normalize(varNormal);
vec3 l9_15=normalize(varTangent.xyz);
l9_9=l9_14;
l9_8=l9_15;
l9_7=cross(l9_14,l9_15)*varTangent.w;
...
vec4 param_3;
Node55_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,l9_9,l9_8,l9_7,l9_6,l9_5,l9_4,l9_3));
vec4 l9_16=param_3;
vec4 l9_17;
#if (Tweak_N6Layout==2)
{
l9_17=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6ArrSC);
}
#else
{
l9_17=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
...
#endif
vec3 l9_18=mix(l9_16.xyz,(l9_17.xyz*l9_16.xyz).xyz,vec3(l9_17.w));
vec4 l9_19=vec4(l9_18.x,l9_18.y,l9_18.z,vec4(0.0).w);
l9_19.w=l9_16.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_16.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_16.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_20,vec4(0.0)));
return;
}
vec4 l9_22;
...
{
l9_24=clamp(l9_16.w*2.0,0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_19.xyz,vec3(l9_16.w)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*l9_16.w;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*l9_16.w;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_30;
#if (sc_BlendMode_Add)
{
l9_30=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_19.xyz,vec3(0.33333001))*l9_16.w;
}
#else
{
float l9_33;
#if (sc_BlendMode_Min)
{
l9_33=1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_Max)
{
l9_34=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_34=1.0;
...
#endif
l9_22=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_19.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_23);
}
#else
{
vec4 l9_35;
...
#if (sc_FramebufferFetch)
{
vec4 l9_38=sc_readFragData0_Platform();
vec4 l9_39;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_40=l9_38;
l9_40.x=l9_38.x+_sc_framebufferFetchMarker;
l9_39=l9_40;
}
#else
{
...
#else
{
vec2 l9_41=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_42;
...
{
l9_43=sc_SampleView(sc_ScreenTextureDims.xy,l9_41,sc_ScreenTextureLayout,l9_42,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_43=sc_SampleView(sc_ScreenTextureDims.xy,l9_41,sc_ScreenTextureLayout,l9_42,0.0,sc_ScreenTexture);
}
#endif
l9_37=l9_43;
}
...
{
vec4 l9_45=l9_37;
l9_45.x=l9_37.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_44=l9_45;
}
#else
{
...
#endif
vec3 l9_46=mix(l9_44.xyz,definedBlend(l9_44.xyz,l9_19.xyz).xyz,vec3(l9_16.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_19.xyz,vec3(l9_16.w)),l9_16.w);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_19.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_19;
...
{
l9_53=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_53=vec4(0.0);
...
vec4 l9_55=outputMotionVectorsIfNeeded(varPos,max(l9_54,vec4(0.0)));
vec4 l9_56=clamp(l9_55,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_57=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_57-0.0039215689)),min(1.0,l9_57+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_58).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_59=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_58).xy);
float l9_60=packValue(l9_59);
int l9_67=int(l9_56.w*255.0);
float l9_68=packValue(l9_67);
sc_writeFragData0(vec4(packValue(l9_59),packValue(l9_59),packValue(l9_59),packValue(l9_59)));
sc_writeFragData1(vec4(l9_60,packValue(l9_59),packValue(l9_59),packValue(l9_59)));
sc_writeFragData2(vec4(l9_68,packValue(l9_67),packValue(l9_67),packValue(l9_67)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_71).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_76==0)
{
l9_79=texture(sc_OITAlpha0,l9_71);
l9_78=texture(sc_OITDepthLow0,l9_71);
l9_77=texture(sc_OITDepthHigh0,l9_71);
}
else
{
l9_79=vec4(0.0);
...
if (l9_76==1)
{
l9_82=texture(sc_OITAlpha1,l9_71);
l9_81=texture(sc_OITDepthLow1,l9_71);
l9_80=texture(sc_OITDepthHigh1,l9_71);
}
else
{
l9_82=l9_79;
...
if (any(notEqual(l9_80,vec4(0.0)))||any(notEqual(l9_81,vec4(0.0))))
{
int l9_83[8]=l9_72;
unpackValues(l9_80.w,l9_76,l9_83);
unpackValues(l9_80.z,l9_76,l9_83);
unpackValues(l9_80.y,l9_76,l9_83);
unpackValues(l9_80.x,l9_76,l9_83);
unpackValues(l9_81.w,l9_76,l9_83);
unpackValues(l9_81.z,l9_76,l9_83);
unpackValues(l9_81.y,l9_76,l9_83);
unpackValues(l9_81.x,l9_76,l9_83);
int l9_92[8]=l9_73;
unpackValues(l9_82.w,l9_76,l9_92);
unpackValues(l9_82.z,l9_76,l9_92);
unpackValues(l9_82.y,l9_76,l9_92);
unpackValues(l9_82.x,l9_76,l9_92);
}
l9_76++;
continue;
}
...
vec4 l9_97=texture(sc_OITFilteredDepthBoundsTexture,l9_71);
vec2 l9_98=l9_97.xy;
int l9_99;
#if (sc_SkinBonesCount>0)
{
l9_99=encodeDepth(((1.0-l9_97.x)*1000.0)+getDepthOrderingEpsilon(),l9_98);
}
#else
{
l9_99=0;
...
#endif
int l9_100=encodeDepth(viewSpaceDepth(),l9_98);
vec4 l9_101;
l9_101=l9_56*l9_56.w;
vec4 l9_102;
int l9_103=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_103<8)
{
int l9_104=l9_72[l9_103];
int l9_105=l9_100-l9_99;
bool l9_106=l9_104<l9_105;
bool l9_107;
if (l9_106)
{
l9_107=l9_72[l9_103]>0;
}
else
{
l9_107=l9_106;
...
if (l9_107)
{
vec3 l9_108=l9_101.xyz*(1.0-(float(l9_73[l9_103])/255.0));
l9_102=vec4(l9_108.x,l9_108.y,l9_108.z,l9_101.w);
}
else
{
l9_102=l9_101;
...
sc_writeFragData0(l9_56);
}
#endif
}
#else
{
sc_writeFragData0(l9_55);
}
#endif
}
#endif
