...
vec4 l9_1=(Port_Value_N010+vec4(0.001))-vec4(0.001);
float l9_2=l9_1.x;
float l9_3=l9_1.w;
if (l9_2<float(l9_2<Port_Input1_N003))
{
discard;
}
...
#endif
sc_writeFragData0(max(l9_4,vec4(0.0)));
return;
}
vec4 l9_6;
...
{
l9_9=clamp(dot(l9_1.xyz,vec3(l9_3)),0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_11=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_3;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_3;
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_14;
#if (sc_BlendMode_Add)
{
l9_14=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_1.xyz,vec3(0.33333001))*l9_3;
}
#else
{
float l9_17;
#if (sc_BlendMode_Min)
{
l9_17=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_18;
#if (sc_BlendMode_Max)
{
l9_18=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_18=1.0;
...
#endif
l9_6=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_7);
}
#else
{
vec4 l9_19;
...
{
l9_27=sc_SampleView(sc_ScreenTextureDims.xy,l9_25,sc_ScreenTextureLayout,l9_26,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_27=sc_SampleView(sc_ScreenTextureDims.xy,l9_25,sc_ScreenTextureLayout,l9_26,0.0,sc_ScreenTexture);
}
#endif
l9_21=l9_27;
}
...
{
vec4 l9_29=l9_21;
l9_29.x=l9_21.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_28=l9_29;
}
#else
{
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_1.xyz).xyz,vec3(l9_3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_3)),l9_3);
}
#else
{
vec4 l9_33;
...
#endif
l9_33=vec4(l9_1.xyz*l9_34,l9_34);
}
#else
{
l9_33=l9_1;
...
{
l9_37=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_37=vec4(0.0);
...
vec4 l9_39=outputMotionVectorsIfNeeded(varPos,max(l9_38,vec4(0.0)));
...
#endif
int l9_43=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_42).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_55).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_60==0)
{
l9_63=texture(sc_OITAlpha0,l9_55);
l9_62=texture(sc_OITDepthLow0,l9_55);
l9_61=texture(sc_OITDepthHigh0,l9_55);
}
else
{
l9_63=vec4(0.0);
...
if (l9_60==1)
{
l9_66=texture(sc_OITAlpha1,l9_55);
l9_65=texture(sc_OITDepthLow1,l9_55);
l9_64=texture(sc_OITDepthHigh1,l9_55);
}
else
{
l9_66=l9_63;
...
vec4 l9_81=texture(sc_OITFilteredDepthBoundsTexture,l9_55);
vec2 l9_82=l9_81.xy;
int l9_83;
#if (sc_SkinBonesCount>0)
{
