...
#endif
vec4 l9_0=(Port_Value_N010+vec4(0.001))-vec4(0.001);
float l9_1=l9_0.x;
float l9_2=l9_0.w;
if (l9_1<float(l9_1<Port_Input1_N003))
{
discard;
}
...
{
l9_6=clamp(dot(l9_0.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_11;
#if (sc_BlendMode_Add)
{
l9_11=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_13;
...
{
l9_13=dot(l9_0.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_14;
#if (sc_BlendMode_Min)
{
l9_14=1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_Max)
{
l9_15=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_15=1.0;
...
#endif
l9_3=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_0.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_4);
}
#else
{
vec4 l9_16;
...
#endif
l9_18=sc_SampleView(sc_ScreenTextureDims.xy,l9_22,sc_ScreenTextureLayout,l9_23,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_24;
...
{
vec4 l9_25=l9_18;
l9_25.x=l9_18.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_24=l9_25;
}
#else
{
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_0.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_29;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_38).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_39=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_38).xy);
...
if (l9_56==0)
{
l9_59=texture2D(sc_OITAlpha0,l9_51);
l9_58=texture2D(sc_OITDepthLow0,l9_51);
l9_57=texture2D(sc_OITDepthHigh0,l9_51);
}
else
{
l9_59=vec4(0.0);
...
if (l9_56==1)
{
l9_62=texture2D(sc_OITAlpha1,l9_51);
l9_61=texture2D(sc_OITDepthLow1,l9_51);
l9_60=texture2D(sc_OITDepthHigh1,l9_51);
}
else
{
l9_62=l9_59;
...
vec4 l9_77=texture2D(sc_OITFilteredDepthBoundsTexture,l9_51);
vec2 l9_78=l9_77.xy;
int l9_79;
#if (sc_SkinBonesCount>0)
{
