...
//}
//ubo int UserUniforms 2:31:4176 {
...
//float4 Port_Value_N010 4144
//float Port_Input1_N003 4160
//float depthRef 4164
//}
...
RayHitPayload l9_3=GetHitData(l9_2,(*sc_set2.UserUniforms),sc_set2.z_rayDirections,sc_set2.z_rayDirectionsSmpSC,sc_set2.z_hitIdAndBarycentric,sc_set2.z_hitIdAndBarycentricSmp,(*sc_set2.layoutVertices),(*sc_set2.layoutVerticesPN),(*sc_set2.layoutIndices));
RayHitPayload rhp=l9_3;
bool l9_4=(*sc_set2.UserUniforms).noEarlyZ!=0;
if (l9_4)
{
...
float4 param=(*sc_set2.UserUniforms).Port_Value_N010;
float4 param_1=param+float4(0.001);
param_1-=float4(0.001);
Output_N10=param_1;
float4 Output_N3=float4(0.0);
Output_N3=float4(float(Output_N10.x<(*sc_set2.UserUniforms).Port_Input1_N003),float(Output_N10.y<(*sc_set2.UserUniforms).Port_Input1_N003),float(Output_N10.z<(*sc_set2.UserUniforms).Port_Input1_N003),float(Output_N10.w<(*sc_set2.UserUniforms).Port_Input1_N003));
float4 Output_N2=float4(0.0);
float4 param_2=Output_N10;
float param_3=Output_N3.x;
float4 param_4=param_2;
if (param_2.x<param_3)
{
discard_fragment();
}
Output_N2=param_4;
...
bool l9_8=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_8)
{
...
float4 l9_9=fast::max(param_6,float4(0.0));
float4 param_7=l9_9;
...
{
l9_12=fast::clamp(l9_11.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_12=fast::clamp(dot(l9_11.xyz,float3(l9_11.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_12=(1.0-dot(l9_11.xyz,float3(0.33333001)))*l9_11.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_12=(1.0-fast::clamp(dot(l9_11.xyz,float3(1.0)),0.0,1.0))*l9_11.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_12=fast::clamp(dot(l9_11.xyz,float3(1.0)),0.0,1.0)*l9_11.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_12=fast::clamp(dot(l9_11.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_12=dot(l9_11.xyz,float3(0.33333001))*l9_11.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_12=1.0-fast::clamp(dot(l9_11.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_13=l9_12;
float l9_14=l9_13;
float l9_15=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_14;
float3 l9_16=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_10.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_17=float4(l9_16.x,l9_16.y,l9_16.z,l9_15);
param_8=l9_17;
}
else
{
...
{
float4 l9_18=param_8;
float4 l9_19=float4(0.0);
float4 l9_20=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_21=out.FragColor0;
float4 l9_22=l9_21;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_22.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_23=l9_22;
l9_20=l9_23;
}
...
{
float4 l9_24=gl_FragCoord;
float2 l9_25=(l9_24.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_26=l9_25;
...
int l9_30=l9_29;
int l9_31=l9_30;
float3 l9_32=float3(l9_26,0.0);
int l9_33=l9_28;
int l9_34=l9_31;
if (l9_33==1)
{
l9_32.y=((2.0*l9_32.y)+float(l9_34))-1.0;
}
float2 l9_35=l9_32.xy;
l9_27=l9_35;
}
else
{
...
float2 l9_51=l9_47;
int l9_52=sc_ScreenTextureLayout_tmp;
int l9_53=l9_48;
float l9_54=l9_49;
float2 l9_55=l9_51;
int l9_56=l9_52;
...
float3 l9_59=l9_58;
float3 l9_60=l9_59;
float2 l9_61=l9_60.xy;
float l9_62=l9_54;
float4 l9_63=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_61,bias(l9_62));
float4 l9_64=l9_63;
l9_50=l9_64;
float4 l9_65=l9_50;
float4 l9_66=l9_65;
...
float4 l9_68=l9_20;
float4 l9_69=l9_68;
float3 l9_70=l9_69.xyz;
float3 l9_71=l9_70;
float3 l9_72=l9_18.xyz;
float3 l9_73=definedBlend(l9_71,l9_72,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_19=float4(l9_73.x,l9_73.y,l9_73.z,l9_19.w);
float3 l9_74=mix(l9_70,l9_19.xyz,float3(l9_18.w));
l9_19=float4(l9_74.x,l9_74.y,l9_74.z,l9_19.w);
l9_19.w=1.0;
float4 l9_75=l9_19;
param_8=l9_75;
}
...
{
float4 l9_76=param_8;
float4 l9_77=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_77=float4(mix(float3(1.0),l9_76.xyz,float3(l9_76.w)),l9_76.w);
}
else
{
...
{
l9_78=fast::clamp(l9_78,0.0,1.0);
}
l9_77=float4(l9_76.xyz*l9_78,l9_78);
}
else
{
l9_77=l9_76;
...
{
l9_81=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_81=float4(0.0);
...
float4 l9_83=param_11;
out.FragColor0=l9_83;
return out;
}
} // FRAGMENT SHADER
