        ...
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                case RotationAxis.X:
                    ...
                    break;
                case RotationAxis.Y:
                    rotationQuaternion = this.yAxisCalculator.getRotation(VEC_UP, this.getForwardVector(), this.getTargetToCameraVector(), this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
        ...
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                case RotationAxis.X:
                    ...
                    break;
                case RotationAxis.Y:
                    rotationQuaternion = this.yAxisCalculator.resetRotation(VEC_UP, this.getForwardVector(), this.getTargetToCameraVector(), this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
