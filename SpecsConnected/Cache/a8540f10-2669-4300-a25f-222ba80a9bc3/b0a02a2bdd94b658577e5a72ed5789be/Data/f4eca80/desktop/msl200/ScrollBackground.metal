...
//}
//ubo int UserUniforms 2:31:4448 {
...
//float size 4140
//float scale 4144
//float Port_Input1_N049 4148
//float Port_RangeMinA_N035 4152
//float Port_RangeMaxA_N035 4156
//float Port_RangeMinA_N050 4160
//float Port_RangeMaxA_N050 4164
//float Port_RangeMinB_N050 4168
//float Port_RangeMaxB_N050 4172
//float Port_RangeMinA_N048 4176
//float Port_RangeMaxA_N048 4180
//float Port_RangeMinB_N048 4184
//float Port_RangeMaxB_N048 4188
//float Port_Value2_N034 4192
//float Port_RangeMinA_N046 4196
//float Port_RangeMaxA_N046 4200
//float Port_RangeMinB_N046 4204
//float Port_RangeMaxB_N046 4208
//float2 Port_Center_N039 4216
//float4 Port_Value0_N040 4224
//float Port_Position1_N040 4240
//float4 Port_Value1_N040 4256
//float Port_Position2_N040 4272
//float4 Port_Value2_N040 4288
//float Port_Position3_N040 4304
//float4 Port_Value3_N040 4320
//float Port_Position4_N040 4336
//float4 Port_Value4_N040 4352
//float Port_Position5_N040 4368
//float4 Port_Value5_N040 4384
//float4 Port_Value6_N040 4400
//float4 Port_Value_N005 4416
//float depthRef 4432
//}
...
float Port_RangeMaxB_N050;
float Port_RangeMinA_N048;
float Port_RangeMaxA_N048;
float Port_RangeMinB_N048;
float Port_RangeMaxB_N048;
float Port_Value2_N034;
float Port_RangeMinA_N046;
float Port_RangeMaxA_N046;
float Port_RangeMinB_N046;
float Port_RangeMaxB_N046;
float2 Port_Center_N039;
float4 Port_Value0_N040;
float Port_Position1_N040;
float4 Port_Value1_N040;
float Port_Position2_N040;
float4 Port_Value2_N040;
float Port_Position3_N040;
float4 Port_Value3_N040;
float Port_Position4_N040;
float4 Port_Value4_N040;
float Port_Position5_N040;
float4 Port_Value5_N040;
float4 Port_Value6_N040;
float4 Port_Value_N005;
float depthRef;
};
struct sc_Bone_t
{
...
float l9_7=0.0;
float l9_8=(*sc_set2.UserUniforms).status;
l9_7=l9_8;
param=l9_7;
float4 param_3;
if ((param*1.0)!=0.0)
...
l9_9=param_4.SurfacePosition_ObjectSpace;
float l9_10=0.0;
float3 l9_11=l9_9;
float l9_12=l9_11.y;
l9_10=l9_12;
float l9_13=0.0;
l9_13=l9_10*(*sc_set2.UserUniforms).Port_Input1_N049;
float l9_14=0.0;
float l9_15=(*sc_set2.UserUniforms).offset;
l9_14=l9_15;
float l9_16=0.0;
float l9_17=(*sc_set2.UserUniforms).size;
l9_16=l9_17;
float l9_18=0.0;
l9_18=(((l9_16-(*sc_set2.UserUniforms).Port_RangeMinA_N050)/((*sc_set2.UserUniforms).Port_RangeMaxA_N050-(*sc_set2.UserUniforms).Port_RangeMinA_N050))*((*sc_set2.UserUniforms).Port_RangeMaxB_N050-(*sc_set2.UserUniforms).Port_RangeMinB_N050))+(*sc_set2.UserUniforms).Port_RangeMinB_N050;
float l9_19=0.0;
l9_19=(((l9_16-(*sc_set2.UserUniforms).Port_RangeMinA_N048)/((*sc_set2.UserUniforms).Port_RangeMaxA_N048-(*sc_set2.UserUniforms).Port_RangeMinA_N048))*((*sc_set2.UserUniforms).Port_RangeMaxB_N048-(*sc_set2.UserUniforms).Port_RangeMinB_N048))+(*sc_set2.UserUniforms).Port_RangeMinB_N048;
float l9_20=0.0;
l9_20=(((l9_14-(*sc_set2.UserUniforms).Port_RangeMinA_N035)/((*sc_set2.UserUniforms).Port_RangeMaxA_N035-(*sc_set2.UserUniforms).Port_RangeMinA_N035))*(l9_19-l9_18))+l9_18;
float2 l9_21=float2(0.0);
l9_21.x=l9_20;
l9_21.y=(*sc_set2.UserUniforms).Port_Value2_N034;
float2 l9_22=float2(0.0);
l9_22=float2(l9_13)+l9_21;
float l9_23=0.0;
float l9_24=(*sc_set2.UserUniforms).scale;
l9_23=l9_24;
float l9_25=0.0;
l9_25=(((l9_23-(*sc_set2.UserUniforms).Port_RangeMinA_N046)/((*sc_set2.UserUniforms).Port_RangeMaxA_N046-(*sc_set2.UserUniforms).Port_RangeMinA_N046))*((*sc_set2.UserUniforms).Port_RangeMaxB_N046-(*sc_set2.UserUniforms).Port_RangeMinB_N046))+(*sc_set2.UserUniforms).Port_RangeMinB_N046;
float2 l9_26=float2(0.0);
l9_26=((l9_22-(*sc_set2.UserUniforms).Port_Center_N039)*float2(l9_25))+(*sc_set2.UserUniforms).Port_Center_N039;
float4 l9_27=float4(0.0);
float l9_28=l9_26.x;
float4 l9_29=(*sc_set2.UserUniforms).Port_Value0_N040;
float l9_30=(*sc_set2.UserUniforms).Port_Position1_N040;
float4 l9_31=(*sc_set2.UserUniforms).Port_Value1_N040;
float l9_32=(*sc_set2.UserUniforms).Port_Position2_N040;
float4 l9_33=(*sc_set2.UserUniforms).Port_Value2_N040;
float l9_34=(*sc_set2.UserUniforms).Port_Position3_N040;
float4 l9_35=(*sc_set2.UserUniforms).Port_Value3_N040;
float l9_36=(*sc_set2.UserUniforms).Port_Position4_N040;
float4 l9_37=(*sc_set2.UserUniforms).Port_Value4_N040;
float l9_38=(*sc_set2.UserUniforms).Port_Position5_N040;
float4 l9_39=(*sc_set2.UserUniforms).Port_Value5_N040;
float4 l9_40=(*sc_set2.UserUniforms).Port_Value6_N040;
l9_28=fast::clamp(l9_28,0.0,1.0);
float4 l9_41;
if (l9_28<l9_30)
{
l9_41=mix(l9_29,l9_31,float4(fast::clamp(l9_28/l9_30,0.0,1.0)));
}
else
{
if (l9_28<l9_32)
{
l9_41=mix(l9_31,l9_33,float4(fast::clamp((l9_28-l9_30)/(l9_32-l9_30),0.0,1.0)));
}
else
{
if (l9_28<l9_34)
{
l9_41=mix(l9_33,l9_35,float4(fast::clamp((l9_28-l9_32)/(l9_34-l9_32),0.0,1.0)));
}
else
{
if (l9_28<l9_36)
{
l9_41=mix(l9_35,l9_37,float4(fast::clamp((l9_28-l9_34)/(l9_36-l9_34),0.0,1.0)));
}
else
{
if (l9_28<l9_38)
{
l9_41=mix(l9_37,l9_39,float4(fast::clamp((l9_28-l9_36)/(l9_38-l9_36),0.0,1.0)));
}
else
{
l9_41=mix(l9_39,l9_40,float4(fast::clamp((l9_28-l9_38)/(1.0-l9_38),0.0,1.0)));
}
}
}
}
}
bool l9_42=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_43;
if (l9_42)
{
...
if (l9_43)
{
l9_44=40==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_44=l9_43;
...
l9_45=(*sc_set2.UserUniforms).Port_Value_N005;
param_2=l9_45;
param_3=param_2;
}
Output_N3=param_3;
...
{
float4 l9_46=gl_FragCoord;
float2 l9_47=floor(mod(l9_46.xy,float2(4.0)));
float l9_48=(mod(dot(l9_47,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_48)
{
discard_fragment();
}
}
bool l9_49=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_49)
{
...
float4 l9_50=fast::max(param_6,float4(0.0));
float4 param_7=l9_50;
...
{
l9_53=fast::clamp(l9_52.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_53=fast::clamp(dot(l9_52.xyz,float3(l9_52.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_53=(1.0-dot(l9_52.xyz,float3(0.33333001)))*l9_52.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_53=(1.0-fast::clamp(dot(l9_52.xyz,float3(1.0)),0.0,1.0))*l9_52.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_53=fast::clamp(dot(l9_52.xyz,float3(1.0)),0.0,1.0)*l9_52.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_53=fast::clamp(dot(l9_52.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_53=dot(l9_52.xyz,float3(0.33333001))*l9_52.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_53=1.0-fast::clamp(dot(l9_52.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_54=l9_53;
float l9_55=l9_54;
float l9_56=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_55;
float3 l9_57=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_51.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_58=float4(l9_57.x,l9_57.y,l9_57.z,l9_56);
param_8=l9_58;
}
else
{
...
{
float4 l9_59=param_8;
float4 l9_60=float4(0.0);
float4 l9_61=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_62=out.FragColor0;
float4 l9_63=l9_62;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_63.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_64=l9_63;
l9_61=l9_64;
}
...
{
float4 l9_65=gl_FragCoord;
float2 l9_66=(l9_65.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_67=l9_66;
...
int l9_71=l9_70;
int l9_72=l9_71;
float3 l9_73=float3(l9_67,0.0);
int l9_74=l9_69;
int l9_75=l9_72;
if (l9_74==1)
{
l9_73.y=((2.0*l9_73.y)+float(l9_75))-1.0;
}
float2 l9_76=l9_73.xy;
l9_68=l9_76;
}
else
{
...
float2 l9_92=l9_88;
int l9_93=sc_ScreenTextureLayout_tmp;
int l9_94=l9_89;
float l9_95=l9_90;
float2 l9_96=l9_92;
int l9_97=l9_93;
...
float l9_103=l9_95;
float4 l9_104=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_102,bias(l9_103));
...
float3 l9_111=l9_110.xyz;
float3 l9_112=l9_111;
float3 l9_113=l9_59.xyz;
float3 l9_114=definedBlend(l9_112,l9_113,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_60=float4(l9_114.x,l9_114.y,l9_114.z,l9_60.w);
float3 l9_115=mix(l9_111,l9_60.xyz,float3(l9_59.w));
l9_60=float4(l9_115.x,l9_115.y,l9_115.z,l9_60.w);
l9_60.w=1.0;
float4 l9_116=l9_60;
param_8=l9_116;
}
...
{
float4 l9_117=param_8;
float4 l9_118=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_118=float4(mix(float3(1.0),l9_117.xyz,float3(l9_117.w)),l9_117.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_119=l9_117.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_119=fast::clamp(l9_119,0.0,1.0);
}
l9_118=float4(l9_117.xyz*l9_119,l9_119);
}
else
{
l9_118=l9_117;
...
{
l9_122=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_122=float4(0.0);
...
float4 l9_124=param_11;
out.FragColor0=l9_124;
return out;
}
} // FRAGMENT SHADER
