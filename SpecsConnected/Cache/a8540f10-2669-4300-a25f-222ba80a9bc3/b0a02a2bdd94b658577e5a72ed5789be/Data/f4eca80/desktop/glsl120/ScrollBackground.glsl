...
if ((status*1.0)!=0.0)
{
float l9_4=(((size-Port_RangeMinA_N050)/(Port_RangeMaxA_N050-Port_RangeMinA_N050))*(Port_RangeMaxB_N050-Port_RangeMinB_N050))+Port_RangeMinB_N050;
float l9_5=clamp(((((vec2((sc_ModelMatrixInverse*vec4(varPos,1.0)).y*Port_Input1_N049)+vec2((((offset-Port_RangeMinA_N035)/(Port_RangeMaxA_N035-Port_RangeMinA_N035))*(((((size-Port_RangeMinA_N048)/(Port_RangeMaxA_N048-Port_RangeMinA_N048))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048)-l9_4))+l9_4,0.0))-Port_Center_N039)*vec2((((scale-Port_RangeMinA_N046)/(Port_RangeMaxA_N046-Port_RangeMinA_N046))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046))+Port_Center_N039).x,0.0,1.0);
vec4 l9_6;
if (l9_5<Port_Position1_N040)
{
l9_6=mix(Port_Value0_N040,Port_Value1_N040,vec4(clamp(l9_5/Port_Position1_N040,0.0,1.0)));
}
else
{
vec4 l9_7;
if (l9_5<Port_Position2_N040)
{
l9_7=mix(Port_Value1_N040,Port_Value2_N040,vec4(clamp((l9_5-Port_Position1_N040)/(Port_Position2_N040-Port_Position1_N040),0.0,1.0)));
}
else
{
vec4 l9_8;
if (l9_5<Port_Position3_N040)
{
l9_8=mix(Port_Value2_N040,Port_Value3_N040,vec4(clamp((l9_5-Port_Position2_N040)/(Port_Position3_N040-Port_Position2_N040),0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_5<Port_Position4_N040)
{
l9_9=mix(Port_Value3_N040,Port_Value4_N040,vec4(clamp((l9_5-Port_Position3_N040)/(Port_Position4_N040-Port_Position3_N040),0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_5<Port_Position5_N040)
{
l9_10=mix(Port_Value4_N040,Port_Value5_N040,vec4(clamp((l9_5-Port_Position4_N040)/(Port_Position5_N040-Port_Position4_N040),0.0,1.0)));
}
else
{
l9_10=mix(Port_Value5_N040,Port_Value6_N040,vec4(clamp((l9_5-Port_Position5_N040)/(1.0-Port_Position5_N040),0.0,1.0)));
}
l9_9=l9_10;
}
l9_8=l9_9;
...
{
l9_3=PreviewVertexColor;
l9_2=l9_0;
l9_1=Port_Value_N005;
}
...
{
l9_18=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
#endif
l9_31=sc_SampleView(sc_ScreenTextureDims.xy,l9_35,sc_ScreenTextureLayout,l9_36,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_37;
...
{
vec4 l9_38=l9_31;
l9_38.x=l9_31.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_37=l9_38;
}
#else
{
...
#endif
vec3 l9_39=mix(l9_37.xyz,definedBlend(l9_37.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_41=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_42;
...
#endif
l9_42=vec4(l9_1.xyz*l9_43,l9_43);
}
#else
{
l9_42=l9_1;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_51).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_52=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_51).xy);
...
if (l9_69==0)
{
l9_72=texture2D(sc_OITAlpha0,l9_64);
l9_71=texture2D(sc_OITDepthLow0,l9_64);
l9_70=texture2D(sc_OITDepthHigh0,l9_64);
}
else
{
l9_72=vec4(0.0);
...
if (l9_69==1)
{
l9_75=texture2D(sc_OITAlpha1,l9_64);
l9_74=texture2D(sc_OITDepthLow1,l9_64);
l9_73=texture2D(sc_OITDepthHigh1,l9_64);
}
else
{
l9_75=l9_72;
...
vec4 l9_90=texture2D(sc_OITFilteredDepthBoundsTexture,l9_64);
vec2 l9_91=l9_90.xy;
int l9_92;
#if (sc_SkinBonesCount>0)
{
