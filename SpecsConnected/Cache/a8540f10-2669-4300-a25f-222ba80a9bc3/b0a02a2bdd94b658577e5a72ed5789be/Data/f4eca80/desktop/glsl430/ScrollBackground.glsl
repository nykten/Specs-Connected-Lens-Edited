...
uniform float Port_RangeMaxB_N050;
...
uniform float Port_Value2_N034;
...
uniform vec2 Port_Center_N039;
uniform vec4 Port_Value0_N040;
uniform float Port_Position1_N040;
uniform vec4 Port_Value1_N040;
uniform float Port_Position2_N040;
uniform vec4 Port_Value2_N040;
uniform float Port_Position3_N040;
uniform vec4 Port_Value3_N040;
uniform float Port_Position4_N040;
uniform vec4 Port_Value4_N040;
uniform float Port_Position5_N040;
uniform vec4 Port_Value5_N040;
uniform vec4 Port_Value6_N040;
...
in vec4 varColor;
vec3 interp_float3_animated(vec3 brc,ivec3 indices,int offset_1)
{
ivec3 l9_0=(indices*ivec3(6))+ivec3(offset_1);
int l9_1=l9_0.x;
int l9_2=l9_0.y;
int l9_3=l9_0.z;
...
vec4 fetch_unorm_byte4(int offset_1)
{
uint l9_0=floatBitsToUint(layoutVertices_obj._Vertices[offset_1]);
...
l9_1=(sc_ModelMatrixInverse*vec4(l9_2.positionWS,1.0)).xyz;
}
else
{
...
if ((status*1.0)!=0.0)
{
float l9_6=(((size-Port_RangeMinA_N050)/(Port_RangeMaxA_N050-Port_RangeMinA_N050))*(Port_RangeMaxB_N050-Port_RangeMinB_N050))+Port_RangeMinB_N050;
float l9_7=clamp(((((vec2(l9_1.y*Port_Input1_N049)+vec2((((offset-Port_RangeMinA_N035)/(Port_RangeMaxA_N035-Port_RangeMinA_N035))*(((((size-Port_RangeMinA_N048)/(Port_RangeMaxA_N048-Port_RangeMinA_N048))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048)-l9_6))+l9_6,0.0))-Port_Center_N039)*vec2((((scale-Port_RangeMinA_N046)/(Port_RangeMaxA_N046-Port_RangeMinA_N046))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046))+Port_Center_N039).x,0.0,1.0);
vec4 l9_8;
if (l9_7<Port_Position1_N040)
{
l9_8=mix(Port_Value0_N040,Port_Value1_N040,vec4(clamp(l9_7/Port_Position1_N040,0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_7<Port_Position2_N040)
{
l9_9=mix(Port_Value1_N040,Port_Value2_N040,vec4(clamp((l9_7-Port_Position1_N040)/(Port_Position2_N040-Port_Position1_N040),0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_7<Port_Position3_N040)
{
l9_10=mix(Port_Value2_N040,Port_Value3_N040,vec4(clamp((l9_7-Port_Position2_N040)/(Port_Position3_N040-Port_Position2_N040),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_7<Port_Position4_N040)
{
l9_11=mix(Port_Value3_N040,Port_Value4_N040,vec4(clamp((l9_7-Port_Position3_N040)/(Port_Position4_N040-Port_Position3_N040),0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_7<Port_Position5_N040)
{
l9_12=mix(Port_Value4_N040,Port_Value5_N040,vec4(clamp((l9_7-Port_Position4_N040)/(Port_Position5_N040-Port_Position4_N040),0.0,1.0)));
}
else
{
l9_12=mix(Port_Value5_N040,Port_Value6_N040,vec4(clamp((l9_7-Port_Position5_N040)/(1.0-Port_Position5_N040),0.0,1.0)));
}
l9_11=l9_12;
}
l9_10=l9_11;
...
{
l9_5=PreviewVertexColor;
l9_4=l9_0;
l9_3=Port_Value_N005;
}
...
#endif
sc_writeFragData0(max(l9_18,vec4(0.0)));
return;
}
vec4 l9_20;
...
{
l9_22=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_28;
#if (sc_BlendMode_Add)
{
l9_28=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_29=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_30;
...
{
l9_30=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_31;
#if (sc_BlendMode_Min)
{
l9_31=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_32;
#if (sc_BlendMode_Max)
{
l9_32=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_32=1.0;
...
#endif
l9_20=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_21);
}
#else
{
vec4 l9_33;
...
#if (sc_FramebufferFetch)
{
vec4 l9_36=sc_readFragData0_Platform();
vec4 l9_37;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_38=l9_36;
l9_38.x=l9_36.x+_sc_framebufferFetchMarker;
l9_37=l9_38;
}
#else
{
...
{
l9_41=sc_SampleView(sc_ScreenTextureDims.xy,l9_39,sc_ScreenTextureLayout,l9_40,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_41=sc_SampleView(sc_ScreenTextureDims.xy,l9_39,sc_ScreenTextureLayout,l9_40,0.0,sc_ScreenTexture);
}
#endif
l9_35=l9_41;
}
...
{
vec4 l9_43=l9_35;
l9_43.x=l9_35.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_42=l9_43;
}
#else
{
...
#endif
vec3 l9_44=mix(l9_42.xyz,definedBlend(l9_42.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_46=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_47;
...
#endif
l9_47=vec4(l9_3.xyz*l9_48,l9_48);
}
#else
{
l9_47=l9_3;
...
{
l9_51=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_51=vec4(0.0);
...
vec4 l9_53=outputMotionVectorsIfNeeded(varPos,max(l9_52,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_55-0.0039215689)),min(1.0,l9_55+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_57),packValue(l9_57),packValue(l9_57),packValue(l9_57)));
