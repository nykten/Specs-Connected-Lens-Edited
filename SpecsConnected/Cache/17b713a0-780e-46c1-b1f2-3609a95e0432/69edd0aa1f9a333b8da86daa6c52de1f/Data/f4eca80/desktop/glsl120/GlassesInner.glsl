...
{
l9_2=clamp(Tweak_N95.w*2.0,0.0,1.0);
}
#else
{
float l9_3;
...
{
l9_3=clamp(dot(Tweak_N95.xyz,vec3(Tweak_N95.w)),0.0,1.0);
}
#else
{
float l9_4;
...
{
l9_5=(1.0-dot(Tweak_N95.xyz,vec3(0.33333001)))*Tweak_N95.w;
}
#else
{
float l9_6;
...
{
l9_6=(1.0-clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0))*Tweak_N95.w;
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0)*Tweak_N95.w;
}
#else
{
float l9_8;
#if (sc_BlendMode_Add)
{
l9_8=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_9;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_9=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0)*Tweak_N95.w;
}
#else
{
float l9_10;
...
{
l9_10=dot(Tweak_N95.xyz,vec3(0.33333001))*Tweak_N95.w;
}
#else
{
float l9_11;
#if (sc_BlendMode_Min)
{
l9_11=1.0-clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_Max)
{
l9_12=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_12=1.0;
...
#endif
l9_0=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*Tweak_N95.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_1);
}
#else
{
vec4 l9_13;
...
#endif
vec3 l9_23=mix(l9_21.xyz,definedBlend(l9_21.xyz,Tweak_N95.xyz).xyz,vec3(Tweak_N95.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),Tweak_N95.xyz,vec3(Tweak_N95.w)),Tweak_N95.w);
}
#else
{
vec4 l9_26;
...
{
l9_27=clamp(Tweak_N95.w,0.0,1.0);
}
#else
{
l9_27=Tweak_N95.w;
...
#endif
l9_26=vec4(Tweak_N95.xyz*l9_27,l9_27);
}
#else
{
l9_26=Tweak_N95;
