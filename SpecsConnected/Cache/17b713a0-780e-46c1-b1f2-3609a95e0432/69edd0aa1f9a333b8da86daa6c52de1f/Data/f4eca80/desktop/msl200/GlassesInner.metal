...
Output_N95=param;
FinalColor=Output_N95;
float param_1=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_1<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
if (l9_8)
{
float4 param_2=FinalColor;
if ((int(sc_ProxyAlphaOne_tmp)!=0))
{
param_2.w=1.0;
}
float4 l9_9=fast::max(param_2,float4(0.0));
float4 param_3=l9_9;
out.FragColor0=param_3;
return out;
}
float4 param_4=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_10=param_4;
float4 l9_11=l9_10;
float l9_12=1.0;
