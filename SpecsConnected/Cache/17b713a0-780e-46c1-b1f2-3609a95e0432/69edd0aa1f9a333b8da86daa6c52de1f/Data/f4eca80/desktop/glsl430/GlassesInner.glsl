...
if (isProxyMode)
{
RayHitPayload l9_0=GetHitData(ivec2(gl_FragCoord.xy));
if (noEarlyZ)
{
if (l9_0.id.x!=uint(instance_id))
{
return;
}
}
...
{
if (Tweak_N95.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (Tweak_N95.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_1,vec4(0.0)));
return;
}
vec4 l9_3;
...
{
l9_5=clamp(Tweak_N95.w*2.0,0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_6=clamp(dot(Tweak_N95.xyz,vec3(Tweak_N95.w)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(Tweak_N95.xyz,vec3(0.33333001)))*Tweak_N95.w;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0))*Tweak_N95.w;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0)*Tweak_N95.w;
}
#else
{
float l9_11;
#if (sc_BlendMode_Add)
{
l9_11=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0)*Tweak_N95.w;
}
#else
{
float l9_13;
...
{
l9_13=dot(Tweak_N95.xyz,vec3(0.33333001))*Tweak_N95.w;
}
#else
{
float l9_14;
#if (sc_BlendMode_Min)
{
l9_14=1.0-clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_Max)
{
l9_15=clamp(dot(Tweak_N95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_15=1.0;
...
#endif
l9_3=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*Tweak_N95.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_4);
}
#else
{
vec4 l9_16;
...
#if (sc_FramebufferFetch)
{
vec4 l9_19=sc_readFragData0_Platform();
vec4 l9_20;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_21=l9_19;
l9_21.x=l9_19.x+_sc_framebufferFetchMarker;
l9_20=l9_21;
}
#else
{
...
#else
{
vec2 l9_22=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_23;
...
{
l9_24=sc_SampleView(sc_ScreenTextureDims.xy,l9_22,sc_ScreenTextureLayout,l9_23,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_24=sc_SampleView(sc_ScreenTextureDims.xy,l9_22,sc_ScreenTextureLayout,l9_23,0.0,sc_ScreenTexture);
}
#endif
l9_18=l9_24;
}
...
{
vec4 l9_26=l9_18;
l9_26.x=l9_18.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_25=l9_26;
}
#else
{
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,Tweak_N95.xyz).xyz,vec3(Tweak_N95.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),Tweak_N95.xyz,vec3(Tweak_N95.w)),Tweak_N95.w);
}
#else
{
vec4 l9_30;
...
{
l9_31=clamp(Tweak_N95.w,0.0,1.0);
}
#else
{
l9_31=Tweak_N95.w;
...
#endif
l9_30=vec4(Tweak_N95.xyz*l9_31,l9_31);
}
#else
{
l9_30=Tweak_N95;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_39).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_40=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_39).xy);
...
if (l9_57==0)
{
l9_60=texture(sc_OITAlpha0,l9_52);
l9_59=texture(sc_OITDepthLow0,l9_52);
l9_58=texture(sc_OITDepthHigh0,l9_52);
}
else
{
l9_60=vec4(0.0);
...
if (l9_57==1)
{
l9_63=texture(sc_OITAlpha1,l9_52);
l9_62=texture(sc_OITDepthLow1,l9_52);
l9_61=texture(sc_OITDepthHigh1,l9_52);
}
else
{
l9_63=l9_60;
...
vec4 l9_78=texture(sc_OITFilteredDepthBoundsTexture,l9_52);
vec2 l9_79=l9_78.xy;
int l9_80;
#if (sc_SkinBonesCount>0)
{
