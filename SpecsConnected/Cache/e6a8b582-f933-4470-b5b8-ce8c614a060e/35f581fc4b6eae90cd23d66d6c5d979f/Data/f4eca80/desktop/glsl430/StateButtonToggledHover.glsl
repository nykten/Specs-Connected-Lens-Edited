...
vec4 l9_30;
if (l9_29<Port_Position1_N003)
{
l9_30=mix(Port_Value0_N003,Port_Value1_N003,vec4(clamp(l9_29/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_29<Port_Position2_N003)
{
l9_31=mix(Port_Value1_N003,Port_Value2_N003,vec4(clamp((l9_29-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_32;
if (l9_29<Port_Position3_N003)
{
l9_32=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_29-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
l9_32=mix(Port_Value3_N003,Port_Value4_N003,vec4(clamp((l9_29-Port_Position3_N003)/(1.0-Port_Position3_N003),0.0,1.0)));
}
l9_31=l9_32;
}
l9_30=l9_31;
}
bool l9_33=PreviewEnabled==1;
bool l9_34;
if (l9_33)
{
l9_34=!l9_0;
...
vec3 l9_38=-l9_6;
vec4 l9_39=mix(l9_30,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(l9_38,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_40=l9_5-Port_Center_N002;
vec2 l9_41=(l9_40*Port_Scale_N002)+Port_Center_N002;
vec4 l9_42;
#if (iconLayout==2)
{
l9_42=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_41,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_42=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_41,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
float l9_43;
...
#if (iconLayout==2)
{
l9_44=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_41,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_44=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_41,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
l9_43=l9_44.w;
}
...
{
l9_43=Port_Input2_N007;
}
vec4 l9_45=vec4(l9_43);
vec4 l9_46=mix(mix(l9_20,l9_27,vec4(Port_Input2_N005))+l9_39,l9_42,l9_45);
float l9_47=l9_46.w;
...
#endif
sc_writeFragData0(max(l9_48,vec4(0.0)));
return;
}
vec4 l9_50;
...
{
l9_53=clamp(dot(l9_46.xyz,vec3(l9_47)),0.0,1.0);
}
#else
{
float l9_54;
...
{
l9_55=(1.0-dot(l9_46.xyz,vec3(0.33333001)))*l9_47;
}
#else
{
float l9_56;
...
{
l9_56=(1.0-clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0))*l9_47;
}
#else
{
float l9_57;
...
#if (sc_BlendMode_Add)
{
l9_58=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_59;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_59=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0)*l9_47;
}
#else
{
float l9_60;
...
{
l9_60=dot(l9_46.xyz,vec3(0.33333001))*l9_47;
}
#else
{
float l9_61;
#if (sc_BlendMode_Min)
{
l9_61=1.0-clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_Max)
{
l9_62=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_62=1.0;
...
#endif
l9_50=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_46.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_51);
}
#else
{
vec4 l9_63;
...
{
l9_71=sc_SampleView(sc_ScreenTextureDims.xy,l9_69,sc_ScreenTextureLayout,l9_70,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_71=sc_SampleView(sc_ScreenTextureDims.xy,l9_69,sc_ScreenTextureLayout,l9_70,0.0,sc_ScreenTexture);
}
#endif
l9_65=l9_71;
}
...
{
vec4 l9_73=l9_65;
l9_73.x=l9_65.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_72=l9_73;
}
#else
{
...
#endif
vec3 l9_74=mix(l9_72.xyz,definedBlend(l9_72.xyz,l9_46.xyz).xyz,vec3(l9_47));
vec4 l9_75=vec4(l9_74.x,l9_74.y,l9_74.z,vec4(0.0).w);
l9_75.w=1.0;
l9_64=l9_75;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_76=vec4(mix(vec3(1.0),l9_46.xyz,vec3(l9_47)),l9_47);
}
#else
{
vec4 l9_77;
...
#endif
l9_77=vec4(l9_46.xyz*l9_78,l9_78);
}
#else
{
l9_77=l9_46;
...
{
l9_81=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_81=vec4(0.0);
...
vec4 l9_83=outputMotionVectorsIfNeeded(varPos,max(l9_82,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_85-0.0039215689)),min(1.0,l9_85+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_87),packValue(l9_87),packValue(l9_87),packValue(l9_87)));
