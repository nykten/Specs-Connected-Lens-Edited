...
//float4 Port_Value0_N003 4496
//float Port_Position1_N003 4512
//float4 Port_Value1_N003 4528
//float Port_Position2_N003 4544
//float4 Port_Value2_N003 4560
//float Port_Position3_N003 4576
//float4 Port_Value3_N003 4592
//float4 Port_Value4_N003 4608
//float4 Port_Input1_N024 4624
...
float4 param_27=(*sc_set2.UserUniforms).Port_Value0_N003;
float param_28=(*sc_set2.UserUniforms).Port_Position1_N003;
float4 param_29=(*sc_set2.UserUniforms).Port_Value1_N003;
float param_30=(*sc_set2.UserUniforms).Port_Position2_N003;
float4 param_31=(*sc_set2.UserUniforms).Port_Value2_N003;
float param_32=(*sc_set2.UserUniforms).Port_Position3_N003;
float4 param_33=(*sc_set2.UserUniforms).Port_Value3_N003;
float4 param_34=(*sc_set2.UserUniforms).Port_Value4_N003;
...
if (l9_178)
{
l9_179=3==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_179=l9_178;
...
Value_N3=param_35;
float Rim_N31=0.0;
float3 param_36=(*sc_set2.UserUniforms).Port_Normal_N031;
float param_37=(*sc_set2.UserUniforms).Port_Exponent_N031;
float param_38=(*sc_set2.UserUniforms).Port_Intensity_N031;
ssGlobals param_40=Globals;
param_36=float3x3(float3(param_40.VertexTangent_WorldSpace),float3(param_40.VertexBinormal_WorldSpace),float3(param_40.VertexNormal_WorldSpace))*param_36;
float l9_180=abs(dot(-param_40.ViewDirWS,param_36));
float param_39=pow(1.0-l9_180,param_37);
param_39=fast::max(param_39,0.0);
param_39*=param_38;
Rim_N31=param_39;
float4 Output_N24=float4(0.0);
Output_N24=mix(Value_N3,(*sc_set2.UserUniforms).Port_Input1_N024,float4(Rim_N31));
float4 Output_N100=float4(0.0);
Output_N100=Output_N5+Output_N24;
...
int l9_186=l9_181;
int param_41=iconLayout_tmp;
int param_42=l9_186;
float2 param_43=CoordsOut_N2;
bool param_44=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 param_45=(*sc_set2.UserUniforms).iconTransform;
int2 param_46=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool param_47=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 param_48=(*sc_set2.UserUniforms).iconUvMinMax;
bool param_49=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_50=(*sc_set2.UserUniforms).iconBorderColor;
float param_51=0.0;
bool l9_187=param_49&&(!param_47);
float l9_188=1.0;
float l9_189=param_43.x;
int l9_190=param_46.x;
if (l9_190==1)
{
l9_189=fract(l9_189);
}
...
param_43.x=l9_189;
float l9_194=param_43.y;
int l9_195=param_46.y;
if (l9_195==1)
{
l9_194=fract(l9_194);
}
...
float l9_202=param_48.x;
float l9_203=param_48.z;
bool l9_204=l9_200;
float l9_205=l9_188;
...
float l9_211=param_48.y;
float l9_212=param_48.w;
bool l9_213=l9_209;
float l9_214=l9_188;
...
float2 l9_217=param_43;
bool l9_218=param_44;
float3x3 l9_219=param_45;
if (l9_218)
{
...
param_43=l9_222;
float l9_223=param_43.x;
int l9_224=param_46.x;
bool l9_225=l9_187;
float l9_226=l9_188;
...
param_43.x=l9_223;
l9_188=l9_226;
float l9_234=param_43.y;
int l9_235=param_46.y;
bool l9_236=l9_187;
float l9_237=l9_188;
...
param_43.y=l9_234;
l9_188=l9_237;
float2 l9_245=param_43;
int l9_246=param_41;
int l9_247=param_42;
float l9_248=param_51;
...
if (param_49)
{
l9_259=mix(param_50,l9_259,float4(l9_188));
}
...
float param_52=1.0;
float param_53=1.0;
float param_54=(*sc_set2.UserUniforms).Port_Input2_N007;
...
l9_263=param_56.Surface_UVCoord1;
...
{
if (param_57<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_364=fast::max(param_58,float4(0.0));
float4 param_59=l9_364;
out.FragColor0=param_59;
return out;
}
float4 param_60=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_365=param_60;
...
{
param_60=float4(param_60.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_373=param_60;
...
float3 param_61=in.varPos;
float4 param_62=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_61,param_62,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_63=FinalColor;
float4 l9_438=param_63;
