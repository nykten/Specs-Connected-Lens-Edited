...
vec4 l9_13;
if (l9_12<Port_Position1_N003)
{
l9_13=mix(Port_Value0_N003,Port_Value1_N003,vec4(clamp(l9_12/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_12<Port_Position2_N003)
{
l9_14=mix(Port_Value1_N003,Port_Value2_N003,vec4(clamp((l9_12-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_15;
if (l9_12<Port_Position3_N003)
{
l9_15=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_12-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
l9_15=mix(Port_Value3_N003,Port_Value4_N003,vec4(clamp((l9_12-Port_Position3_N003)/(1.0-Port_Position3_N003),0.0,1.0)));
}
l9_14=l9_15;
}
l9_13=l9_14;
}
bool l9_16=PreviewEnabled==1;
bool l9_17;
if (l9_16)
{
l9_17=!l9_0;
...
{
l9_19=PreviewVertexColor;
l9_18=l9_0;
}
vec4 l9_21=mix(l9_13,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
...
{
l9_24=Port_Input2_N007;
}
vec4 l9_25=vec4(l9_24);
vec4 l9_26=mix(mix(vec4(Port_Import_N006)*l9_7,vec4(Port_Import_N062)*l9_11,vec4(Port_Input2_N005))+l9_21,l9_23,l9_25);
float l9_27=l9_26.w;
