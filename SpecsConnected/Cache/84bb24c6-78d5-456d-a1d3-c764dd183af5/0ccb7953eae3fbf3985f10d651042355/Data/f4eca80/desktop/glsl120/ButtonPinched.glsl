...
vec3 l9_2=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*Port_Import_N068;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,l9_6,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073)).xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
float l9_8=clamp(length((varPackedTex.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_9;
if (l9_8<Port_Position1_N014)
{
l9_9=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_8/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_8<Port_Position2_N014)
{
l9_10=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_8-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_10=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_8-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_9=l9_10;
}
vec4 l9_11=(vec4(Port_Import_N062)*l9_7)+l9_9;
vec2 l9_12=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_13=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_12,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
float l9_14;
if ((float(iconEnabled)*1.0)!=0.0)
{
l9_14=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_12,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon).w;
}
else
{
l9_14=Port_Input2_N003;
}
vec4 l9_15=vec4(l9_14);
vec4 l9_16=mix(l9_11,l9_13,l9_15);
float l9_17=l9_16.w;
...
{
l9_21=clamp(dot(l9_16.xyz,vec3(l9_17)),0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_23=(1.0-dot(l9_16.xyz,vec3(0.33333001)))*l9_17;
}
#else
{
float l9_24;
...
{
l9_24=(1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0))*l9_17;
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_17;
}
#else
{
float l9_26;
#if (sc_BlendMode_Add)
{
l9_26=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_27=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_17;
}
#else
{
float l9_28;
...
{
l9_28=dot(l9_16.xyz,vec3(0.33333001))*l9_17;
}
#else
{
float l9_29;
#if (sc_BlendMode_Min)
{
l9_29=1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_Max)
{
l9_30=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_30=1.0;
...
#endif
l9_18=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_16.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_19);
}
#else
{
vec4 l9_31;
...
#endif
vec3 l9_41=mix(l9_39.xyz,definedBlend(l9_39.xyz,l9_16.xyz).xyz,vec3(l9_17));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_43=vec4(mix(vec3(1.0),l9_16.xyz,vec3(l9_17)),l9_17);
}
#else
{
vec4 l9_44;
...
#endif
l9_44=vec4(l9_16.xyz*l9_45,l9_45);
}
#else
{
l9_44=l9_16;
...
#endif
int l9_54=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_53).xy);
...
if (l9_71==0)
{
l9_74=texture2D(sc_OITAlpha0,l9_66);
l9_73=texture2D(sc_OITDepthLow0,l9_66);
l9_72=texture2D(sc_OITDepthHigh0,l9_66);
}
else
{
l9_74=vec4(0.0);
...
if (l9_71==1)
{
l9_77=texture2D(sc_OITAlpha1,l9_66);
l9_76=texture2D(sc_OITDepthLow1,l9_66);
l9_75=texture2D(sc_OITDepthHigh1,l9_66);
}
else
{
l9_77=l9_74;
...
vec4 l9_92=texture2D(sc_OITFilteredDepthBoundsTexture,l9_66);
vec2 l9_93=l9_92.xy;
int l9_94;
#if (sc_SkinBonesCount>0)
{
