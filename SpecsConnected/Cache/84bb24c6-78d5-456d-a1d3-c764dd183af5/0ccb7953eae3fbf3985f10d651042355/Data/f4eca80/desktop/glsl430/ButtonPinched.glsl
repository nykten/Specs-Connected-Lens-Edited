...
uniform vec4 Port_Value0_N014;
uniform float Port_Position1_N014;
uniform vec4 Port_Value1_N014;
uniform float Port_Position2_N014;
uniform vec4 Port_Value2_N014;
uniform vec4 Port_Value3_N014;
...
vec3 l9_12=l9_11*Port_Import_N068;
...
#endif
vec4 l9_18=vec4(Port_Import_N062)*l9_17;
vec2 l9_19=l9_3*Port_Input1_N009;
float l9_20=clamp(length(l9_19+Port_Input2_N009),0.0,1.0);
vec4 l9_21;
if (l9_20<Port_Position1_N014)
{
l9_21=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_20/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_22;
if (l9_20<Port_Position2_N014)
{
l9_22=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_20-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_22=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_20-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_21=l9_22;
}
vec4 l9_23=l9_18+l9_21;
vec2 l9_24=l9_4-Port_Center_N002;
vec2 l9_25=(l9_24*Port_Scale_N002)+Port_Center_N002;
vec4 l9_26;
#if (iconLayout==2)
{
l9_26=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_26=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
float l9_27;
...
#if (iconLayout==2)
{
l9_28=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_28=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
l9_27=l9_28.w;
}
...
{
l9_27=Port_Input2_N003;
}
vec4 l9_29=vec4(l9_27);
vec4 l9_30=mix(l9_23,l9_26,l9_29);
float l9_31=l9_30.w;
