...
//sampler sampler Tweak_N41SmpSC 2:24
//sampler sampler Tweak_N42SmpSC 2:25
//sampler sampler Tweak_N99SmpSC 2:26
...
//texture texture2D Tweak_N41 2:4:2:24
//texture texture2D Tweak_N42 2:5:2:25
//texture texture2D Tweak_N99 2:6:2:26
...
//}
//ubo int UserUniforms 2:37:4688 {
...
//float4 Tweak_N42Size 4144
//float4 Tweak_N42Dims 4160
//float4 Tweak_N42View 4176
//float3x3 Tweak_N42Transform 4192
//float4 Tweak_N42UvMinMax 4240
//float4 Tweak_N42BorderColor 4256
//float Tweak_N80 4272
//float4 Tweak_N41Size 4288
//float4 Tweak_N41Dims 4304
//float4 Tweak_N41View 4320
//float3x3 Tweak_N41Transform 4336
//float4 Tweak_N41UvMinMax 4384
//float4 Tweak_N41BorderColor 4400
//float4 Tweak_N46 4416
//float Tweak_N85 4432
//float4 Tweak_N99Size 4448
//float4 Tweak_N99Dims 4464
//float4 Tweak_N99View 4480
//float3x3 Tweak_N99Transform 4496
//float4 Tweak_N99UvMinMax 4544
//float4 Tweak_N99BorderColor 4560
//float4 Port_Import_N048 4576
//float Port_Import_N057 4592
//float Port_RangeMinA_N070 4596
//float Port_RangeMaxA_N070 4600
//float Port_RangeMinB_N070 4604
//float Port_RangeMaxB_N070 4608
//float Port_Import_N072 4612
//float Port_Input1_N073 4616
//float Port_Import_N074 4620
//float Port_Input1_N075 4624
//float4 Port_Input1_N097 4640
//float2 Port_Seed_N083 4656
//float2 Port_Scale_N092 4664
//float2 Port_Center_N092 4672
//float depthRef 4680
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N41 1031
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 1032
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N99 1033
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 1034
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N41 1035
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N42 1036
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N99 1037
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 1038
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N41 1039
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N42 1040
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N99 1041
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 1042
//spec_const bool Tweak_N41HasSwappedViews 1043
//spec_const bool Tweak_N42HasSwappedViews 1044
//spec_const bool Tweak_N99HasSwappedViews 1045
//spec_const bool UseViewSpaceDepthVariant 1046
...
//spec_const int SC_DEVICE_CLASS 1078
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 1079
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 1080
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N99 1081
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1082
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 1083
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 1084
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N99 1085
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1086
//spec_const int Tweak_N41Layout 1087
//spec_const int Tweak_N42Layout 1088
//spec_const int Tweak_N99Layout 1089
//spec_const int intensityTextureLayout 1090
//spec_const int sc_DepthBufferMode 1091
//spec_const int sc_RenderingSpace 1092
//spec_const int sc_ScreenTextureLayout 1093
//spec_const int sc_SkinBonesCount 1094
//spec_const int sc_StereoRenderingMode 1095
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 1096
//SG_REFLECTION_END
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N41 [[function_constant(1031)]];
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N41_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_Tweak_N41) ? SC_USE_CLAMP_TO_BORDER_Tweak_N41 : false;
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 [[function_constant(1032)]];
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N42_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_Tweak_N42) ? SC_USE_CLAMP_TO_BORDER_Tweak_N42 : false;
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N99 [[function_constant(1033)]];
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N99_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_Tweak_N99) ? SC_USE_CLAMP_TO_BORDER_Tweak_N99 : false;
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture [[function_constant(1034)]];
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_intensityTexture) ? SC_USE_CLAMP_TO_BORDER_intensityTexture : false;
constant bool SC_USE_UV_MIN_MAX_Tweak_N41 [[function_constant(1035)]];
constant bool SC_USE_UV_MIN_MAX_Tweak_N41_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_Tweak_N41) ? SC_USE_UV_MIN_MAX_Tweak_N41 : false;
constant bool SC_USE_UV_MIN_MAX_Tweak_N42 [[function_constant(1036)]];
constant bool SC_USE_UV_MIN_MAX_Tweak_N42_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_Tweak_N42) ? SC_USE_UV_MIN_MAX_Tweak_N42 : false;
constant bool SC_USE_UV_MIN_MAX_Tweak_N99 [[function_constant(1037)]];
constant bool SC_USE_UV_MIN_MAX_Tweak_N99_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_Tweak_N99) ? SC_USE_UV_MIN_MAX_Tweak_N99 : false;
constant bool SC_USE_UV_MIN_MAX_intensityTexture [[function_constant(1038)]];
constant bool SC_USE_UV_MIN_MAX_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_intensityTexture) ? SC_USE_UV_MIN_MAX_intensityTexture : false;
constant bool SC_USE_UV_TRANSFORM_Tweak_N41 [[function_constant(1039)]];
constant bool SC_USE_UV_TRANSFORM_Tweak_N41_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_Tweak_N41) ? SC_USE_UV_TRANSFORM_Tweak_N41 : false;
constant bool SC_USE_UV_TRANSFORM_Tweak_N42 [[function_constant(1040)]];
constant bool SC_USE_UV_TRANSFORM_Tweak_N42_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_Tweak_N42) ? SC_USE_UV_TRANSFORM_Tweak_N42 : false;
constant bool SC_USE_UV_TRANSFORM_Tweak_N99 [[function_constant(1041)]];
constant bool SC_USE_UV_TRANSFORM_Tweak_N99_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_Tweak_N99) ? SC_USE_UV_TRANSFORM_Tweak_N99 : false;
constant bool SC_USE_UV_TRANSFORM_intensityTexture [[function_constant(1042)]];
constant bool SC_USE_UV_TRANSFORM_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_intensityTexture) ? SC_USE_UV_TRANSFORM_intensityTexture : false;
constant bool Tweak_N41HasSwappedViews [[function_constant(1043)]];
constant bool Tweak_N41HasSwappedViews_tmp = is_function_constant_defined(Tweak_N41HasSwappedViews) ? Tweak_N41HasSwappedViews : false;
constant bool Tweak_N42HasSwappedViews [[function_constant(1044)]];
constant bool Tweak_N42HasSwappedViews_tmp = is_function_constant_defined(Tweak_N42HasSwappedViews) ? Tweak_N42HasSwappedViews : false;
constant bool Tweak_N99HasSwappedViews [[function_constant(1045)]];
constant bool Tweak_N99HasSwappedViews_tmp = is_function_constant_defined(Tweak_N99HasSwappedViews) ? Tweak_N99HasSwappedViews : false;
constant bool UseViewSpaceDepthVariant [[function_constant(1046)]];
...
constant int SC_DEVICE_CLASS [[function_constant(1078)]];
constant int SC_DEVICE_CLASS_tmp = is_function_constant_defined(SC_DEVICE_CLASS) ? SC_DEVICE_CLASS : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 [[function_constant(1079)]];
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_Tweak_N41) ? SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 [[function_constant(1080)]];
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42) ? SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N99 [[function_constant(1081)]];
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N99_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99) ? SC_SOFTWARE_WRAP_MODE_U_Tweak_N99 : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture [[function_constant(1082)]];
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_U_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 [[function_constant(1083)]];
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_Tweak_N41) ? SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 [[function_constant(1084)]];
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_Tweak_N42) ? SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N99 [[function_constant(1085)]];
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N99_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_Tweak_N99) ? SC_SOFTWARE_WRAP_MODE_V_Tweak_N99 : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(1086)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int Tweak_N41Layout [[function_constant(1087)]];
constant int Tweak_N41Layout_tmp = is_function_constant_defined(Tweak_N41Layout) ? Tweak_N41Layout : 0;
constant int Tweak_N42Layout [[function_constant(1088)]];
constant int Tweak_N42Layout_tmp = is_function_constant_defined(Tweak_N42Layout) ? Tweak_N42Layout : 0;
constant int Tweak_N99Layout [[function_constant(1089)]];
constant int Tweak_N99Layout_tmp = is_function_constant_defined(Tweak_N99Layout) ? Tweak_N99Layout : 0;
constant int intensityTextureLayout [[function_constant(1090)]];
constant int intensityTextureLayout_tmp = is_function_constant_defined(intensityTextureLayout) ? intensityTextureLayout : 0;
constant int sc_DepthBufferMode [[function_constant(1091)]];
constant int sc_DepthBufferMode_tmp = is_function_constant_defined(sc_DepthBufferMode) ? sc_DepthBufferMode : 0;
constant int sc_RenderingSpace [[function_constant(1092)]];
constant int sc_RenderingSpace_tmp = is_function_constant_defined(sc_RenderingSpace) ? sc_RenderingSpace : -1;
constant int sc_ScreenTextureLayout [[function_constant(1093)]];
constant int sc_ScreenTextureLayout_tmp = is_function_constant_defined(sc_ScreenTextureLayout) ? sc_ScreenTextureLayout : 0;
constant int sc_SkinBonesCount [[function_constant(1094)]];
constant int sc_SkinBonesCount_tmp = is_function_constant_defined(sc_SkinBonesCount) ? sc_SkinBonesCount : 0;
constant int sc_StereoRenderingMode [[function_constant(1095)]];
constant int sc_StereoRenderingMode_tmp = is_function_constant_defined(sc_StereoRenderingMode) ? sc_StereoRenderingMode : 0;
constant int sc_StereoRendering_IsClipDistanceEnabled [[function_constant(1096)]];
...
float4 Tweak_N42Size;
float4 Tweak_N42Dims;
float4 Tweak_N42View;
float3x3 Tweak_N42Transform;
float4 Tweak_N42UvMinMax;
float4 Tweak_N42BorderColor;
float Tweak_N80;
float4 Tweak_N41Size;
float4 Tweak_N41Dims;
float4 Tweak_N41View;
float3x3 Tweak_N41Transform;
float4 Tweak_N41UvMinMax;
float4 Tweak_N41BorderColor;
float4 Tweak_N46;
float Tweak_N85;
float4 Tweak_N99Size;
float4 Tweak_N99Dims;
float4 Tweak_N99View;
float3x3 Tweak_N99Transform;
float4 Tweak_N99UvMinMax;
float4 Tweak_N99BorderColor;
float4 Port_Import_N048;
float Port_Import_N057;
float Port_RangeMinA_N070;
float Port_RangeMaxA_N070;
float Port_RangeMinB_N070;
float Port_RangeMaxB_N070;
float Port_Import_N072;
float Port_Input1_N073;
float Port_Import_N074;
float Port_Input1_N075;
float4 Port_Input1_N097;
float2 Port_Seed_N083;
float2 Port_Scale_N092;
...
texture2d<float> Tweak_N41 [[id(4)]];
texture2d<float> Tweak_N42 [[id(5)]];
texture2d<float> Tweak_N99 [[id(6)]];
...
sampler Tweak_N41SmpSC [[id(24)]];
sampler Tweak_N42SmpSC [[id(25)]];
sampler Tweak_N99SmpSC [[id(26)]];
...
fragment main_frag_out main_frag(main_frag_in in [[stage_in]],constant sc_Set2& sc_set2 [[buffer(2)]],float4 gl_FragCoord [[position]],bool gl_FrontFacing [[front_facing]])
{
main_frag_out out={};
...
bool l9_8=gl_FrontFacing;
Globals.gFrontFacing=float(l9_8);
}
float4 Output_N42=float4(0.0);
int l9_9=0;
if ((int(Tweak_N42HasSwappedViews_tmp)!=0))
{
int l9_10=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_14=l9_9;
int param=Tweak_N42Layout_tmp;
int param_1=l9_14;
float2 param_2=Globals.Surface_UVCoord1;
bool param_3=(int(SC_USE_UV_TRANSFORM_Tweak_N42_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).Tweak_N42Transform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_Tweak_N42_tmp)!=0);
float4 param_7=(*sc_set2.UserUniforms).Tweak_N42UvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).Tweak_N42BorderColor;
float param_10=0.0;
bool l9_15=param_8&&(!param_6);
float l9_16=1.0;
float l9_17=param_2.x;
int l9_18=param_5.x;
if (l9_18==1)
{
l9_17=fract(l9_17);
...
float l9_29=param_2.x;
float l9_30=param_7.x;
float l9_31=param_7.z;
bool l9_32=l9_28;
float l9_33=l9_16;
...
float l9_38=param_2.y;
float l9_39=param_7.y;
float l9_40=param_7.w;
bool l9_41=l9_37;
float l9_42=l9_16;
...
float2 l9_45=param_2;
bool l9_46=param_3;
float3x3 l9_47=param_4;
if (l9_46)
{
...
float3 l9_81=l9_80;
float3 l9_82=l9_81;
float2 l9_83=l9_82.xy;
float l9_84=l9_76;
float4 l9_85=sc_set2.Tweak_N42.sample(sc_set2.Tweak_N42SmpSC,l9_83,bias(l9_84));
float4 l9_86=l9_85;
float4 l9_87=l9_86;
if (param_8)
{
l9_87=mix(param_9,l9_87,float4(l9_16));
}
float4 l9_88=l9_87;
Output_N42=l9_88;
float4 Value_N48=float4(0.0);
Value_N48=Output_N42;
float4 HSV_N54=float4(0.0);
float3 param_11=Value_N48.xyz;
float3 l9_89=float3(0.0);
float3 l9_90=param_11;
float3 l9_91=fast::clamp(l9_90,float3(0.0),float3(1.0));
param_11=l9_91;
float l9_92=fast::max(fast::max(param_11.x,param_11.y),param_11.z);
l9_89.z=l9_92;
float l9_93=l9_92-fast::min(fast::min(param_11.x,param_11.y),param_11.z);
float3 l9_94=float3(0.0,0.33333334,0.66666669)+(((param_11.yzx-param_11.zxy)*0.16666667)/float3(l9_93));
float2 l9_95;
if (l9_93==0.0)
{
l9_95=float2(0.0);
...
l9_95=float2(l9_96,l9_93/l9_92);
}
l9_89=float3(l9_95.x,l9_95.y,l9_89.z);
float3 l9_98=l9_89;
HSV_N54=float4(l9_98,Value_N48.w);
float Value_N57=0.0;
Value_N57=fast::clamp((*sc_set2.UserUniforms).Port_Import_N057,-180.0,180.0);
float ValueOut_N70=0.0;
ValueOut_N70=(((Value_N57-(*sc_set2.UserUniforms).Port_RangeMinA_N070)/((*sc_set2.UserUniforms).Port_RangeMaxA_N070-(*sc_set2.UserUniforms).Port_RangeMinA_N070))*((*sc_set2.UserUniforms).Port_RangeMaxB_N070-(*sc_set2.UserUniforms).Port_RangeMinB_N070))+(*sc_set2.UserUniforms).Port_RangeMinB_N070;
float Output_N80=0.0;
float param_12=(*sc_set2.UserUniforms).Tweak_N80;
Output_N80=param_12;
float Value_N72=0.0;
Value_N72=fast::clamp(Output_N80,-100.0,100.0);
float Output_N73=0.0;
Output_N73=Value_N72*(*sc_set2.UserUniforms).Port_Input1_N073;
float Value_N74=0.0;
Value_N74=fast::clamp((*sc_set2.UserUniforms).Port_Import_N074,-100.0,100.0);
float Output_N75=0.0;
Output_N75=Value_N74*(*sc_set2.UserUniforms).Port_Input1_N075;
float3 Value_N76=float3(0.0);
Value_N76.x=ValueOut_N70;
Value_N76.y=Output_N73;
Value_N76.z=Output_N75;
float4 Output_N77=float4(0.0);
Output_N77=HSV_N54+float4(Value_N76,0.0);
float4 RGB_N78=float4(0.0);
float3 param_13=Output_N77.xyz;
float3 l9_99=param_13.zzz;
float l9_100=3.0*fract(param_13.x+0.16666667);
float l9_101=2.0*fract(l9_100);
float l9_102=param_13.y;
float l9_103=fast::clamp(l9_102,0.0,1.0);
float2 l9_104=l9_99.yz-((float2(1.0,l9_101)-float2(fast::max(0.0,l9_101-1.0)))*(param_13.z*l9_103));
l9_99=float3(l9_99.x,l9_104.x,l9_104.y);
if (l9_100>=1.0)
{
l9_99=l9_99.zxy;
}
...
float3 l9_105=l9_99;
RGB_N78=float4(l9_105,Output_N77.w);
float4 Export_N79=float4(0.0);
Export_N79=RGB_N78;
float4 Output_N41=float4(0.0);
int l9_106=0;
if ((int(Tweak_N41HasSwappedViews_tmp)!=0))
{
int l9_107=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_111=l9_106;
int param_14=Tweak_N41Layout_tmp;
int param_15=l9_111;
float2 param_16=Globals.Surface_UVCoord0;
bool param_17=(int(SC_USE_UV_TRANSFORM_Tweak_N41_tmp)!=0);
float3x3 param_18=(*sc_set2.UserUniforms).Tweak_N41Transform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N41_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N41_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_Tweak_N41_tmp)!=0);
float4 param_21=(*sc_set2.UserUniforms).Tweak_N41UvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N41_tmp)!=0);
float4 param_23=(*sc_set2.UserUniforms).Tweak_N41BorderColor;
float param_24=0.0;
bool l9_112=param_22&&(!param_20);
float l9_113=1.0;
float l9_114=param_16.x;
int l9_115=param_19.x;
if (l9_115==1)
{
l9_114=fract(l9_114);
}
...
param_16.x=l9_114;
float l9_119=param_16.y;
int l9_120=param_19.y;
if (l9_120==1)
{
l9_119=fract(l9_119);
}
...
float l9_126=param_16.x;
float l9_127=param_21.x;
float l9_128=param_21.z;
bool l9_129=l9_125;
float l9_130=l9_113;
...
float l9_135=param_16.y;
float l9_136=param_21.y;
float l9_137=param_21.w;
bool l9_138=l9_134;
float l9_139=l9_113;
...
float2 l9_142=param_16;
bool l9_143=param_17;
float3x3 l9_144=param_18;
if (l9_143)
{
...
param_16=l9_147;
float l9_148=param_16.x;
int l9_149=param_19.x;
bool l9_150=l9_112;
float l9_151=l9_113;
...
param_16.x=l9_148;
l9_113=l9_151;
float l9_159=param_16.y;
int l9_160=param_19.y;
bool l9_161=l9_112;
float l9_162=l9_113;
...
param_16.y=l9_159;
l9_113=l9_162;
float2 l9_170=param_16;
int l9_171=param_14;
int l9_172=param_15;
float l9_173=param_24;
float2 l9_174=l9_170;
int l9_175=l9_171;
int l9_176=l9_172;
float3 l9_177=float3(0.0);
if (l9_175==0)
{
l9_177=float3(l9_174,0.0);
}
else
{
if (l9_175==1)
{
l9_177=float3(l9_174.x,(l9_174.y*0.5)+(0.5-(float(l9_176)*0.5)),0.0);
}
else
{
l9_177=float3(l9_174,float(l9_176));
}
}
float3 l9_178=l9_177;
float3 l9_179=l9_178;
float2 l9_180=l9_179.xy;
float l9_181=l9_173;
float4 l9_182=sc_set2.Tweak_N41.sample(sc_set2.Tweak_N41SmpSC,l9_180,bias(l9_181));
float4 l9_183=l9_182;
float4 l9_184=l9_183;
if (param_22)
{
l9_184=mix(param_23,l9_184,float4(l9_113));
}
float4 l9_185=l9_184;
Output_N41=l9_185;
float4 Output_N46=float4(0.0);
float4 param_25=(*sc_set2.UserUniforms).Tweak_N46;
Output_N46=param_25;
float4 Output_N45=float4(0.0);
Output_N45=Output_N41+Output_N46;
float Output_N85=0.0;
float param_26=(*sc_set2.UserUniforms).Tweak_N85;
Output_N85=param_26;
float4 Output_N82=float4(0.0);
Output_N82=Output_N45*float4(Output_N85);
float FrontFacing_N96=0.0;
FrontFacing_N96=Globals.gFrontFacing;
float4 Output_N97=float4(0.0);
Output_N97=mix(Output_N82,(*sc_set2.UserUniforms).Port_Input1_N097,float4(FrontFacing_N96));
float4 Output_N84=float4(0.0);
Output_N84=Output_N82*Output_N97;
float4 Output_N99=float4(0.0);
int l9_186=0;
if ((int(Tweak_N99HasSwappedViews_tmp)!=0))
{
int l9_187=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_191=l9_186;
int param_27=Tweak_N99Layout_tmp;
int param_28=l9_191;
float2 param_29=Globals.Surface_UVCoord0;
bool param_30=(int(SC_USE_UV_TRANSFORM_Tweak_N99_tmp)!=0);
float3x3 param_31=(*sc_set2.UserUniforms).Tweak_N99Transform;
int2 param_32=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99_tmp);
bool param_33=(int(SC_USE_UV_MIN_MAX_Tweak_N99_tmp)!=0);
float4 param_34=(*sc_set2.UserUniforms).Tweak_N99UvMinMax;
bool param_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99_tmp)!=0);
float4 param_36=(*sc_set2.UserUniforms).Tweak_N99BorderColor;
float param_37=0.0;
bool l9_192=param_35&&(!param_33);
float l9_193=1.0;
float l9_194=param_29.x;
int l9_195=param_32.x;
if (l9_195==1)
{
l9_194=fract(l9_194);
}
...
param_29.x=l9_194;
float l9_199=param_29.y;
int l9_200=param_32.y;
if (l9_200==1)
{
l9_199=fract(l9_199);
}
...
float l9_206=param_29.x;
float l9_207=param_34.x;
float l9_208=param_34.z;
bool l9_209=l9_205;
float l9_210=l9_193;
...
float l9_215=param_29.y;
float l9_216=param_34.y;
float l9_217=param_34.w;
bool l9_218=l9_214;
float l9_219=l9_193;
...
float2 l9_222=param_29;
bool l9_223=param_30;
float3x3 l9_224=param_31;
if (l9_223)
{
...
param_29=l9_227;
float l9_228=param_29.x;
int l9_229=param_32.x;
bool l9_230=l9_192;
float l9_231=l9_193;
...
param_29.x=l9_228;
l9_193=l9_231;
float l9_239=param_29.y;
int l9_240=param_32.y;
bool l9_241=l9_192;
float l9_242=l9_193;
if ((l9_240==0)||(l9_240==3))
{
float l9_243=l9_239;
float l9_244=0.0;
float l9_245=1.0;
...
param_29.y=l9_239;
l9_193=l9_242;
float2 l9_250=param_29;
int l9_251=param_27;
int l9_252=param_28;
float l9_253=param_37;
float2 l9_254=l9_250;
int l9_255=l9_251;
int l9_256=l9_252;
float3 l9_257=float3(0.0);
if (l9_255==0)
{
l9_257=float3(l9_254,0.0);
}
else
{
if (l9_255==1)
{
l9_257=float3(l9_254.x,(l9_254.y*0.5)+(0.5-(float(l9_256)*0.5)),0.0);
}
else
{
l9_257=float3(l9_254,float(l9_256));
}
}
float3 l9_258=l9_257;
float3 l9_259=l9_258;
float2 l9_260=l9_259.xy;
float l9_261=l9_253;
float4 l9_262=sc_set2.Tweak_N99.sample(sc_set2.Tweak_N99SmpSC,l9_260,bias(l9_261));
float4 l9_263=l9_262;
float4 l9_264=l9_263;
if (param_35)
{
l9_264=mix(param_36,l9_264,float4(l9_193));
}
float4 l9_265=l9_264;
Output_N99=l9_265;
float4 Output_N89=float4(0.0);
Output_N89=Output_N84+Output_N99;
float2 UVCoord_N91=float2(0.0);
UVCoord_N91=Globals.Surface_UVCoord0;
float2 CoordsOut_N92=float2(0.0);
CoordsOut_N92=((UVCoord_N91-(*sc_set2.UserUniforms).Port_Center_N092)*(*sc_set2.UserUniforms).Port_Scale_N092)+(*sc_set2.UserUniforms).Port_Center_N092;
float Noise_N83=0.0;
float2 param_38=(*sc_set2.UserUniforms).Port_Seed_N083;
float2 param_39=CoordsOut_N92;
param_38.x=floor(param_38.x*10000.0)*9.9999997e-05;
param_38.y=floor(param_38.y*10000.0)*9.9999997e-05;
param_38*=(param_39*0.5);
float2 l9_266=param_38;
float param_40=(snoise(l9_266)*0.5)+0.5;
param_40=floor(param_40*10000.0)*9.9999997e-05;
Noise_N83=param_40;
float4 Output_N94=float4(0.0);
float4 param_41=Output_N89;
float4 param_42=float4(Noise_N83);
float3 l9_267=param_42.xyz*param_41.xyz;
float4 param_43;
param_43=float4(l9_267.x,l9_267.y,l9_267.z,param_43.w);
float3 l9_268=mix(param_41.xyz,param_43.xyz,float3(param_42.w));
param_43=float4(l9_268.x,l9_268.y,l9_268.z,param_43.w);
param_43.w=param_41.w;
Output_N94=param_43;
float4 Value_N1=float4(0.0);
Value_N1=float4(Export_N79.xyz.x,Export_N79.xyz.y,Export_N79.xyz.z,Value_N1.w);
Value_N1.w=Output_N94.x;
FinalColor=Value_N1;
float param_44=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_44<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_269=gl_FragCoord;
float2 l9_270=floor(mod(l9_269.xy,float2(4.0)));
float l9_271=(mod(dot(l9_270,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_44<l9_271)
{
discard_fragment();
}
}
bool l9_272=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_272)
{
...
float4 l9_273=fast::max(param_45,float4(0.0));
float4 param_46=l9_273;
...
{
l9_276=fast::clamp(l9_275.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_276=fast::clamp(dot(l9_275.xyz,float3(l9_275.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_276=(1.0-dot(l9_275.xyz,float3(0.33333001)))*l9_275.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_276=(1.0-fast::clamp(dot(l9_275.xyz,float3(1.0)),0.0,1.0))*l9_275.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_276=fast::clamp(dot(l9_275.xyz,float3(1.0)),0.0,1.0)*l9_275.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_276=fast::clamp(dot(l9_275.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_276=dot(l9_275.xyz,float3(0.33333001))*l9_275.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_276=1.0-fast::clamp(dot(l9_275.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_277=l9_276;
float l9_278=l9_277;
float l9_279=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_278;
float3 l9_280=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_274.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_281=float4(l9_280.x,l9_280.y,l9_280.z,l9_279);
param_47=l9_281;
}
else
{
...
{
float4 l9_282=param_47;
float4 l9_283=float4(0.0);
float4 l9_284=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_285=out.FragColor0;
float4 l9_286=l9_285;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_286.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_288=gl_FragCoord;
float2 l9_289=(l9_288.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_294=l9_293;
int l9_295=l9_294;
float3 l9_296=float3(l9_290,0.0);
int l9_297=l9_292;
int l9_298=l9_295;
if (l9_297==1)
{
l9_296.y=((2.0*l9_296.y)+float(l9_298))-1.0;
}
float2 l9_299=l9_296.xy;
l9_291=l9_299;
}
else
{
...
int l9_308=l9_303;
float2 l9_309=l9_302;
int l9_310=l9_308;
float2 l9_311=l9_309;
int l9_312=l9_310;
float l9_313=0.0;
...
float l9_326=l9_318;
float4 l9_327=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_325,bias(l9_326));
float4 l9_328=l9_327;
l9_314=l9_328;
float4 l9_329=l9_314;
float4 l9_330=l9_329;
float4 l9_331=l9_330;
l9_284=l9_331;
}
float4 l9_332=l9_284;
float4 l9_333=l9_332;
float3 l9_334=l9_333.xyz;
float3 l9_335=l9_334;
float3 l9_336=l9_282.xyz;
float3 l9_337=definedBlend(l9_335,l9_336,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_283=float4(l9_337.x,l9_337.y,l9_337.z,l9_283.w);
float3 l9_338=mix(l9_334,l9_283.xyz,float3(l9_282.w));
l9_283=float4(l9_338.x,l9_338.y,l9_338.z,l9_283.w);
l9_283.w=1.0;
float4 l9_339=l9_283;
param_47=l9_339;
}
else
{
float4 l9_340=param_47;
float4 l9_341=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_341=float4(mix(float3(1.0),l9_340.xyz,float3(l9_340.w)),l9_340.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_342=l9_340.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_342=fast::clamp(l9_342,0.0,1.0);
}
l9_341=float4(l9_340.xyz*l9_342,l9_342);
}
else
{
l9_341=l9_340;
...
float4 l9_343=l9_341;
param_47=l9_343;
}
}
}
float4 l9_344=param_47;
FinalColor=l9_344;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_345=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_345=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_48,param_49,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_50=FinalColor;
float4 l9_347=param_50;
out.FragColor0=l9_347;
return out;
}
} // FRAGMENT SHADER
