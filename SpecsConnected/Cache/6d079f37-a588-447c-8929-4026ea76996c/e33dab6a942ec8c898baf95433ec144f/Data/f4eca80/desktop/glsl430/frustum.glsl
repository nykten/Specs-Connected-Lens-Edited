...
#endif
vec4 l9_28=(l9_25*mix(l9_25,Port_Input1_N097,l9_26))+l9_27;
float l9_29=snoise(vec2(floor(Port_Seed_N083.x*10000.0)*9.9999997e-05,floor(Port_Seed_N083.y*10000.0)*9.9999997e-05)*((((l9_1-Port_Center_N092)*Port_Scale_N092)+Port_Center_N092)*0.5));
float l9_30=floor(((l9_29*0.5)+0.5)*10000.0)*9.9999997e-05;
vec3 l9_31=l9_28.xyz;
vec3 l9_32=mix(l9_31,(vec4(l9_30).xyz*l9_31).xyz,vec3(l9_30));
float l9_33=l9_32.x;
vec4 l9_34=vec4(l9_22.x,l9_22.y,l9_22.z,vec4(0.0).w);
l9_34.w=l9_33;
...
#endif
sc_writeFragData0(max(l9_35,vec4(0.0)));
return;
}
vec4 l9_37;
...
{
l9_40=clamp(dot(l9_34.xyz,vec3(l9_33)),0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_42=(1.0-dot(l9_34.xyz,vec3(0.33333001)))*l9_33;
}
#else
{
float l9_43;
...
{
l9_43=(1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0))*l9_33;
}
#else
{
float l9_44;
...
#if (sc_BlendMode_Add)
{
l9_45=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_46;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_46=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_33;
}
#else
{
float l9_47;
...
{
l9_47=dot(l9_34.xyz,vec3(0.33333001))*l9_33;
}
#else
{
float l9_48;
#if (sc_BlendMode_Min)
{
l9_48=1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_49;
#if (sc_BlendMode_Max)
{
l9_49=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_49=1.0;
...
#endif
l9_37=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_34.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_38);
}
#else
{
vec4 l9_50;
...
#if (sc_FramebufferFetch)
{
vec4 l9_53=sc_readFragData0_Platform();
vec4 l9_54;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_55=l9_53;
l9_55.x=l9_53.x+_sc_framebufferFetchMarker;
l9_54=l9_55;
}
#else
{
...
#else
{
vec2 l9_56=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_57;
...
{
l9_58=sc_SampleView(sc_ScreenTextureDims.xy,l9_56,sc_ScreenTextureLayout,l9_57,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_58=sc_SampleView(sc_ScreenTextureDims.xy,l9_56,sc_ScreenTextureLayout,l9_57,0.0,sc_ScreenTexture);
}
#endif
l9_52=l9_58;
}
...
{
vec4 l9_60=l9_52;
l9_60.x=l9_52.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_59=l9_60;
}
#else
{
...
#endif
vec3 l9_61=mix(l9_59.xyz,definedBlend(l9_59.xyz,l9_34.xyz).xyz,vec3(l9_33));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_63=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_33)),l9_33);
}
#else
{
vec4 l9_64;
...
#endif
l9_64=vec4(l9_34.xyz*l9_65,l9_65);
}
#else
{
l9_64=l9_34;
...
{
l9_68=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_68=vec4(0.0);
...
vec4 l9_70=outputMotionVectorsIfNeeded(varPos,max(l9_69,vec4(0.0)));
vec4 l9_71=clamp(l9_70,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_72=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_72-0.0039215689)),min(1.0,l9_72+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_73=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_73).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_74=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_73).xy);
float l9_75=packValue(l9_74);
int l9_82=int(l9_71.w*255.0);
float l9_83=packValue(l9_82);
sc_writeFragData0(vec4(packValue(l9_74),packValue(l9_74),packValue(l9_74),packValue(l9_74)));
sc_writeFragData1(vec4(l9_75,packValue(l9_74),packValue(l9_74),packValue(l9_74)));
sc_writeFragData2(vec4(l9_83,packValue(l9_82),packValue(l9_82),packValue(l9_82)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_86=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_91==0)
{
l9_94=texture(sc_OITAlpha0,l9_86);
l9_93=texture(sc_OITDepthLow0,l9_86);
l9_92=texture(sc_OITDepthHigh0,l9_86);
}
else
{
l9_94=vec4(0.0);
...
if (l9_91==1)
{
l9_97=texture(sc_OITAlpha1,l9_86);
l9_96=texture(sc_OITDepthLow1,l9_86);
l9_95=texture(sc_OITDepthHigh1,l9_86);
}
else
{
l9_97=l9_94;
...
if (any(notEqual(l9_95,vec4(0.0)))||any(notEqual(l9_96,vec4(0.0))))
{
int l9_98[8]=l9_87;
unpackValues(l9_95.w,l9_91,l9_98);
unpackValues(l9_95.z,l9_91,l9_98);
unpackValues(l9_95.y,l9_91,l9_98);
unpackValues(l9_95.x,l9_91,l9_98);
unpackValues(l9_96.w,l9_91,l9_98);
unpackValues(l9_96.z,l9_91,l9_98);
unpackValues(l9_96.y,l9_91,l9_98);
unpackValues(l9_96.x,l9_91,l9_98);
int l9_107[8]=l9_88;
unpackValues(l9_97.w,l9_91,l9_107);
unpackValues(l9_97.z,l9_91,l9_107);
unpackValues(l9_97.y,l9_91,l9_107);
unpackValues(l9_97.x,l9_91,l9_107);
}
l9_91++;
continue;
}
...
vec4 l9_112=texture(sc_OITFilteredDepthBoundsTexture,l9_86);
vec2 l9_113=l9_112.xy;
int l9_114;
#if (sc_SkinBonesCount>0)
{
l9_114=encodeDepth(((1.0-l9_112.x)*1000.0)+getDepthOrderingEpsilon(),l9_113);
}
#else
{
l9_114=0;
...
#endif
int l9_115=encodeDepth(viewSpaceDepth(),l9_113);
vec4 l9_116;
l9_116=l9_71*l9_71.w;
vec4 l9_117;
int l9_118=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_118<8)
{
int l9_119=l9_87[l9_118];
int l9_120=l9_115-l9_114;
bool l9_121=l9_119<l9_120;
bool l9_122;
if (l9_121)
{
l9_122=l9_87[l9_118]>0;
}
else
{
l9_122=l9_121;
...
if (l9_122)
{
vec3 l9_123=l9_116.xyz*(1.0-(float(l9_88[l9_118])/255.0));
l9_117=vec4(l9_123.x,l9_123.y,l9_123.z,l9_116.w);
}
else
{
l9_117=l9_116;
...
sc_writeFragData0(l9_71);
}
#endif
}
#else
{
sc_writeFragData0(l9_70);
}
#endif
}
#endif
