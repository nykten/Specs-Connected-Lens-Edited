...
uniform vec4 Tweak_N1;
uniform float Tweak_N8;
uniform float Tweak_N5;
...
vec4 l9_1=Tweak_N1+vec4(Tweak_N8);
...
#endif
sc_writeFragData0(max(l9_3,vec4(0.0)));
return;
}
vec4 l9_5;
...
{
l9_8=clamp(dot(l9_2.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_13;
#if (sc_BlendMode_Add)
{
l9_13=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_2.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_16;
#if (sc_BlendMode_Min)
{
l9_16=1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_Max)
{
l9_17=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_17=1.0;
...
#endif
l9_5=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_2.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_6);
}
#else
{
vec4 l9_18;
...
#if (sc_FramebufferFetch)
{
vec4 l9_21=sc_readFragData0_Platform();
vec4 l9_22;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_23=l9_21;
l9_23.x=l9_21.x+_sc_framebufferFetchMarker;
l9_22=l9_23;
}
#else
{
...
#else
{
vec2 l9_24=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_25;
...
{
l9_26=sc_SampleView(sc_ScreenTextureDims.xy,l9_24,sc_ScreenTextureLayout,l9_25,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_26=sc_SampleView(sc_ScreenTextureDims.xy,l9_24,sc_ScreenTextureLayout,l9_25,0.0,sc_ScreenTexture);
}
#endif
l9_20=l9_26;
}
...
{
vec4 l9_28=l9_20;
l9_28.x=l9_20.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_27=l9_28;
}
#else
{
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_2.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_2.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_32;
...
#endif
l9_32=vec4(l9_2.xyz*l9_33,l9_33);
}
#else
{
l9_32=l9_2;
...
vec4 l9_38=outputMotionVectorsIfNeeded(varPos,max(l9_37,vec4(0.0)));
vec4 l9_39=clamp(l9_38,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_40=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_40-0.0039215689)),min(1.0,l9_40+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_41).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_42=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_41).xy);
float l9_43=packValue(l9_42);
int l9_50=int(l9_39.w*255.0);
float l9_51=packValue(l9_50);
sc_writeFragData0(vec4(packValue(l9_42),packValue(l9_42),packValue(l9_42),packValue(l9_42)));
sc_writeFragData1(vec4(l9_43,packValue(l9_42),packValue(l9_42),packValue(l9_42)));
sc_writeFragData2(vec4(l9_51,packValue(l9_50),packValue(l9_50),packValue(l9_50)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_54).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_59==0)
{
l9_62=texture(sc_OITAlpha0,l9_54);
l9_61=texture(sc_OITDepthLow0,l9_54);
l9_60=texture(sc_OITDepthHigh0,l9_54);
}
else
{
l9_62=vec4(0.0);
...
if (l9_59==1)
{
l9_65=texture(sc_OITAlpha1,l9_54);
l9_64=texture(sc_OITDepthLow1,l9_54);
l9_63=texture(sc_OITDepthHigh1,l9_54);
}
else
{
l9_65=l9_62;
...
if (any(notEqual(l9_63,vec4(0.0)))||any(notEqual(l9_64,vec4(0.0))))
{
int l9_66[8]=l9_55;
unpackValues(l9_63.w,l9_59,l9_66);
unpackValues(l9_63.z,l9_59,l9_66);
unpackValues(l9_63.y,l9_59,l9_66);
unpackValues(l9_63.x,l9_59,l9_66);
unpackValues(l9_64.w,l9_59,l9_66);
unpackValues(l9_64.z,l9_59,l9_66);
unpackValues(l9_64.y,l9_59,l9_66);
unpackValues(l9_64.x,l9_59,l9_66);
int l9_75[8]=l9_56;
unpackValues(l9_65.w,l9_59,l9_75);
unpackValues(l9_65.z,l9_59,l9_75);
unpackValues(l9_65.y,l9_59,l9_75);
unpackValues(l9_65.x,l9_59,l9_75);
}
l9_59++;
continue;
}
...
vec4 l9_80=texture(sc_OITFilteredDepthBoundsTexture,l9_54);
vec2 l9_81=l9_80.xy;
int l9_82;
#if (sc_SkinBonesCount>0)
{
l9_82=encodeDepth(((1.0-l9_80.x)*1000.0)+getDepthOrderingEpsilon(),l9_81);
}
#else
{
l9_82=0;
...
#endif
int l9_83=encodeDepth(viewSpaceDepth(),l9_81);
vec4 l9_84;
l9_84=l9_39*l9_39.w;
vec4 l9_85;
int l9_86=0;
...
if (l9_86<8)
{
int l9_87=l9_55[l9_86];
int l9_88=l9_83-l9_82;
bool l9_89=l9_87<l9_88;
bool l9_90;
if (l9_89)
{
l9_90=l9_55[l9_86]>0;
...
if (l9_90)
{
vec3 l9_91=l9_84.xyz*(1.0-(float(l9_56[l9_86])/255.0));
l9_85=vec4(l9_91.x,l9_91.y,l9_91.z,l9_84.w);
}
else
{
l9_85=l9_84;
