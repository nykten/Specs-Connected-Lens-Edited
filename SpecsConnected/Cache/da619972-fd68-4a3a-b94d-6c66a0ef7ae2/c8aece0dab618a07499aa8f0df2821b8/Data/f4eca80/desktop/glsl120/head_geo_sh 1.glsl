...
#endif
vec4 l9_0=Tweak_N1+vec4(Tweak_N8);
...
{
l9_5=clamp(dot(l9_1.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_7=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_8;
...
{
l9_8=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_9;
...
{
l9_9=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_10;
#if (sc_BlendMode_Add)
{
l9_10=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_11;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_12;
...
{
l9_12=dot(l9_1.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_13;
#if (sc_BlendMode_Min)
{
l9_13=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
...
#endif
l9_2=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_3);
}
#else
{
vec4 l9_15;
...
#endif
vec3 l9_25=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_1.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_27=vec4(mix(vec3(1.0),l9_1.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_28;
