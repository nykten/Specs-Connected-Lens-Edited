...
//}
//ubo int UserUniforms 2:26:4624 {
...
//float opacity 4228
//float cutOutCenter 4232
//float Port_Input1_N021 4236
//float Port_Input2_N014 4240
//float Port_Input1_N018 4244
//float Port_Input1_N002 4248
//float Port_Input2_N019 4252
//float Port_Input1_N008 4256
//float Port_Input2_N023 4260
...
//float Port_Input0_N107 4592
//float Port_Input0_N106 4596
//float Port_Input0_N091 4600
//float Port_Input1_N085 4604
//float2 Port_Input1_N102 4608
//float Port_Input1_N093 4616
//}
...
float param_61=(*sc_set2.UserUniforms).cutOutCenter;
Output_N103=param_61;
float Output_N107=0.0;
Output_N107=(*sc_set2.UserUniforms).Port_Input0_N107-Output_N103;
float Output_N91=0.0;
Output_N91=(*sc_set2.UserUniforms).Port_Input0_N091/(Output_N132+1.234e-06);
...
Output_N85=Output_N115-float2((*sc_set2.UserUniforms).Port_Input1_N085);
float2 Output_N102=float2(0.0);
Output_N102=fast::max(Output_N85,(*sc_set2.UserUniforms).Port_Input1_N102);
...
Output_N106=smoothstep((*sc_set2.UserUniforms).Port_Input0_N106,Output_N91,Output_N105);
...
float4 param_62=Value_N90;
float param_63=Output_N93;
float4 param_64=param_62;
if ((param_63*1.0)!=0.0)
{
discard_fragment();
}
...
{
param_66=float4(param_66.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_145=param_66;
...
float3 param_67=in.varPos;
float4 param_68=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_67,param_68,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_69=FinalColor;
float4 l9_210=param_69;
