...
uniform float Port_Input0_N106;
uniform float Port_Input0_N091;
uniform float Port_Input1_N085;
uniform vec2 Port_Input1_N102;
...
{
vec4 l9_48=l9_40;
l9_48.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_40.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_40.w;
l9_47=l9_48;
}
else
{
...
{
float l9_49=dot(l9_46,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_49);
}
#else
{
varClipDistance=l9_49;
}
#endif
}
#endif
...
float l9_1=max(fullScale.x,fullScale.y)+1.234e-06;
float l9_2=Port_Input0_N125/l9_1;
vec2 l9_3=Port_Input0_N096+rawScale;
float l9_4=l9_3.x;
float l9_5=l9_3.y;
float l9_6=min(l9_4,l9_5);
float l9_7=max(l9_4,l9_5);
float l9_8=l9_6+1.234e-06;
float l9_9=l9_7/l9_8;
vec2 l9_10=vec2(step(l9_4,l9_5));
vec2 l9_11=vec2(scaleFactor/l9_8);
vec2 l9_12=(((sc_ModelMatrixInverse*l9_0).xy*vec2(l9_6))/(vec2(l9_7)+vec2(1.234e-06)))*(l9_11*mix(vec2(Port_Value1_N050,l9_9),vec2(l9_9,Port_Value2_N049),l9_10));
float l9_13=l9_6/(l9_7+1.234e-06);
vec2 l9_14=l9_12/(((vec2(frameMargin/(scaleFactor+1.234e-06))*((l9_11*mix(vec2(l9_13,Port_Value2_N064),vec2(Port_Value1_N065,l9_13),l9_10))*vec2(Port_Input1_N059)))+vec2(Port_Input1_N062))+vec2(1.234e-06));
vec2 l9_15=aspectRatio+vec2(1.234e-06);
float l9_16=length((l9_14-touchPosition.xy)/l9_15);
float l9_17=smoothstep(l9_2*Port_Input1_N084,Port_Input1_N033,l9_16);
float l9_18=(((l9_17-Port_RangeMinA_N112)/(Port_RangeMaxA_N112-Port_RangeMinA_N112))*(Port_RangeMaxB_N112-Port_RangeMinB_N112))+Port_RangeMinB_N112;
float l9_19;
if (Port_RangeMaxB_N112>Port_RangeMinB_N112)
{
l9_19=clamp(l9_18,Port_RangeMinB_N112,Port_RangeMaxB_N112);
}
else
{
l9_19=clamp(l9_18,Port_RangeMaxB_N112,Port_RangeMinB_N112);
}
float l9_20;
if (l9_19<=0.0)
{
...
{
l9_20=pow(l9_19,Port_Input1_N072);
}
vec3 l9_21=vec3(l9_20);
float l9_22=(((l9_17-Port_RangeMinA_N053)/(Port_RangeMaxA_N053-Port_RangeMinA_N053))*(Port_RangeMaxB_N053-Port_RangeMinB_N053))+Port_RangeMinB_N053;
float l9_23;
if (Port_RangeMaxB_N053>Port_RangeMinB_N053)
{
l9_23=clamp(l9_22,Port_RangeMinB_N053,Port_RangeMaxB_N053);
}
else
{
l9_23=clamp(l9_22,Port_RangeMaxB_N053,Port_RangeMinB_N053);
}
float l9_24;
if (l9_23<=0.0)
{
...
{
l9_24=pow(l9_23,Port_Input1_N160);
}
float l9_25=l9_24*isHovered;
vec2 l9_26=l9_14*fullScale;
float l9_27=(((borderAlpha-Port_RangeMinA_N110)/(Port_RangeMaxA_N110-Port_RangeMinA_N110))*(Port_RangeMaxB_N110-Port_RangeMinB_N110))+Port_RangeMinB_N110;
float l9_28;
if (Port_RangeMaxB_N110>Port_RangeMinB_N110)
{
l9_28=clamp(l9_27,Port_RangeMinB_N110,Port_RangeMaxB_N110);
}
else
{
l9_28=clamp(l9_27,Port_RangeMaxB_N110,Port_RangeMinB_N110);
}
vec2 l9_29=fullScale*0.5;
float l9_30=N104_roundedBox(l9_26,l9_29-Port_borderOffset_N104,Port_radius_N104);
float l9_31=N104_roundedBox(l9_26,l9_29-vec2(l9_28),Port_radius_N104);
float l9_32=1.0-clamp(smoothstep(0.0,Port_backingSoftness_N104,l9_31),0.0,1.0);
float l9_33=N104_roundedBox(l9_26,l9_29-Port_handleOffset_N104,Port_handleRadius_N104);
float l9_34=l9_29.y;
float l9_35=l9_26.y;
float l9_36=smoothstep(l9_34-5.0,l9_34,l9_35);
float l9_37=l9_29.x;
float l9_38=l9_26.x;
float l9_39=smoothstep(l9_37-5.0,l9_37,l9_38);
float l9_40=-l9_34;
float l9_41=smoothstep(l9_40+5.0,l9_40,l9_35);
float l9_42=-l9_37;
float l9_43=smoothstep(l9_42+5.0,l9_42,l9_38);
float l9_44=Port_Input0_N109-(1.0-clamp(smoothstep(0.0,Port_borderSoftness_N104,l9_30),0.0,1.0));
vec4 l9_45;
if (l9_44>0.0)
{
vec3 l9_46=cross(normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0).xyz),normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(normalize(varNormal),0.0)).xyz));
vec2 l9_47=l9_46.yx;
l9_47.x=l9_46.y*(-1.0);
int l9_48;
...
{
l9_49=pow(l9_44,Port_Input1_N087);
}
vec4 l9_50=vec4(l9_49);
vec4 l9_51=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_50));
float l9_52=borderAlpha*l9_44;
float l9_53;
if (l9_32<=0.0)
{
l9_53=0.0;
...
{
l9_53=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_54=(backingAlpha*Port_Input1_N052)*l9_53;
float l9_55=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_56=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_56.w=l9_55;
vec4 l9_57=mix(vec4((Port_Value_N151.xyz*l9_54)+((l9_51*vec4(Port_Input1_N149)).xyz*l9_52),max(l9_54,l9_52)),l9_56,vec4(l9_55));
vec3 l9_58=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_57.xyz;
float l9_59=(l9_57.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15)));
vec4 l9_60=vec4(l9_58.x,l9_58.y,l9_58.z,vec4(0.0).w);
l9_60.w=l9_59;
if ((step(l9_59,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
...
#endif
l9_76=sc_SampleView(sc_ScreenTextureDims.xy,l9_80,sc_ScreenTextureLayout,l9_81,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_82;
...
{
vec4 l9_83=l9_76;
l9_83.x=l9_76.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_82=l9_83;
}
#else
{
...
#endif
vec3 l9_84=mix(l9_82.xyz,definedBlend(l9_82.xyz,l9_60.xyz).xyz,vec3(l9_59));
vec4 l9_85=vec4(l9_84.x,l9_84.y,l9_84.z,vec4(0.0).w);
l9_85.w=1.0;
l9_75=l9_85;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_86=vec4(mix(vec3(1.0),l9_60.xyz,vec3(l9_59)),l9_59);
}
#else
{
vec4 l9_87;
...
#endif
l9_87=vec4(l9_60.xyz*l9_88,l9_88);
}
#else
{
l9_87=l9_60;
...
{
l9_91=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_91=vec4(0.0);
...
vec4 l9_93=outputMotionVectorsIfNeeded(varPos,max(l9_92,vec4(0.0)));
vec4 l9_94=clamp(l9_93,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_95=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_95-0.0039215689)),min(1.0,l9_95+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_97=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_96).xy);
float l9_98=packValue(l9_97);
int l9_105=int(l9_94.w*255.0);
float l9_106=packValue(l9_105);
sc_writeFragData0(vec4(packValue(l9_97),packValue(l9_97),packValue(l9_97),packValue(l9_97)));
sc_writeFragData1(vec4(l9_98,packValue(l9_97),packValue(l9_97),packValue(l9_97)));
sc_writeFragData2(vec4(l9_106,packValue(l9_105),packValue(l9_105),packValue(l9_105)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_109=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_114==0)
{
l9_117=texture2D(sc_OITAlpha0,l9_109);
l9_116=texture2D(sc_OITDepthLow0,l9_109);
l9_115=texture2D(sc_OITDepthHigh0,l9_109);
}
else
{
l9_117=vec4(0.0);
...
if (l9_114==1)
{
l9_120=texture2D(sc_OITAlpha1,l9_109);
l9_119=texture2D(sc_OITDepthLow1,l9_109);
l9_118=texture2D(sc_OITDepthHigh1,l9_109);
}
else
{
l9_120=l9_117;
...
if (any(notEqual(l9_118,vec4(0.0)))||any(notEqual(l9_119,vec4(0.0))))
{
int l9_121[8]=l9_110;
unpackValues(l9_118.w,l9_114,l9_121);
unpackValues(l9_118.z,l9_114,l9_121);
unpackValues(l9_118.y,l9_114,l9_121);
unpackValues(l9_118.x,l9_114,l9_121);
unpackValues(l9_119.w,l9_114,l9_121);
unpackValues(l9_119.z,l9_114,l9_121);
unpackValues(l9_119.y,l9_114,l9_121);
unpackValues(l9_119.x,l9_114,l9_121);
int l9_130[8]=l9_111;
unpackValues(l9_120.w,l9_114,l9_130);
unpackValues(l9_120.z,l9_114,l9_130);
unpackValues(l9_120.y,l9_114,l9_130);
unpackValues(l9_120.x,l9_114,l9_130);
}
l9_114++;
continue;
}
...
vec4 l9_135=texture2D(sc_OITFilteredDepthBoundsTexture,l9_109);
vec2 l9_136=l9_135.xy;
int l9_137;
#if (sc_SkinBonesCount>0)
{
l9_137=encodeDepth(((1.0-l9_135.x)*1000.0)+getDepthOrderingEpsilon(),l9_136);
}
#else
{
l9_137=0;
...
#endif
int l9_138=encodeDepth(viewSpaceDepth(),l9_136);
vec4 l9_139;
l9_139=l9_94*l9_94.w;
vec4 l9_140;
int l9_141=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_141<8)
{
int l9_142=l9_110[l9_141];
int l9_143=l9_138-l9_137;
bool l9_144=l9_142<l9_143;
bool l9_145;
if (l9_144)
{
l9_145=l9_110[l9_141]>0;
}
else
{
l9_145=l9_144;
...
if (l9_145)
{
vec3 l9_146=l9_139.xyz*(1.0-(float(l9_111[l9_141])/255.0));
l9_140=vec4(l9_146.x,l9_146.y,l9_146.z,l9_139.w);
}
else
{
l9_140=l9_139;
