...
//texture texture2DArray intensityTextureArrSC 2:25:2:16
//texture texture2DArray matcapTextureArrSC 2:26:2:17
...
uniform sampler2DArray matcapTextureArrSC;
...
int matcapTextureGetStereoViewIndex()
{
int l9_0;
...
vec2 l9_47=l9_46.yx;
l9_47.x=l9_46.y*(-1.0);
vec2 l9_48=(l9_47*0.5)+vec2(0.5);
vec4 l9_49;
#if (matcapTextureLayout==2)
{
l9_49=sc_SampleTextureBiasOrLevel(matcapTextureDims.xy,matcapTextureLayout,matcapTextureGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture),(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0),matcapTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0),matcapTextureBorderColor,0.0,matcapTextureArrSC);
}
#else
{
...
{
l9_50=pow(l9_44,Port_Input1_N087);
}
vec4 l9_51=vec4(l9_50);
vec4 l9_52=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_51));
float l9_53=borderAlpha*l9_44;
float l9_54;
if (l9_32<=0.0)
{
l9_54=0.0;
...
{
l9_54=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_55=(backingAlpha*Port_Input1_N052)*l9_54;
float l9_56=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_57=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_57.w=l9_56;
vec4 l9_58=mix(vec4((Port_Value_N151.xyz*l9_55)+((l9_52*vec4(Port_Input1_N149)).xyz*l9_53),max(l9_55,l9_53)),l9_57,vec4(l9_56));
vec3 l9_59=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_58.xyz;
float l9_60=(l9_58.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15)));
vec4 l9_61=vec4(l9_59.x,l9_59.y,l9_59.z,vec4(0.0).w);
l9_61.w=l9_60;
if ((step(l9_60,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_60<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_60<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_65=clamp(dot(l9_61.xyz,vec3(l9_60)),0.0,1.0);
}
#else
{
float l9_66;
...
{
l9_67=(1.0-dot(l9_61.xyz,vec3(0.33333001)))*l9_60;
}
#else
{
float l9_68;
...
{
l9_68=(1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0))*l9_60;
}
#else
{
float l9_69;
...
{
l9_69=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_60;
}
#else
{
float l9_70;
#if (sc_BlendMode_Add)
{
l9_70=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_71;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_71=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_60;
}
#else
{
float l9_72;
...
{
l9_72=dot(l9_61.xyz,vec3(0.33333001))*l9_60;
}
#else
{
float l9_73;
#if (sc_BlendMode_Min)
{
l9_73=1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_74;
#if (sc_BlendMode_Max)
{
l9_74=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_74=1.0;
...
#endif
l9_62=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_61.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_63);
}
#else
{
vec4 l9_75;
...
#if (sc_FramebufferFetch)
{
vec4 l9_78=sc_readFragData0_Platform();
vec4 l9_79;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_80=l9_78;
l9_80.x=l9_78.x+_sc_framebufferFetchMarker;
l9_79=l9_80;
}
#else
{
...
{
l9_83=sc_SampleView(sc_ScreenTextureDims.xy,l9_81,sc_ScreenTextureLayout,l9_82,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_83=sc_SampleView(sc_ScreenTextureDims.xy,l9_81,sc_ScreenTextureLayout,l9_82,0.0,sc_ScreenTexture);
}
#endif
l9_77=l9_83;
}
...
{
vec4 l9_85=l9_77;
l9_85.x=l9_77.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_84=l9_85;
}
#else
{
...
#endif
vec3 l9_86=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_61.xyz).xyz,vec3(l9_60));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_88=vec4(mix(vec3(1.0),l9_61.xyz,vec3(l9_60)),l9_60);
}
#else
{
vec4 l9_89;
...
#endif
l9_89=vec4(l9_61.xyz*l9_90,l9_90);
}
#else
{
l9_89=l9_61;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_98=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_111=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
