...
#endif
vec4 param_5;
Node78_Gradient(varPackedTex.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_9);
vec4 l9_13=param_5;
vec4 param_10;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_10,l9_9);
vec4 l9_14=param_10;
float l9_15;
...
{
vec2 l9_19;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_19,l9_9);
l9_18=l9_19;
}
#else
{
...
{
vec2 l9_21;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_21,l9_9);
l9_20=l9_21;
}
#else
{
l9_20=varPackedTex.xy;
}
#endif
l9_18=l9_20;
}
...
#endif
l9_15=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_22,l9_16,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x;
}
#else
{
l9_15=Port_Default_N204;
}
#endif
float l9_23;
#if (NODE_38_DROPLIST_ITEM==1)
...
#else
{
l9_23=Port_Input2_N072;
}
#endif
float l9_24=(l9_13*l9_14).w*l9_15;
float l9_25=l9_24*l9_23;
vec3 l9_26;
#if (ENABLE_NORMALMAP)
{
vec2 l9_27;
...
{
vec2 l9_30;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_30,l9_9);
l9_29=l9_30;
}
#else
{
...
{
vec2 l9_32;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_32,l9_9);
l9_31=l9_32;
}
#else
{
l9_31=varPackedTex.xy;
}
#endif
l9_29=l9_31;
}
...
#endif
vec4 l9_34=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,l9_33,l9_27,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
vec3 l9_35;
...
{
vec2 l9_39;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_39,l9_9);
l9_38=l9_39;
}
#else
{
...
{
vec2 l9_41;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_41,l9_9);
l9_40=l9_41;
}
#else
{
...
#endif
l9_35=((sc_SampleTextureBiasOrLevel(detailNormalTexDims.xy,detailNormalTexLayout,l9_42,l9_36,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex),(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0),detailNormalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0),detailNormalTexBorderColor,0.0,detailNormalTex).xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_35=Port_Default_N113;
}
#endif
vec3 l9_43=mix(vec3(0.0,0.0,1.0),((l9_34.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_44=mix(vec3(0.0,0.0,1.0),l9_35,vec3(Port_Strength2_N200));
vec3 l9_45=l9_44*vec3(-1.0,-1.0,1.0);
vec3 l9_46=mat3(l9_6,l9_8,l9_7)*normalize((l9_43*dot(l9_43,l9_45))-(l9_45*l9_43.z));
...
#else
{
float l9_49=dot(l9_7,l9_7);
float l9_50;
if (l9_49>0.0)
{
l9_50=1.0/sqrt(l9_49);
}
else
{
l9_50=0.0;
...
#endif
float l9_52=clamp(l9_25,0.0,1.0);
...
#endif
vec3 l9_53=max(l9_10.xyz,vec3(0.0));
vec4 l9_54;
#if (sc_ProjectiveShadowsCaster)
{
l9_54=vec4(l9_53,l9_52);
}
#else
{
vec3 l9_55=ssSRGB_to_Linear(l9_53);
vec3 l9_56=normalize(l9_51);
vec3 l9_57=ssSRGB_to_Linear(Port_Emissive_N036);
vec3 l9_58;
#if (sc_SSAOEnabled)
{
l9_58=evaluateSSAO(varPos);
}
#else
{
l9_58=Port_AO_N036;
...
#endif
vec3 l9_59=l9_55*(1.0-0.0);
SurfaceProperties l9_60=SurfaceProperties(l9_59,l9_52,l9_56,varPos,l9_3,0.0,1.0,l9_57,l9_58,vec3(1.0),vec3(1.0),vec3(0.039999999));
vec4 l9_61=vec4(1.0);
vec3 l9_62;
vec3 l9_63;
vec3 l9_64;
...
l9_70=vec3(0.0);
l9_69=vec3(0.0);
LightingComponents l9_76;
LightProperties l9_77;
SurfaceProperties l9_78;
vec3 l9_79;
int l9_80=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_80<sc_DirectionalLightsCount)
{
LightingComponents l9_81=accumulateLight(LightingComponents(l9_69,l9_70,l9_75,l9_73,l9_72,l9_71),LightProperties(sc_DirectionalLights[l9_80].direction,sc_DirectionalLights[l9_80].color.xyz,sc_DirectionalLights[l9_80].color.w*l9_61[(l9_74<3) ? l9_74 : 3]),l9_60,l9_3);
l9_75=l9_81.indirectDiffuse;
l9_74++;
l9_73=l9_81.indirectSpecular;
l9_72=l9_81.emitted;
l9_71=l9_81.transmitted;
l9_70=l9_81.directSpecular;
l9_69=l9_81.directDiffuse;
l9_80++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_98<sc_PointLightsCount)
{
vec3 l9_100=sc_PointLights[l9_98].position-varPos;
vec3 l9_101=normalize(l9_100);
float l9_102=l9_61[(l9_99<3) ? l9_99 : 3];
float l9_103=clamp((dot(l9_101,sc_PointLights[l9_98].direction)*sc_PointLights[l9_98].angleScale)+sc_PointLights[l9_98].angleOffset,0.0,1.0);
float l9_104=(sc_PointLights[l9_98].color.w*l9_102)*(l9_103*l9_103);
float l9_105;
if (sc_PointLights[l9_98].falloffEnabled)
{
l9_105=l9_104*computeDistanceAttenuation(length(l9_100),sc_PointLights[l9_98].falloffEndDistance);
}
else
{
l9_105=l9_104;
...
l9_91=l9_99+1;
LightingComponents l9_106=accumulateLight(LightingComponents(l9_85,l9_86,l9_90,l9_89,l9_88,l9_87),LightProperties(l9_101,sc_PointLights[l9_98].color.xyz,l9_105),l9_60,l9_3);
l9_92=l9_106.directDiffuse;
l9_93=l9_106.directSpecular;
l9_94=l9_106.indirectDiffuse;
l9_95=l9_106.indirectSpecular;
l9_96=l9_106.emitted;
l9_97=l9_106.transmitted;
l9_90=l9_94;
l9_99=l9_91;
l9_89=l9_95;
l9_88=l9_96;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_109=abs(varShadowTex-vec2(0.5));
vec4 l9_110=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_109.x,l9_109.y),0.5);
l9_108=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_110.xyz,vec3(sc_ShadowColor.w)),vec3(l9_110.w*sc_ShadowDensity));
}
#else
{
l9_108=vec3(1.0);
...
{
float l9_112=-l9_56.z;
float l9_113=l9_56.x;
vec2 l9_114=vec2((((l9_113<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_112/length(vec2(l9_113,l9_112)),-1.0,1.0)))-1.5707964,acos(l9_56.y))/vec2(6.2831855,3.1415927);
float l9_115=l9_114.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_116=vec2(l9_115,1.0-l9_114.y);
l9_116.x=fract((l9_115+floor(l9_115))+1.0);
vec4 l9_117;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_118=calcSeamlessPanoramicUvsForSampling(l9_116,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_118=l9_116;
...
#endif
l9_117=sc_EnvmapSpecularSampleViewIndexBias(l9_118,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_119;
...
{
vec2 l9_120=calcSeamlessPanoramicUvsForSampling(l9_116,sc_EnvmapDiffuseSize.xy,0.0);
int l9_121;
...
#endif
l9_119=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_120,sc_EnvmapDiffuseLayout,l9_121,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_119=sc_EnvmapSpecularSampleViewIndexBias(l9_116,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_117=l9_119;
}
#endif
l9_111=(l9_117.xyz*(1.0/l9_117.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_122;
...
float l9_125=l9_123.y;
float l9_126=l9_123.z;
l9_122=(((((((sc_Sh[8]*0.42904299)*((l9_124*l9_124)-(l9_125*l9_125)))+((sc_Sh[6]*0.74312502)*(l9_126*l9_126)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_124*l9_125))+(sc_Sh[7]*(l9_124*l9_126)))+(sc_Sh[5]*(l9_125*l9_126)))*0.85808599))+((((sc_Sh[3]*l9_124)+(sc_Sh[1]*l9_125))+(sc_Sh[2]*l9_126))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_122=vec3(0.0);
...
{
l9_128=l9_111+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_129=l9_111;
l9_129.x=l9_111.x+(1e-06*sc_AmbientLights[0].color.x);
l9_128=l9_129;
}
#endif
l9_127=l9_128;
...
{
l9_131=l9_127+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_132=l9_127;
l9_132.x=l9_127.x+(1e-06*sc_AmbientLights[1].color.x);
l9_131=l9_132;
}
#endif
l9_130=l9_131;
...
{
l9_134=l9_130+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_135=l9_130;
l9_135.x=l9_130.x+(1e-06*sc_AmbientLights[2].color.x);
l9_134=l9_135;
}
#endif
l9_133=l9_134;
...
{
vec3 l9_137;
l9_137=sc_LightEstimationData.ambientLight;
vec3 l9_138;
int l9_139=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_139<sc_LightEstimationSGCount)
{
float l9_140=dot(sc_LightEstimationData.sg[l9_139].axis,l9_56);
float l9_141=exp(-sc_LightEstimationData.sg[l9_139].sharpness);
float l9_142=l9_141*l9_141;
float l9_143=1.0/sc_LightEstimationData.sg[l9_139].sharpness;
float l9_144=(1.0+(2.0*l9_142))-l9_143;
float l9_145=sqrt(1.0-l9_144);
float l9_146=0.36000001*l9_140;
float l9_147=(1.0/(4.0*0.36000001))*l9_145;
float l9_148=l9_146+l9_147;
float l9_149;
if (step(abs(l9_146),l9_147)>0.5)
{
l9_149=(l9_148*l9_148)/l9_145;
}
else
{
l9_149=clamp(l9_140,0.0,1.0);
}
l9_138=l9_137+((((sc_LightEstimationData.sg[l9_139].color/vec3(sc_LightEstimationData.sg[l9_139].sharpness))*6.2831855)*((l9_144*l9_149)+(((l9_141-l9_142)*l9_143)-l9_142)))/vec3(3.1415927));
l9_137=l9_138;
l9_139++;
continue;
}
...
l9_153=vec3(0.0);
l9_152=vec3(0.0);
l9_151=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_59,vec3(l9_52));
l9_150=1.0;
}
#else
{
...
#endif
vec3 l9_155=l9_152*l9_58;
vec3 l9_156=l9_153+l9_155;
vec3 l9_157=l9_59*l9_156;
vec3 l9_158=l9_84*vec3(1.0);
vec3 l9_159;
if (l9_154)
{
l9_159=l9_157*srgbToLinear(l9_150);
}
else
{
l9_159=l9_157;
}
vec3 l9_160=l9_159+(vec3(0.0)+l9_158);
vec3 l9_161=(l9_160+l9_57)+l9_151;
float l9_162=l9_161.x;
vec4 l9_163=vec4(l9_162,l9_161.yz,l9_150);
vec4 l9_164;
#if (sc_IsEditor)
{
vec4 l9_165=l9_163;
l9_165.x=l9_162+((l9_58.x*1.0)*9.9999997e-06);
l9_164=l9_165;
}
#else
{
...
l9_54=vec4(l9_169.x,l9_169.y,l9_169.z,l9_166.w);
}
#endif
vec4 l9_170=max(l9_54,vec4(0.0));
vec4 l9_171=l9_170*vec4(colorMultiplier+1.0);
float l9_172=l9_170.w;
vec4 l9_173=vec4(l9_171.x,l9_171.y,l9_171.z,vec4(0.0).w);
l9_173.w=l9_172;
vec4 l9_174;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_176=clamp(l9_172*2.0,0.0,1.0);
}
#else
{
float l9_177;
...
{
l9_177=clamp(dot(l9_173.xyz,vec3(l9_172)),0.0,1.0);
}
#else
{
float l9_178;
...
#if (sc_BlendMode_Multiply)
{
l9_179=(1.0-dot(l9_173.xyz,vec3(0.33333001)))*l9_172;
}
#else
{
float l9_180;
...
{
l9_180=(1.0-clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0))*l9_172;
}
#else
{
float l9_181;
#if (sc_BlendMode_ColoredGlass)
{
l9_181=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0)*l9_172;
}
#else
{
float l9_182;
#if (sc_BlendMode_Add)
{
l9_182=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_183;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_183=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0)*l9_172;
}
#else
{
float l9_184;
...
{
l9_184=dot(l9_173.xyz,vec3(0.33333001))*l9_172;
}
#else
{
float l9_185;
#if (sc_BlendMode_Min)
{
l9_185=1.0-clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_186;
#if (sc_BlendMode_Max)
{
l9_186=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_186=1.0;
...
#endif
l9_174=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_173.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_175);
}
#else
{
vec4 l9_187;
...
{
vec3 l9_189=sc_GetFramebufferColor().xyz;
vec3 l9_190=mix(l9_189,definedBlend(l9_189,l9_173.xyz).xyz,vec3(l9_172));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_192=vec4(mix(vec3(1.0),l9_173.xyz,vec3(l9_172)),l9_172);
}
#else
{
vec4 l9_193;
...
#endif
l9_193=vec4(l9_173.xyz*l9_194,l9_194);
}
#else
{
l9_193=l9_173;
...
{
l9_197=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_197=vec4(0.0);
...
vec4 l9_199=outputMotionVectorsIfNeeded(varPos,max(l9_198,vec4(0.0)));
vec4 l9_200=clamp(l9_199,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_201=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_201-0.0039215689)),min(1.0,l9_201+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_202=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_202).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_203=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_202).xy);
float l9_204=packValue(l9_203);
int l9_211=int(l9_200.w*255.0);
float l9_212=packValue(l9_211);
sc_writeFragData0(vec4(packValue(l9_203),packValue(l9_203),packValue(l9_203),packValue(l9_203)));
sc_writeFragData1(vec4(l9_204,packValue(l9_203),packValue(l9_203),packValue(l9_203)));
sc_writeFragData2(vec4(l9_212,packValue(l9_211),packValue(l9_211),packValue(l9_211)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_215=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_215).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_220==0)
{
l9_223=texture2D(sc_OITAlpha0,l9_215);
l9_222=texture2D(sc_OITDepthLow0,l9_215);
l9_221=texture2D(sc_OITDepthHigh0,l9_215);
}
else
{
l9_223=vec4(0.0);
...
if (l9_220==1)
{
l9_226=texture2D(sc_OITAlpha1,l9_215);
l9_225=texture2D(sc_OITDepthLow1,l9_215);
l9_224=texture2D(sc_OITDepthHigh1,l9_215);
}
else
{
l9_226=l9_223;
...
if (any(notEqual(l9_224,vec4(0.0)))||any(notEqual(l9_225,vec4(0.0))))
{
int l9_227[8]=l9_216;
unpackValues(l9_224.w,l9_220,l9_227);
unpackValues(l9_224.z,l9_220,l9_227);
unpackValues(l9_224.y,l9_220,l9_227);
unpackValues(l9_224.x,l9_220,l9_227);
unpackValues(l9_225.w,l9_220,l9_227);
unpackValues(l9_225.z,l9_220,l9_227);
unpackValues(l9_225.y,l9_220,l9_227);
unpackValues(l9_225.x,l9_220,l9_227);
int l9_236[8]=l9_217;
unpackValues(l9_226.w,l9_220,l9_236);
unpackValues(l9_226.z,l9_220,l9_236);
unpackValues(l9_226.y,l9_220,l9_236);
unpackValues(l9_226.x,l9_220,l9_236);
}
l9_220++;
continue;
}
...
vec4 l9_241=texture2D(sc_OITFilteredDepthBoundsTexture,l9_215);
vec2 l9_242=l9_241.xy;
int l9_243;
#if (sc_SkinBonesCount>0)
{
l9_243=encodeDepth(((1.0-l9_241.x)*1000.0)+getDepthOrderingEpsilon(),l9_242);
}
#else
{
l9_243=0;
...
#endif
int l9_244=encodeDepth(viewSpaceDepth(),l9_242);
vec4 l9_245;
l9_245=l9_200*l9_200.w;
vec4 l9_246;
int l9_247=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_247<8)
{
int l9_248=l9_216[l9_247];
int l9_249=l9_244-l9_243;
bool l9_250=l9_248<l9_249;
bool l9_251;
if (l9_250)
{
l9_251=l9_216[l9_247]>0;
}
else
{
l9_251=l9_250;
...
if (l9_251)
{
vec3 l9_252=l9_245.xyz*(1.0-(float(l9_217[l9_247])/255.0));
l9_246=vec4(l9_252.x,l9_252.y,l9_252.z,l9_245.w);
}
else
{
l9_246=l9_245;
