...
#endif
vec4 param_5;
Node78_Gradient(varPackedTex.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_8);
vec4 l9_11=param_5;
vec4 param_10;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_10,l9_8);
vec4 l9_12=param_10;
float l9_13;
...
{
vec2 l9_19;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_19,l9_8);
l9_18=l9_19;
}
#else
{
...
{
l9_20=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_14,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
...
#else
{
l9_21=Port_Input2_N072;
}
#endif
float l9_22=(l9_11*l9_12).w*l9_13;
float l9_23=l9_22*l9_21;
#if (ENABLE_NORMALMAP)
{
vec2 l9_24;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_24=varPackedTex.xy;
}
#else
{
vec2 l9_25;
...
{
vec2 l9_27;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_27,l9_8);
l9_26=l9_27;
}
#else
{
...
{
vec2 l9_29;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_29,l9_8);
l9_28=l9_29;
}
#else
{
l9_28=varPackedTex.xy;
}
#endif
l9_26=l9_28;
}
...
{
vec2 l9_33;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_33,l9_8);
l9_32=l9_33;
}
#else
{
...
{
vec2 l9_35;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_35,l9_8);
l9_34=l9_35;
}
#else
{
l9_34=varPackedTex.xy;
}
#endif
l9_32=l9_34;
}
...
#endif
float l9_36=clamp(l9_23,0.0,1.0);
...
#endif
vec4 param_5;
Node78_Gradient(l9_8.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_20);
vec4 l9_24=param_5;
vec4 param_10;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_10,l9_20);
vec4 l9_25=param_10;
float l9_26;
#if (ENABLE_OPACITY_TEX)
{
...
{
vec2 l9_30;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_30,l9_20);
l9_29=l9_30;
}
#else
{
...
{
vec2 l9_32;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_32,l9_20);
l9_31=l9_32;
}
#else
{
...
#if (opacityTexLayout==2)
{
l9_33=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_27,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
l9_33=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_27,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex);
...
#else
{
l9_34=Port_Input2_N072;
}
#endif
float l9_35=(l9_24*l9_25).w*l9_26;
float l9_36=l9_35*l9_34;
vec3 l9_37;
#if (ENABLE_NORMALMAP)
{
mat3 l9_38=mat3(l9_5,l9_3,l9_4);
vec2 l9_39;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_39=l9_8;
...
{
vec2 l9_42;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_42,l9_20);
l9_41=l9_42;
}
#else
{
...
{
vec2 l9_44;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_44,l9_20);
l9_43=l9_44;
}
#else
{
...
#if (normalTexLayout==2)
{
l9_45=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_45=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
{
vec2 l9_50;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_50,l9_20);
l9_49=l9_50;
}
#else
{
...
{
vec2 l9_52;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_52,l9_20);
l9_51=l9_52;
}
#else
{
...
#endif
l9_46=((l9_53.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_46=Port_Default_N113;
}
#endif
vec3 l9_54=mix(vec3(0.0,0.0,1.0),((l9_45.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_55=mix(vec3(0.0,0.0,1.0),l9_46,vec3(Port_Strength2_N200));
vec3 l9_56=l9_55*vec3(-1.0,-1.0,1.0);
vec3 l9_57=l9_38*normalize((l9_54*dot(l9_54,l9_56))-(l9_56*l9_54.z));
float l9_58=dot(l9_57,l9_57);
float l9_59;
if (l9_58>0.0)
{
...
#else
{
float l9_60=dot(l9_4,l9_4);
float l9_61;
if (l9_60>0.0)
{
l9_61=1.0/sqrt(l9_60);
}
else
{
l9_61=0.0;
...
#endif
float l9_63=clamp(l9_36,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_63<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_63<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_64=max(l9_21.xyz,vec3(0.0));
vec4 l9_65;
#if (sc_ProjectiveShadowsCaster)
{
l9_65=vec4(l9_64,l9_63);
}
#else
{
l9_65=ngsCalculateLighting(l9_64,l9_63,l9_62,l9_10,l9_11,Port_Emissive_N036,0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_66=max(l9_65,vec4(0.0));
vec4 l9_67=l9_66*vec4(colorMultiplier+1.0);
float l9_68=l9_66.w;
...
#endif
sc_writeFragData0(max(l9_70,vec4(0.0)));
return;
}
vec4 l9_72;
#if (sc_ProjectiveShadowsCaster)
...
{
vec3 l9_87=sc_GetFramebufferColor().xyz;
vec3 l9_88=mix(l9_87,definedBlend(l9_87,l9_69.xyz).xyz,vec3(l9_68));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_90=vec4(mix(vec3(1.0),l9_69.xyz,vec3(l9_68)),l9_68);
}
#else
{
vec4 l9_91;
...
#endif
l9_91=vec4(l9_69.xyz*l9_92,l9_92);
}
#else
{
l9_91=l9_69;
...
{
l9_95=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_95=vec4(0.0);
...
vec4 l9_97=outputMotionVectorsIfNeeded(varPos,max(l9_96,vec4(0.0)));
vec4 l9_98=clamp(l9_97,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_99=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_99-0.0039215689)),min(1.0,l9_99+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_101=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_100).xy);
float l9_102=packValue(l9_101);
int l9_109=int(l9_98.w*255.0);
float l9_110=packValue(l9_109);
sc_writeFragData0(vec4(packValue(l9_101),packValue(l9_101),packValue(l9_101),packValue(l9_101)));
sc_writeFragData1(vec4(l9_102,packValue(l9_101),packValue(l9_101),packValue(l9_101)));
sc_writeFragData2(vec4(l9_110,packValue(l9_109),packValue(l9_109),packValue(l9_109)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_113=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_113).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_118==0)
{
l9_121=texture(sc_OITAlpha0,l9_113);
l9_120=texture(sc_OITDepthLow0,l9_113);
l9_119=texture(sc_OITDepthHigh0,l9_113);
}
else
{
l9_121=vec4(0.0);
...
if (l9_118==1)
{
l9_124=texture(sc_OITAlpha1,l9_113);
l9_123=texture(sc_OITDepthLow1,l9_113);
l9_122=texture(sc_OITDepthHigh1,l9_113);
}
else
{
l9_124=l9_121;
...
if (any(notEqual(l9_122,vec4(0.0)))||any(notEqual(l9_123,vec4(0.0))))
{
int l9_125[8]=l9_114;
unpackValues(l9_122.w,l9_118,l9_125);
unpackValues(l9_122.z,l9_118,l9_125);
unpackValues(l9_122.y,l9_118,l9_125);
unpackValues(l9_122.x,l9_118,l9_125);
unpackValues(l9_123.w,l9_118,l9_125);
unpackValues(l9_123.z,l9_118,l9_125);
unpackValues(l9_123.y,l9_118,l9_125);
unpackValues(l9_123.x,l9_118,l9_125);
int l9_134[8]=l9_115;
unpackValues(l9_124.w,l9_118,l9_134);
unpackValues(l9_124.z,l9_118,l9_134);
unpackValues(l9_124.y,l9_118,l9_134);
unpackValues(l9_124.x,l9_118,l9_134);
}
l9_118++;
continue;
}
...
vec4 l9_139=texture(sc_OITFilteredDepthBoundsTexture,l9_113);
vec2 l9_140=l9_139.xy;
int l9_141;
#if (sc_SkinBonesCount>0)
{
l9_141=encodeDepth(((1.0-l9_139.x)*1000.0)+getDepthOrderingEpsilon(),l9_140);
}
#else
{
l9_141=0;
...
#endif
int l9_142=encodeDepth(viewSpaceDepth(),l9_140);
vec4 l9_143;
l9_143=l9_98*l9_98.w;
vec4 l9_144;
int l9_145=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_145<8)
{
int l9_146=l9_114[l9_145];
int l9_147=l9_142-l9_141;
bool l9_148=l9_146<l9_147;
bool l9_149;
if (l9_148)
{
l9_149=l9_114[l9_145]>0;
}
else
{
l9_149=l9_148;
...
if (l9_149)
{
vec3 l9_150=l9_143.xyz*(1.0-(float(l9_115[l9_145])/255.0));
l9_144=vec4(l9_150.x,l9_150.y,l9_150.z,l9_143.w);
}
else
{
l9_144=l9_143;
