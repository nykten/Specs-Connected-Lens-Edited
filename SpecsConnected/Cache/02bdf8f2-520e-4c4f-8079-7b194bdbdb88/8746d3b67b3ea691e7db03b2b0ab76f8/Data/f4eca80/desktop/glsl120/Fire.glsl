...
//sampler sampler Tweak_N14SmpSC 2:16
...
//texture texture2D Tweak_N14 2:0:2:16
...
uniform vec4 Tweak_N14Size;
uniform vec4 Tweak_N14View;
...
varying vec2 Interpolator_UVCoord3;
...
float l9_2=((((floor(((snoise(vec2(floor(((Globals.gTimeElapsed*Port_Multiplier_N024)+(l9_0+Port_Input1_N034))*10000.0)*9.9999997e-05)*(vec2(Port_Value1_N031,noise_freq*Port_Input1_N032)*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N035)/(Port_RangeMaxA_N035-Port_RangeMinA_N035))*((l9_1+range)-l9_1))+l9_1;
...
float l9_6=((((floor(((snoise(vec2(floor(((Globals.gTimeElapsed*Port_Multiplier_N024)+(l9_4+Port_Input1_N034))*10000.0)*9.9999997e-05)*(vec2(Port_Value1_N031,noise_freq*Port_Input1_N032)*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N038)/(Port_RangeMaxA_N038-Port_RangeMinA_N038))*((l9_5+range)-l9_5))+l9_5;
...
float l9_10=((((floor(((snoise(vec2(floor(((Globals.gTimeElapsed*Port_Multiplier_N024)+(l9_8+Port_Input1_N034))*10000.0)*9.9999997e-05)*(vec2(Port_Value1_N031,noise_freq*Port_Input1_N032)*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N040)/(Port_RangeMaxA_N040-Port_RangeMinA_N040))*((l9_9+range)-l9_9))+l9_9;
...
vec3 l9_33=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
vec3 l9_34=varNormal;
vec4 param_5;
Node17_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),Port_Default_N017,param_5,ssGlobals(l9_31,l9_32,0.0,l9_33,varColor,texture3));
vec3 l9_35;
vec3 l9_36;
vec3 l9_37;
if (l9_27)
{
l9_37=varTangent.xyz;
l9_36=varNormal;
l9_35=varPos;
}
else
...
l9_37=varTangent.xyz;
l9_36=l9_34;
l9_35=(sc_ModelMatrix*vec4(((l9_33*vec3((floor(float(sc_GetLocalInstanceID())+0.5)*Port_Input1_N009)+Port_Input1_N007,Port_Value2_N059,Port_Value3_N059))*param_5.xyz)*vec3(smoothstep(Port_Input0_N006,Port_Input1_N006,fire_scale)),1.0)).xyz;
}
varPos=l9_35;
varNormal=normalize(l9_36);
vec3 l9_38=normalize(l9_37);
varTangent=vec4(l9_38.x,l9_38.y,l9_38.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_39=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_40;
#if (sc_RenderingSpace==2)
{
l9_40=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_41;
#if (sc_RenderingSpace==1)
{
l9_41=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_41=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_43=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_44;
#if (sc_RenderingSpace==2)
{
l9_44=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_45;
...
#endif
vec4 l9_47=sc_ProjectorMatrix*l9_46;
varShadowTex=((l9_47.xy/vec2(l9_47.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_48;
...
{
vec4 l9_50=l9_42;
l9_50.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_42.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_42.w;
l9_49=l9_50;
}
else
{
...
{
float l9_51=dot(l9_48,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_51);
}
#else
{
varClipDistance=l9_51;
}
#endif
}
#endif
...
float l9_2=floor(floor((varColor.x*Port_Input1_N019)+0.5));
vec4 l9_3;
bool l9_4;
vec4 l9_5;
if (l9_2==0.0)
{
float l9_6=clamp(Interpolator_UVCoord3.y,0.0,1.0);
vec4 l9_7;
if (l9_6<Port_Position1_N010)
{
l9_7=mix(Port_Value0_N010,Port_Value1_N010,vec4(clamp(l9_6/Port_Position1_N010,0.0,1.0)));
}
else
{
l9_7=mix(Port_Value1_N010,Port_Value2_N010,vec4(clamp((l9_6-Port_Position1_N010)/(1.0-Port_Position1_N010),0.0,1.0)));
}
...
if (l9_2==1.0)
{
float l9_16=clamp(Interpolator_UVCoord3.y,0.0,1.0);
vec4 l9_17;
if (l9_16<Port_Position1_N043)
{
l9_17=mix(Port_Value0_N043,Port_Value1_N043,vec4(clamp(l9_16/Port_Position1_N043,0.0,1.0)));
}
else
{
l9_17=mix(Port_Value1_N043,Port_Value2_N043,vec4(clamp((l9_16-Port_Position1_N043)/(1.0-Port_Position1_N043),0.0,1.0)));
}
bool l9_18=PreviewEnabled==1;
bool l9_19;
if (l9_18)
{
l9_19=!l9_0;
...
if (l9_2==2.0)
{
float l9_26=clamp(Interpolator_UVCoord3.y,0.0,1.0);
vec4 l9_27;
if (l9_26<Port_Position1_N044)
{
l9_27=mix(Port_Value0_N044,Port_Value1_N044,vec4(clamp(l9_26/Port_Position1_N044,0.0,1.0)));
}
else
{
l9_27=mix(Port_Value1_N044,Port_Value2_N044,vec4(clamp((l9_26-Port_Position1_N044)/(1.0-Port_Position1_N044),0.0,1.0)));
}
bool l9_28=PreviewEnabled==1;
bool l9_29;
if (l9_28)
{
l9_29=!l9_0;
...
float l9_33=radians(Port_Rotation_N012);
float l9_34=clamp((vec2(dot(vec2(cos(l9_33),sin(l9_33)),Interpolator_UVCoord3-Port_Center_N012),0.0)+Port_Center_N012).x,0.0,1.0);
vec4 l9_35;
if (l9_34<Port_Position1_N049)
{
l9_35=mix(Port_Value0_N049,Port_Value1_N049,vec4(clamp(l9_34/Port_Position1_N049,0.0,1.0)));
}
else
{
l9_35=mix(Port_Value1_N049,Port_Value2_N049,vec4(clamp((l9_34-Port_Position1_N049)/(1.0-Port_Position1_N049),0.0,1.0)));
}
bool l9_36=PreviewEnabled==1;
bool l9_37;
if (l9_36)
{
l9_37=!l9_4;
...
float l9_41=l9_1*Port_Speed_N013;
int l9_42;
...
#endif
vec3 l9_43=mix(l9_3.xyz,l9_35.xyz,vec3(1.0-sc_SampleTextureBiasOrLevel(Tweak_N14Dims.xy,Tweak_N14Layout,l9_42,Interpolator_UVCoord3+(Port_Direction_N013*l9_41),(int(SC_USE_UV_TRANSFORM_Tweak_N14)!=0),Tweak_N14Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14),(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0),Tweak_N14UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0),Tweak_N14BorderColor,0.0,Tweak_N14).x));
vec4 l9_44=vec4(l9_43.x,l9_43.y,l9_43.z,vec4(0.0).w);
l9_44.w=Port_Value2_N001;
...
{
l9_47=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_44.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_49;
...
{
l9_50=(1.0-dot(l9_44.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_51;
...
{
l9_51=(1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_52;
...
{
l9_52=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_53;
#if (sc_BlendMode_Add)
{
l9_53=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_54;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_54=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_55;
...
{
l9_55=dot(l9_44.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_56;
#if (sc_BlendMode_Min)
{
l9_56=1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
#if (sc_BlendMode_Max)
{
l9_57=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_57=1.0;
...
#endif
l9_45=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_44.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_46);
}
#else
{
vec4 l9_58;
...
#if (sc_FramebufferFetch)
{
vec4 l9_61=sc_readFragData0_Platform();
vec4 l9_62;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_63=l9_61;
l9_63.x=l9_61.x+_sc_framebufferFetchMarker;
l9_62=l9_63;
}
#else
{
...
#endif
l9_60=sc_SampleView(sc_ScreenTextureDims.xy,l9_64,sc_ScreenTextureLayout,l9_65,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_66;
...
{
vec4 l9_67=l9_60;
l9_67.x=l9_60.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_66=l9_67;
}
#else
{
...
#endif
vec3 l9_68=mix(l9_66.xyz,definedBlend(l9_66.xyz,l9_44.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_70=vec4(mix(vec3(1.0),l9_44.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_71;
...
{
l9_72=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_72=Port_Value2_N001;
}
#endif
l9_71=vec4(l9_44.xyz*l9_72,l9_72);
}
#else
{
l9_71=l9_44;
...
#endif
int l9_81=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_80).xy);
...
if (l9_98==0)
{
l9_101=texture2D(sc_OITAlpha0,l9_93);
l9_100=texture2D(sc_OITDepthLow0,l9_93);
l9_99=texture2D(sc_OITDepthHigh0,l9_93);
}
else
{
l9_101=vec4(0.0);
...
if (l9_98==1)
{
l9_104=texture2D(sc_OITAlpha1,l9_93);
l9_103=texture2D(sc_OITDepthLow1,l9_93);
l9_102=texture2D(sc_OITDepthHigh1,l9_93);
}
else
{
l9_104=l9_101;
...
vec4 l9_119=texture2D(sc_OITFilteredDepthBoundsTexture,l9_93);
