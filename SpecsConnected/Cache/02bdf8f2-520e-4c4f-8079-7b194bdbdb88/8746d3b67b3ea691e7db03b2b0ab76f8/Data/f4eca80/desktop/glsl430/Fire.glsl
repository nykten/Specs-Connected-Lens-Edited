...
//texture texture2DArray Tweak_N14ArrSC 2:25:2:16
...
vec2 l9_42=Interpolator_UVCoord3+(Port_Direction_N013*l9_41);
vec4 l9_43;
#if (Tweak_N14Layout==2)
{
l9_43=sc_SampleTextureBiasOrLevel(Tweak_N14Dims.xy,Tweak_N14Layout,Tweak_N14GetStereoViewIndex(),l9_42,(int(SC_USE_UV_TRANSFORM_Tweak_N14)!=0),Tweak_N14Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14),(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0),Tweak_N14UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0),Tweak_N14BorderColor,0.0,Tweak_N14ArrSC);
}
#else
{
l9_43=sc_SampleTextureBiasOrLevel(Tweak_N14Dims.xy,Tweak_N14Layout,Tweak_N14GetStereoViewIndex(),l9_42,(int(SC_USE_UV_TRANSFORM_Tweak_N14)!=0),Tweak_N14Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14),(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0),Tweak_N14UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0),Tweak_N14BorderColor,0.0,Tweak_N14);
}
#endif
vec3 l9_44=mix(l9_3.xyz,l9_35.xyz,vec3(1.0-l9_43.x));
vec4 l9_45=vec4(l9_44.x,l9_44.y,l9_44.z,vec4(0.0).w);
l9_45.w=Port_Value2_N001;
...
{
l9_48=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_45.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_50;
...
{
l9_51=(1.0-dot(l9_45.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_52;
...
{
l9_52=(1.0-clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_53;
...
{
l9_53=clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_54;
#if (sc_BlendMode_Add)
{
l9_54=clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_55;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_55=clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_56;
...
{
l9_56=dot(l9_45.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_57;
#if (sc_BlendMode_Min)
{
l9_57=1.0-clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
#if (sc_BlendMode_Max)
{
l9_58=clamp(dot(l9_45.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_58=1.0;
...
#endif
l9_46=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_45.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_47);
}
#else
{
vec4 l9_59;
...
#endif
vec3 l9_70=mix(l9_68.xyz,definedBlend(l9_68.xyz,l9_45.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_72=vec4(mix(vec3(1.0),l9_45.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_73;
...
{
l9_74=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_74=Port_Value2_N001;
}
#endif
l9_73=vec4(l9_45.xyz*l9_74,l9_74);
}
#else
{
l9_73=l9_45;
