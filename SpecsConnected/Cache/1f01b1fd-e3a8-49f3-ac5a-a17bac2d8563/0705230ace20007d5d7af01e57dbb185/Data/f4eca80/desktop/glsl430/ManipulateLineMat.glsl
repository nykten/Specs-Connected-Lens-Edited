...
{
l9_25=sc_SampleView(sc_ScreenTextureDims.xy,l9_23,sc_ScreenTextureLayout,l9_24,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_25=sc_SampleView(sc_ScreenTextureDims.xy,l9_23,sc_ScreenTextureLayout,l9_24,0.0,sc_ScreenTexture);
}
#endif
l9_19=l9_25;
}
...
{
vec4 l9_27=l9_19;
l9_27.x=l9_19.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_26=l9_27;
}
#else
{
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_31;
...
#endif
l9_31=vec4(l9_3.xyz*l9_32,l9_32);
}
#else
{
l9_31=l9_3;
...
{
l9_35=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_35=vec4(0.0);
...
vec4 l9_37=outputMotionVectorsIfNeeded(varPos,max(l9_36,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_40=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
