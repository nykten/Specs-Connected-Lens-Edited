...
//sampler sampler handGlowTexSmpSC 2:21
...
//texture texture2D handGlowTex 2:3:2:21
...
//texture texture2DArray handGlowTexArrSC 2:32:2:21
...
uniform sampler2DArray handGlowTexArrSC;
...
int handGlowTexGetStereoViewIndex()
{
int l9_0;
...
vec4 l9_2;
#if (handGlowTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(handGlowTexDims.xy,handGlowTexLayout,handGlowTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex),(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0),handGlowTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0),handGlowTexBorderColor,0.0,handGlowTexArrSC);
}
#else
{
...
#endif
vec4 l9_3=mix(Port_Input0_N003,l9_2,vec4(brightness));
float l9_4=l9_3.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_4<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_4<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_5,vec4(0.0)));
return;
}
vec4 l9_7;
...
{
l9_10=clamp(dot(l9_3.xyz,vec3(l9_4)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_4;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_4;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_15;
#if (sc_BlendMode_Add)
{
l9_15=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_3.xyz,vec3(0.33333001))*l9_4;
}
#else
{
float l9_18;
#if (sc_BlendMode_Min)
{
l9_18=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
#if (sc_BlendMode_Max)
{
l9_19=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_19=1.0;
...
#endif
l9_7=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_8);
}
#else
{
vec4 l9_20;
...
#if (sc_FramebufferFetch)
{
vec4 l9_23=sc_readFragData0_Platform();
vec4 l9_24;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_25=l9_23;
l9_25.x=l9_23.x+_sc_framebufferFetchMarker;
l9_24=l9_25;
}
#else
{
...
#else
{
vec2 l9_26=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_27;
...
{
l9_28=sc_SampleView(sc_ScreenTextureDims.xy,l9_26,sc_ScreenTextureLayout,l9_27,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_28=sc_SampleView(sc_ScreenTextureDims.xy,l9_26,sc_ScreenTextureLayout,l9_27,0.0,sc_ScreenTexture);
}
#endif
l9_22=l9_28;
}
...
{
vec4 l9_30=l9_22;
l9_30.x=l9_22.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_29=l9_30;
}
#else
{
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_3.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_34;
...
#endif
l9_34=vec4(l9_3.xyz*l9_35,l9_35);
}
#else
{
l9_34=l9_3;
...
{
l9_38=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_38=vec4(0.0);
...
vec4 l9_40=outputMotionVectorsIfNeeded(varPos,max(l9_39,vec4(0.0)));
