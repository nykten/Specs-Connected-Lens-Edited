...
//sampler sampler handGlowTexSmpSC 2:16
...
//texture texture2D handGlowTex 2:0:2:16
...
uniform vec4 handGlowTexSize;
uniform vec4 handGlowTexView;
uniform mat3 handGlowTexTransform;
uniform vec4 handGlowTexUvMinMax;
uniform vec4 handGlowTexBorderColor;
uniform float brightness;
uniform vec4 Port_Input0_N003;
...
#endif
#ifndef handGlowTexHasSwappedViews
#define handGlowTexHasSwappedViews 0
#elif handGlowTexHasSwappedViews==1
#undef handGlowTexHasSwappedViews
#define handGlowTexHasSwappedViews 1
#endif
#ifndef handGlowTexLayout
#define handGlowTexLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_handGlowTex
#define SC_USE_UV_TRANSFORM_handGlowTex 0
#elif SC_USE_UV_TRANSFORM_handGlowTex==1
#undef SC_USE_UV_TRANSFORM_handGlowTex
#define SC_USE_UV_TRANSFORM_handGlowTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_handGlowTex
#define SC_SOFTWARE_WRAP_MODE_U_handGlowTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_handGlowTex
#define SC_SOFTWARE_WRAP_MODE_V_handGlowTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_handGlowTex
#define SC_USE_UV_MIN_MAX_handGlowTex 0
#elif SC_USE_UV_MIN_MAX_handGlowTex==1
#undef SC_USE_UV_MIN_MAX_handGlowTex
#define SC_USE_UV_MIN_MAX_handGlowTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_handGlowTex
#define SC_USE_CLAMP_TO_BORDER_handGlowTex 0
#elif SC_USE_CLAMP_TO_BORDER_handGlowTex==1
#undef SC_USE_CLAMP_TO_BORDER_handGlowTex
#define SC_USE_CLAMP_TO_BORDER_handGlowTex 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(handGlowTexDims.xy,handGlowTexLayout,l9_0,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex),(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0),handGlowTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0),handGlowTexBorderColor,0.0,handGlowTex);
vec4 l9_2=mix(Port_Input0_N003,l9_1,vec4(brightness));
float l9_3=l9_2.w;
...
{
if (l9_3<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_7=clamp(dot(l9_2.xyz,vec3(l9_3)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_3;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_3;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_12;
#if (sc_BlendMode_Add)
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_13;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_2.xyz,vec3(0.33333001))*l9_3;
}
#else
{
float l9_15;
#if (sc_BlendMode_Min)
{
l9_15=1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
#if (sc_BlendMode_Max)
{
l9_16=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_16=1.0;
...
#endif
l9_4=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_2.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_5);
}
#else
{
vec4 l9_17;
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_2.xyz).xyz,vec3(l9_3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_3)),l9_3);
}
#else
{
vec4 l9_30;
...
#endif
l9_30=vec4(l9_2.xyz*l9_31,l9_31);
}
#else
{
l9_30=l9_2;
