...
uniform float pinch;
uniform float level;
uniform vec4 Port_Value_N013;
uniform float Port_Position1_N010;
uniform vec2 Port_Offset_N009;
uniform vec4 Port_Value0_N011;
uniform float Port_Position1_N011;
uniform vec4 Port_Value1_N011;
uniform float Port_Position2_N011;
uniform vec4 Port_Value2_N011;
uniform vec4 Port_Value3_N011;
...
vec2 l9_3=l9_1+Port_Offset_N009;
float l9_4=clamp(l9_3.x,0.0,1.0);
vec4 l9_5;
if (l9_4<Port_Position1_N011)
{
l9_5=mix(Port_Value0_N011,Port_Value1_N011,vec4(clamp(l9_4/Port_Position1_N011,0.0,1.0)));
}
else
{
vec4 l9_6;
if (l9_4<Port_Position2_N011)
{
l9_6=mix(Port_Value1_N011,Port_Value2_N011,vec4(clamp((l9_4-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0)));
}
else
{
l9_6=mix(Port_Value2_N011,Port_Value3_N011,vec4(clamp((l9_4-Port_Position2_N011)/(1.0-Port_Position2_N011),0.0,1.0)));
}
l9_5=l9_6;
}
...
float l9_12=clamp(pinch,0.0,1.0);
vec4 l9_13;
if (l9_12<Port_Position1_N010)
{
l9_13=mix(Port_Value_N013,l9_5,vec4(clamp(l9_12/Port_Position1_N010,0.0,1.0)));
}
else
{
l9_13=mix(l9_5,l9_5,vec4(clamp((l9_12-Port_Position1_N010)/(1.0-Port_Position1_N010),0.0,1.0)));
}
bool l9_14;
if (l9_7)
{
...
vec4 l9_18=l9_13*vec4(smoothstep(Port_Input0_N005+level,level,l9_1.x));
float l9_19=l9_18.w;
...
{
l9_25=clamp(dot(l9_18.xyz,vec3(l9_19)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_18.xyz,vec3(0.33333001)))*l9_19;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0))*l9_19;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_30;
#if (sc_BlendMode_Add)
{
l9_30=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_18.xyz,vec3(0.33333001))*l9_19;
}
#else
{
float l9_33;
#if (sc_BlendMode_Min)
{
l9_33=1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_Max)
{
l9_34=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_34=1.0;
...
#endif
l9_22=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_18.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_23);
}
#else
{
vec4 l9_35;
...
#endif
vec3 l9_46=mix(l9_44.xyz,definedBlend(l9_44.xyz,l9_18.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_18.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_18.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_18;
