...
//}
//ubo int UserUniforms 2:31:4288 {
...
//float pinch 4132
//float level 4136
//float4 Port_Value_N013 4144
//float Port_Position1_N010 4160
//float2 Port_Offset_N009 4168
//float4 Port_Value0_N011 4176
//float Port_Position1_N011 4192
//float4 Port_Value1_N011 4208
//float Port_Position2_N011 4224
//float4 Port_Value2_N011 4240
//float4 Port_Value3_N011 4256
//float Port_Input0_N005 4272
//float depthRef 4276
//}
...
float pinch;
float level;
float4 Port_Value_N013;
float Port_Position1_N010;
float2 Port_Offset_N009;
float4 Port_Value0_N011;
float Port_Position1_N011;
float4 Port_Value1_N011;
float Port_Position2_N011;
float4 Port_Value2_N011;
float4 Port_Value3_N011;
...
float Output_N8=0.0;
float param=(*sc_set2.UserUniforms).pinch;
Output_N8=param;
float4 Output_N13=float4(0.0);
Output_N13=(*sc_set2.UserUniforms).Port_Value_N013;
...
float4 Value_N11=float4(0.0);
float param_1=CoordsOut_N9.x;
float4 param_2=(*sc_set2.UserUniforms).Port_Value0_N011;
float param_3=(*sc_set2.UserUniforms).Port_Position1_N011;
float4 param_4=(*sc_set2.UserUniforms).Port_Value1_N011;
float param_5=(*sc_set2.UserUniforms).Port_Position2_N011;
float4 param_6=(*sc_set2.UserUniforms).Port_Value2_N011;
float4 param_7=(*sc_set2.UserUniforms).Port_Value3_N011;
param_1=fast::clamp(param_1,0.0,1.0);
float4 param_8;
if (param_1<param_3)
{
param_8=mix(param_2,param_4,float4(fast::clamp(param_1/param_3,0.0,1.0)));
}
else
{
if (param_1<param_5)
{
param_8=mix(param_4,param_6,float4(fast::clamp((param_1-param_3)/(param_5-param_3),0.0,1.0)));
}
else
{
param_8=mix(param_6,param_7,float4(fast::clamp((param_1-param_5)/(1.0-param_5),0.0,1.0)));
}
}
...
if (l9_8)
{
l9_9=11==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_9=l9_8;
...
PreviewInfo.Color=param_8;
PreviewInfo.Color.w=1.0;
}
Value_N11=param_8;
float4 Value_N10=float4(0.0);
float param_9=Output_N8;
float4 param_10=Output_N13;
float param_11=(*sc_set2.UserUniforms).Port_Position1_N010;
float4 param_12=Value_N11;
float4 param_13=Value_N11;
...
bool l9_10=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_11;
if (l9_10)
{
l9_11=!PreviewInfo.Saved;
}
else
{
l9_11=l9_10;
...
if (l9_11)
{
l9_12=10==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_12=l9_11;
...
Value_N10=param_14;
float Output_N3=0.0;
float param_15=(*sc_set2.UserUniforms).level;
Output_N3=param_15;
float Output_N5=0.0;
Output_N5=(*sc_set2.UserUniforms).Port_Input0_N005+Output_N3;
float2 UVCoord_N0=float2(0.0);
UVCoord_N0=Globals.Surface_UVCoord0;
float Output_N1=0.0;
Output_N1=UVCoord_N0.x;
float Output_N2=0.0;
Output_N2=smoothstep(Output_N5,Output_N3,Output_N1);
float4 Output_N7=float4(0.0);
Output_N7=Value_N10*float4(Output_N2);
...
{
float4 l9_13=gl_FragCoord;
float2 l9_14=floor(mod(l9_13.xy,float2(4.0)));
float l9_15=(mod(dot(l9_14,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_16<l9_15)
{
discard_fragment();
}
}
bool l9_16=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_16)
{
...
float4 l9_17=fast::max(param_17,float4(0.0));
float4 param_18=l9_17;
...
{
l9_20=fast::clamp(l9_19.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_20=fast::clamp(dot(l9_19.xyz,float3(l9_19.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_20=(1.0-dot(l9_19.xyz,float3(0.33333001)))*l9_19.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_20=(1.0-fast::clamp(dot(l9_19.xyz,float3(1.0)),0.0,1.0))*l9_19.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_20=fast::clamp(dot(l9_19.xyz,float3(1.0)),0.0,1.0)*l9_19.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_20=fast::clamp(dot(l9_19.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_20=dot(l9_19.xyz,float3(0.33333001))*l9_19.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_20=1.0-fast::clamp(dot(l9_19.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_21=l9_20;
float l9_22=l9_21;
float l9_23=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_22;
float3 l9_24=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_18.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_25=float4(l9_24.x,l9_24.y,l9_24.z,l9_23);
param_19=l9_25;
}
else
{
...
{
float4 l9_26=param_19;
float4 l9_27=float4(0.0);
float4 l9_28=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_29=out.FragColor0;
float4 l9_30=l9_29;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_30.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_31=l9_30;
l9_28=l9_31;
}
...
{
float4 l9_32=gl_FragCoord;
float2 l9_33=(l9_32.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_34=l9_33;
...
int l9_38=l9_37;
int l9_39=l9_38;
float3 l9_40=float3(l9_34,0.0);
int l9_41=l9_36;
int l9_42=l9_39;
if (l9_41==1)
{
l9_40.y=((2.0*l9_40.y)+float(l9_42))-1.0;
}
...
float4 l9_58=float4(0.0);
float2 l9_59=l9_55;
int l9_60=sc_ScreenTextureLayout_tmp;
int l9_61=l9_56;
float l9_62=l9_57;
float2 l9_63=l9_59;
int l9_64=l9_60;
...
if (l9_64==0)
{
l9_66=float3(l9_63,0.0);
}
else
{
if (l9_64==1)
{
l9_66=float3(l9_63.x,(l9_63.y*0.5)+(0.5-(float(l9_65)*0.5)),0.0);
}
else
{
l9_66=float3(l9_63,float(l9_65));
}
}
float3 l9_67=l9_66;
float3 l9_68=l9_67;
float2 l9_69=l9_68.xy;
float l9_70=l9_62;
float4 l9_71=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_69,bias(l9_70));
float4 l9_72=l9_71;
l9_58=l9_72;
float4 l9_73=l9_58;
float4 l9_74=l9_73;
...
float4 l9_76=l9_28;
float4 l9_77=l9_76;
float3 l9_78=l9_77.xyz;
float3 l9_79=l9_78;
float3 l9_80=l9_26.xyz;
float3 l9_81=definedBlend(l9_79,l9_80,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_27=float4(l9_81.x,l9_81.y,l9_81.z,l9_27.w);
float3 l9_82=mix(l9_78,l9_27.xyz,float3(l9_26.w));
l9_27=float4(l9_82.x,l9_82.y,l9_82.z,l9_27.w);
l9_27.w=1.0;
float4 l9_83=l9_27;
param_19=l9_83;
}
...
{
float4 l9_84=param_19;
float4 l9_85=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_85=float4(mix(float3(1.0),l9_84.xyz,float3(l9_84.w)),l9_84.w);
}
else
{
...
{
l9_86=fast::clamp(l9_86,0.0,1.0);
}
l9_85=float4(l9_84.xyz*l9_86,l9_86);
}
else
{
l9_85=l9_84;
...
{
l9_89=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_89=float4(0.0);
...
float4 l9_91=param_22;
out.FragColor0=l9_91;
return out;
}
} // FRAGMENT SHADER
