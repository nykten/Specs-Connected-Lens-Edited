...
float l9_20=clamp(l9_13.x,0.0,1.0);
float l9_21;
if (l9_20<Port_Position1_N018)
{
l9_21=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_20/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_22;
if (l9_20<Port_Position2_N018)
{
l9_22=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_20-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_23;
if (l9_20<Port_Position3_N018)
{
l9_23=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_20-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_23=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_20-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_22=l9_23;
}
l9_21=l9_22;
}
vec4 l9_24=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_24.w=l9_21;
vec2 l9_25=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_26=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
float l9_27;
if ((float(iconEnabled)*1.0)!=0.0)
{
l9_27=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_25,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon).w;
}
else
{
l9_27=Port_Input2_N003;
}
vec4 l9_28=vec4(l9_27);
vec4 l9_29=mix(mix(vec4(Port_Import_N006)*l9_7,vec4(Port_Import_N062)*l9_11,vec4(Port_Input2_N005))+mix(l9_24,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_26,l9_28);
float l9_30=l9_29.w;
...
{
l9_34=clamp(dot(l9_29.xyz,vec3(l9_30)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*l9_30;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*l9_30;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_30;
}
#else
{
float l9_39;
#if (sc_BlendMode_Add)
{
l9_39=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_41=dot(l9_29.xyz,vec3(0.33333001))*l9_30;
}
#else
{
float l9_42;
#if (sc_BlendMode_Min)
{
l9_42=1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_Max)
{
l9_43=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_43=1.0;
...
#endif
l9_31=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_29.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_32);
}
#else
{
vec4 l9_44;
...
#endif
vec3 l9_54=mix(l9_52.xyz,definedBlend(l9_52.xyz,l9_29.xyz).xyz,vec3(l9_30));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_56=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_30)),l9_30);
}
#else
{
vec4 l9_57;
...
#endif
l9_57=vec4(l9_29.xyz*l9_58,l9_58);
}
#else
{
l9_57=l9_29;
