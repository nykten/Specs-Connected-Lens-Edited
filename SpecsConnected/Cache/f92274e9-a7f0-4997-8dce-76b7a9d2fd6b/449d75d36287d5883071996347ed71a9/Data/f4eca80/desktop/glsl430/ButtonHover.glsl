...
//sampler sampler additional_settings_btn_refl_texSmpSC 2:22
//sampler sampler iconSmpSC 2:23
...
//texture texture2D additional_settings_btn_refl_tex 2:3:2:22
//texture texture2D icon 2:4:2:23
...
//texture texture2DArray additional_settings_btn_refl_texArrSC 2:34:2:22
//texture texture2DArray iconArrSC 2:35:2:23
...
uniform float Port_Value0_N018;
uniform float Port_Position1_N018;
uniform float Port_Value1_N018;
uniform float Port_Position2_N018;
uniform float Port_Value2_N018;
uniform float Port_Position3_N018;
uniform float Port_Value3_N018;
uniform float Port_Value4_N018;
...
float l9_37=clamp(l9_30.x,0.0,1.0);
float l9_38;
if (l9_37<Port_Position1_N018)
{
l9_38=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_37/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_39;
if (l9_37<Port_Position2_N018)
{
l9_39=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_37-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_40;
if (l9_37<Port_Position3_N018)
{
l9_40=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_37-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_40=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_37-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_39=l9_40;
}
l9_38=l9_39;
}
vec4 l9_41=vec4(l9_30.x,l9_30.y,l9_30.z,vec4(0.0).w);
l9_41.w=l9_38;
vec3 l9_42=-l9_6;
vec2 l9_43=l9_5-Port_Center_N002;
vec2 l9_44=(l9_43*Port_Scale_N002)+Port_Center_N002;
vec4 l9_45;
#if (iconLayout==2)
{
l9_45=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_44,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_45=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_44,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
float l9_46;
...
#if (iconLayout==2)
{
l9_47=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_44,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_47=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_44,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
l9_46=l9_47.w;
}
...
{
l9_46=Port_Input2_N003;
}
vec4 l9_48=vec4(l9_46);
vec4 l9_49=mix(mix(l9_20,l9_27,vec4(Port_Input2_N005))+mix(l9_41,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_42,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_45,l9_48);
float l9_50=l9_49.w;
...
#endif
sc_writeFragData0(max(l9_51,vec4(0.0)));
return;
}
vec4 l9_53;
...
{
l9_56=clamp(dot(l9_49.xyz,vec3(l9_50)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_49.xyz,vec3(0.33333001)))*l9_50;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0))*l9_50;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_49.xyz,vec3(0.33333001))*l9_50;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_49.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
#if (sc_FramebufferFetch)
{
vec4 l9_69=sc_readFragData0_Platform();
vec4 l9_70;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_71=l9_69;
l9_71.x=l9_69.x+_sc_framebufferFetchMarker;
l9_70=l9_71;
}
#else
{
...
#else
{
vec2 l9_72=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_73;
...
{
l9_74=sc_SampleView(sc_ScreenTextureDims.xy,l9_72,sc_ScreenTextureLayout,l9_73,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_74=sc_SampleView(sc_ScreenTextureDims.xy,l9_72,sc_ScreenTextureLayout,l9_73,0.0,sc_ScreenTexture);
}
#endif
l9_68=l9_74;
}
...
{
vec4 l9_76=l9_68;
l9_76.x=l9_68.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_75=l9_76;
}
#else
{
...
#endif
vec3 l9_77=mix(l9_75.xyz,definedBlend(l9_75.xyz,l9_49.xyz).xyz,vec3(l9_50));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_49.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_49.xyz*l9_81,l9_81);
}
#else
{
l9_80=l9_49;
...
vec4 l9_86=outputMotionVectorsIfNeeded(varPos,max(l9_85,vec4(0.0)));
vec4 l9_87=clamp(l9_86,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_88=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_88-0.0039215689)),min(1.0,l9_88+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_89=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_89).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_90=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_89).xy);
float l9_91=packValue(l9_90);
int l9_98=int(l9_87.w*255.0);
float l9_99=packValue(l9_98);
sc_writeFragData0(vec4(packValue(l9_90),packValue(l9_90),packValue(l9_90),packValue(l9_90)));
sc_writeFragData1(vec4(l9_91,packValue(l9_90),packValue(l9_90),packValue(l9_90)));
sc_writeFragData2(vec4(l9_99,packValue(l9_98),packValue(l9_98),packValue(l9_98)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_102=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_107==0)
{
l9_110=texture(sc_OITAlpha0,l9_102);
l9_109=texture(sc_OITDepthLow0,l9_102);
l9_108=texture(sc_OITDepthHigh0,l9_102);
}
else
{
l9_110=vec4(0.0);
...
if (l9_107==1)
{
l9_113=texture(sc_OITAlpha1,l9_102);
l9_112=texture(sc_OITDepthLow1,l9_102);
l9_111=texture(sc_OITDepthHigh1,l9_102);
}
else
{
l9_113=l9_110;
...
if (any(notEqual(l9_111,vec4(0.0)))||any(notEqual(l9_112,vec4(0.0))))
{
int l9_114[8]=l9_103;
unpackValues(l9_111.w,l9_107,l9_114);
unpackValues(l9_111.z,l9_107,l9_114);
unpackValues(l9_111.y,l9_107,l9_114);
unpackValues(l9_111.x,l9_107,l9_114);
unpackValues(l9_112.w,l9_107,l9_114);
unpackValues(l9_112.z,l9_107,l9_114);
unpackValues(l9_112.y,l9_107,l9_114);
unpackValues(l9_112.x,l9_107,l9_114);
int l9_123[8]=l9_104;
unpackValues(l9_113.w,l9_107,l9_123);
unpackValues(l9_113.z,l9_107,l9_123);
unpackValues(l9_113.y,l9_107,l9_123);
unpackValues(l9_113.x,l9_107,l9_123);
}
l9_107++;
continue;
}
...
vec4 l9_128=texture(sc_OITFilteredDepthBoundsTexture,l9_102);
vec2 l9_129=l9_128.xy;
int l9_130;
#if (sc_SkinBonesCount>0)
{
l9_130=encodeDepth(((1.0-l9_128.x)*1000.0)+getDepthOrderingEpsilon(),l9_129);
}
#else
{
l9_130=0;
...
#endif
int l9_131=encodeDepth(viewSpaceDepth(),l9_129);
vec4 l9_132;
l9_132=l9_87*l9_87.w;
vec4 l9_133;
int l9_134=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_134<8)
{
int l9_135=l9_103[l9_134];
int l9_136=l9_131-l9_130;
bool l9_137=l9_135<l9_136;
bool l9_138;
if (l9_137)
{
l9_138=l9_103[l9_134]>0;
}
else
{
l9_138=l9_137;
...
if (l9_138)
{
vec3 l9_139=l9_132.xyz*(1.0-(float(l9_104[l9_134])/255.0));
l9_133=vec4(l9_139.x,l9_139.y,l9_139.z,l9_132.w);
}
else
{
l9_133=l9_132;
