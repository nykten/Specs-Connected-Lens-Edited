...
//sampler sampler Tweak_N42SmpSC 2:16
...
//texture texture2D Tweak_N42 2:0:2:16
...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(Tweak_N42Dims.xy,Tweak_N42Layout,l9_0,((varPackedTex.xy-Port_Center_N046)*vec2(Tweak_N47))+Port_Center_N046,(int(SC_USE_UV_TRANSFORM_Tweak_N42)!=0),Tweak_N42Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42),(int(SC_USE_UV_MIN_MAX_Tweak_N42)!=0),Tweak_N42UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0),Tweak_N42BorderColor,0.0,Tweak_N42)*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_2=mix(Port_Input0_N102,mix(vec4(dot(l9_1,Port_Input1_N094)),l9_1,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
...
{
l9_6=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(l9_3.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_3.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_15;
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_3.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_3.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_30;
