...
//sampler sampler Tweak_N42SmpSC 2:22
...
//texture texture2D Tweak_N42 2:4:2:22
...
//}
//ubo int UserUniforms 2:33:4416 {
...
//float Tweak_N47 4272
//float Tweak_N2 4276
//float4 baseColor 4288
//float Tweak_N41 4304
//float4 Port_Input0_N102 4320
//float2 Port_Center_N046 4336
//float4 Port_Import_N091 4352
//float Port_Import_N092 4368
//float4 Port_Input1_N094 4384
//float Port_Import_N095 4400
//float Port_Import_N100 4404
//float depthRef 4408
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 1031
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 1032
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N42 1033
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 1034
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N42 1035
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 1036
//spec_const bool Tweak_N42HasSwappedViews 1037
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 1070
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1071
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 1072
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1073
//spec_const int Tweak_N42Layout 1074
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 [[function_constant(1031)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N42 [[function_constant(1033)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N42 [[function_constant(1035)]];
...
constant bool Tweak_N42HasSwappedViews [[function_constant(1037)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 [[function_constant(1070)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 [[function_constant(1072)]];
...
constant int Tweak_N42Layout [[function_constant(1074)]];
...
texture2d<float> Tweak_N42 [[id(4)]];
...
float2 UVCoord_N45=float2(0.0);
UVCoord_N45=Globals.Surface_UVCoord0;
float Output_N47=0.0;
float param=(*sc_set2.UserUniforms).Tweak_N47;
Output_N47=param;
float2 CoordsOut_N46=float2(0.0);
CoordsOut_N46=((UVCoord_N45-(*sc_set2.UserUniforms).Port_Center_N046)*float2(Output_N47))+(*sc_set2.UserUniforms).Port_Center_N046;
...
int l9_12=l9_7;
int param_1=Tweak_N42Layout_tmp;
int param_2=l9_12;
float2 param_3=CoordsOut_N46;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N42_tmp)!=0);
float3x3 param_5=(*sc_set2.UserUniforms).Tweak_N42Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N42_tmp)!=0);
float4 param_8=(*sc_set2.UserUniforms).Tweak_N42UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42_tmp)!=0);
float4 param_10=(*sc_set2.UserUniforms).Tweak_N42BorderColor;
float param_11=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set2.Tweak_N42.sample(sc_set2.Tweak_N42SmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_9)
{
...
Value_N91=Output_N42;
float Value_N92=0.0;
Value_N92=fast::clamp((*sc_set2.UserUniforms).Port_Import_N092,0.0,5.0);
float4 Output_N93=float4(0.0);
Output_N93=Value_N91*float4(Value_N92);
float Output_N94=0.0;
Output_N94=dot(Output_N93,(*sc_set2.UserUniforms).Port_Input1_N094);
float Output_N2=0.0;
float param_12=(*sc_set2.UserUniforms).Tweak_N2;
Output_N2=param_12;
float Value_N95=0.0;
Value_N95=fast::clamp(Output_N2,0.0,2.0);
float4 Output_N98=float4(0.0);
Output_N98=mix(float4(Output_N94),Output_N93,float4(Value_N95));
float Value_N100=0.0;
Value_N100=fast::clamp((*sc_set2.UserUniforms).Port_Import_N100,0.0,2.0);
float4 Output_N102=float4(0.0);
Output_N102=mix((*sc_set2.UserUniforms).Port_Input0_N102,Output_N98,float4(Value_N100));
float4 Export_N113=float4(0.0);
Export_N113=Output_N102;
float4 Output_N5=float4(0.0);
float4 param_13=(*sc_set2.UserUniforms).baseColor;
Output_N5=param_13;
float4 Output_N44=float4(0.0);
Output_N44=Export_N113*Output_N5;
float Output_N41=0.0;
float param_14=(*sc_set2.UserUniforms).Tweak_N41;
Output_N41=param_14;
float4 Value_N1=float4(0.0);
Value_N1=float4(Output_N44.xyz.x,Output_N44.xyz.y,Output_N44.xyz.z,Value_N1.w);
Value_N1.w=Output_N41;
FinalColor=Value_N1;
float param_15=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_15<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_88=floor(mod(l9_87.xy,float2(4.0)));
float l9_89=(mod(dot(l9_88,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_15<l9_89)
{
discard_fragment();
}
}
bool l9_90=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_90)
{
...
float4 l9_91=fast::max(param_16,float4(0.0));
float4 param_17=l9_91;
...
{
l9_94=fast::clamp(l9_93.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_94=fast::clamp(dot(l9_93.xyz,float3(l9_93.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_94=(1.0-dot(l9_93.xyz,float3(0.33333001)))*l9_93.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_94=(1.0-fast::clamp(dot(l9_93.xyz,float3(1.0)),0.0,1.0))*l9_93.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_94=fast::clamp(dot(l9_93.xyz,float3(1.0)),0.0,1.0)*l9_93.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_94=fast::clamp(dot(l9_93.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_94=dot(l9_93.xyz,float3(0.33333001))*l9_93.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_94=1.0-fast::clamp(dot(l9_93.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_95=l9_94;
float l9_96=l9_95;
float l9_97=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_96;
float3 l9_98=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_92.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_99=float4(l9_98.x,l9_98.y,l9_98.z,l9_97);
param_18=l9_99;
}
else
{
...
{
float4 l9_100=param_18;
float4 l9_101=float4(0.0);
float4 l9_102=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_103=out.FragColor0;
float4 l9_104=l9_103;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_104.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_106=gl_FragCoord;
float2 l9_107=(l9_106.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_112=l9_111;
int l9_113=l9_112;
float3 l9_114=float3(l9_108,0.0);
int l9_115=l9_110;
int l9_116=l9_113;
if (l9_115==1)
{
l9_114.y=((2.0*l9_114.y)+float(l9_116))-1.0;
}
float2 l9_117=l9_114.xy;
l9_109=l9_117;
}
else
{
...
int l9_126=l9_121;
float2 l9_127=l9_120;
int l9_128=l9_126;
float2 l9_129=l9_127;
int l9_130=l9_128;
float l9_131=0.0;
float4 l9_132=float4(0.0);
float2 l9_133=l9_129;
int l9_134=sc_ScreenTextureLayout_tmp;
int l9_135=l9_130;
float l9_136=l9_131;
...
float l9_144=l9_136;
float4 l9_145=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_143,bias(l9_144));
float4 l9_146=l9_145;
l9_132=l9_146;
...
float4 l9_150=l9_102;
float4 l9_151=l9_150;
float3 l9_152=l9_151.xyz;
float3 l9_153=l9_152;
float3 l9_154=l9_100.xyz;
float3 l9_155=definedBlend(l9_153,l9_154,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_101=float4(l9_155.x,l9_155.y,l9_155.z,l9_101.w);
float3 l9_156=mix(l9_152,l9_101.xyz,float3(l9_100.w));
l9_101=float4(l9_156.x,l9_156.y,l9_156.z,l9_101.w);
l9_101.w=1.0;
float4 l9_157=l9_101;
param_18=l9_157;
}
else
{
float4 l9_158=param_18;
float4 l9_159=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_159=float4(mix(float3(1.0),l9_158.xyz,float3(l9_158.w)),l9_158.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_160=l9_158.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_160=fast::clamp(l9_160,0.0,1.0);
}
l9_159=float4(l9_158.xyz*l9_160,l9_160);
}
else
{
l9_159=l9_158;
...
{
l9_163=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_163=float4(0.0);
...
float4 l9_165=param_21;
out.FragColor0=l9_165;
return out;
}
} // FRAGMENT SHADER
