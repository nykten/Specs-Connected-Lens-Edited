...
//sampler sampler Tweak_N42SmpSC 2:21
...
//texture texture2D Tweak_N42 2:3:2:21
...
//texture texture2DArray Tweak_N42ArrSC 2:32:2:21
...
uniform float Tweak_N47;
uniform float Tweak_N2;
uniform vec4 baseColor;
uniform float Tweak_N41;
uniform vec4 Port_Input0_N102;
uniform vec2 Port_Center_N046;
uniform vec4 Port_Import_N091;
uniform float Port_Import_N092;
uniform vec4 Port_Input1_N094;
uniform float Port_Import_N095;
uniform float Port_Import_N100;
...
vec2 l9_2=l9_0-Port_Center_N046;
vec2 l9_3=(l9_2*vec2(Tweak_N47))+Port_Center_N046;
vec4 l9_4;
#if (Tweak_N42Layout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(Tweak_N42Dims.xy,Tweak_N42Layout,Tweak_N42GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N42)!=0),Tweak_N42Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42),(int(SC_USE_UV_MIN_MAX_Tweak_N42)!=0),Tweak_N42UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0),Tweak_N42BorderColor,0.0,Tweak_N42ArrSC);
}
#else
{
...
#endif
vec4 l9_5=l9_4*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_6=mix(Port_Input0_N102,mix(vec4(dot(l9_5,Port_Input1_N094)),l9_5,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
vec4 l9_7=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_7.w=Tweak_N41;
#if (sc_BlendMode_AlphaTest)
{
if (Tweak_N41<alphaTestThreshold)
{
discard;
}
}
...
{
if (Tweak_N41<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_8,vec4(0.0)));
return;
}
vec4 l9_10;
...
{
l9_12=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_7.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_18;
#if (sc_BlendMode_Add)
{
l9_18=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_7.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_21;
#if (sc_BlendMode_Min)
{
l9_21=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_Max)
{
l9_22=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_22=1.0;
...
#endif
l9_10=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_11);
}
#else
{
vec4 l9_23;
...
#else
{
vec2 l9_29=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_30;
...
{
l9_31=sc_SampleView(sc_ScreenTextureDims.xy,l9_29,sc_ScreenTextureLayout,l9_30,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_31=sc_SampleView(sc_ScreenTextureDims.xy,l9_29,sc_ScreenTextureLayout,l9_30,0.0,sc_ScreenTexture);
}
#endif
l9_25=l9_31;
}
...
{
vec4 l9_33=l9_25;
l9_33.x=l9_25.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_32=l9_33;
}
#else
{
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_7.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_7.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_37;
...
#endif
l9_37=vec4(l9_7.xyz*l9_38,l9_38);
}
#else
{
l9_37=l9_7;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_46).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_47=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_46).xy);
...
if (l9_64==0)
{
l9_67=texture(sc_OITAlpha0,l9_59);
l9_66=texture(sc_OITDepthLow0,l9_59);
l9_65=texture(sc_OITDepthHigh0,l9_59);
}
else
{
l9_67=vec4(0.0);
...
if (l9_64==1)
{
l9_70=texture(sc_OITAlpha1,l9_59);
l9_69=texture(sc_OITDepthLow1,l9_59);
l9_68=texture(sc_OITDepthHigh1,l9_59);
}
else
{
l9_70=l9_67;
...
vec4 l9_85=texture(sc_OITFilteredDepthBoundsTexture,l9_59);
vec2 l9_86=l9_85.xy;
int l9_87;
#if (sc_SkinBonesCount>0)
{
