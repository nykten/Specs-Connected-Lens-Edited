...
float l9_28=clamp(((l9_27.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_29;
if (l9_28<Port_Position1_N005)
{
l9_29=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_28/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_28<Port_Position2_N005)
{
l9_30=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_28-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_30=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_28-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_29=l9_30;
}
vec3 l9_31=-l9_4;
vec4 l9_32=mix(l9_29,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_31,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec2 l9_33=l9_3*Port_Input1_N067;
float l9_34=clamp(length(l9_33+Port_Input2_N067),0.0,1.0);
vec4 l9_35;
if (l9_34<Port_Position1_N069)
{
l9_35=mix(Port_Value0_N069,Port_Value1_N069,vec4(clamp(l9_34/Port_Position1_N069,0.0,1.0)));
}
else
{
vec4 l9_36;
if (l9_34<Port_Position2_N069)
{
l9_36=mix(Port_Value1_N069,Port_Value2_N069,vec4(clamp((l9_34-Port_Position1_N069)/(Port_Position2_N069-Port_Position1_N069),0.0,1.0)));
}
else
{
vec4 l9_37;
if (l9_34<Port_Position3_N069)
{
l9_37=mix(Port_Value2_N069,Port_Value3_N069,vec4(clamp((l9_34-Port_Position2_N069)/(Port_Position3_N069-Port_Position2_N069),0.0,1.0)));
}
else
{
l9_37=mix(Port_Value3_N069,Port_Value4_N069,vec4(clamp((l9_34-Port_Position3_N069)/(1.0-Port_Position3_N069),0.0,1.0)));
}
l9_36=l9_37;
}
l9_35=l9_36;
}
vec4 l9_38=l9_32+l9_35;
vec2 l9_39=l9_3-vec2(Port_RangeMinA_N076);
float l9_40=radians(Port_Rotation_N090);
float l9_41=sin(l9_40);
float l9_42=cos(l9_40);
vec2 l9_43=Port_CoordsIn_N090-Port_Center_N090;
vec2 l9_44=Port_Import_N081-Port_Import_N079;
vec4 l9_45=l9_38+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_31,l9_11*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot(((((((l9_39/vec2(Port_RangeMaxA_N076-Port_RangeMinA_N076))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_42,l9_41),l9_43),dot(vec2(-l9_41,l9_42),l9_43))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_44)/dot(l9_44,l9_44))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
vec2 l9_46=l9_3*Port_Input1_N028;
float l9_47=clamp(length(l9_46+Port_Input2_N028),0.0,1.0);
float l9_48;
if (l9_47<Port_Position1_N016)
{
l9_48=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_47/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_49;
if (l9_47<Port_Position2_N016)
{
l9_49=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_47-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_50;
if (l9_47<Port_Position3_N016)
{
l9_50=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_47-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_50=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_47-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_49=l9_50;
}
l9_48=l9_49;
}
vec4 l9_51=vec4(l9_45.x,l9_45.y,l9_45.z,vec4(0.0).w);
l9_51.w=l9_48;
vec4 l9_52=l9_20+l9_51;
float l9_53=l9_52.w;
...
#endif
sc_writeFragData0(max(l9_54,vec4(0.0)));
return;
}
vec4 l9_56;
...
{
l9_59=clamp(dot(l9_52.xyz,vec3(l9_53)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*l9_53;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*l9_53;
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_53;
}
#else
{
float l9_64;
#if (sc_BlendMode_Add)
{
l9_64=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_65=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_53;
}
#else
{
float l9_66;
...
{
l9_66=dot(l9_52.xyz,vec3(0.33333001))*l9_53;
}
#else
{
float l9_67;
#if (sc_BlendMode_Min)
{
l9_67=1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
#if (sc_BlendMode_Max)
{
l9_68=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_68=1.0;
...
#endif
l9_56=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_52.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_57);
}
#else
{
vec4 l9_69;
...
#if (sc_FramebufferFetch)
{
vec4 l9_72=sc_readFragData0_Platform();
vec4 l9_73;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_74=l9_72;
l9_74.x=l9_72.x+_sc_framebufferFetchMarker;
l9_73=l9_74;
}
#else
{
...
{
l9_77=sc_SampleView(sc_ScreenTextureDims.xy,l9_75,sc_ScreenTextureLayout,l9_76,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_77=sc_SampleView(sc_ScreenTextureDims.xy,l9_75,sc_ScreenTextureLayout,l9_76,0.0,sc_ScreenTexture);
}
#endif
l9_71=l9_77;
}
...
{
vec4 l9_79=l9_71;
l9_79.x=l9_71.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_78=l9_79;
}
#else
{
...
#endif
vec3 l9_80=mix(l9_78.xyz,definedBlend(l9_78.xyz,l9_52.xyz).xyz,vec3(l9_53));
vec4 l9_81=vec4(l9_80.x,l9_80.y,l9_80.z,vec4(0.0).w);
l9_81.w=1.0;
l9_70=l9_81;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_53)),l9_53);
}
#else
{
vec4 l9_83;
...
#endif
l9_83=vec4(l9_52.xyz*l9_84,l9_84);
}
#else
{
l9_83=l9_52;
...
{
l9_87=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_87=vec4(0.0);
...
vec4 l9_89=outputMotionVectorsIfNeeded(varPos,max(l9_88,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_92=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_105=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
