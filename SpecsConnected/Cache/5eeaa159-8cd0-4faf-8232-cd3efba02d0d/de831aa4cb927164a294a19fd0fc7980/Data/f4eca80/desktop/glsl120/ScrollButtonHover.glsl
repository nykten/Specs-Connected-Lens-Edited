...
//sampler sampler capsule_btn_refl_tex_1SmpSC 2:18
//sampler sampler capsule_btn_refl_tex_2SmpSC 2:19
//sampler sampler capsule_btn_refl_tex_3SmpSC 2:20
...
//texture texture2D capsule_btn_refl_tex_1 2:0:2:18
//texture texture2D capsule_btn_refl_tex_2 2:1:2:19
//texture texture2D capsule_btn_refl_tex_3 2:2:2:20
...
uniform vec4 capsule_btn_refl_tex_2Dims;
uniform vec4 capsule_btn_refl_tex_3Dims;
uniform vec4 capsule_btn_refl_tex_1Dims;
...
uniform vec4 capsule_btn_refl_tex_2Size;
uniform vec4 capsule_btn_refl_tex_2View;
...
uniform vec4 capsule_btn_refl_tex_3Size;
uniform vec4 capsule_btn_refl_tex_3View;
...
uniform vec4 capsule_btn_refl_tex_1Size;
uniform vec4 capsule_btn_refl_tex_1View;
...
#endif
vec4 l9_8=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_2Dims.xy,capsule_btn_refl_tex_2Layout,l9_7,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6,0.0)).xyz*vec3(Port_Input1_N115))+vec3(Port_Input2_N115)).xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2BorderColor,0.0,capsule_btn_refl_tex_2);
int l9_9;
...
#endif
vec4 l9_10=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_3Dims.xy,capsule_btn_refl_tex_3Layout,l9_9,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3BorderColor,0.0,capsule_btn_refl_tex_3);
vec3 l9_11=l9_2*Port_Import_N041;
float l9_12=dot(l9_11,l9_11);
float l9_13;
if (l9_12>0.0)
{
l9_13=1.0/sqrt(l9_12);
}
else
{
l9_13=0.0;
}
vec3 l9_14=l9_11*l9_13;
int l9_15;
...
#endif
vec4 l9_16=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,l9_15,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_14,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045)).xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1);
float l9_17=clamp((((vec4(Port_Import_N027)*l9_16).xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_18;
...
{
l9_19=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_17-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_18=l9_19;
}
vec3 l9_20=-normalize(sc_Camera.position-varPos);
vec4 l9_21=mix(l9_18,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_20,l9_2*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
float l9_22=clamp(length((varPackedTex.xy*Port_Input1_N067)+Port_Input2_N067),0.0,1.0);
vec4 l9_23;
if (l9_22<Port_Position1_N069)
{
l9_23=mix(Port_Value0_N069,Port_Value1_N069,vec4(clamp(l9_22/Port_Position1_N069,0.0,1.0)));
}
else
{
vec4 l9_24;
if (l9_22<Port_Position2_N069)
{
l9_24=mix(Port_Value1_N069,Port_Value2_N069,vec4(clamp((l9_22-Port_Position1_N069)/(Port_Position2_N069-Port_Position1_N069),0.0,1.0)));
}
else
{
vec4 l9_25;
if (l9_22<Port_Position3_N069)
{
l9_25=mix(Port_Value2_N069,Port_Value3_N069,vec4(clamp((l9_22-Port_Position2_N069)/(Port_Position3_N069-Port_Position2_N069),0.0,1.0)));
}
else
{
l9_25=mix(Port_Value3_N069,Port_Value4_N069,vec4(clamp((l9_22-Port_Position3_N069)/(1.0-Port_Position3_N069),0.0,1.0)));
}
l9_24=l9_25;
}
l9_23=l9_24;
}
vec4 l9_26=l9_21+l9_23;
float l9_27=radians(Port_Rotation_N090);
float l9_28=sin(l9_27);
float l9_29=cos(l9_27);
vec2 l9_30=Port_CoordsIn_N090-Port_Center_N090;
vec2 l9_31=Port_Import_N081-Port_Import_N079;
vec4 l9_32=l9_26+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_20,l9_2*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot((((((((varPackedTex.xy-vec2(Port_RangeMinA_N076))/vec2(Port_RangeMaxA_N076-Port_RangeMinA_N076))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_29,l9_28),l9_30),dot(vec2(-l9_28,l9_29),l9_30))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_31)/dot(l9_31,l9_31))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
float l9_33=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
float l9_34;
if (l9_33<Port_Position1_N016)
{
l9_34=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_33/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_35;
if (l9_33<Port_Position2_N016)
{
l9_35=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_33-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_36;
if (l9_33<Port_Position3_N016)
{
l9_36=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_33-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_36=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_33-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_35=l9_36;
}
l9_34=l9_35;
}
vec4 l9_37=vec4(l9_32.x,l9_32.y,l9_32.z,vec4(0.0).w);
l9_37.w=l9_34;
vec4 l9_38=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_37;
float l9_39=l9_38.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_39<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_39<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_43=clamp(dot(l9_38.xyz,vec3(l9_39)),0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_45=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*l9_39;
}
#else
{
float l9_46;
...
{
l9_46=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*l9_39;
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_39;
}
#else
{
float l9_48;
#if (sc_BlendMode_Add)
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_49;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_49=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_39;
}
#else
{
float l9_50;
...
{
l9_50=dot(l9_38.xyz,vec3(0.33333001))*l9_39;
}
#else
{
float l9_51;
#if (sc_BlendMode_Min)
{
l9_51=1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_Max)
{
l9_52=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_52=1.0;
...
#endif
l9_40=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_38.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_41);
}
#else
{
vec4 l9_53;
...
#endif
vec3 l9_63=mix(l9_61.xyz,definedBlend(l9_61.xyz,l9_38.xyz).xyz,vec3(l9_39));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_39)),l9_39);
}
#else
{
vec4 l9_66;
...
#endif
l9_66=vec4(l9_38.xyz*l9_67,l9_67);
}
#else
{
l9_66=l9_38;
