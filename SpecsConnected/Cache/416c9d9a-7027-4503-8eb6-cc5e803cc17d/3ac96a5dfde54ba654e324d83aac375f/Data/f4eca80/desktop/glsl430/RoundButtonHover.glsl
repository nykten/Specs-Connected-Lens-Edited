...
vec4 l9_21;
if (l9_20<Port_Position1_N007)
{
l9_21=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_20/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_22;
if (l9_20<Port_Position2_N007)
{
l9_22=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_20-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_20<Port_Position3_N007)
{
l9_23=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_20-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_23=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_20-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_22=l9_23;
}
l9_21=l9_22;
...
vec3 l9_24=-l9_4;
vec4 l9_25=mix(l9_21,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(l9_24,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_26=l9_25.w;
vec3 l9_27=(l9_18.xyz+Port_Input1_N002)+l9_25.xyz;
...
#endif
sc_writeFragData0(max(l9_29,vec4(0.0)));
return;
}
vec4 l9_31;
...
{
l9_34=clamp(dot(l9_28.xyz,vec3(l9_26)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*l9_26;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*l9_26;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_39;
#if (sc_BlendMode_Add)
{
l9_39=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_28.xyz,vec3(0.33333001))*l9_26;
}
#else
{
float l9_42;
#if (sc_BlendMode_Min)
{
l9_42=1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_Max)
{
l9_43=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_43=1.0;
...
#endif
l9_31=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_28.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_32);
}
#else
{
vec4 l9_44;
...
{
l9_52=sc_SampleView(sc_ScreenTextureDims.xy,l9_50,sc_ScreenTextureLayout,l9_51,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_52=sc_SampleView(sc_ScreenTextureDims.xy,l9_50,sc_ScreenTextureLayout,l9_51,0.0,sc_ScreenTexture);
}
#endif
l9_46=l9_52;
}
...
{
vec4 l9_54=l9_46;
l9_54.x=l9_46.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_53=l9_54;
}
#else
{
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_28.xyz).xyz,vec3(l9_26));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_58;
...
#endif
l9_58=vec4(l9_28.xyz*l9_59,l9_59);
}
#else
{
l9_58=l9_28;
