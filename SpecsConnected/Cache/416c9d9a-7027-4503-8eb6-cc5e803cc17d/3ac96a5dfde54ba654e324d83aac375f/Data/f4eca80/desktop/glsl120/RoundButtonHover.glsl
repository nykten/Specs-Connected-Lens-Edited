...
//sampler sampler simple_round_buttonSmpSC 2:24
...
//texture texture2D simple_round_button 2:15:2:24
//SG_REFLECTION_END
...
vec3 l9_3=l9_2*Port_Import_N089;
...
#endif
vec4 l9_8=sc_SampleTextureBiasOrLevel(simple_round_buttonDims.xy,simple_round_buttonLayout,l9_7,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037)).xy,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button),(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0),simple_round_buttonUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0),simple_round_buttonBorderColor,0.0,simple_round_button);
float l9_9=clamp(length((varPackedTex.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_10;
...
{
vec4 l9_12;
if (l9_9<Port_Position3_N007)
{
l9_12=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_9-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_12=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_9-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_11=l9_12;
}
l9_10=l9_11;
}
vec4 l9_13=mix(l9_10,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_14=l9_13.w;
vec3 l9_15=((vec4(Port_Import_N027)*l9_8).xyz+Port_Input1_N002)+l9_13.xyz;
vec4 l9_16=vec4(l9_15.x,l9_15.y,l9_15.z,vec4(0.0).w);
l9_16.w=l9_14;
#if (sc_BlendMode_AlphaTest)
{
if (l9_14<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_14<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_20=clamp(dot(l9_16.xyz,vec3(l9_14)),0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_22=(1.0-dot(l9_16.xyz,vec3(0.33333001)))*l9_14;
}
#else
{
float l9_23;
...
{
l9_23=(1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0))*l9_14;
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_25;
#if (sc_BlendMode_Add)
{
l9_25=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_26;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_26=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_27;
...
{
l9_27=dot(l9_16.xyz,vec3(0.33333001))*l9_14;
}
#else
{
float l9_28;
#if (sc_BlendMode_Min)
{
l9_28=1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
#if (sc_BlendMode_Max)
{
l9_29=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_29=1.0;
...
#endif
l9_17=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_16.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_18);
}
#else
{
vec4 l9_30;
...
#if (sc_FramebufferFetch)
{
vec4 l9_33=sc_readFragData0_Platform();
vec4 l9_34;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_35=l9_33;
l9_35.x=l9_33.x+_sc_framebufferFetchMarker;
l9_34=l9_35;
}
#else
{
...
#endif
l9_32=sc_SampleView(sc_ScreenTextureDims.xy,l9_36,sc_ScreenTextureLayout,l9_37,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_38;
...
{
vec4 l9_39=l9_32;
l9_39.x=l9_32.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_38=l9_39;
}
#else
{
...
#endif
vec3 l9_40=mix(l9_38.xyz,definedBlend(l9_38.xyz,l9_16.xyz).xyz,vec3(l9_14));
vec4 l9_41=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_41.w=1.0;
l9_31=l9_41;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_42=vec4(mix(vec3(1.0),l9_16.xyz,vec3(l9_14)),l9_14);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_16.xyz*l9_44,l9_44);
}
#else
{
l9_43=l9_16;
...
{
l9_47=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_47=vec4(0.0);
...
vec4 l9_49=outputMotionVectorsIfNeeded(varPos,max(l9_48,vec4(0.0)));
vec4 l9_50=clamp(l9_49,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_51=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_51-0.0039215689)),min(1.0,l9_51+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_53=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_52).xy);
float l9_54=packValue(l9_53);
int l9_61=int(l9_50.w*255.0);
float l9_62=packValue(l9_61);
sc_writeFragData0(vec4(packValue(l9_53),packValue(l9_53),packValue(l9_53),packValue(l9_53)));
sc_writeFragData1(vec4(l9_54,packValue(l9_53),packValue(l9_53),packValue(l9_53)));
sc_writeFragData2(vec4(l9_62,packValue(l9_61),packValue(l9_61),packValue(l9_61)));
...
if (l9_70==0)
{
l9_73=texture2D(sc_OITAlpha0,l9_65);
l9_72=texture2D(sc_OITDepthLow0,l9_65);
l9_71=texture2D(sc_OITDepthHigh0,l9_65);
}
else
{
l9_73=vec4(0.0);
...
if (l9_70==1)
{
l9_76=texture2D(sc_OITAlpha1,l9_65);
l9_75=texture2D(sc_OITDepthLow1,l9_65);
l9_74=texture2D(sc_OITDepthHigh1,l9_65);
}
else
{
l9_76=l9_73;
...
if (any(notEqual(l9_74,vec4(0.0)))||any(notEqual(l9_75,vec4(0.0))))
{
int l9_77[8]=l9_66;
unpackValues(l9_74.w,l9_70,l9_77);
unpackValues(l9_74.z,l9_70,l9_77);
unpackValues(l9_74.y,l9_70,l9_77);
unpackValues(l9_74.x,l9_70,l9_77);
unpackValues(l9_75.w,l9_70,l9_77);
unpackValues(l9_75.z,l9_70,l9_77);
unpackValues(l9_75.y,l9_70,l9_77);
unpackValues(l9_75.x,l9_70,l9_77);
int l9_86[8]=l9_67;
unpackValues(l9_76.w,l9_70,l9_86);
unpackValues(l9_76.z,l9_70,l9_86);
unpackValues(l9_76.y,l9_70,l9_86);
unpackValues(l9_76.x,l9_70,l9_86);
}
l9_70++;
continue;
}
...
vec4 l9_91=texture2D(sc_OITFilteredDepthBoundsTexture,l9_65);
vec2 l9_92=l9_91.xy;
int l9_93;
#if (sc_SkinBonesCount>0)
{
l9_93=encodeDepth(((1.0-l9_91.x)*1000.0)+getDepthOrderingEpsilon(),l9_92);
}
#else
{
l9_93=0;
...
#endif
int l9_94=encodeDepth(viewSpaceDepth(),l9_92);
vec4 l9_95;
l9_95=l9_50*l9_50.w;
vec4 l9_96;
int l9_97=0;
...
if (l9_97<8)
{
int l9_98=l9_66[l9_97];
int l9_99=l9_94-l9_93;
bool l9_100=l9_98<l9_99;
bool l9_101;
if (l9_100)
{
l9_101=l9_66[l9_97]>0;
}
else
{
l9_101=l9_100;
...
if (l9_101)
{
vec3 l9_102=l9_95.xyz*(1.0-(float(l9_67[l9_97])/255.0));
