...
//sampler sampler Tweak_N1SmpSC 2:16
...
//texture texture2D Tweak_N1 2:0:2:16
...
vec3 l9_2=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*Port_Import_N052;
...
vec3 l9_5=l9_2*l9_4;
vec3 l9_6=reflect(normalize(sc_Camera.position-varPos),l9_5)*Port_Input1_N058;
float l9_7=l9_6.x;
float l9_8=l9_6.y;
float l9_9=l9_6.z+Port_Input1_N070;
float l9_10=((l9_7*l9_7)+(l9_8*l9_8))+(l9_9*l9_9);
float l9_11;
if (l9_10<=0.0)
{
l9_11=0.0;
...
float l9_12=l9_11*Port_Input1_N075;
int l9_13;
...
#endif
vec4 l9_14=sc_SampleTextureBiasOrLevel(Tweak_N1Dims.xy,Tweak_N1Layout,l9_13,(vec2(1.0)-((vec2(l9_7,l9_8)/vec2(l9_12))+Port_Input1_N083))+vec2(Port_Import_N059,Port_Import_N060),(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1);
vec4 l9_15;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_15=vec4(pow(l9_14.x,2.2),pow(l9_14.y,2.2),pow(l9_14.z,2.2),0.0);
}
#else
{
l9_15=l9_14*l9_14;
...
#endif
vec3 l9_16=vec3(Port_Import_N062)*l9_15.xyz;
vec3 l9_17;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_17=vec3(pow(l9_16.x,0.45454544),pow(l9_16.y,0.45454544),pow(l9_16.z,0.45454544));
}
#else
{
l9_17=sqrt(l9_16);
...
#endif
vec3 l9_18=mix(baseColor.xyz,min(baseColor.xyz+l9_17.xyz,vec3(1.0)).xyz,vec3(Port_Value2_N003));
...
{
l9_22=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_19.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_28;
#if (sc_BlendMode_Add)
{
l9_28=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_30;
...
{
l9_30=dot(l9_19.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_31;
#if (sc_BlendMode_Min)
{
l9_31=1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_32;
#if (sc_BlendMode_Max)
{
l9_32=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_32=1.0;
...
#endif
l9_20=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_19.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_21);
}
#else
{
vec4 l9_33;
...
#endif
l9_35=sc_SampleView(sc_ScreenTextureDims.xy,l9_39,sc_ScreenTextureLayout,l9_40,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_41;
...
{
vec4 l9_42=l9_35;
l9_42.x=l9_35.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_41=l9_42;
}
#else
{
...
#endif
vec3 l9_43=mix(l9_41.xyz,definedBlend(l9_41.xyz,l9_19.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_45=vec4(mix(vec3(1.0),l9_19.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_46;
...
{
l9_47=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_47=baseColor.w;
...
#endif
l9_46=vec4(l9_19.xyz*l9_47,l9_47);
}
#else
{
l9_46=l9_19;
...
{
l9_50=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_50=vec4(0.0);
...
vec4 l9_52=outputMotionVectorsIfNeeded(varPos,max(l9_51,vec4(0.0)));
vec4 l9_53=clamp(l9_52,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_54=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_54-0.0039215689)),min(1.0,l9_54+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_56=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_55).xy);
float l9_57=packValue(l9_56);
int l9_64=int(l9_53.w*255.0);
float l9_65=packValue(l9_64);
sc_writeFragData0(vec4(packValue(l9_56),packValue(l9_56),packValue(l9_56),packValue(l9_56)));
sc_writeFragData1(vec4(l9_57,packValue(l9_56),packValue(l9_56),packValue(l9_56)));
sc_writeFragData2(vec4(l9_65,packValue(l9_64),packValue(l9_64),packValue(l9_64)));
...
if (l9_73==0)
{
l9_76=texture2D(sc_OITAlpha0,l9_68);
l9_75=texture2D(sc_OITDepthLow0,l9_68);
l9_74=texture2D(sc_OITDepthHigh0,l9_68);
}
else
{
l9_76=vec4(0.0);
...
if (l9_73==1)
{
l9_79=texture2D(sc_OITAlpha1,l9_68);
l9_78=texture2D(sc_OITDepthLow1,l9_68);
l9_77=texture2D(sc_OITDepthHigh1,l9_68);
}
else
{
l9_79=l9_76;
...
if (any(notEqual(l9_77,vec4(0.0)))||any(notEqual(l9_78,vec4(0.0))))
{
int l9_80[8]=l9_69;
unpackValues(l9_77.w,l9_73,l9_80);
unpackValues(l9_77.z,l9_73,l9_80);
unpackValues(l9_77.y,l9_73,l9_80);
unpackValues(l9_77.x,l9_73,l9_80);
unpackValues(l9_78.w,l9_73,l9_80);
unpackValues(l9_78.z,l9_73,l9_80);
unpackValues(l9_78.y,l9_73,l9_80);
unpackValues(l9_78.x,l9_73,l9_80);
int l9_89[8]=l9_70;
unpackValues(l9_79.w,l9_73,l9_89);
unpackValues(l9_79.z,l9_73,l9_89);
unpackValues(l9_79.y,l9_73,l9_89);
unpackValues(l9_79.x,l9_73,l9_89);
}
l9_73++;
continue;
}
...
vec4 l9_94=texture2D(sc_OITFilteredDepthBoundsTexture,l9_68);
vec2 l9_95=l9_94.xy;
int l9_96;
#if (sc_SkinBonesCount>0)
{
l9_96=encodeDepth(((1.0-l9_94.x)*1000.0)+getDepthOrderingEpsilon(),l9_95);
}
#else
{
l9_96=0;
...
#endif
int l9_97=encodeDepth(viewSpaceDepth(),l9_95);
vec4 l9_98;
l9_98=l9_53*l9_53.w;
vec4 l9_99;
int l9_100=0;
...
if (l9_100<8)
{
int l9_101=l9_69[l9_100];
int l9_102=l9_97-l9_96;
bool l9_103=l9_101<l9_102;
bool l9_104;
if (l9_103)
{
l9_104=l9_69[l9_100]>0;
}
else
{
l9_104=l9_103;
...
if (l9_104)
{
vec3 l9_105=l9_98.xyz*(1.0-(float(l9_70[l9_100])/255.0));
l9_99=vec4(l9_105.x,l9_105.y,l9_105.z,l9_98.w);
}
else
{
l9_99=l9_98;
