...
//sampler sampler Tweak_N1SmpSC 2:21
...
//texture texture2D Tweak_N1 2:3:2:21
...
//texture texture2DArray Tweak_N1ArrSC 2:32:2:21
...
uniform sampler2DArray Tweak_N1ArrSC;
...
#if (Tweak_N1Layout==2)
{
l9_24=sc_SampleTextureBiasOrLevel(Tweak_N1Dims.xy,Tweak_N1Layout,Tweak_N1GetStereoViewIndex(),l9_23,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1ArrSC);
}
#else
{
...
#endif
vec3 l9_26=vec3(Port_Import_N062)*l9_25.xyz;
vec3 l9_27;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
vec3 l9_28=mix(baseColor.xyz,min(baseColor.xyz+l9_27.xyz,vec3(1.0)).xyz,vec3(Port_Value2_N003));
...
#endif
sc_writeFragData0(max(l9_30,vec4(0.0)));
return;
}
vec4 l9_32;
...
{
l9_34=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_29.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_40;
#if (sc_BlendMode_Add)
{
l9_40=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_41;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_41=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_42;
...
{
l9_42=dot(l9_29.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_43;
#if (sc_BlendMode_Min)
{
l9_43=1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_Max)
{
l9_44=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_44=1.0;
...
#endif
l9_32=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_29.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_33);
}
#else
{
vec4 l9_45;
...
{
l9_53=sc_SampleView(sc_ScreenTextureDims.xy,l9_51,sc_ScreenTextureLayout,l9_52,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_53=sc_SampleView(sc_ScreenTextureDims.xy,l9_51,sc_ScreenTextureLayout,l9_52,0.0,sc_ScreenTexture);
}
#endif
l9_47=l9_53;
}
...
{
vec4 l9_55=l9_47;
l9_55.x=l9_47.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_54=l9_55;
}
#else
{
...
#endif
vec3 l9_56=mix(l9_54.xyz,definedBlend(l9_54.xyz,l9_29.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_29.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_59;
...
{
l9_60=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_60=baseColor.w;
...
#endif
l9_59=vec4(l9_29.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_29;
