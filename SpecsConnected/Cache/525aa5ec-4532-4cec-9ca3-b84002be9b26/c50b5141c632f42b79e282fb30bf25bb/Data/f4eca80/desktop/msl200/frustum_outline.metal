...
//}
//ubo int UserUniforms 2:35:4640 {
...
float param_9=(*sc_set2.UserUniforms).alpha;
Output_N127=param_9;
float4 Value_N126=float4(0.0);
Value_N126=float4(Value_N1.xyz.x,Value_N1.xyz.y,Value_N1.xyz.z,Value_N126.w);
...
float4 l9_631=fast::max(param_11,float4(0.0));
float4 param_12=l9_631;
