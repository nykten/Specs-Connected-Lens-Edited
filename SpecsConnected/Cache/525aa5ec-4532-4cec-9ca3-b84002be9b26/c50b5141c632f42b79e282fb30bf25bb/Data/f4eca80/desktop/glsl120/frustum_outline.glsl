...
{
vec2 l9_20;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_20,l9_5);
float l9_21;
Node67_Bool_Parameter(l9_21,l9_5);
l9_19=mix(varPackedTex.xy,l9_20,vec2(l9_21));
}
#else
{
vec2 l9_22;
...
{
vec2 l9_23;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_23,l9_5);
float l9_24;
Node11_Bool_Parameter(l9_24,l9_5);
l9_22=mix(varPackedTex.xy,l9_23,vec2(l9_24));
}
#else
{
l9_22=varPackedTex.xy;
}
#endif
l9_19=l9_22;
}
...
#endif
vec4 l9_26=vec4(l9_16.x,l9_16.y,l9_16.z,vec4(0.0).w);
l9_26.w=alpha;
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_38;
...
#else
{
vec2 l9_46=sc_ScreenCoordsGlobalToView(l9_3);
int l9_47;
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_26.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_26.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_53;
