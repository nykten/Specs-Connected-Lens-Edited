...
{
vec2 l9_23;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_23,l9_8);
float l9_24;
Node67_Bool_Parameter(l9_24,l9_8);
l9_22=mix(l9_5,l9_23,vec2(l9_24));
}
#else
{
vec2 l9_25;
...
{
vec2 l9_26;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_26,l9_8);
float l9_27;
Node11_Bool_Parameter(l9_27,l9_8);
l9_25=mix(l9_5,l9_26,vec2(l9_27));
}
#else
{
l9_25=l9_5;
...
#endif
vec4 l9_28=vec4(l9_19.x,l9_19.y,l9_19.z,vec4(0.0).w);
l9_28.w=alpha;
...
{
l9_34=clamp(dot(l9_28.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_39;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_28.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_42;
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_28.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_28.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_58;
