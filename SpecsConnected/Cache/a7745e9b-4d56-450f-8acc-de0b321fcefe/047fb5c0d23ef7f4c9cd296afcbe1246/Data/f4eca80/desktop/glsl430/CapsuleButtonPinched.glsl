...
uniform vec4 Port_Value0_N067;
uniform float Port_Position1_N067;
uniform vec4 Port_Value1_N067;
uniform float Port_Position2_N067;
uniform vec4 Port_Value2_N067;
uniform float Port_Position3_N067;
uniform vec4 Port_Value3_N067;
uniform vec4 Port_Value4_N067;
...
vec4 l9_29;
if (l9_28<Port_Position1_N067)
{
l9_29=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_28/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_28<Port_Position2_N067)
{
l9_30=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_28-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_28<Port_Position3_N067)
{
l9_31=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_28-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_31=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_28-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_30=l9_31;
}
l9_29=l9_30;
...
vec3 l9_32=-l9_4;
vec4 l9_33=mix(l9_29,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_32,l9_11*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_34=l9_20+l9_33;
float l9_35=l9_34.w;
...
{
l9_41=clamp(dot(l9_34.xyz,vec3(l9_35)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_34.xyz,vec3(0.33333001)))*l9_35;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0))*l9_35;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_35;
}
#else
{
float l9_46;
#if (sc_BlendMode_Add)
{
l9_46=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*l9_35;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_34.xyz,vec3(0.33333001))*l9_35;
}
#else
{
float l9_49;
#if (sc_BlendMode_Min)
{
l9_49=1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_Max)
{
l9_50=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_50=1.0;
...
#endif
l9_38=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_34.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_39);
}
#else
{
vec4 l9_51;
...
#if (sc_FramebufferFetch)
{
vec4 l9_54=sc_readFragData0_Platform();
vec4 l9_55;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_56=l9_54;
l9_56.x=l9_54.x+_sc_framebufferFetchMarker;
l9_55=l9_56;
}
#else
{
...
{
l9_59=sc_SampleView(sc_ScreenTextureDims.xy,l9_57,sc_ScreenTextureLayout,l9_58,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_59=sc_SampleView(sc_ScreenTextureDims.xy,l9_57,sc_ScreenTextureLayout,l9_58,0.0,sc_ScreenTexture);
}
#endif
l9_53=l9_59;
}
...
{
vec4 l9_61=l9_53;
l9_61.x=l9_53.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_60=l9_61;
}
#else
{
...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_34.xyz).xyz,vec3(l9_35));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_34.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_34;
...
{
l9_69=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_69=vec4(0.0);
...
vec4 l9_71=outputMotionVectorsIfNeeded(varPos,max(l9_70,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_73-0.0039215689)),min(1.0,l9_73+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_74).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_75=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_74).xy);
float l9_76=packValue(l9_75);
int l9_83=int(l9_72.w*255.0);
float l9_84=packValue(l9_83);
sc_writeFragData0(vec4(packValue(l9_75),packValue(l9_75),packValue(l9_75),packValue(l9_75)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_87=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_87).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_92==0)
{
l9_95=texture(sc_OITAlpha0,l9_87);
l9_94=texture(sc_OITDepthLow0,l9_87);
l9_93=texture(sc_OITDepthHigh0,l9_87);
}
else
{
l9_95=vec4(0.0);
...
if (l9_92==1)
{
l9_98=texture(sc_OITAlpha1,l9_87);
l9_97=texture(sc_OITDepthLow1,l9_87);
l9_96=texture(sc_OITDepthHigh1,l9_87);
}
else
{
l9_98=l9_95;
...
vec4 l9_113=texture(sc_OITFilteredDepthBoundsTexture,l9_87);
