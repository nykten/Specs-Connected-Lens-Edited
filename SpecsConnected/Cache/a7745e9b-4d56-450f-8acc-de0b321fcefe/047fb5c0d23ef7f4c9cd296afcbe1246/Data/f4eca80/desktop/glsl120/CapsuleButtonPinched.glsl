...
float l9_17=clamp((vec4(Port_Import_N027)*l9_16).x,0.0,1.0);
vec4 l9_18;
if (l9_17<Port_Position1_N067)
{
l9_18=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_17/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_19;
if (l9_17<Port_Position2_N067)
{
l9_19=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_17-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_17<Port_Position3_N067)
{
l9_20=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_17-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_20=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_17-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_19=l9_20;
}
l9_18=l9_19;
}
vec4 l9_21=mix(l9_18,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_22=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_21;
float l9_23=l9_22.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_23<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_23<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_27=clamp(dot(l9_22.xyz,vec3(l9_23)),0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_29=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*l9_23;
}
#else
{
float l9_30;
...
{
l9_30=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*l9_23;
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_23;
}
#else
{
float l9_32;
#if (sc_BlendMode_Add)
{
l9_32=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_33=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_23;
}
#else
{
float l9_34;
...
{
l9_34=dot(l9_22.xyz,vec3(0.33333001))*l9_23;
}
#else
{
float l9_35;
#if (sc_BlendMode_Min)
{
l9_35=1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_Max)
{
l9_36=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_36=1.0;
...
#endif
l9_24=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_22.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_25);
}
#else
{
vec4 l9_37;
...
#if (sc_FramebufferFetch)
{
vec4 l9_40=sc_readFragData0_Platform();
vec4 l9_41;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_42=l9_40;
l9_42.x=l9_40.x+_sc_framebufferFetchMarker;
l9_41=l9_42;
}
#else
{
...
#else
{
vec2 l9_43=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_44;
...
#endif
l9_39=sc_SampleView(sc_ScreenTextureDims.xy,l9_43,sc_ScreenTextureLayout,l9_44,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_45;
...
{
vec4 l9_46=l9_39;
l9_46.x=l9_39.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_45=l9_46;
}
#else
{
...
#endif
vec3 l9_47=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_22.xyz).xyz,vec3(l9_23));
vec4 l9_48=vec4(l9_47.x,l9_47.y,l9_47.z,vec4(0.0).w);
l9_48.w=1.0;
l9_38=l9_48;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_49=vec4(mix(vec3(1.0),l9_22.xyz,vec3(l9_23)),l9_23);
}
#else
{
vec4 l9_50;
...
#endif
l9_50=vec4(l9_22.xyz*l9_51,l9_51);
}
#else
{
l9_50=l9_22;
...
{
l9_54=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_54=vec4(0.0);
...
vec4 l9_56=outputMotionVectorsIfNeeded(varPos,max(l9_55,vec4(0.0)));
vec4 l9_57=clamp(l9_56,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_58=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_58-0.0039215689)),min(1.0,l9_58+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_59).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_60=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_59).xy);
float l9_61=packValue(l9_60);
int l9_68=int(l9_57.w*255.0);
float l9_69=packValue(l9_68);
sc_writeFragData0(vec4(packValue(l9_60),packValue(l9_60),packValue(l9_60),packValue(l9_60)));
sc_writeFragData1(vec4(l9_61,packValue(l9_60),packValue(l9_60),packValue(l9_60)));
sc_writeFragData2(vec4(l9_69,packValue(l9_68),packValue(l9_68),packValue(l9_68)));
...
if (l9_77==0)
{
l9_80=texture2D(sc_OITAlpha0,l9_72);
l9_79=texture2D(sc_OITDepthLow0,l9_72);
l9_78=texture2D(sc_OITDepthHigh0,l9_72);
}
else
{
l9_80=vec4(0.0);
...
if (l9_77==1)
{
l9_83=texture2D(sc_OITAlpha1,l9_72);
l9_82=texture2D(sc_OITDepthLow1,l9_72);
l9_81=texture2D(sc_OITDepthHigh1,l9_72);
}
else
{
l9_83=l9_80;
...
if (any(notEqual(l9_81,vec4(0.0)))||any(notEqual(l9_82,vec4(0.0))))
{
int l9_84[8]=l9_73;
unpackValues(l9_81.w,l9_77,l9_84);
unpackValues(l9_81.z,l9_77,l9_84);
unpackValues(l9_81.y,l9_77,l9_84);
unpackValues(l9_81.x,l9_77,l9_84);
unpackValues(l9_82.w,l9_77,l9_84);
unpackValues(l9_82.z,l9_77,l9_84);
unpackValues(l9_82.y,l9_77,l9_84);
unpackValues(l9_82.x,l9_77,l9_84);
int l9_93[8]=l9_74;
unpackValues(l9_83.w,l9_77,l9_93);
unpackValues(l9_83.z,l9_77,l9_93);
unpackValues(l9_83.y,l9_77,l9_93);
unpackValues(l9_83.x,l9_77,l9_93);
}
l9_77++;
continue;
}
...
vec4 l9_98=texture2D(sc_OITFilteredDepthBoundsTexture,l9_72);
vec2 l9_99=l9_98.xy;
int l9_100;
#if (sc_SkinBonesCount>0)
{
l9_100=encodeDepth(((1.0-l9_98.x)*1000.0)+getDepthOrderingEpsilon(),l9_99);
}
#else
{
l9_100=0;
...
#endif
int l9_101=encodeDepth(viewSpaceDepth(),l9_99);
vec4 l9_102;
l9_102=l9_57*l9_57.w;
vec4 l9_103;
int l9_104=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_104<8)
{
int l9_105=l9_73[l9_104];
int l9_106=l9_101-l9_100;
bool l9_107=l9_105<l9_106;
bool l9_108;
if (l9_107)
{
l9_108=l9_73[l9_104]>0;
}
else
{
l9_108=l9_107;
...
if (l9_108)
{
vec3 l9_109=l9_102.xyz*(1.0-(float(l9_74[l9_104])/255.0));
l9_103=vec4(l9_109.x,l9_109.y,l9_109.z,l9_102.w);
}
else
{
l9_103=l9_102;
