...
//sampler sampler additional_setting_btn_icon_texSmpSC 2:22
//sampler sampler additional_settings_btn_refl_texSmpSC 2:23
//sampler sampler intensityTextureSmpSC 2:24
//sampler sampler sc_OITCommonSampler 2:27
//sampler sampler sc_ScreenTextureSmpSC 2:29
//sampler sampler z_hitIdAndBarycentricSmp 2:32
//sampler sampler z_rayDirectionsSmpSC 2:33
//texture texture2D additional_setting_btn_icon_tex 2:3:2:22
//texture texture2D additional_settings_btn_refl_tex 2:4:2:23
//texture texture2D intensityTexture 2:5:2:24
//texture texture2D sc_OITAlpha0 2:8:2:27
//texture texture2D sc_OITAlpha1 2:9:2:27
//texture texture2D sc_OITDepthHigh0 2:10:2:27
//texture texture2D sc_OITDepthHigh1 2:11:2:27
//texture texture2D sc_OITDepthLow0 2:12:2:27
//texture texture2D sc_OITDepthLow1 2:13:2:27
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:14:2:27
//texture texture2D sc_OITFrontDepthTexture 2:15:2:27
//texture texture2D sc_ScreenTexture 2:17:2:29
//texture utexture2D z_hitIdAndBarycentric 2:20:2:32
//texture texture2D z_rayDirections 2:21:2:33
//texture texture2DArray additional_setting_btn_icon_texArrSC 2:34:2:22
//texture texture2DArray additional_settings_btn_refl_texArrSC 2:35:2:23
//texture texture2DArray intensityTextureArrSC 2:36:2:24
//texture texture2DArray sc_ScreenTextureArrSC 2:39:2:29
...
uniform vec4 additional_setting_btn_icon_texDims;
...
uniform vec4 additional_setting_btn_icon_texSize;
uniform vec4 additional_setting_btn_icon_texView;
uniform mat3 additional_setting_btn_icon_texTransform;
uniform vec4 additional_setting_btn_icon_texUvMinMax;
uniform vec4 additional_setting_btn_icon_texBorderColor;
uniform float alpha;
...
uniform float Port_Position1_N021;
uniform vec4 Port_Input1_N034;
uniform vec3 Port_Normal_N031;
uniform float Port_Exponent_N031;
uniform float Port_Intensity_N031;
uniform float Port_Position2_N021;
uniform vec2 Port_Scale_N002;
uniform vec2 Port_Center_N002;
uniform float Port_Position1_N136;
uniform float Port_Position2_N136;
uniform float Port_Value2_N003;
...
#endif
#ifndef additional_setting_btn_icon_texHasSwappedViews
#define additional_setting_btn_icon_texHasSwappedViews 0
#elif additional_setting_btn_icon_texHasSwappedViews==1
#undef additional_setting_btn_icon_texHasSwappedViews
#define additional_setting_btn_icon_texHasSwappedViews 1
#endif
#ifndef additional_setting_btn_icon_texLayout
#define additional_setting_btn_icon_texLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex
#define SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex 0
#elif SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex==1
#undef SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex
#define SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex
#define SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex
#define SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex
#define SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex 0
#elif SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex==1
#undef SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex
#define SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex
#define SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex 0
#elif SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex==1
#undef SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex
#define SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2D additional_setting_btn_icon_tex;
uniform sampler2DArray additional_setting_btn_icon_texArrSC;
...
int additional_setting_btn_icon_texGetStereoViewIndex()
{
int l9_0;
#if (additional_setting_btn_icon_texHasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
vec3 l9_12=normalize(varNormal);
...
mat3 l9_13=mat3(l9_1,l9_2,l9_3);
...
{
l9_19=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_18.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_texArrSC);
}
#else
{
l9_19=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_18.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
}
#endif
vec4 l9_20=vec4(Port_Import_N006)*l9_19;
vec3 l9_21=l9_13*Port_Import_N068;
float l9_22=dot(l9_21,l9_21);
float l9_23;
if (l9_22>0.0)
{
l9_23=1.0/sqrt(l9_22);
}
else
{
l9_23=0.0;
}
vec3 l9_24=l9_21*l9_23;
vec3 l9_25=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_24,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_26;
#if (additional_settings_btn_refl_texLayout==2)
{
l9_26=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_25.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_texArrSC);
}
#else
{
l9_26=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_25.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
...
#endif
vec4 l9_27=vec4(Port_Import_N062)*l9_26;
vec2 l9_28=l9_4*Port_Input1_N009;
float l9_29=clamp(length(l9_28+Port_Input2_N009),0.0,1.0);
vec4 l9_30;
if (l9_29<Port_Position1_N007)
{
l9_30=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_29/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_29<Port_Position2_N007)
{
l9_31=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_29-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_31=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_29-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_30=l9_31;
}
bool l9_32=PreviewEnabled==1;
bool l9_33;
if (l9_32)
{
l9_33=!l9_0;
...
vec3 l9_37=-l9_6;
vec4 l9_38=mix(l9_30,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_37,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_39=clamp(status,0.0,1.0);
vec4 l9_40;
if (l9_39<Port_Position1_N021)
{
l9_40=mix(l9_30,l9_38,vec4(clamp(l9_39/Port_Position1_N021,0.0,1.0)));
}
else
{
vec4 l9_41;
if (l9_39<Port_Position2_N021)
{
l9_41=mix(l9_38,l9_30,vec4(clamp((l9_39-Port_Position1_N021)/(Port_Position2_N021-Port_Position1_N021),0.0,1.0)));
}
else
{
l9_41=mix(l9_30,l9_38,vec4(clamp((l9_39-Port_Position2_N021)/(1.0-Port_Position2_N021),0.0,1.0)));
}
l9_40=l9_41;
}
bool l9_42;
...
vec4 l9_46=mix(l9_20,l9_27,vec4(status))+l9_40;
vec2 l9_47=l9_5-Port_Center_N002;
vec2 l9_48=(l9_47*Port_Scale_N002)+Port_Center_N002;
vec4 l9_49;
#if (additional_setting_btn_icon_texLayout==2)
{
l9_49=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_texArrSC);
}
#else
{
l9_49=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_tex);
}
#endif
vec4 l9_50;
#if (additional_setting_btn_icon_texLayout==2)
{
l9_50=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_texArrSC);
}
#else
{
l9_50=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_tex);
...
#endif
vec4 l9_51;
if (l9_39<Port_Position1_N136)
{
l9_51=mix(l9_49,l9_49,vec4(clamp(l9_39/Port_Position1_N136,0.0,1.0)));
}
else
{
vec4 l9_52;
if (l9_39<Port_Position2_N136)
{
l9_52=mix(l9_49,l9_50,vec4(clamp((l9_39-Port_Position1_N136)/(Port_Position2_N136-Port_Position1_N136),0.0,1.0)));
}
else
{
l9_52=mix(l9_50,l9_50,vec4(clamp((l9_39-Port_Position2_N136)/(1.0-Port_Position2_N136),0.0,1.0)));
}
l9_51=l9_52;
}
bool l9_53;
...
vec4 l9_57=mix(l9_46,vec4(l9_51.xyz,0.0),vec4(l9_51.w));
vec4 l9_58=vec4(l9_57.x,l9_57.y,l9_57.z,vec4(0.0).w);
l9_58.w=alpha;
...
{
if (alpha<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_59,vec4(0.0)));
return;
}
vec4 l9_61;
...
{
l9_64=clamp(dot(l9_58.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_65;
...
{
l9_66=(1.0-dot(l9_58.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_67;
...
{
l9_67=(1.0-clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_68;
...
{
l9_68=clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_69;
#if (sc_BlendMode_Add)
{
l9_69=clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_70=clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_71;
...
{
l9_71=dot(l9_58.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_72;
#if (sc_BlendMode_Min)
{
l9_72=1.0-clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_Max)
{
l9_73=clamp(dot(l9_58.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_73=1.0;
...
#endif
l9_61=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_58.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_62);
}
#else
{
vec4 l9_74;
...
#if (sc_FramebufferFetch)
{
vec4 l9_77=sc_readFragData0_Platform();
vec4 l9_78;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_79=l9_77;
l9_79.x=l9_77.x+_sc_framebufferFetchMarker;
l9_78=l9_79;
}
#else
{
...
#else
{
vec2 l9_80=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_81;
...
{
l9_82=sc_SampleView(sc_ScreenTextureDims.xy,l9_80,sc_ScreenTextureLayout,l9_81,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_82=sc_SampleView(sc_ScreenTextureDims.xy,l9_80,sc_ScreenTextureLayout,l9_81,0.0,sc_ScreenTexture);
}
#endif
l9_76=l9_82;
}
...
{
vec4 l9_84=l9_76;
l9_84.x=l9_76.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_83=l9_84;
}
#else
{
...
#endif
vec3 l9_85=mix(l9_83.xyz,definedBlend(l9_83.xyz,l9_58.xyz).xyz,vec3(alpha));
vec4 l9_86=vec4(l9_85.x,l9_85.y,l9_85.z,vec4(0.0).w);
l9_86.w=1.0;
l9_75=l9_86;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_87=vec4(mix(vec3(1.0),l9_58.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_88;
...
#endif
l9_88=vec4(l9_58.xyz*l9_89,l9_89);
}
#else
{
l9_88=l9_58;
...
{
l9_92=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_92=vec4(0.0);
...
vec4 l9_94=outputMotionVectorsIfNeeded(varPos,max(l9_93,vec4(0.0)));
vec4 l9_95=clamp(l9_94,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_96=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_96-0.0039215689)),min(1.0,l9_96+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_97=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_98=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_97).xy);
float l9_99=packValue(l9_98);
int l9_106=int(l9_95.w*255.0);
float l9_107=packValue(l9_106);
sc_writeFragData0(vec4(packValue(l9_98),packValue(l9_98),packValue(l9_98),packValue(l9_98)));
sc_writeFragData1(vec4(l9_99,packValue(l9_98),packValue(l9_98),packValue(l9_98)));
sc_writeFragData2(vec4(l9_107,packValue(l9_106),packValue(l9_106),packValue(l9_106)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_110=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_110).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_115==0)
{
l9_118=texture(sc_OITAlpha0,l9_110);
l9_117=texture(sc_OITDepthLow0,l9_110);
l9_116=texture(sc_OITDepthHigh0,l9_110);
}
else
{
l9_118=vec4(0.0);
...
if (l9_115==1)
{
l9_121=texture(sc_OITAlpha1,l9_110);
l9_120=texture(sc_OITDepthLow1,l9_110);
l9_119=texture(sc_OITDepthHigh1,l9_110);
}
else
{
l9_121=l9_118;
...
if (any(notEqual(l9_119,vec4(0.0)))||any(notEqual(l9_120,vec4(0.0))))
{
int l9_122[8]=l9_111;
unpackValues(l9_119.w,l9_115,l9_122);
unpackValues(l9_119.z,l9_115,l9_122);
unpackValues(l9_119.y,l9_115,l9_122);
unpackValues(l9_119.x,l9_115,l9_122);
unpackValues(l9_120.w,l9_115,l9_122);
unpackValues(l9_120.z,l9_115,l9_122);
unpackValues(l9_120.y,l9_115,l9_122);
unpackValues(l9_120.x,l9_115,l9_122);
int l9_131[8]=l9_112;
unpackValues(l9_121.w,l9_115,l9_131);
unpackValues(l9_121.z,l9_115,l9_131);
unpackValues(l9_121.y,l9_115,l9_131);
unpackValues(l9_121.x,l9_115,l9_131);
}
l9_115++;
continue;
}
...
vec4 l9_136=texture(sc_OITFilteredDepthBoundsTexture,l9_110);
vec2 l9_137=l9_136.xy;
int l9_138;
#if (sc_SkinBonesCount>0)
{
l9_138=encodeDepth(((1.0-l9_136.x)*1000.0)+getDepthOrderingEpsilon(),l9_137);
}
#else
{
l9_138=0;
...
#endif
int l9_139=encodeDepth(viewSpaceDepth(),l9_137);
vec4 l9_140;
l9_140=l9_95*l9_95.w;
vec4 l9_141;
int l9_142=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_142<8)
{
int l9_143=l9_111[l9_142];
int l9_144=l9_139-l9_138;
bool l9_145=l9_143<l9_144;
bool l9_146;
if (l9_145)
{
l9_146=l9_111[l9_142]>0;
}
else
{
l9_146=l9_145;
...
if (l9_146)
{
vec3 l9_147=l9_140.xyz*(1.0-(float(l9_112[l9_142])/255.0));
l9_141=vec4(l9_147.x,l9_147.y,l9_147.z,l9_140.w);
}
else
{
l9_141=l9_140;
