...
//sampler sampler additional_setting_btn_icon_texSmpSC 2:17
//sampler sampler additional_settings_btn_refl_texSmpSC 2:18
...
//texture texture2D additional_setting_btn_icon_tex 2:0:2:17
//texture texture2D additional_settings_btn_refl_tex 2:1:2:18
...
mat3 l9_3=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2);
vec3 l9_4=l9_3*Port_Import_N049;
...
vec4 l9_11=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_8*l9_10,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073)).xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
float l9_12=clamp(length((varPackedTex.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_13;
if (l9_12<Port_Position1_N007)
{
l9_13=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_12/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_12<Port_Position2_N007)
{
l9_14=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_12-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_14=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_12-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_13=l9_14;
}
bool l9_15=PreviewEnabled==1;
bool l9_16;
if (l9_15)
{
l9_16=!l9_0;
...
{
l9_18=PreviewVertexColor;
l9_17=l9_0;
}
vec4 l9_20=mix(l9_13,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_21=clamp(status,0.0,1.0);
vec4 l9_22;
if (l9_21<Port_Position1_N021)
{
l9_22=mix(l9_13,l9_20,vec4(clamp(l9_21/Port_Position1_N021,0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_21<Port_Position2_N021)
{
l9_23=mix(l9_20,l9_13,vec4(clamp((l9_21-Port_Position1_N021)/(Port_Position2_N021-Port_Position1_N021),0.0,1.0)));
}
else
{
l9_23=mix(l9_13,l9_20,vec4(clamp((l9_21-Port_Position2_N021)/(1.0-Port_Position2_N021),0.0,1.0)));
}
l9_22=l9_23;
}
bool l9_24;
...
vec4 l9_28=mix(vec4(Port_Import_N006)*l9_7,vec4(Port_Import_N062)*l9_11,vec4(status))+l9_22;
vec2 l9_29=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_30=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_29,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_tex);
vec4 l9_31=sc_SampleTextureBiasOrLevel(additional_setting_btn_icon_texDims.xy,additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex(),l9_29,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex),(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texBorderColor,0.0,additional_setting_btn_icon_tex);
vec4 l9_32;
if (l9_21<Port_Position1_N136)
{
l9_32=mix(l9_30,l9_30,vec4(clamp(l9_21/Port_Position1_N136,0.0,1.0)));
}
else
{
vec4 l9_33;
if (l9_21<Port_Position2_N136)
{
l9_33=mix(l9_30,l9_31,vec4(clamp((l9_21-Port_Position1_N136)/(Port_Position2_N136-Port_Position1_N136),0.0,1.0)));
}
else
{
l9_33=mix(l9_31,l9_31,vec4(clamp((l9_21-Port_Position2_N136)/(1.0-Port_Position2_N136),0.0,1.0)));
}
l9_32=l9_33;
}
bool l9_34;
...
vec4 l9_38=mix(l9_28,vec4(l9_32.xyz,0.0),vec4(l9_32.w));
...
{
l9_43=clamp(dot(l9_39.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_45=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_46;
...
{
l9_46=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_48;
#if (sc_BlendMode_Add)
{
l9_48=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_49;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_50;
...
{
l9_50=dot(l9_39.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_51;
#if (sc_BlendMode_Min)
{
l9_51=1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_Max)
{
l9_52=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_52=1.0;
...
#endif
l9_40=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_39.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_41);
}
#else
{
vec4 l9_53;
...
#if (sc_FramebufferFetch)
{
vec4 l9_56=sc_readFragData0_Platform();
vec4 l9_57;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_58=l9_56;
l9_58.x=l9_56.x+_sc_framebufferFetchMarker;
l9_57=l9_58;
}
#else
{
...
#else
{
vec2 l9_59=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_60;
...
#endif
l9_55=sc_SampleView(sc_ScreenTextureDims.xy,l9_59,sc_ScreenTextureLayout,l9_60,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_61;
...
{
vec4 l9_62=l9_55;
l9_62.x=l9_55.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_61=l9_62;
}
#else
{
...
#endif
vec3 l9_63=mix(l9_61.xyz,definedBlend(l9_61.xyz,l9_39.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_39.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_66;
...
#endif
l9_66=vec4(l9_39.xyz*l9_67,l9_67);
}
#else
{
l9_66=l9_39;
...
#endif
int l9_76=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_75).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_88).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_93==0)
{
l9_96=texture2D(sc_OITAlpha0,l9_88);
l9_95=texture2D(sc_OITDepthLow0,l9_88);
l9_94=texture2D(sc_OITDepthHigh0,l9_88);
}
else
{
l9_96=vec4(0.0);
...
if (l9_93==1)
{
l9_99=texture2D(sc_OITAlpha1,l9_88);
l9_98=texture2D(sc_OITDepthLow1,l9_88);
l9_97=texture2D(sc_OITDepthHigh1,l9_88);
}
else
{
l9_99=l9_96;
...
vec4 l9_114=texture2D(sc_OITFilteredDepthBoundsTexture,l9_88);
