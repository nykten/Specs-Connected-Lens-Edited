...
uniform float innerColorMultiplier;
uniform float outerColorMultiplier;
...
void Node70_Conditional(float Input0,vec4 Input1,vec4 Input2,out vec4 Output,ssGlobals Globals)
{
Input0=float(Globals.Surface_UVCoord0.x<Level);
if ((Input0*1.0)!=0.0)
{
Input1=mix(innerColor1,innerColor2,vec4(Globals.Surface_UVCoord0.y));
Output=Input1;
}
else
{
Input2=mix(outerColor1,outerColor2,vec4(Globals.Surface_UVCoord0.y));
Output=Input2;
}
}
...
{
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,Globals);
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,Globals);
vec4 l9_0=param_3*param_8;
...
{
vec4 param_13;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_13,Globals);
vec4 param_18;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_18,Globals);
Default=(param_13*param_18).xyz;
Result=Default;
}
#endif
}
...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_9);
vec4 l9_13=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_9);
vec4 l9_14=param_8;
float l9_15;
...
float l9_171;
if ((float(varPackedTex.x<Level)*1.0)!=0.0)
{
l9_171=innerColorMultiplier;
}
else
{
l9_171=outerColorMultiplier;
}
vec4 l9_172=l9_170*vec4(l9_171+1.0);
float l9_173=l9_170.w;
vec4 l9_174=vec4(l9_172.x,l9_172.y,l9_172.z,vec4(0.0).w);
l9_174.w=l9_173;
vec4 l9_175;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_177=clamp(l9_173*2.0,0.0,1.0);
}
#else
{
float l9_178;
...
{
l9_178=clamp(dot(l9_174.xyz,vec3(l9_173)),0.0,1.0);
}
#else
{
float l9_179;
...
#if (sc_BlendMode_Multiply)
{
l9_180=(1.0-dot(l9_174.xyz,vec3(0.33333001)))*l9_173;
}
#else
{
float l9_181;
...
{
l9_181=(1.0-clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0))*l9_173;
}
#else
{
float l9_182;
#if (sc_BlendMode_ColoredGlass)
{
l9_182=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0)*l9_173;
}
#else
{
float l9_183;
#if (sc_BlendMode_Add)
{
l9_183=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_184;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_184=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0)*l9_173;
}
#else
{
float l9_185;
...
{
l9_185=dot(l9_174.xyz,vec3(0.33333001))*l9_173;
}
#else
{
float l9_186;
#if (sc_BlendMode_Min)
{
l9_186=1.0-clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_187;
#if (sc_BlendMode_Max)
{
l9_187=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_187=1.0;
...
#endif
l9_175=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_174.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_176);
}
#else
{
vec4 l9_188;
...
{
vec3 l9_190=sc_GetFramebufferColor().xyz;
vec3 l9_191=mix(l9_190,definedBlend(l9_190,l9_174.xyz).xyz,vec3(l9_173));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_193=vec4(mix(vec3(1.0),l9_174.xyz,vec3(l9_173)),l9_173);
}
#else
{
vec4 l9_194;
...
#endif
l9_194=vec4(l9_174.xyz*l9_195,l9_195);
}
#else
{
l9_194=l9_174;
...
{
l9_198=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_198=vec4(0.0);
...
vec4 l9_200=outputMotionVectorsIfNeeded(varPos,max(l9_199,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_202-0.0039215689)),min(1.0,l9_202+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_203=sc_ScreenCoordsGlobalToView(l9_4);
...
#endif
int l9_204=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_203).xy);
float l9_205=packValue(l9_204);
int l9_212=int(l9_201.w*255.0);
float l9_213=packValue(l9_212);
sc_writeFragData0(vec4(packValue(l9_204),packValue(l9_204),packValue(l9_204),packValue(l9_204)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_216=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_216).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_221==0)
{
l9_224=texture2D(sc_OITAlpha0,l9_216);
l9_223=texture2D(sc_OITDepthLow0,l9_216);
l9_222=texture2D(sc_OITDepthHigh0,l9_216);
}
else
{
l9_224=vec4(0.0);
...
if (l9_221==1)
{
l9_227=texture2D(sc_OITAlpha1,l9_216);
l9_226=texture2D(sc_OITDepthLow1,l9_216);
l9_225=texture2D(sc_OITDepthHigh1,l9_216);
}
else
{
l9_227=l9_224;
...
vec4 l9_242=texture2D(sc_OITFilteredDepthBoundsTexture,l9_216);
