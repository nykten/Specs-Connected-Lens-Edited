...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_8);
vec4 l9_11=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_8);
vec4 l9_12=param_8;
float l9_13;
...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_20);
vec4 l9_24=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_20);
vec4 l9_25=param_8;
float l9_26;
#if (ENABLE_OPACITY_TEX)
{
...
float l9_67;
if ((float(l9_8.x<Level)*1.0)!=0.0)
{
l9_67=innerColorMultiplier;
}
else
{
l9_67=outerColorMultiplier;
}
vec4 l9_68=l9_66*vec4(l9_67+1.0);
float l9_69=l9_66.w;
...
#endif
sc_writeFragData0(max(l9_71,vec4(0.0)));
return;
}
vec4 l9_73;
#if (sc_ProjectiveShadowsCaster)
...
{
vec3 l9_88=sc_GetFramebufferColor().xyz;
vec3 l9_89=mix(l9_88,definedBlend(l9_88,l9_70.xyz).xyz,vec3(l9_69));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_70.xyz,vec3(l9_69)),l9_69);
}
#else
{
vec4 l9_92;
...
#endif
l9_92=vec4(l9_70.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_70;
