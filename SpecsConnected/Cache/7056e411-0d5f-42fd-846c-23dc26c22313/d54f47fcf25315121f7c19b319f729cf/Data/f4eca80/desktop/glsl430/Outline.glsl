...
l9_35=varTangent.xyz;
l9_34=l9_32;
l9_33=(l9_30*vec3(Tweak_N19))+l9_31;
}
varPos=l9_33;
...
{
l9_5=clamp(dot(l9_0.xyz,vec3(l9_1)),0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_7=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_1;
}
#else
{
float l9_8;
...
{
l9_8=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_1;
}
#else
{
float l9_9;
...
{
l9_9=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_10;
#if (sc_BlendMode_Add)
{
l9_10=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_11;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_11=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_12;
...
{
l9_12=dot(l9_0.xyz,vec3(0.33333001))*l9_1;
}
#else
{
float l9_13;
#if (sc_BlendMode_Min)
{
l9_13=1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
#if (sc_BlendMode_Max)
{
l9_14=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_14=1.0;
...
#endif
l9_2=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_0.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_3);
}
#else
{
vec4 l9_15;
...
#if (sc_FramebufferFetch)
{
vec4 l9_18=sc_readFragData0_Platform();
vec4 l9_19;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_20=l9_18;
l9_20.x=l9_18.x+_sc_framebufferFetchMarker;
l9_19=l9_20;
}
#else
{
...
#else
{
vec2 l9_21=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_22;
...
{
l9_23=sc_SampleView(sc_ScreenTextureDims.xy,l9_21,sc_ScreenTextureLayout,l9_22,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_23=sc_SampleView(sc_ScreenTextureDims.xy,l9_21,sc_ScreenTextureLayout,l9_22,0.0,sc_ScreenTexture);
}
#endif
l9_17=l9_23;
}
...
{
vec4 l9_25=l9_17;
l9_25.x=l9_17.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_24=l9_25;
}
#else
{
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_0.xyz).xyz,vec3(l9_1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_1)),l9_1);
}
#else
{
vec4 l9_29;
...
#endif
l9_29=vec4(l9_0.xyz*l9_30,l9_30);
}
#else
{
l9_29=l9_0;
...
{
l9_33=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_33=vec4(0.0);
...
vec4 l9_35=outputMotionVectorsIfNeeded(varPos,max(l9_34,vec4(0.0)));
vec4 l9_36=clamp(l9_35,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_37=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_37-0.0039215689)),min(1.0,l9_37+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_38=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_38).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_39=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_38).xy);
float l9_40=packValue(l9_39);
int l9_47=int(l9_36.w*255.0);
float l9_48=packValue(l9_47);
sc_writeFragData0(vec4(packValue(l9_39),packValue(l9_39),packValue(l9_39),packValue(l9_39)));
sc_writeFragData1(vec4(l9_40,packValue(l9_39),packValue(l9_39),packValue(l9_39)));
sc_writeFragData2(vec4(l9_48,packValue(l9_47),packValue(l9_47),packValue(l9_47)));
...
if (l9_56==0)
{
l9_59=texture(sc_OITAlpha0,l9_51);
l9_58=texture(sc_OITDepthLow0,l9_51);
l9_57=texture(sc_OITDepthHigh0,l9_51);
}
else
{
l9_59=vec4(0.0);
...
if (l9_56==1)
{
l9_62=texture(sc_OITAlpha1,l9_51);
l9_61=texture(sc_OITDepthLow1,l9_51);
l9_60=texture(sc_OITDepthHigh1,l9_51);
}
else
{
l9_62=l9_59;
...
if (any(notEqual(l9_60,vec4(0.0)))||any(notEqual(l9_61,vec4(0.0))))
{
int l9_63[8]=l9_52;
unpackValues(l9_60.w,l9_56,l9_63);
unpackValues(l9_60.z,l9_56,l9_63);
unpackValues(l9_60.y,l9_56,l9_63);
unpackValues(l9_60.x,l9_56,l9_63);
unpackValues(l9_61.w,l9_56,l9_63);
unpackValues(l9_61.z,l9_56,l9_63);
unpackValues(l9_61.y,l9_56,l9_63);
unpackValues(l9_61.x,l9_56,l9_63);
int l9_72[8]=l9_53;
unpackValues(l9_62.w,l9_56,l9_72);
unpackValues(l9_62.z,l9_56,l9_72);
unpackValues(l9_62.y,l9_56,l9_72);
unpackValues(l9_62.x,l9_56,l9_72);
}
l9_56++;
continue;
}
...
vec4 l9_77=texture(sc_OITFilteredDepthBoundsTexture,l9_51);
vec2 l9_78=l9_77.xy;
int l9_79;
#if (sc_SkinBonesCount>0)
{
l9_79=encodeDepth(((1.0-l9_77.x)*1000.0)+getDepthOrderingEpsilon(),l9_78);
}
#else
{
l9_79=0;
...
#endif
int l9_80=encodeDepth(viewSpaceDepth(),l9_78);
vec4 l9_81;
l9_81=l9_36*l9_36.w;
vec4 l9_82;
int l9_83=0;
...
if (l9_83<8)
{
int l9_84=l9_52[l9_83];
int l9_85=l9_80-l9_79;
bool l9_86=l9_84<l9_85;
bool l9_87;
if (l9_86)
{
l9_87=l9_52[l9_83]>0;
...
if (l9_87)
{
vec3 l9_88=l9_81.xyz*(1.0-(float(l9_53[l9_83])/255.0));
l9_82=vec4(l9_88.x,l9_88.y,l9_88.z,l9_81.w);
}
else
{
l9_82=l9_81;
