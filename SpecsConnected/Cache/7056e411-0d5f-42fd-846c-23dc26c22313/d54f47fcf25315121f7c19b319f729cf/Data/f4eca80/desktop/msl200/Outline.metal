...
//}
//ubo int UserUniforms 2:24:4032 {
...
//float Tweak_N19 3988
//float4 Tweak_N6 4000
//float alpha 4016
//}
...
float param_1=(*sc_set2.UserUniforms).Tweak_N19;
Output_N19=param_1;
float3 Output_N0=float3(0.0);
Output_N0=Normal_N5*float3(Output_N19);
float3 Position_N2=float3(0.0);
Position_N2=Globals.SurfacePosition_WorldSpace;
float3 Output_N3=float3(0.0);
Output_N3=Output_N0+Position_N2;
WorldPosition=Output_N3;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
...
float l9_6=l9_5;
float l9_7=l9_6;
float l9_8=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_7;
float3 l9_9=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_3.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
...
{
float4 l9_11=param_3;
float4 l9_12=float4(0.0);
float4 l9_13=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_14=out.FragColor0;
float4 l9_15=l9_14;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_15.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_16=l9_15;
l9_13=l9_16;
}
...
float2 l9_18=(l9_17.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_19=l9_18;
...
float2 l9_44=l9_40;
int l9_45=sc_ScreenTextureLayout_tmp;
int l9_46=l9_41;
float l9_47=l9_42;
float2 l9_48=l9_44;
int l9_49=l9_45;
...
if (l9_49==0)
{
l9_51=float3(l9_48,0.0);
}
else
{
if (l9_49==1)
{
l9_51=float3(l9_48.x,(l9_48.y*0.5)+(0.5-(float(l9_50)*0.5)),0.0);
}
else
{
l9_51=float3(l9_48,float(l9_50));
}
}
float3 l9_52=l9_51;
float3 l9_53=l9_52;
float2 l9_54=l9_53.xy;
float l9_55=l9_47;
float4 l9_56=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_54,bias(l9_55));
float4 l9_57=l9_56;
l9_43=l9_57;
float4 l9_58=l9_43;
float4 l9_59=l9_58;
...
float4 l9_61=l9_13;
float4 l9_62=l9_61;
float3 l9_63=l9_62.xyz;
float3 l9_64=l9_63;
float3 l9_65=l9_11.xyz;
float3 l9_66=definedBlend(l9_64,l9_65,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_12=float4(l9_66.x,l9_66.y,l9_66.z,l9_12.w);
float3 l9_67=mix(l9_63,l9_12.xyz,float3(l9_11.w));
l9_12=float4(l9_67.x,l9_67.y,l9_67.z,l9_12.w);
l9_12.w=1.0;
float4 l9_68=l9_12;
param_3=l9_68;
}
...
{
float4 l9_69=param_3;
float4 l9_70=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_70=float4(mix(float3(1.0),l9_69.xyz,float3(l9_69.w)),l9_69.w);
}
else
{
...
{
l9_71=fast::clamp(l9_71,0.0,1.0);
}
l9_70=float4(l9_69.xyz*l9_71,l9_71);
}
else
{
l9_70=l9_69;
...
{
l9_74=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_74=float4(0.0);
