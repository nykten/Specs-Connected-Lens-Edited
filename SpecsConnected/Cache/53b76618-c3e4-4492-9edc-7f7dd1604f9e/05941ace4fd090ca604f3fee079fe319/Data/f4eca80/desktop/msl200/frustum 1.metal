...
//float4 Tweak_N99Size 4432
//float4 Tweak_N99Dims 4448
//float4 Tweak_N99View 4464
//float3x3 Tweak_N99Transform 4480
//float4 Tweak_N99UvMinMax 4528
//float4 Tweak_N99BorderColor 4544
//float alpha 4560
...
Output_N97=mix(Output_N45,(*sc_set2.UserUniforms).Port_Input1_N097,float4(FrontFacing_N96));
float4 Output_N84=float4(0.0);
Output_N84=Output_N45*Output_N97;
...
int l9_191=l9_186;
int param_26=Tweak_N99Layout_tmp;
int param_27=l9_191;
float2 param_28=Globals.Surface_UVCoord0;
bool param_29=(int(SC_USE_UV_TRANSFORM_Tweak_N99_tmp)!=0);
float3x3 param_30=(*sc_set2.UserUniforms).Tweak_N99Transform;
int2 param_31=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99_tmp);
bool param_32=(int(SC_USE_UV_MIN_MAX_Tweak_N99_tmp)!=0);
float4 param_33=(*sc_set2.UserUniforms).Tweak_N99UvMinMax;
bool param_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99_tmp)!=0);
float4 param_35=(*sc_set2.UserUniforms).Tweak_N99BorderColor;
float param_36=0.0;
bool l9_192=param_34&&(!param_32);
float l9_193=1.0;
float l9_194=param_28.x;
int l9_195=param_31.x;
if (l9_195==1)
{
l9_194=fract(l9_194);
}
...
param_28.x=l9_194;
float l9_199=param_28.y;
int l9_200=param_31.y;
if (l9_200==1)
{
l9_199=fract(l9_199);
}
...
float l9_206=param_28.x;
float l9_207=param_33.x;
float l9_208=param_33.z;
bool l9_209=l9_205;
float l9_210=l9_193;
...
float l9_215=param_28.y;
float l9_216=param_33.y;
float l9_217=param_33.w;
bool l9_218=l9_214;
float l9_219=l9_193;
...
float2 l9_222=param_28;
bool l9_223=param_29;
float3x3 l9_224=param_30;
if (l9_223)
{
...
param_28=l9_227;
float l9_228=param_28.x;
int l9_229=param_31.x;
bool l9_230=l9_192;
float l9_231=l9_193;
...
param_28.x=l9_228;
l9_193=l9_231;
float l9_239=param_28.y;
int l9_240=param_31.y;
bool l9_241=l9_192;
float l9_242=l9_193;
...
param_28.y=l9_239;
l9_193=l9_242;
float2 l9_250=param_28;
int l9_251=param_26;
int l9_252=param_27;
float l9_253=param_36;
...
if (param_34)
{
l9_264=mix(param_35,l9_264,float4(l9_193));
}
...
float Noise_N83=0.0;
float2 param_37=(*sc_set2.UserUniforms).Port_Seed_N083;
float2 param_38=CoordsOut_N92;
param_37.x=floor(param_37.x*10000.0)*9.9999997e-05;
param_37.y=floor(param_37.y*10000.0)*9.9999997e-05;
param_37*=(param_38*0.5);
float2 l9_266=param_37;
float param_39=(snoise(l9_266)*0.5)+0.5;
param_39=floor(param_39*10000.0)*9.9999997e-05;
Noise_N83=param_39;
float4 Output_N94=float4(0.0);
float4 param_40=Output_N89;
float4 param_41=float4(Noise_N83);
float3 l9_267=param_41.xyz*param_40.xyz;
float4 param_42;
param_42=float4(l9_267.x,l9_267.y,l9_267.z,param_42.w);
float3 l9_268=mix(param_40.xyz,param_42.xyz,float3(param_41.w));
param_42=float4(l9_268.x,l9_268.y,l9_268.z,param_42.w);
param_42.w=param_40.w;
Output_N94=param_42;
...
float param_43=(*sc_set2.UserUniforms).alpha;
Output_N85=param_43;
float4 Output_N82=float4(0.0);
Output_N82=Value_N1*float4(Output_N85);
FinalColor=Output_N82;
