...
//}
//ubo int UserUniforms 2:33:4304 {
...
//float4 Tweak_N1Size 4144
//float4 Tweak_N1Dims 4160
//float4 Tweak_N1View 4176
//float3x3 Tweak_N1Transform 4192
//float4 Tweak_N1UvMinMax 4240
//float4 Tweak_N1BorderColor 4256
//float4 Tweak_N5 4272
//float depthRef 4288
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 1070
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1071
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 1072
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1073
//spec_const int Tweak_N1Layout 1074
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 [[function_constant(1070)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 [[function_constant(1072)]];
...
constant int Tweak_N1Layout [[function_constant(1074)]];
...
int l9_12=l9_7;
int param=Tweak_N1Layout_tmp;
int param_1=l9_12;
float2 param_2=UVCoord_N2;
bool param_3=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).Tweak_N1Transform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 param_7=(*sc_set2.UserUniforms).Tweak_N1UvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).Tweak_N1BorderColor;
float param_10=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set2.Tweak_N1.sample(sc_set2.Tweak_N1SmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_8)
{
...
float4 param_11=(*sc_set2.UserUniforms).Tweak_N5;
Output_N5=param_11;
float4 Output_N3=float4(0.0);
Output_N3=Color_N0*Output_N5;
