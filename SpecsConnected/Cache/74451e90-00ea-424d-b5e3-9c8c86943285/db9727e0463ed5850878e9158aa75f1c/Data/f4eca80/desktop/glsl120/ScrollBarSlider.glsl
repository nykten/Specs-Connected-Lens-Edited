...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(Tweak_N1Dims.xy,Tweak_N1Layout,l9_0,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1);
vec4 l9_2=l9_1*Tweak_N5;
float l9_3=l9_2.w;
