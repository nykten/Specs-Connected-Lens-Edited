...
#if (Tweak_N1Layout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(Tweak_N1Dims.xy,Tweak_N1Layout,Tweak_N1GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1ArrSC);
}
#else
{
