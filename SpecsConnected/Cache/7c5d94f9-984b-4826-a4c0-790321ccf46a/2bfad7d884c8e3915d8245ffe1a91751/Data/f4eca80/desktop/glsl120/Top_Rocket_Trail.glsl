...
//sampler sampler sc_OITCommonSampler 2:19
//sampler sampler sc_ScreenTextureSmpSC 2:21
//sampler sampler texture_mapSmpSC 2:24
//texture texture2D intensityTexture 2:0:2:16
//texture texture2D sc_OITAlpha0 2:3:2:19
//texture texture2D sc_OITAlpha1 2:4:2:19
//texture texture2D sc_OITDepthHigh0 2:5:2:19
//texture texture2D sc_OITDepthHigh1 2:6:2:19
//texture texture2D sc_OITDepthLow0 2:7:2:19
//texture texture2D sc_OITDepthLow1 2:8:2:19
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:9:2:19
//texture texture2D sc_OITFrontDepthTexture 2:10:2:19
//texture texture2D sc_ScreenTexture 2:12:2:21
//texture texture2D texture_map 2:15:2:24
//SG_REFLECTION_END
...
float l9_2=l9_1*Port_Multiplier_N039;
float l9_3=clamp(mod(l9_2+(varColor.x*Port_Input1_N041),Port_Input1_N043),0.0,1.0);
vec4 l9_4;
if (l9_3<Port_Position1_N038)
{
l9_4=mix(Port_Value0_N038,Port_Value1_N038,vec4(clamp(l9_3/Port_Position1_N038,0.0,1.0)));
}
else
{
l9_4=mix(Port_Value1_N038,Port_Value2_N038,vec4(clamp((l9_3-Port_Position1_N038)/(1.0-Port_Position1_N038),0.0,1.0)));
}
...
float l9_10=l9_1*(Tweak_N44*Port_Input1_N046);
int l9_11;
...
#endif
vec4 l9_12=sc_SampleTextureBiasOrLevel(texture_mapDims.xy,texture_mapLayout,l9_11,((((varPackedTex.xy-Port_Center_N032)*Port_Scale_N032)+Port_Center_N032)+vec2(varColor.x*Port_Input1_N034))+(Port_Direction_N037*l9_10),(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map),(int(SC_USE_UV_MIN_MAX_texture_map)!=0),texture_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0),texture_mapBorderColor,0.0,texture_map);
float l9_13=mix(((vec4((1.0-max(smoothstep(Port_Input0_N000,Port_Input1_N000,varPackedTex.x),1.0-smoothstep(Port_Input0_N003,Port_Input1_N003,varPackedTex.x)))*(1.0-smoothstep(Port_Input0_N014,Port_Input1_N014,abs(varPackedTex.y-Port_Input1_N013))))*(vec4(1.0)-l9_12))*vec4(smoothstep(Port_Input0_N045,Port_Input1_N045,Tweak_N44))).x,Port_Input1_N047,float(varPos.y<black_height));
vec4 l9_14=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_14.w=l9_13;
...
{
l9_18=clamp(dot(l9_14.xyz,vec3(l9_13)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*l9_13;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*l9_13;
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_13;
}
#else
{
float l9_23;
#if (sc_BlendMode_Add)
{
l9_23=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=dot(l9_14.xyz,vec3(0.33333001))*l9_13;
}
#else
{
float l9_26;
#if (sc_BlendMode_Min)
{
l9_26=1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_Max)
{
l9_27=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_27=1.0;
...
#endif
l9_15=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_14.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_16);
}
#else
{
vec4 l9_28;
...
#if (sc_FramebufferFetch)
{
vec4 l9_31=sc_readFragData0_Platform();
vec4 l9_32;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_33=l9_31;
l9_33.x=l9_31.x+_sc_framebufferFetchMarker;
l9_32=l9_33;
}
#else
{
...
#endif
l9_30=sc_SampleView(sc_ScreenTextureDims.xy,l9_34,sc_ScreenTextureLayout,l9_35,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_36;
...
{
vec4 l9_37=l9_30;
l9_37.x=l9_30.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_36=l9_37;
}
#else
{
...
#endif
vec3 l9_38=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_14.xyz).xyz,vec3(l9_13));
...
{
l9_45=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_45=vec4(0.0);
...
vec4 l9_47=outputMotionVectorsIfNeeded(varPos,max(l9_46,vec4(0.0)));
