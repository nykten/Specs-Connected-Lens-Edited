...
//sampler sampler texture_mapSmpSC 2:29
...
//texture texture2D texture_map 2:18:2:29
...
//texture texture2DArray sc_ScreenTextureArrSC 2:35:2:26
//texture texture2DArray texture_mapArrSC 2:36:2:29
...
uniform vec4 texture_mapSize;
uniform vec4 texture_mapView;
uniform mat3 texture_mapTransform;
uniform vec4 texture_mapUvMinMax;
uniform vec4 texture_mapBorderColor;
uniform float Tweak_N44;
uniform float black_height;
uniform float Port_Multiplier_N039;
uniform float Port_Input1_N041;
uniform float Port_Input1_N043;
uniform vec4 Port_Value0_N038;
uniform float Port_Position1_N038;
uniform vec4 Port_Value1_N038;
uniform vec4 Port_Value2_N038;
uniform float Port_Input0_N000;
uniform float Port_Input1_N000;
uniform float Port_Input0_N003;
uniform float Port_Input1_N003;
uniform float Port_Input0_N014;
uniform float Port_Input1_N014;
uniform float Port_Input1_N013;
uniform vec2 Port_Scale_N032;
uniform vec2 Port_Center_N032;
uniform float Port_Input1_N034;
uniform vec2 Port_Direction_N037;
uniform float Port_Input1_N046;
uniform float Port_Input0_N045;
...
#endif
#ifndef texture_mapHasSwappedViews
#define texture_mapHasSwappedViews 0
#elif texture_mapHasSwappedViews==1
#undef texture_mapHasSwappedViews
#define texture_mapHasSwappedViews 1
#endif
#ifndef texture_mapLayout
#define texture_mapLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_texture_map
#define SC_USE_UV_TRANSFORM_texture_map 0
#elif SC_USE_UV_TRANSFORM_texture_map==1
#undef SC_USE_UV_TRANSFORM_texture_map
#define SC_USE_UV_TRANSFORM_texture_map 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_texture_map
#define SC_SOFTWARE_WRAP_MODE_U_texture_map -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_texture_map
#define SC_SOFTWARE_WRAP_MODE_V_texture_map -1
#endif
#ifndef SC_USE_UV_MIN_MAX_texture_map
#define SC_USE_UV_MIN_MAX_texture_map 0
#elif SC_USE_UV_MIN_MAX_texture_map==1
#undef SC_USE_UV_MIN_MAX_texture_map
#define SC_USE_UV_MIN_MAX_texture_map 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_texture_map
#define SC_USE_CLAMP_TO_BORDER_texture_map 0
#elif SC_USE_CLAMP_TO_BORDER_texture_map==1
#undef SC_USE_CLAMP_TO_BORDER_texture_map
#define SC_USE_CLAMP_TO_BORDER_texture_map 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2DArray texture_mapArrSC;
...
int texture_mapGetStereoViewIndex()
{
int l9_0;
#if (texture_mapHasSwappedViews)
{
...
float l9_6=l9_1*Port_Multiplier_N039;
float l9_7=clamp(mod(l9_6+(l9_2.x*Port_Input1_N041),Port_Input1_N043),0.0,1.0);
vec4 l9_8;
if (l9_7<Port_Position1_N038)
{
l9_8=mix(Port_Value0_N038,Port_Value1_N038,vec4(clamp(l9_7/Port_Position1_N038,0.0,1.0)));
}
else
{
l9_8=mix(Port_Value1_N038,Port_Value2_N038,vec4(clamp((l9_7-Port_Position1_N038)/(1.0-Port_Position1_N038),0.0,1.0)));
}
...
{
l9_12=PreviewVertexColor;
l9_11=l9_0;
}
vec2 l9_14=l9_3-Port_Center_N032;
float l9_15=l9_1*(Tweak_N44*Port_Input1_N046);
vec2 l9_16=(((l9_14*Port_Scale_N032)+Port_Center_N032)+vec2(l9_2.x*Port_Input1_N034))+(Port_Direction_N037*l9_15);
vec4 l9_17;
#if (texture_mapLayout==2)
{
l9_17=sc_SampleTextureBiasOrLevel(texture_mapDims.xy,texture_mapLayout,texture_mapGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map),(int(SC_USE_UV_MIN_MAX_texture_map)!=0),texture_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0),texture_mapBorderColor,0.0,texture_mapArrSC);
}
#else
{
l9_17=sc_SampleTextureBiasOrLevel(texture_mapDims.xy,texture_mapLayout,texture_mapGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map),(int(SC_USE_UV_MIN_MAX_texture_map)!=0),texture_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0),texture_mapBorderColor,0.0,texture_map);
}
#endif
vec4 l9_18=vec4(1.0)-l9_17;
float l9_19=mix(((vec4((1.0-max(smoothstep(Port_Input0_N000,Port_Input1_N000,l9_3.x),1.0-smoothstep(Port_Input0_N003,Port_Input1_N003,l9_3.x)))*(1.0-smoothstep(Port_Input0_N014,Port_Input1_N014,abs(l9_3.y-Port_Input1_N013))))*l9_18)*vec4(smoothstep(Port_Input0_N045,Port_Input1_N045,Tweak_N44))).x,Port_Input1_N047,float(l9_4.y<black_height));
vec4 l9_20=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_20.w=l9_19;
#if (sc_BlendMode_AlphaTest)
{
if (l9_19<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_19<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_26=clamp(dot(l9_20.xyz,vec3(l9_19)),0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_28=(1.0-dot(l9_20.xyz,vec3(0.33333001)))*l9_19;
}
#else
{
float l9_29;
...
{
l9_29=(1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0))*l9_19;
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_31;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_32=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_33;
...
{
l9_33=dot(l9_20.xyz,vec3(0.33333001))*l9_19;
}
#else
{
float l9_34;
...
#if (sc_FramebufferFetch)
{
vec4 l9_39=sc_readFragData0_Platform();
vec4 l9_40;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_41=l9_39;
l9_41.x=l9_39.x+_sc_framebufferFetchMarker;
l9_40=l9_41;
}
#else
{
...
{
l9_44=sc_SampleView(sc_ScreenTextureDims.xy,l9_42,sc_ScreenTextureLayout,l9_43,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_44=sc_SampleView(sc_ScreenTextureDims.xy,l9_42,sc_ScreenTextureLayout,l9_43,0.0,sc_ScreenTexture);
}
#endif
l9_38=l9_44;
}
...
{
vec4 l9_46=l9_38;
l9_46.x=l9_38.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_45=l9_46;
}
#else
{
...
#endif
vec3 l9_47=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_20.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_49=vec4(mix(vec3(1.0),l9_20.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_50;
...
#endif
l9_50=vec4(l9_20.xyz*l9_51,l9_51);
}
#else
{
l9_50=l9_20;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_59).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_60=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_59).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_72).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_77==0)
{
l9_80=texture(sc_OITAlpha0,l9_72);
l9_79=texture(sc_OITDepthLow0,l9_72);
l9_78=texture(sc_OITDepthHigh0,l9_72);
}
else
{
l9_80=vec4(0.0);
...
if (l9_77==1)
{
l9_83=texture(sc_OITAlpha1,l9_72);
l9_82=texture(sc_OITDepthLow1,l9_72);
l9_81=texture(sc_OITDepthHigh1,l9_72);
}
else
{
l9_83=l9_80;
...
vec4 l9_98=texture(sc_OITFilteredDepthBoundsTexture,l9_72);
vec2 l9_99=l9_98.xy;
int l9_100;
#if (sc_SkinBonesCount>0)
{
