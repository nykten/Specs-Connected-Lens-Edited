...
bool l9_4;
vec4 l9_5;
if ((float(varPackedTex.y<Port_Input1_N010)*1.0)!=0.0)
{
float l9_6=radians(Port_Rotation_N012);
float l9_7=fract((vec2(dot(vec2(cos(l9_6),sin(l9_6)),varPackedTex.xy-Port_Center_N012),0.0)+Port_Center_N012).x);
vec4 l9_8;
if (l9_7<Port_Position1_N005)
{
l9_8=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_7/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_7<Port_Position2_N005)
{
l9_9=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_7-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_7<Port_Position3_N005)
{
l9_10=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_7-Port_Position2_N005)/(Port_Position3_N005-Port_Position2_N005),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_7<Port_Position4_N005)
{
l9_11=mix(Port_Value3_N005,Port_Value4_N005,vec4(clamp((l9_7-Port_Position3_N005)/(Port_Position4_N005-Port_Position3_N005),0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_7<Port_Position5_N005)
{
l9_12=mix(Port_Value4_N005,Port_Value5_N005,vec4(clamp((l9_7-Port_Position4_N005)/(Port_Position5_N005-Port_Position4_N005),0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_7<Port_Position6_N005)
{
l9_13=mix(Port_Value5_N005,Port_Value6_N005,vec4(clamp((l9_7-Port_Position5_N005)/(Port_Position6_N005-Port_Position5_N005),0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_7<Port_Position7_N005)
{
l9_14=mix(Port_Value6_N005,Port_Value7_N005,vec4(clamp((l9_7-Port_Position6_N005)/(Port_Position7_N005-Port_Position6_N005),0.0,1.0)));
}
else
{
vec4 l9_15;
if (l9_7<Port_Position8_N005)
{
l9_15=mix(Port_Value7_N005,Port_Value8_N005,vec4(clamp((l9_7-Port_Position7_N005)/(Port_Position8_N005-Port_Position7_N005),0.0,1.0)));
}
else
{
vec4 l9_16;
if (l9_7<Port_Position9_N005)
{
l9_16=mix(Port_Value8_N005,Port_Value9_N005,vec4(clamp((l9_7-Port_Position8_N005)/(Port_Position9_N005-Port_Position8_N005),0.0,1.0)));
}
else
{
vec4 l9_17;
if (l9_7<Port_Position10_N005)
{
l9_17=mix(Port_Value9_N005,Port_Value10_N005,vec4(clamp((l9_7-Port_Position9_N005)/(Port_Position10_N005-Port_Position9_N005),0.0,1.0)));
}
else
{
vec4 l9_18;
if (l9_7<Port_Position11_N005)
{
l9_18=mix(Port_Value10_N005,Port_Value11_N005,vec4(clamp((l9_7-Port_Position10_N005)/(Port_Position11_N005-Port_Position10_N005),0.0,1.0)));
}
else
{
vec4 l9_19;
if (l9_7<Port_Position12_N005)
{
l9_19=mix(Port_Value11_N005,Port_Value12_N005,vec4(clamp((l9_7-Port_Position11_N005)/(Port_Position12_N005-Port_Position11_N005),0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_7<Port_Position13_N005)
{
l9_20=mix(Port_Value12_N005,Port_Value13_N005,vec4(clamp((l9_7-Port_Position12_N005)/(Port_Position13_N005-Port_Position12_N005),0.0,1.0)));
}
else
{
vec4 l9_21;
if (l9_7<Port_Position14_N005)
{
l9_21=mix(Port_Value13_N005,Port_Value14_N005,vec4(clamp((l9_7-Port_Position13_N005)/(Port_Position14_N005-Port_Position13_N005),0.0,1.0)));
}
else
{
l9_21=mix(Port_Value14_N005,Port_Value15_N005,vec4(clamp((l9_7-Port_Position14_N005)/(1.0-Port_Position14_N005),0.0,1.0)));
}
l9_20=l9_21;
}
l9_19=l9_20;
...
#endif
l9_65=sc_SampleView(sc_ScreenTextureDims.xy,l9_69,sc_ScreenTextureLayout,l9_70,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_71;
