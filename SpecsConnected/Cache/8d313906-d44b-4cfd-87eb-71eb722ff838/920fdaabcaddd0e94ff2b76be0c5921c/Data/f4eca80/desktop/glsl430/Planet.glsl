...
//sampler sampler z_rayDirectionsSmpSC 2:29
//texture texture2D intensityTexture 2:3:2:20
//texture texture2D sc_OITAlpha0 2:6:2:23
//texture texture2D sc_OITAlpha1 2:7:2:23
//texture texture2D sc_OITDepthHigh0 2:8:2:23
//texture texture2D sc_OITDepthHigh1 2:9:2:23
//texture texture2D sc_OITDepthLow0 2:10:2:23
//texture texture2D sc_OITDepthLow1 2:11:2:23
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:12:2:23
//texture texture2D sc_OITFrontDepthTexture 2:13:2:23
//texture texture2D sc_ScreenTexture 2:15:2:25
//texture utexture2D z_hitIdAndBarycentric 2:18:2:28
//texture texture2D z_rayDirections 2:19:2:29
//texture texture2DArray intensityTextureArrSC 2:30:2:20
//texture texture2DArray sc_ScreenTextureArrSC 2:33:2:25
...
uniform float Port_Position3_N005;
uniform vec4 Port_Value3_N005;
uniform float Port_Position4_N005;
uniform vec4 Port_Value4_N005;
uniform float Port_Position5_N005;
uniform vec4 Port_Value5_N005;
uniform float Port_Position6_N005;
uniform vec4 Port_Value6_N005;
uniform float Port_Position7_N005;
uniform vec4 Port_Value7_N005;
uniform float Port_Position8_N005;
uniform vec4 Port_Value8_N005;
uniform float Port_Position9_N005;
uniform vec4 Port_Value9_N005;
uniform float Port_Position10_N005;
uniform vec4 Port_Value10_N005;
uniform float Port_Position11_N005;
uniform vec4 Port_Value11_N005;
uniform float Port_Position12_N005;
uniform vec4 Port_Value12_N005;
uniform float Port_Position13_N005;
uniform vec4 Port_Value13_N005;
uniform float Port_Position14_N005;
uniform vec4 Port_Value14_N005;
uniform vec4 Port_Value15_N005;
uniform float Port_Rotation_N002;
uniform vec2 Port_Center_N002;
uniform vec4 Port_Value0_N019;
uniform float Port_Position1_N019;
uniform vec4 Port_Value1_N019;
uniform float Port_Position2_N019;
uniform vec4 Port_Value2_N019;
uniform float Port_Position3_N019;
uniform vec4 Port_Value3_N019;
uniform float Port_Position4_N019;
uniform vec4 Port_Value4_N019;
uniform float Port_Position5_N019;
uniform vec4 Port_Value5_N019;
uniform float Port_Position6_N019;
uniform vec4 Port_Value6_N019;
uniform float Port_Position7_N019;
uniform vec4 Port_Value7_N019;
uniform float Port_Position8_N019;
uniform vec4 Port_Value8_N019;
uniform float Port_Position9_N019;
uniform vec4 Port_Value9_N019;
uniform float Port_Position10_N019;
uniform vec4 Port_Value10_N019;
uniform float Port_Position11_N019;
uniform vec4 Port_Value11_N019;
uniform float Port_Position12_N019;
uniform vec4 Port_Value12_N019;
uniform float Port_Position13_N019;
uniform vec4 Port_Value13_N019;
uniform float Port_Position14_N019;
uniform vec4 Port_Value14_N019;
uniform vec4 Port_Value15_N019;
uniform vec4 Port_Input0_N001;
uniform vec4 Port_Input1_N001;
uniform vec3 Port_Normal_N024;
uniform float Port_Exponent_N024;
uniform float Port_Intensity_N024;
uniform vec4 Port_Input2_N026;
...
bool l9_13;
vec4 l9_14;
if ((float(l9_5.y<Port_Input1_N010)*1.0)!=0.0)
{
float l9_15=radians(Port_Rotation_N012);
vec2 l9_16=l9_5-Port_Center_N012;
float l9_17=fract((vec2(dot(vec2(cos(l9_15),sin(l9_15)),l9_16),0.0)+Port_Center_N012).x);
vec4 l9_18;
if (l9_17<Port_Position1_N005)
{
l9_18=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_17/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_19;
if (l9_17<Port_Position2_N005)
{
l9_19=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_17-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_17<Port_Position3_N005)
{
l9_20=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_17-Port_Position2_N005)/(Port_Position3_N005-Port_Position2_N005),0.0,1.0)));
}
else
{
vec4 l9_21;
if (l9_17<Port_Position4_N005)
{
l9_21=mix(Port_Value3_N005,Port_Value4_N005,vec4(clamp((l9_17-Port_Position3_N005)/(Port_Position4_N005-Port_Position3_N005),0.0,1.0)));
}
else
{
vec4 l9_22;
if (l9_17<Port_Position5_N005)
{
l9_22=mix(Port_Value4_N005,Port_Value5_N005,vec4(clamp((l9_17-Port_Position4_N005)/(Port_Position5_N005-Port_Position4_N005),0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_17<Port_Position6_N005)
{
l9_23=mix(Port_Value5_N005,Port_Value6_N005,vec4(clamp((l9_17-Port_Position5_N005)/(Port_Position6_N005-Port_Position5_N005),0.0,1.0)));
}
else
{
vec4 l9_24;
if (l9_17<Port_Position7_N005)
{
l9_24=mix(Port_Value6_N005,Port_Value7_N005,vec4(clamp((l9_17-Port_Position6_N005)/(Port_Position7_N005-Port_Position6_N005),0.0,1.0)));
}
else
{
vec4 l9_25;
if (l9_17<Port_Position8_N005)
{
l9_25=mix(Port_Value7_N005,Port_Value8_N005,vec4(clamp((l9_17-Port_Position7_N005)/(Port_Position8_N005-Port_Position7_N005),0.0,1.0)));
}
else
{
vec4 l9_26;
if (l9_17<Port_Position9_N005)
{
l9_26=mix(Port_Value8_N005,Port_Value9_N005,vec4(clamp((l9_17-Port_Position8_N005)/(Port_Position9_N005-Port_Position8_N005),0.0,1.0)));
}
else
{
vec4 l9_27;
if (l9_17<Port_Position10_N005)
{
l9_27=mix(Port_Value9_N005,Port_Value10_N005,vec4(clamp((l9_17-Port_Position9_N005)/(Port_Position10_N005-Port_Position9_N005),0.0,1.0)));
}
else
{
vec4 l9_28;
if (l9_17<Port_Position11_N005)
{
l9_28=mix(Port_Value10_N005,Port_Value11_N005,vec4(clamp((l9_17-Port_Position10_N005)/(Port_Position11_N005-Port_Position10_N005),0.0,1.0)));
}
else
{
vec4 l9_29;
if (l9_17<Port_Position12_N005)
{
l9_29=mix(Port_Value11_N005,Port_Value12_N005,vec4(clamp((l9_17-Port_Position11_N005)/(Port_Position12_N005-Port_Position11_N005),0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_17<Port_Position13_N005)
{
l9_30=mix(Port_Value12_N005,Port_Value13_N005,vec4(clamp((l9_17-Port_Position12_N005)/(Port_Position13_N005-Port_Position12_N005),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_17<Port_Position14_N005)
{
l9_31=mix(Port_Value13_N005,Port_Value14_N005,vec4(clamp((l9_17-Port_Position13_N005)/(Port_Position14_N005-Port_Position13_N005),0.0,1.0)));
}
else
{
l9_31=mix(Port_Value14_N005,Port_Value15_N005,vec4(clamp((l9_17-Port_Position14_N005)/(1.0-Port_Position14_N005),0.0,1.0)));
}
l9_30=l9_31;
}
l9_29=l9_30;
...
{
float l9_37=radians(Port_Rotation_N002);
vec2 l9_38=l9_5-Port_Center_N002;
float l9_39=fract((vec2(dot(vec2(cos(l9_37),sin(l9_37)),l9_38),0.0)+Port_Center_N002).x);
vec4 l9_40;
if (l9_39<Port_Position1_N019)
{
l9_40=mix(Port_Value0_N019,Port_Value1_N019,vec4(clamp(l9_39/Port_Position1_N019,0.0,1.0)));
}
else
{
vec4 l9_41;
if (l9_39<Port_Position2_N019)
{
l9_41=mix(Port_Value1_N019,Port_Value2_N019,vec4(clamp((l9_39-Port_Position1_N019)/(Port_Position2_N019-Port_Position1_N019),0.0,1.0)));
}
else
{
vec4 l9_42;
if (l9_39<Port_Position3_N019)
{
l9_42=mix(Port_Value2_N019,Port_Value3_N019,vec4(clamp((l9_39-Port_Position2_N019)/(Port_Position3_N019-Port_Position2_N019),0.0,1.0)));
}
else
{
vec4 l9_43;
if (l9_39<Port_Position4_N019)
{
l9_43=mix(Port_Value3_N019,Port_Value4_N019,vec4(clamp((l9_39-Port_Position3_N019)/(Port_Position4_N019-Port_Position3_N019),0.0,1.0)));
}
else
{
vec4 l9_44;
if (l9_39<Port_Position5_N019)
{
l9_44=mix(Port_Value4_N019,Port_Value5_N019,vec4(clamp((l9_39-Port_Position4_N019)/(Port_Position5_N019-Port_Position4_N019),0.0,1.0)));
}
else
{
vec4 l9_45;
if (l9_39<Port_Position6_N019)
{
l9_45=mix(Port_Value5_N019,Port_Value6_N019,vec4(clamp((l9_39-Port_Position5_N019)/(Port_Position6_N019-Port_Position5_N019),0.0,1.0)));
}
else
{
vec4 l9_46;
if (l9_39<Port_Position7_N019)
{
l9_46=mix(Port_Value6_N019,Port_Value7_N019,vec4(clamp((l9_39-Port_Position6_N019)/(Port_Position7_N019-Port_Position6_N019),0.0,1.0)));
}
else
{
vec4 l9_47;
if (l9_39<Port_Position8_N019)
{
l9_47=mix(Port_Value7_N019,Port_Value8_N019,vec4(clamp((l9_39-Port_Position7_N019)/(Port_Position8_N019-Port_Position7_N019),0.0,1.0)));
}
else
{
vec4 l9_48;
if (l9_39<Port_Position9_N019)
{
l9_48=mix(Port_Value8_N019,Port_Value9_N019,vec4(clamp((l9_39-Port_Position8_N019)/(Port_Position9_N019-Port_Position8_N019),0.0,1.0)));
}
else
{
vec4 l9_49;
if (l9_39<Port_Position10_N019)
{
l9_49=mix(Port_Value9_N019,Port_Value10_N019,vec4(clamp((l9_39-Port_Position9_N019)/(Port_Position10_N019-Port_Position9_N019),0.0,1.0)));
}
else
{
vec4 l9_50;
if (l9_39<Port_Position11_N019)
{
l9_50=mix(Port_Value10_N019,Port_Value11_N019,vec4(clamp((l9_39-Port_Position10_N019)/(Port_Position11_N019-Port_Position10_N019),0.0,1.0)));
}
else
{
vec4 l9_51;
if (l9_39<Port_Position12_N019)
{
l9_51=mix(Port_Value11_N019,Port_Value12_N019,vec4(clamp((l9_39-Port_Position11_N019)/(Port_Position12_N019-Port_Position11_N019),0.0,1.0)));
}
else
{
vec4 l9_52;
if (l9_39<Port_Position13_N019)
{
l9_52=mix(Port_Value12_N019,Port_Value13_N019,vec4(clamp((l9_39-Port_Position12_N019)/(Port_Position13_N019-Port_Position12_N019),0.0,1.0)));
}
else
{
vec4 l9_53;
if (l9_39<Port_Position14_N019)
{
l9_53=mix(Port_Value13_N019,Port_Value14_N019,vec4(clamp((l9_39-Port_Position13_N019)/(Port_Position14_N019-Port_Position13_N019),0.0,1.0)));
}
else
{
l9_53=mix(Port_Value14_N019,Port_Value15_N019,vec4(clamp((l9_39-Port_Position14_N019)/(1.0-Port_Position14_N019),0.0,1.0)));
}
l9_52=l9_53;
}
l9_51=l9_52;
...
mat3 l9_59=mat3(l9_4,l9_2,l9_3);
vec3 l9_60=-l9_1;
vec4 l9_61=mix(l9_12,mix(Port_Input0_N001,Port_Input1_N001,vec4(max(1.0-pow(1.0-abs(dot(l9_60,l9_59*Port_Normal_N024)),Port_Exponent_N024),0.0)*Port_Intensity_N024)),Port_Input2_N026);
float l9_62=l9_61.w;
...
#endif
sc_writeFragData0(max(l9_63,vec4(0.0)));
return;
}
vec4 l9_65;
...
{
l9_68=clamp(dot(l9_61.xyz,vec3(l9_62)),0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_70=(1.0-dot(l9_61.xyz,vec3(0.33333001)))*l9_62;
}
#else
{
float l9_71;
...
{
l9_71=(1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0))*l9_62;
}
#else
{
float l9_72;
...
{
l9_72=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_62;
}
#else
{
float l9_73;
#if (sc_BlendMode_Add)
{
l9_73=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_74;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_74=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_62;
}
#else
{
float l9_75;
...
{
l9_75=dot(l9_61.xyz,vec3(0.33333001))*l9_62;
}
#else
{
float l9_76;
#if (sc_BlendMode_Min)
{
l9_76=1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_77;
#if (sc_BlendMode_Max)
{
l9_77=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_77=1.0;
...
#endif
l9_65=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_61.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_66);
}
#else
{
vec4 l9_78;
...
#if (sc_FramebufferFetch)
{
vec4 l9_81=sc_readFragData0_Platform();
vec4 l9_82;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_83=l9_81;
l9_83.x=l9_81.x+_sc_framebufferFetchMarker;
l9_82=l9_83;
}
#else
{
...
#else
{
vec2 l9_84=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_85;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_85=1-sc_GetStereoViewIndex();
}
#else
{
l9_85=sc_GetStereoViewIndex();
}
#endif
vec4 l9_86;
#if (sc_ScreenTextureLayout==2)
{
l9_86=sc_SampleView(sc_ScreenTextureDims.xy,l9_84,sc_ScreenTextureLayout,l9_85,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_86=sc_SampleView(sc_ScreenTextureDims.xy,l9_84,sc_ScreenTextureLayout,l9_85,0.0,sc_ScreenTexture);
}
#endif
l9_80=l9_86;
}
...
{
vec4 l9_88=l9_80;
l9_88.x=l9_80.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_87=l9_88;
}
#else
{
...
#endif
vec3 l9_89=mix(l9_87.xyz,definedBlend(l9_87.xyz,l9_61.xyz).xyz,vec3(l9_62));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_61.xyz,vec3(l9_62)),l9_62);
}
#else
{
vec4 l9_92;
...
#endif
l9_92=vec4(l9_61.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_61;
...
{
l9_96=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_96=vec4(0.0);
...
vec4 l9_98=outputMotionVectorsIfNeeded(varPos,max(l9_97,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_100-0.0039215689)),min(1.0,l9_100+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_101=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
sc_writeFragData0(vec4(packValue(l9_102),packValue(l9_102),packValue(l9_102),packValue(l9_102)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_114=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0(l9_99);
}
#endif
}
#else
{
sc_writeFragData0(l9_98);
}
#endif
}
#endif
