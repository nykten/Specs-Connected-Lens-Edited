...
//sampler sampler baseTexSmpSC 2:16
//sampler sampler intensityTextureSmpSC 2:17
//sampler sampler sc_EnvmapDiffuseSmpSC 2:18
//sampler sampler sc_EnvmapSpecularSmpSC 2:19
//sampler sampler sc_OITCommonSampler 2:20
//sampler sampler sc_SSAOTextureSmpSC 2:21
//sampler sampler sc_ScreenTextureSmpSC 2:22
//sampler sampler sc_ShadowTextureSmpSC 2:23
//texture texture2D baseTex 2:0:2:16
//texture texture2D intensityTexture 2:1:2:17
//texture texture2D sc_EnvmapDiffuse 2:2:2:18
//texture texture2D sc_EnvmapSpecular 2:3:2:19
...
//texture texture2D sc_SSAOTexture 2:12:2:21
//texture texture2D sc_ScreenTexture 2:13:2:22
//texture texture2D sc_ShadowTexture 2:14:2:23
//SG_REFLECTION_END
...
#endif
vec4 l9_2=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_1,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_3=baseColor*l9_2;
vec3 l9_4;
...
#endif
float l9_5=clamp(l9_3.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_5<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_5<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_6=max(l9_3.xyz,vec3(0.0));
vec4 l9_7;
#if (sc_ProjectiveShadowsCaster)
{
l9_7=vec4(l9_6,l9_5);
...
#else
{
float l9_8=clamp(metallic,0.0,1.0);
float l9_9=clamp(roughness,0.0,1.0);
vec3 l9_10=ssSRGB_to_Linear(l9_6);
vec3 l9_11=normalize(l9_4);
vec3 l9_12=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_13;
#if (sc_SSAOEnabled)
{
l9_13=evaluateSSAO(varPos);
}
#else
{
l9_13=Port_AO_N006;
...
#endif
vec3 l9_14=vec3(l9_8);
vec3 l9_15=mix(vec3(0.039999999),l9_10*l9_8,l9_14);
vec3 l9_16=mix(l9_10*(1.0-l9_8),vec3(0.0),l9_14);
SurfaceProperties l9_17=SurfaceProperties(l9_16,l9_5,l9_11,varPos,l9_0,l9_8,l9_9,l9_12,l9_13,Port_SpecularAO_N006,vec3(1.0),l9_15);
vec4 l9_18=vec4(1.0);
vec3 l9_19;
vec3 l9_20;
vec3 l9_21;
...
LightProperties l9_34;
SurfaceProperties l9_35;
vec3 l9_36;
int l9_37=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_37<sc_DirectionalLightsCount)
{
LightingComponents l9_38=accumulateLight(LightingComponents(l9_26,l9_27,l9_32,l9_31,l9_29,l9_28),LightProperties(sc_DirectionalLights[l9_37].direction,sc_DirectionalLights[l9_37].color.xyz,sc_DirectionalLights[l9_37].color.w*l9_18[(l9_30<3) ? l9_30 : 3]),l9_17,l9_0);
l9_32=l9_38.indirectDiffuse;
l9_31=l9_38.indirectSpecular;
l9_30++;
l9_29=l9_38.emitted;
l9_28=l9_38.transmitted;
l9_27=l9_38.directSpecular;
l9_26=l9_38.directDiffuse;
l9_37++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_55<sc_PointLightsCount)
{
vec3 l9_57=sc_PointLights[l9_55].position-varPos;
vec3 l9_58=normalize(l9_57);
float l9_59=l9_18[(l9_56<3) ? l9_56 : 3];
float l9_60=clamp((dot(l9_58,sc_PointLights[l9_55].direction)*sc_PointLights[l9_55].angleScale)+sc_PointLights[l9_55].angleOffset,0.0,1.0);
float l9_61=(sc_PointLights[l9_55].color.w*l9_59)*(l9_60*l9_60);
float l9_62;
if (sc_PointLights[l9_55].falloffEnabled)
{
l9_62=l9_61*computeDistanceAttenuation(length(l9_57),sc_PointLights[l9_55].falloffEndDistance);
}
else
{
l9_62=l9_61;
...
l9_48=l9_56+1;
LightingComponents l9_63=accumulateLight(LightingComponents(l9_42,l9_43,l9_47,l9_46,l9_45,l9_44),LightProperties(l9_58,sc_PointLights[l9_55].color.xyz,l9_62),l9_17,l9_0);
l9_49=l9_63.directDiffuse;
l9_50=l9_63.directSpecular;
l9_51=l9_63.indirectDiffuse;
l9_52=l9_63.indirectSpecular;
l9_53=l9_63.emitted;
l9_54=l9_63.transmitted;
l9_47=l9_51;
l9_46=l9_52;
l9_56=l9_48;
l9_45=l9_53;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_67=abs(varShadowTex-vec2(0.5));
vec4 l9_68=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_67.x,l9_67.y),0.5);
l9_66=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_68.xyz,vec3(sc_ShadowColor.w)),vec3(l9_68.w*sc_ShadowDensity));
}
#else
{
l9_66=vec3(1.0);
...
{
vec2 l9_70=calcPanoramicTexCoordsFromDir(l9_11,sc_EnvmapRotation.y);
vec4 l9_71;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_72=calcSeamlessPanoramicUvsForSampling(l9_70,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_72=l9_70;
...
#endif
l9_71=sc_EnvmapSpecularSampleViewIndexBias(l9_72,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_73;
...
{
vec2 l9_74=calcSeamlessPanoramicUvsForSampling(l9_70,sc_EnvmapDiffuseSize.xy,0.0);
int l9_75;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_75=1-sc_GetStereoViewIndex();
}
#else
{
l9_75=sc_GetStereoViewIndex();
}
#endif
l9_73=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_74,sc_EnvmapDiffuseLayout,l9_75,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_73=sc_EnvmapSpecularSampleViewIndexBias(l9_70,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_71=l9_73;
}
#endif
l9_69=(l9_71.xyz*(1.0/l9_71.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_76;
...
float l9_79=l9_77.y;
float l9_80=l9_77.z;
l9_76=(((((((sc_Sh[8]*0.42904299)*((l9_78*l9_78)-(l9_79*l9_79)))+((sc_Sh[6]*0.74312502)*(l9_80*l9_80)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_78*l9_79))+(sc_Sh[7]*(l9_78*l9_80)))+(sc_Sh[5]*(l9_79*l9_80)))*0.85808599))+((((sc_Sh[3]*l9_78)+(sc_Sh[1]*l9_79))+(sc_Sh[2]*l9_80))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_76=vec3(0.0);
...
{
l9_82=l9_69+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_83=l9_69;
l9_83.x=l9_69.x+(1e-06*sc_AmbientLights[0].color.x);
l9_82=l9_83;
}
#endif
l9_81=l9_82;
...
{
l9_85=l9_81+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_86=l9_81;
l9_86.x=l9_81.x+(1e-06*sc_AmbientLights[1].color.x);
l9_85=l9_86;
}
#endif
l9_84=l9_85;
...
{
l9_88=l9_84+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_89=l9_84;
l9_89.x=l9_84.x+(1e-06*sc_AmbientLights[2].color.x);
l9_88=l9_89;
}
#endif
l9_87=l9_88;
...
{
vec3 l9_91;
l9_91=sc_LightEstimationData.ambientLight;
vec3 l9_92;
int l9_93=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_93<sc_LightEstimationSGCount)
{
float l9_94=dot(sc_LightEstimationData.sg[l9_93].axis,l9_11);
float l9_95=exp(-sc_LightEstimationData.sg[l9_93].sharpness);
float l9_96=l9_95*l9_95;
float l9_97=1.0/sc_LightEstimationData.sg[l9_93].sharpness;
float l9_98=(1.0+(2.0*l9_96))-l9_97;
float l9_99=sqrt(1.0-l9_98);
float l9_100=0.36000001*l9_94;
float l9_101=(1.0/(4.0*0.36000001))*l9_99;
float l9_102=l9_100+l9_101;
float l9_103;
if (step(abs(l9_100),l9_101)>0.5)
{
l9_103=(l9_102*l9_102)/l9_99;
}
else
{
l9_103=clamp(l9_94,0.0,1.0);
}
l9_92=l9_91+((((sc_LightEstimationData.sg[l9_93].color/vec3(sc_LightEstimationData.sg[l9_93].sharpness))*6.2831855)*((l9_98*l9_103)+(((l9_95-l9_96)*l9_97)-l9_96)))/vec3(3.1415927));
l9_91=l9_92;
l9_93++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_105=clamp(pow(l9_9,0.66666669),0.0,1.0)*5.0;
vec2 l9_106=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_11,reflect(-l9_0,l9_11),l9_9),sc_EnvmapRotation.y);
vec4 l9_107;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_108=floor(l9_105);
float l9_109=ceil(l9_105);
l9_107=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_106,sc_EnvmapSpecularSize.xy,l9_108),sc_EnvmapSpecularGetStereoViewIndex(),l9_108),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_106,sc_EnvmapSpecularSize.xy,l9_109),sc_EnvmapSpecularGetStereoViewIndex(),l9_109),vec4(l9_105-l9_108));
}
#else
{
l9_107=sc_EnvmapSpecularSampleViewIndexLevel(l9_106,sc_EnvmapSpecularGetStereoViewIndex(),l9_105);
}
#endif
l9_104=vec3(0.0)+((((l9_107.xyz*(1.0/l9_107.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_17,abs(dot(l9_11,l9_0))));
}
#else
{
l9_104=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_111=clamp(l9_9*l9_9,0.0099999998,1.0);
vec3 l9_112;
l9_112=sc_LightEstimationData.ambientLight*l9_15;
int l9_113=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_113<sc_LightEstimationSGCount)
{
float l9_114=l9_111*l9_111;
vec3 l9_115=reflect(-l9_0,l9_11);
float l9_116=dot(l9_11,l9_0);
float l9_117=(2.0/l9_114)/(4.0*max(l9_116,9.9999997e-05));
float l9_118=length((l9_115*l9_117)+(sc_LightEstimationData.sg[l9_113].axis*sc_LightEstimationData.sg[l9_113].sharpness));
float l9_119=clamp(dot(l9_11,l9_115),0.0,1.0);
float l9_120=clamp(l9_116,0.0,1.0);
float l9_121=1.0-l9_114;
l9_112+=((((((((vec3(1.0/(3.1415927*l9_114))*exp((l9_118-l9_117)-sc_LightEstimationData.sg[l9_113].sharpness))*sc_LightEstimationData.sg[l9_113].color)*6.2831855)*(1.0-exp((-2.0)*l9_118)))/vec3(l9_118))*((1.0/(l9_119+sqrt(l9_114+((l9_121*l9_119)*l9_119))))*(1.0/(l9_120+sqrt(l9_114+((l9_121*l9_120)*l9_120))))))*(l9_15+((vec3(1.0)-l9_15)*pow(1.0-clamp(dot(l9_115,normalize(l9_115+l9_0)),0.0,1.0),5.0))))*l9_119);
l9_113++;
continue;
}
else
...
l9_125=vec3(0.0);
l9_124=vec3(0.0);
l9_123=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_16,vec3(l9_5));
l9_122=1.0;
}
#else
{
...
#endif
vec3 l9_127=l9_124*l9_13;
vec3 l9_128=l9_125+l9_127;
vec3 l9_129=l9_16*l9_128;
vec3 l9_130=l9_110*Port_SpecularAO_N006;
vec3 l9_131=l9_64+l9_130;
vec3 l9_132;
if (l9_126)
{
l9_132=l9_129*srgbToLinear(l9_122);
}
else
{
l9_132=l9_129;
}
vec3 l9_133=l9_132+l9_131;
vec3 l9_134=(l9_133+l9_12)+l9_123;
float l9_135=l9_134.x;
vec4 l9_136=vec4(l9_135,l9_134.yz,l9_122);
vec4 l9_137;
#if (sc_IsEditor)
{
vec4 l9_138=l9_136;
l9_138.x=l9_135+((l9_13.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_137=l9_138;
}
#else
{
...
{
vec3 l9_140=l9_137.xyz*1.8;
vec3 l9_141=(l9_137.xyz*(l9_140+vec3(1.4)))/((l9_137.xyz*(l9_140+vec3(0.5)))+vec3(1.5));
l9_139=vec4(l9_141.x,l9_141.y,l9_141.z,l9_137.w);
}
#else
{
l9_139=l9_137;
...
#endif
vec3 l9_142=vec3(linearToSrgb(l9_139.x),linearToSrgb(l9_139.y),linearToSrgb(l9_139.z));
l9_7=vec4(l9_142.x,l9_142.y,l9_142.z,l9_139.w);
}
#endif
vec4 l9_143=max(l9_7,vec4(0.0));
vec4 l9_144;
#if (sc_ProjectiveShadowsCaster)
{
float l9_145;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_146=clamp(l9_143.w*2.0,0.0,1.0);
}
#else
{
float l9_147;
...
{
l9_147=clamp(dot(l9_143.xyz,vec3(l9_143.w)),0.0,1.0);
}
#else
{
float l9_148;
...
#if (sc_BlendMode_Multiply)
{
l9_149=(1.0-dot(l9_143.xyz,vec3(0.33333001)))*l9_143.w;
}
#else
{
float l9_150;
...
{
l9_150=(1.0-clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0))*l9_143.w;
}
#else
{
float l9_151;
#if (sc_BlendMode_ColoredGlass)
{
l9_151=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0)*l9_143.w;
}
#else
{
float l9_152;
#if (sc_BlendMode_Add)
{
l9_152=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_153;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_153=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0)*l9_143.w;
}
#else
{
float l9_154;
...
{
l9_154=dot(l9_143.xyz,vec3(0.33333001))*l9_143.w;
}
#else
{
float l9_155;
#if (sc_BlendMode_Min)
{
l9_155=1.0-clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_156;
#if (sc_BlendMode_Max)
{
l9_156=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_156=1.0;
...
#endif
l9_144=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_143.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_145);
}
#else
{
vec4 l9_157;
...
{
vec3 l9_159=sc_GetFramebufferColor().xyz;
vec3 l9_160=mix(l9_159,definedBlend(l9_159,l9_143.xyz).xyz,vec3(l9_143.w));
vec4 l9_161=vec4(l9_160.x,l9_160.y,l9_160.z,vec4(0.0).w);
l9_161.w=1.0;
l9_158=l9_161;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_163=l9_143.w;
l9_162=vec4(mix(vec3(1.0),l9_143.xyz,vec3(l9_163)),l9_163);
}
#else
{
vec4 l9_164;
...
{
float l9_165=l9_143.w;
float l9_166;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_166=clamp(l9_165,0.0,1.0);
}
#else
{
l9_166=l9_165;
...
#endif
l9_164=vec4(l9_143.xyz*l9_166,l9_166);
}
#else
{
l9_164=l9_143;
...
{
l9_169=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_169=vec4(0.0);
...
vec4 l9_171=outputMotionVectorsIfNeeded(varPos,max(l9_170,vec4(0.0)));
vec4 l9_172=clamp(l9_171,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_173=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_173-0.0039215689)),min(1.0,l9_173+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_174=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_174).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_175=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_174).xy);
float l9_176=packValue(l9_175);
int l9_183=int(l9_172.w*255.0);
float l9_184=packValue(l9_183);
sc_writeFragData0(vec4(packValue(l9_175),packValue(l9_175),packValue(l9_175),packValue(l9_175)));
sc_writeFragData1(vec4(l9_176,packValue(l9_175),packValue(l9_175),packValue(l9_175)));
sc_writeFragData2(vec4(l9_184,packValue(l9_183),packValue(l9_183),packValue(l9_183)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_187=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_187).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_192==0)
{
l9_195=texture2D(sc_OITAlpha0,l9_187);
l9_194=texture2D(sc_OITDepthLow0,l9_187);
l9_193=texture2D(sc_OITDepthHigh0,l9_187);
}
else
{
l9_195=vec4(0.0);
...
if (l9_192==1)
{
l9_198=texture2D(sc_OITAlpha1,l9_187);
l9_197=texture2D(sc_OITDepthLow1,l9_187);
l9_196=texture2D(sc_OITDepthHigh1,l9_187);
}
else
{
l9_198=l9_195;
...
if (any(notEqual(l9_196,vec4(0.0)))||any(notEqual(l9_197,vec4(0.0))))
{
int l9_199[8]=l9_188;
unpackValues(l9_196.w,l9_192,l9_199);
unpackValues(l9_196.z,l9_192,l9_199);
unpackValues(l9_196.y,l9_192,l9_199);
unpackValues(l9_196.x,l9_192,l9_199);
unpackValues(l9_197.w,l9_192,l9_199);
unpackValues(l9_197.z,l9_192,l9_199);
unpackValues(l9_197.y,l9_192,l9_199);
unpackValues(l9_197.x,l9_192,l9_199);
int l9_208[8]=l9_189;
unpackValues(l9_198.w,l9_192,l9_208);
unpackValues(l9_198.z,l9_192,l9_208);
unpackValues(l9_198.y,l9_192,l9_208);
unpackValues(l9_198.x,l9_192,l9_208);
}
l9_192++;
continue;
}
...
vec4 l9_213=texture2D(sc_OITFilteredDepthBoundsTexture,l9_187);
vec2 l9_214=l9_213.xy;
int l9_215;
#if (sc_SkinBonesCount>0)
{
l9_215=encodeDepth(((1.0-l9_213.x)*1000.0)+getDepthOrderingEpsilon(),l9_214);
}
#else
{
l9_215=0;
...
#endif
int l9_216=encodeDepth(viewSpaceDepth(),l9_214);
vec4 l9_217;
l9_217=l9_172*l9_172.w;
vec4 l9_218;
int l9_219=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_219<8)
{
int l9_220=l9_188[l9_219];
int l9_221=l9_216-l9_215;
bool l9_222=l9_220<l9_221;
bool l9_223;
if (l9_222)
{
l9_223=l9_188[l9_219]>0;
}
else
{
l9_223=l9_222;
...
if (l9_223)
{
vec3 l9_224=l9_217.xyz*(1.0-(float(l9_189[l9_219])/255.0));
l9_218=vec4(l9_224.x,l9_224.y,l9_224.z,l9_217.w);
}
else
{
l9_218=l9_217;
...
sc_writeFragData0(l9_172);
}
#endif
}
#else
{
sc_writeFragData0(l9_171);
}
#endif
}
#endif
