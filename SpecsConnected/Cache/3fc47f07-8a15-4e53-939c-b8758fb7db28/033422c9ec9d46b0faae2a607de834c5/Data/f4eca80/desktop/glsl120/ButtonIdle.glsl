...
//sampler sampler additional_settings_btn_refl_texSmpSC 2:17
//sampler sampler iconSmpSC 2:18
...
//texture texture2D additional_settings_btn_refl_tex 2:0:2:17
//texture texture2D icon 2:1:2:18
...
vec3 l9_3=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*Port_Import_N049;
...
#endif
vec4 l9_8=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,l9_7,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6,0.0)).xyz*vec3(Port_Input1_N053))+vec3(Port_Input2_N053)).xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
float l9_9=clamp(length((varPackedTex.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_10;
if (l9_9<Port_Position1_N007)
{
l9_10=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_9/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_9<Port_Position2_N007)
{
l9_11=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_9-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_11=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_9-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_10=l9_11;
}
bool l9_12=PreviewEnabled==1;
bool l9_13;
if (l9_12)
{
l9_13=!l9_0;
...
{
l9_15=PreviewVertexColor;
l9_14=l9_0;
}
float l9_17=clamp(l9_10.x,0.0,1.0);
float l9_18;
if (l9_17<Port_Position1_N018)
{
l9_18=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_17/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_19;
if (l9_17<Port_Position2_N018)
{
l9_19=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_17-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_20;
if (l9_17<Port_Position3_N018)
{
l9_20=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_17-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_20=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_17-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_19=l9_20;
}
l9_18=l9_19;
}
vec4 l9_21=vec4(l9_10.x,l9_10.y,l9_10.z,vec4(0.0).w);
l9_21.w=l9_18;
vec2 l9_22=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_23=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_22,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
float l9_24;
if ((float(iconEnabled)*1.0)!=0.0)
{
l9_24=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_22,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon).w;
}
else
{
l9_24=Port_Input2_N003;
}
vec4 l9_25=vec4(l9_24);
vec4 l9_26=mix((vec4(Port_Import_N006)*l9_8)+l9_21,l9_23,l9_25);
float l9_27=l9_26.w;
...
{
if (l9_27<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_31=clamp(dot(l9_26.xyz,vec3(l9_27)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*l9_27;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*l9_27;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_36;
#if (sc_BlendMode_Add)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_37;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_26.xyz,vec3(0.33333001))*l9_27;
}
#else
{
float l9_39;
#if (sc_BlendMode_Min)
{
l9_39=1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
#if (sc_BlendMode_Max)
{
l9_40=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_40=1.0;
...
#endif
l9_28=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_26.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_29);
}
#else
{
vec4 l9_41;
...
#if (sc_FramebufferFetch)
{
vec4 l9_44=sc_readFragData0_Platform();
vec4 l9_45;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_46=l9_44;
l9_46.x=l9_44.x+_sc_framebufferFetchMarker;
l9_45=l9_46;
}
#else
{
...
#endif
l9_43=sc_SampleView(sc_ScreenTextureDims.xy,l9_47,sc_ScreenTextureLayout,l9_48,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_49;
...
{
vec4 l9_50=l9_43;
l9_50.x=l9_43.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_49=l9_50;
}
#else
{
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_26.xyz).xyz,vec3(l9_27));
vec4 l9_52=vec4(l9_51.x,l9_51.y,l9_51.z,vec4(0.0).w);
l9_52.w=1.0;
l9_42=l9_52;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_26.xyz,vec3(l9_27)),l9_27);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_26.xyz*l9_55,l9_55);
}
#else
{
l9_54=l9_26;
