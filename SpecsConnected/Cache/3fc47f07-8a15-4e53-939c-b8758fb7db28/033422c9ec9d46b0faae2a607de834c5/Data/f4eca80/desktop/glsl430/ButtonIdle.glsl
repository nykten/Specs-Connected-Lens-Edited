...
#endif
vec4 l9_19=vec4(Port_Import_N006)*l9_18;
vec2 l9_20=l9_4*Port_Input1_N009;
float l9_21=clamp(length(l9_20+Port_Input2_N009),0.0,1.0);
vec4 l9_22;
if (l9_21<Port_Position1_N007)
{
l9_22=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_21/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_21<Port_Position2_N007)
{
l9_23=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_21-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_23=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_21-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_22=l9_23;
}
bool l9_24=PreviewEnabled==1;
bool l9_25;
if (l9_24)
{
l9_25=!l9_0;
...
{
l9_27=PreviewVertexColor;
l9_26=l9_0;
}
float l9_29=clamp(l9_22.x,0.0,1.0);
float l9_30;
if (l9_29<Port_Position1_N018)
{
l9_30=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_29/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_31;
if (l9_29<Port_Position2_N018)
{
l9_31=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_29-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_32;
if (l9_29<Port_Position3_N018)
{
l9_32=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_29-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_32=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_29-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_31=l9_32;
}
l9_30=l9_31;
}
vec4 l9_33=vec4(l9_22.x,l9_22.y,l9_22.z,vec4(0.0).w);
l9_33.w=l9_30;
vec2 l9_34=l9_5-Port_Center_N002;
vec2 l9_35=(l9_34*Port_Scale_N002)+Port_Center_N002;
vec4 l9_36;
#if (iconLayout==2)
{
l9_36=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_36=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
float l9_37;
...
#if (iconLayout==2)
{
l9_38=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_38=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
l9_37=l9_38.w;
}
...
{
l9_37=Port_Input2_N003;
}
vec4 l9_39=vec4(l9_37);
vec4 l9_40=mix(l9_19+l9_33,l9_36,l9_39);
float l9_41=l9_40.w;
...
#endif
sc_writeFragData0(max(l9_42,vec4(0.0)));
return;
}
vec4 l9_44;
...
{
l9_47=clamp(dot(l9_40.xyz,vec3(l9_41)),0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_49=(1.0-dot(l9_40.xyz,vec3(0.33333001)))*l9_41;
}
#else
{
float l9_50;
...
{
l9_50=(1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0))*l9_41;
}
#else
{
float l9_51;
...
{
l9_51=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*l9_41;
}
#else
{
float l9_52;
#if (sc_BlendMode_Add)
{
l9_52=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_53=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*l9_41;
}
#else
{
float l9_54;
...
{
l9_54=dot(l9_40.xyz,vec3(0.33333001))*l9_41;
}
#else
{
float l9_55;
#if (sc_BlendMode_Min)
{
l9_55=1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
#if (sc_BlendMode_Max)
{
l9_56=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_56=1.0;
...
#endif
l9_44=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_40.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_45);
}
#else
{
vec4 l9_57;
...
#if (sc_FramebufferFetch)
{
vec4 l9_60=sc_readFragData0_Platform();
vec4 l9_61;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_62=l9_60;
l9_62.x=l9_60.x+_sc_framebufferFetchMarker;
l9_61=l9_62;
}
#else
{
...
{
l9_64=1-sc_GetStereoViewIndex();
}
#else
{
l9_64=sc_GetStereoViewIndex();
}
#endif
vec4 l9_65;
#if (sc_ScreenTextureLayout==2)
{
l9_65=sc_SampleView(sc_ScreenTextureDims.xy,l9_63,sc_ScreenTextureLayout,l9_64,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_65=sc_SampleView(sc_ScreenTextureDims.xy,l9_63,sc_ScreenTextureLayout,l9_64,0.0,sc_ScreenTexture);
}
#endif
l9_59=l9_65;
}
...
{
vec4 l9_67=l9_59;
l9_67.x=l9_59.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_66=l9_67;
}
#else
{
...
#endif
vec3 l9_68=mix(l9_66.xyz,definedBlend(l9_66.xyz,l9_40.xyz).xyz,vec3(l9_41));
vec4 l9_69=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_69.w=1.0;
l9_58=l9_69;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_70=vec4(mix(vec3(1.0),l9_40.xyz,vec3(l9_41)),l9_41);
}
#else
{
vec4 l9_71;
...
#endif
l9_71=vec4(l9_40.xyz*l9_72,l9_72);
}
#else
{
l9_71=l9_40;
...
{
l9_75=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_75=vec4(0.0);
...
vec4 l9_77=outputMotionVectorsIfNeeded(varPos,max(l9_76,vec4(0.0)));
vec4 l9_78=clamp(l9_77,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_79=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_79-0.0039215689)),min(1.0,l9_79+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_81=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_80).xy);
float l9_82=packValue(l9_81);
int l9_89=int(l9_78.w*255.0);
float l9_90=packValue(l9_89);
sc_writeFragData0(vec4(packValue(l9_81),packValue(l9_81),packValue(l9_81),packValue(l9_81)));
sc_writeFragData1(vec4(l9_82,packValue(l9_81),packValue(l9_81),packValue(l9_81)));
sc_writeFragData2(vec4(l9_90,packValue(l9_89),packValue(l9_89),packValue(l9_89)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_93).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_98==0)
{
l9_101=texture(sc_OITAlpha0,l9_93);
l9_100=texture(sc_OITDepthLow0,l9_93);
l9_99=texture(sc_OITDepthHigh0,l9_93);
}
else
{
l9_101=vec4(0.0);
...
if (l9_98==1)
{
l9_104=texture(sc_OITAlpha1,l9_93);
l9_103=texture(sc_OITDepthLow1,l9_93);
l9_102=texture(sc_OITDepthHigh1,l9_93);
}
else
{
l9_104=l9_101;
...
if (any(notEqual(l9_102,vec4(0.0)))||any(notEqual(l9_103,vec4(0.0))))
{
int l9_105[8]=l9_94;
unpackValues(l9_102.w,l9_98,l9_105);
unpackValues(l9_102.z,l9_98,l9_105);
unpackValues(l9_102.y,l9_98,l9_105);
unpackValues(l9_102.x,l9_98,l9_105);
unpackValues(l9_103.w,l9_98,l9_105);
unpackValues(l9_103.z,l9_98,l9_105);
unpackValues(l9_103.y,l9_98,l9_105);
unpackValues(l9_103.x,l9_98,l9_105);
int l9_114[8]=l9_95;
unpackValues(l9_104.w,l9_98,l9_114);
unpackValues(l9_104.z,l9_98,l9_114);
unpackValues(l9_104.y,l9_98,l9_114);
unpackValues(l9_104.x,l9_98,l9_114);
}
l9_98++;
continue;
}
...
vec4 l9_119=texture(sc_OITFilteredDepthBoundsTexture,l9_93);
vec2 l9_120=l9_119.xy;
int l9_121;
#if (sc_SkinBonesCount>0)
{
l9_121=encodeDepth(((1.0-l9_119.x)*1000.0)+getDepthOrderingEpsilon(),l9_120);
}
#else
{
l9_121=0;
...
#endif
int l9_122=encodeDepth(viewSpaceDepth(),l9_120);
vec4 l9_123;
l9_123=l9_78*l9_78.w;
vec4 l9_124;
int l9_125=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_125<8)
{
int l9_126=l9_94[l9_125];
int l9_127=l9_122-l9_121;
bool l9_128=l9_126<l9_127;
bool l9_129;
if (l9_128)
{
l9_129=l9_94[l9_125]>0;
}
else
{
l9_129=l9_128;
...
if (l9_129)
{
vec3 l9_130=l9_123.xyz*(1.0-(float(l9_95[l9_125])/255.0));
l9_124=vec4(l9_130.x,l9_130.y,l9_130.z,l9_123.w);
}
else
{
l9_124=l9_123;
