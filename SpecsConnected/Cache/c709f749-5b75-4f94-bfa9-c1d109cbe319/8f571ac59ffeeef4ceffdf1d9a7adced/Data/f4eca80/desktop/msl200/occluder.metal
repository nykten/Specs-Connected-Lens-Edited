...
//float4 Port_FinalColor_N004 4144
//float depthRef 4160
//}
...
float4 FinalColor=(*sc_set2.UserUniforms).Port_FinalColor_N004;
bool l9_0=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_0)
{
...
float param=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
if (l9_8)
{
float4 param_1=FinalColor;
if ((int(sc_ProxyAlphaOne_tmp)!=0))
{
param_1.w=1.0;
}
float4 l9_9=fast::max(param_1,float4(0.0));
float4 param_2=l9_9;
out.FragColor0=param_2;
return out;
}
float4 param_3=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_10=param_3;
float4 l9_11=l9_10;
float l9_12=1.0;
...
float3 param_4=in.varPos;
float4 param_5=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_4,param_5,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_6=FinalColor;
float4 l9_83=param_6;
