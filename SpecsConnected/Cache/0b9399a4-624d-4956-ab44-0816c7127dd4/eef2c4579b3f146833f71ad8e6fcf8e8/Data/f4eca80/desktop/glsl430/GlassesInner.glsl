...
vec4 l9_1=Tweak_N95*vec4(alpha);
float l9_2=l9_1.w;
...
{
l9_8=clamp(dot(l9_1.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_13;
#if (sc_BlendMode_Add)
{
l9_13=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_1.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_16;
#if (sc_BlendMode_Min)
{
l9_16=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_Max)
{
l9_17=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_17=1.0;
...
#endif
l9_5=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_6);
}
#else
{
vec4 l9_18;
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_1.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_32;
...
#endif
l9_32=vec4(l9_1.xyz*l9_33,l9_33);
}
#else
{
l9_32=l9_1;
