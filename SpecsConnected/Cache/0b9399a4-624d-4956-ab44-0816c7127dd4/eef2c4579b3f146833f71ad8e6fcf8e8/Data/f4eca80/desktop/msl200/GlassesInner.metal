...
float4 Output_N95=float4(0.0);
float4 param=(*sc_set2.UserUniforms).Tweak_N95;
Output_N95=param;
float Output_N129=0.0;
float param_1=(*sc_set2.UserUniforms).alpha;
Output_N129=param_1;
float4 Output_N130=float4(0.0);
Output_N130=Output_N95*float4(Output_N129);
FinalColor=Output_N130;
float param_2=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_2<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
if (l9_8)
{
float4 param_3=FinalColor;
if ((int(sc_ProxyAlphaOne_tmp)!=0))
{
param_3.w=1.0;
}
float4 l9_9=fast::max(param_3,float4(0.0));
float4 param_4=l9_9;
...
FinalColor=outputMotionVectorsIfNeeded(param_6,param_7,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_8=FinalColor;
float4 l9_83=param_8;
