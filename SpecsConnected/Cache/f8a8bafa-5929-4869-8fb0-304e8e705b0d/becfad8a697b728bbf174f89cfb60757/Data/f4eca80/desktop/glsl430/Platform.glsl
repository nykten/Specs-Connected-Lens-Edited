...
l9_6=l9_11;
l9_5=l9_12;
l9_4=cross(l9_11,l9_12)*varTangent.w;
l9_3=normalize(sc_Camera.position-varPos);
l9_2=varPackedTex.zw;
l9_1=varPackedTex.xy;
}
mat3 l9_13=mat3(l9_5,l9_4,l9_6);
vec3 l9_14=-l9_3;
vec3 l9_15=normalize(l9_14);
vec3 l9_16=normalize(cross(l9_15,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_17=cross(l9_16,l9_15);
vec2 l9_18=((mat3(vec3(l9_16.x,l9_17.x,l9_15.x),vec3(l9_16.y,l9_17.y,l9_15.y),vec3(l9_16.z,l9_17.z,l9_15.z))*normalize(l9_13*Port_Import_N013)).xy*0.5)+vec2(0.5);
vec4 l9_19;
#if (planet_refl_mapLayout==2)
{
l9_19=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_mapArrSC);
}
#else
{
...
#endif
vec4 l9_20=vec4(reflIntensity)*l9_19;
float l9_21=radians(Port_Rotation_N003);
vec2 l9_22=l9_2-Port_Center_N003;
float l9_23=clamp((vec2(dot(vec2(cos(l9_21),sin(l9_21)),l9_22),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_24;
if (l9_23<colorRatio)
{
l9_24=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_23/colorRatio,0.0,1.0)));
}
else
{
l9_24=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_23-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
...
vec4 l9_30=l9_20+l9_24;
vec4 l9_31;
#if (Tweak_N6Layout==2)
{
l9_31=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6ArrSC);
}
#else
{
l9_31=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,Tweak_N6GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
...
#endif
vec3 l9_32=l9_30.xyz;
vec3 l9_33=mix(l9_32,(l9_31.xyz*l9_32).xyz,vec3(l9_31.w));
float l9_34=l9_30.w;
vec4 l9_35=vec4(l9_33.x,l9_33.y,l9_33.z,vec4(0.0).w);
l9_35.w=l9_34;
