...
vec3 l9_3=normalize(-normalize(sc_Camera.position-varPos));
vec3 l9_4=normalize(cross(l9_3,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_5=cross(l9_4,l9_3);
int l9_6;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(planet_refl_mapDims.xy,planet_refl_mapLayout,l9_6,((mat3(vec3(l9_4.x,l9_5.x,l9_3.x),vec3(l9_4.y,l9_5.y,l9_3.y),vec3(l9_4.z,l9_5.z,l9_3.z))*normalize(mat3(l9_2,cross(l9_1,l9_2)*varTangent.w,l9_1)*Port_Import_N013)).xy*0.5)+vec2(0.5),(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map),(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0),planet_refl_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0),planet_refl_mapBorderColor,0.0,planet_refl_map);
float l9_8=radians(Port_Rotation_N003);
float l9_9=clamp((vec2(dot(vec2(cos(l9_8),sin(l9_8)),varPackedTex.zw-Port_Center_N003),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_10;
if (l9_9<colorRatio)
{
l9_10=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_9/colorRatio,0.0,1.0)));
}
else
{
l9_10=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_9-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
...
vec4 l9_16=(vec4(reflIntensity)*l9_7)+l9_10;
int l9_17;
...
#endif
vec4 l9_18=sc_SampleTextureBiasOrLevel(Tweak_N6Dims.xy,Tweak_N6Layout,l9_17,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6),(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0),Tweak_N6UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0),Tweak_N6BorderColor,0.0,Tweak_N6);
vec3 l9_19=l9_16.xyz;
vec3 l9_20=mix(l9_19,(l9_18.xyz*l9_19).xyz,vec3(l9_18.w));
float l9_21=l9_16.w;
vec4 l9_22=vec4(l9_20.x,l9_20.y,l9_20.z,vec4(0.0).w);
l9_22.w=l9_21;
...
{
if (l9_21<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_26=clamp(dot(l9_22.xyz,vec3(l9_21)),0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_28=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*l9_21;
}
#else
{
float l9_29;
...
{
l9_29=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*l9_21;
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_31;
#if (sc_BlendMode_Add)
{
l9_31=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_32;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_32=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_33;
...
{
l9_33=dot(l9_22.xyz,vec3(0.33333001))*l9_21;
}
#else
{
float l9_34;
#if (sc_BlendMode_Min)
{
l9_34=1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_35;
#if (sc_BlendMode_Max)
{
l9_35=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_35=1.0;
...
#endif
l9_23=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_22.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_24);
}
#else
{
vec4 l9_36;
...
#endif
l9_38=sc_SampleView(sc_ScreenTextureDims.xy,l9_42,sc_ScreenTextureLayout,l9_43,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_44;
...
{
vec4 l9_45=l9_38;
l9_45.x=l9_38.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_44=l9_45;
}
#else
{
...
#endif
vec3 l9_46=mix(l9_44.xyz,definedBlend(l9_44.xyz,l9_22.xyz).xyz,vec3(l9_21));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_22.xyz,vec3(l9_21)),l9_21);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_22.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_22;
...
#endif
int l9_59=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_58).xy);
...
if (l9_76==0)
{
l9_79=texture2D(sc_OITAlpha0,l9_71);
l9_78=texture2D(sc_OITDepthLow0,l9_71);
l9_77=texture2D(sc_OITDepthHigh0,l9_71);
}
else
{
l9_79=vec4(0.0);
...
if (l9_76==1)
{
l9_82=texture2D(sc_OITAlpha1,l9_71);
l9_81=texture2D(sc_OITDepthLow1,l9_71);
l9_80=texture2D(sc_OITDepthHigh1,l9_71);
}
else
{
l9_82=l9_79;
...
vec4 l9_97=texture2D(sc_OITFilteredDepthBoundsTexture,l9_71);
vec2 l9_98=l9_97.xy;
int l9_99;
#if (sc_SkinBonesCount>0)
{
