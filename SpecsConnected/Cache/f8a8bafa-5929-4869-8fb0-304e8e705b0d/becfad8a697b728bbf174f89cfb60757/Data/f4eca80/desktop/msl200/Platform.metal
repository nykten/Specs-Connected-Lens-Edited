...
//sampler sampler Tweak_N6SmpSC 2:23
//sampler sampler intensityTextureSmpSC 2:24
//sampler sampler planet_refl_mapSmpSC 2:25
...
//texture texture2D Tweak_N6 2:4:2:23
//texture texture2D intensityTexture 2:5:2:24
//texture texture2D planet_refl_map 2:6:2:25
...
//}
//ubo int UserUniforms 2:35:4528 {
...
//float4 Tweak_N6Size 4336
//float4 Tweak_N6Dims 4352
//float4 Tweak_N6View 4368
//float3x3 Tweak_N6Transform 4384
//float4 Tweak_N6UvMinMax 4432
//float4 Tweak_N6BorderColor 4448
//float Port_Import_N006 4464
//float3 Port_Import_N013 4480
//float Port_Rotation_N003 4496
//float2 Port_Center_N003 4504
//float depthRef 4512
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N6 1031
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 1032
//spec_const bool SC_USE_CLAMP_TO_BORDER_planet_refl_map 1033
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N6 1034
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 1035
//spec_const bool SC_USE_UV_MIN_MAX_planet_refl_map 1036
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 1037
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 1038
//spec_const bool SC_USE_UV_TRANSFORM_planet_refl_map 1039
//spec_const bool Tweak_N6HasSwappedViews 1040
//spec_const bool UseViewSpaceDepthVariant 1041
//spec_const bool intensityTextureHasSwappedViews 1042
//spec_const bool planet_refl_mapHasSwappedViews 1043
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 1074
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1075
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 1076
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 1077
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1078
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 1079
//spec_const int Tweak_N6Layout 1080
//spec_const int intensityTextureLayout 1081
//spec_const int planet_refl_mapLayout 1082
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N6 [[function_constant(1031)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_planet_refl_map [[function_constant(1033)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N6 [[function_constant(1034)]];
...
constant bool SC_USE_UV_MIN_MAX_planet_refl_map [[function_constant(1036)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N6 [[function_constant(1037)]];
...
constant bool SC_USE_UV_TRANSFORM_planet_refl_map [[function_constant(1039)]];
...
constant bool Tweak_N6HasSwappedViews [[function_constant(1040)]];
...
constant bool intensityTextureHasSwappedViews [[function_constant(1042)]];
constant bool intensityTextureHasSwappedViews_tmp = is_function_constant_defined(intensityTextureHasSwappedViews) ? intensityTextureHasSwappedViews : false;
constant bool planet_refl_mapHasSwappedViews [[function_constant(1043)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(1074)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map [[function_constant(1076)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(1077)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map [[function_constant(1079)]];
...
constant int Tweak_N6Layout [[function_constant(1080)]];
...
constant int planet_refl_mapLayout [[function_constant(1082)]];
...
UVCoord_N11=Globals.Surface_UVCoord1;
float2 CoordsOut_N3=float2(0.0);
float2 param_16=UVCoord_N11;
float param_17=(*sc_set2.UserUniforms).Port_Rotation_N003;
float2 param_18=(*sc_set2.UserUniforms).Port_Center_N003;
float l9_101=sin(radians(param_17));
float l9_102=cos(radians(param_17));
float2 param_19=param_16-param_18;
param_19=float2(dot(float2(l9_102,l9_101),param_19),dot(float2(-l9_101,l9_102),param_19))+param_18;
CoordsOut_N3=param_19;
float4 Output_N2=float4(0.0);
float4 param_20=(*sc_set2.UserUniforms).Tweak_N2;
Output_N2=param_20;
float Output_N12=0.0;
float param_21=(*sc_set2.UserUniforms).colorRatio;
Output_N12=param_21;
float4 Output_N8=float4(0.0);
float4 param_22=(*sc_set2.UserUniforms).Tweak_N8;
Output_N8=param_22;
float4 Output_N9=float4(0.0);
float4 param_23=(*sc_set2.UserUniforms).Tweak_N9;
Output_N9=param_23;
float4 Value_N0=float4(0.0);
float param_24=CoordsOut_N3.x;
float4 param_25=Output_N2;
float param_26=Output_N12;
float4 param_27=Output_N8;
float4 param_28=Output_N9;
param_24=fast::clamp(param_24,0.0,1.0);
float4 param_29;
if (param_24<param_26)
{
param_29=mix(param_25,param_27,float4(fast::clamp(param_24/param_26,0.0,1.0)));
}
else
{
param_29=mix(param_27,param_28,float4(fast::clamp((param_24-param_26)/(1.0-param_26),0.0,1.0)));
}
bool l9_103=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_104;
if (l9_103)
{
l9_104=!PreviewInfo.Saved;
}
else
{
l9_104=l9_103;
...
if (l9_104)
{
l9_105=0==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_105=l9_104;
...
PreviewInfo.Color=param_29;
PreviewInfo.Color.w=1.0;
}
Value_N0=param_29;
float4 Output_N17=float4(0.0);
Output_N17=Export_N40+Value_N0;
...
int l9_111=l9_106;
int param_30=Tweak_N6Layout_tmp;
int param_31=l9_111;
float2 param_32=UVCoord_N19;
bool param_33=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_34=(*sc_set2.UserUniforms).Tweak_N6Transform;
int2 param_35=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_36=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_37=(*sc_set2.UserUniforms).Tweak_N6UvMinMax;
bool param_38=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_39=(*sc_set2.UserUniforms).Tweak_N6BorderColor;
float param_40=0.0;
bool l9_112=param_38&&(!param_36);
float l9_113=1.0;
float l9_114=param_32.x;
int l9_115=param_35.x;
if (l9_115==1)
{
l9_114=fract(l9_114);
}
...
param_32.x=l9_114;
float l9_119=param_32.y;
int l9_120=param_35.y;
if (l9_120==1)
{
l9_119=fract(l9_119);
}
...
float l9_126=param_32.x;
float l9_127=param_37.x;
float l9_128=param_37.z;
bool l9_129=l9_125;
float l9_130=l9_113;
...
float l9_135=param_32.y;
float l9_136=param_37.y;
float l9_137=param_37.w;
bool l9_138=l9_134;
float l9_139=l9_113;
...
float2 l9_142=param_32;
bool l9_143=param_33;
float3x3 l9_144=param_34;
if (l9_143)
{
...
param_32=l9_147;
float l9_148=param_32.x;
int l9_149=param_35.x;
bool l9_150=l9_112;
float l9_151=l9_113;
...
param_32.x=l9_148;
l9_113=l9_151;
float l9_159=param_32.y;
int l9_160=param_35.y;
bool l9_161=l9_112;
float l9_162=l9_113;
...
param_32.y=l9_159;
l9_113=l9_162;
float2 l9_170=param_32;
int l9_171=param_30;
int l9_172=param_31;
float l9_173=param_40;
...
float l9_181=l9_173;
float4 l9_182=sc_set2.Tweak_N6.sample(sc_set2.Tweak_N6SmpSC,l9_180,bias(l9_181));
float4 l9_183=l9_182;
float4 l9_184=l9_183;
if (param_38)
{
l9_184=mix(param_39,l9_184,float4(l9_113));
}
float4 l9_185=l9_184;
Color_N20=l9_185;
float4 Output_N21=float4(0.0);
float4 param_41=Output_N17;
float4 param_42=Color_N20;
float3 l9_186=param_42.xyz*param_41.xyz;
float4 param_43;
param_43=float4(l9_186.x,l9_186.y,l9_186.z,param_43.w);
float3 l9_187=mix(param_41.xyz,param_43.xyz,float3(param_42.w));
param_43=float4(l9_187.x,l9_187.y,l9_187.z,param_43.w);
...
bool l9_191=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_191)
{
...
float4 l9_192=fast::max(param_45,float4(0.0));
float4 param_46=l9_192;
...
{
l9_195=fast::clamp(l9_194.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_195=fast::clamp(dot(l9_194.xyz,float3(l9_194.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_195=(1.0-dot(l9_194.xyz,float3(0.33333001)))*l9_194.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_195=(1.0-fast::clamp(dot(l9_194.xyz,float3(1.0)),0.0,1.0))*l9_194.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_195=fast::clamp(dot(l9_194.xyz,float3(1.0)),0.0,1.0)*l9_194.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_195=fast::clamp(dot(l9_194.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_195=dot(l9_194.xyz,float3(0.33333001))*l9_194.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_195=1.0-fast::clamp(dot(l9_194.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_196=l9_195;
float l9_197=l9_196;
float l9_198=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_197;
float3 l9_199=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_193.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_200=float4(l9_199.x,l9_199.y,l9_199.z,l9_198);
param_47=l9_200;
}
else
{
...
{
l9_205.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_208=(l9_207.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
float l9_245=l9_237;
float4 l9_246=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_244,bias(l9_245));
...
float3 l9_256=definedBlend(l9_254,l9_255,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
...
{
l9_264=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_264=float4(0.0);
...
float4 l9_266=param_50;
out.FragColor0=l9_266;
return out;
}
} // FRAGMENT SHADER
