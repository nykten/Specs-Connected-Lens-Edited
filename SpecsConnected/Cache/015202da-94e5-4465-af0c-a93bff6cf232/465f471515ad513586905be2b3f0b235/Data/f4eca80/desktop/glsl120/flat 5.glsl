...
{
l9_32=clamp(dot(l9_28.xyz,vec3(l9_27)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*l9_27;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*l9_27;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_28.xyz,vec3(0.33333001))*l9_27;
}
#else
{
float l9_40;
...
#endif
vec3 l9_52=mix(l9_50.xyz,definedBlend(l9_50.xyz,l9_28.xyz).xyz,vec3(l9_27));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_27)),l9_27);
}
#else
{
vec4 l9_55;
...
#endif
l9_55=vec4(l9_28.xyz*l9_56,l9_56);
}
#else
{
l9_55=l9_28;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_64=sc_ScreenCoordsGlobalToView(l9_3);
...
#if (sc_OITCompositingPass)
{
vec2 l9_77=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
