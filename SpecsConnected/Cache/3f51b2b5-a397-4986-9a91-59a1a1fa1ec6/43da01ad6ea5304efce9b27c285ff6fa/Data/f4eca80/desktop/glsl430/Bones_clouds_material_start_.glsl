...
//texture texture2DArray intensityTextureArrSC 2:23:2:15
//texture texture2DArray sc_ScreenTextureArrSC 2:26:2:20
//SG_REFLECTION_END
...
{
l9_33=sc_SampleView(sc_ScreenTextureDims.xy,l9_31,sc_ScreenTextureLayout,l9_32,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_33=sc_SampleView(sc_ScreenTextureDims.xy,l9_31,sc_ScreenTextureLayout,l9_32,0.0,sc_ScreenTexture);
}
#endif
l9_27=l9_33;
}
...
{
vec4 l9_35=l9_27;
l9_35.x=l9_27.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_34=l9_35;
}
#else
{
...
#endif
vec3 l9_36=mix(l9_34.xyz,definedBlend(l9_34.xyz,l9_11.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_38=vec4(mix(vec3(1.0),l9_11.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_39;
...
#endif
l9_39=vec4(l9_11.xyz*l9_40,l9_40);
}
#else
{
l9_39=l9_11;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_47-0.0039215689)),min(1.0,l9_47+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_49),packValue(l9_49),packValue(l9_49),packValue(l9_49)));
