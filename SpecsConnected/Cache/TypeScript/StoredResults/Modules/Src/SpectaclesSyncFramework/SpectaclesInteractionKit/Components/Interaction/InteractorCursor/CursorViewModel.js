...
class CursorViewModel {
    ...
    setInteractor(interactor) {
        ...
        this.currentInteractableUnsubscribeCallback =
            (_b = (_a = this.interactor) === null || _a === void 0 ? void 0 : _a.onCurrentInteractableChanged.add((interactable) => {
    ...
    setupStateMachine() {
        ...
        this.stateMachine.addState({
            ...
            onUpdate: () => {
                ...
                this.updateIndirectCursorPosition((_b = (_a = this.interactor) === null || _a === void 0 ? void 0 : _a.interactionStrength) !== null && _b !== void 0 ? _b : null, position);
            },
            transitions: [
                {
        ...
        this.stateMachine.addState({
            ...
            onUpdate: () => {
                ...
                if (!this.isAnimating) {
                    ...
                    this.cursorDistance =
                        (_d = (_c = (_b = this.interactor) === null || _b === void 0 ? void 0 : _b.targetHitInfo) === null || _c === void 0 ? void 0 : _c.hit.position.distance(this.interactor.startPoint)) !== null && _d !== void 0 ? _d : this.cursorDistance;
                }
                const position = this.shouldCursorHold()
                    ? this.getHeldCursorPosition()
                    : this.getFarFieldCursorPosition();
                this.updateIndirectCursorPosition((_f = (_e = this.interactor) === null || _e === void 0 ? void 0 : _e.interactionStrength) !== null && _f !== void 0 ? _f : null, position);
            },
            transitions: [
                {
                    nextStateName: CursorState.Inactive,
