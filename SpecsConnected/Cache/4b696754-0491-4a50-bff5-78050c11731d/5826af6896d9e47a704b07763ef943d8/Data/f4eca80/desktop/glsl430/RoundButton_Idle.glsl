...
//sampler sampler simple_round_buttonSmpSC 2:29
...
//texture texture2D simple_round_button 2:18:2:29
...
//texture texture2DArray simple_round_buttonArrSC 2:36:2:29
...
uniform vec4 simple_round_buttonDims;
...
uniform vec4 simple_round_buttonSize;
uniform vec4 simple_round_buttonView;
...
vec3 l9_11=l9_10*Port_Import_N089;
...
vec3 l9_15=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_14,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037);
vec4 l9_16;
#if (simple_round_buttonLayout==2)
{
l9_16=sc_SampleTextureBiasOrLevel(simple_round_buttonDims.xy,simple_round_buttonLayout,simple_round_buttonGetStereoViewIndex(),l9_15.xy,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button),(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0),simple_round_buttonUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0),simple_round_buttonBorderColor,0.0,simple_round_buttonArrSC);
}
#else
{
l9_16=sc_SampleTextureBiasOrLevel(simple_round_buttonDims.xy,simple_round_buttonLayout,simple_round_buttonGetStereoViewIndex(),l9_15.xy,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button),(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0),simple_round_buttonUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0),simple_round_buttonBorderColor,0.0,simple_round_button);
}
#endif
vec4 l9_17=vec4(Port_Import_N027)*l9_16;
vec2 l9_18=l9_3*Port_Input1_N010;
float l9_19=clamp(length(l9_18+Port_Input2_N010),0.0,1.0);
vec4 l9_20;
if (l9_19<Port_Position1_N007)
{
l9_20=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_19/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_21;
if (l9_19<Port_Position2_N007)
{
l9_21=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_19-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_22;
if (l9_19<Port_Position3_N007)
{
l9_22=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_19-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_22=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_19-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_21=l9_22;
}
l9_20=l9_21;
}
vec3 l9_23=(l9_17.xyz+Port_Input1_N002)+l9_20.xyz;
vec4 l9_24=vec4(l9_23.x,l9_23.y,l9_23.z,vec4(0.0).w);
l9_24.w=l9_20.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_20.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_20.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_25,vec4(0.0)));
return;
}
vec4 l9_27;
...
{
l9_29=clamp(l9_20.w*2.0,0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_24.xyz,vec3(l9_20.w)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_24.xyz,vec3(0.33333001)))*l9_20.w;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0))*l9_20.w;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*l9_20.w;
}
#else
{
float l9_35;
#if (sc_BlendMode_Add)
{
l9_35=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*l9_20.w;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_24.xyz,vec3(0.33333001))*l9_20.w;
}
#else
{
float l9_38;
#if (sc_BlendMode_Min)
{
l9_38=1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_Max)
{
l9_39=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_39=1.0;
...
#endif
l9_27=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_24.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_28);
}
#else
{
vec4 l9_40;
...
#if (sc_FramebufferFetch)
{
vec4 l9_43=sc_readFragData0_Platform();
vec4 l9_44;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_45=l9_43;
l9_45.x=l9_43.x+_sc_framebufferFetchMarker;
l9_44=l9_45;
}
#else
{
...
{
l9_48=sc_SampleView(sc_ScreenTextureDims.xy,l9_46,sc_ScreenTextureLayout,l9_47,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_48=sc_SampleView(sc_ScreenTextureDims.xy,l9_46,sc_ScreenTextureLayout,l9_47,0.0,sc_ScreenTexture);
}
#endif
l9_42=l9_48;
}
...
{
vec4 l9_50=l9_42;
l9_50.x=l9_42.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_49=l9_50;
}
#else
{
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_24.xyz).xyz,vec3(l9_20.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_24.xyz,vec3(l9_20.w)),l9_20.w);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_24.xyz*l9_55,l9_55);
}
#else
{
l9_54=l9_24;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_63).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_64=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_63).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_76).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_81==0)
{
l9_84=texture(sc_OITAlpha0,l9_76);
l9_83=texture(sc_OITDepthLow0,l9_76);
l9_82=texture(sc_OITDepthHigh0,l9_76);
}
else
{
l9_84=vec4(0.0);
...
if (l9_81==1)
{
l9_87=texture(sc_OITAlpha1,l9_76);
l9_86=texture(sc_OITDepthLow1,l9_76);
l9_85=texture(sc_OITDepthHigh1,l9_76);
}
else
{
l9_87=l9_84;
...
vec4 l9_102=texture(sc_OITFilteredDepthBoundsTexture,l9_76);
