...
vec3 l9_2=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*Port_Import_N089;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(simple_round_buttonDims.xy,simple_round_buttonLayout,l9_6,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037)).xy,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button),(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0),simple_round_buttonUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0),simple_round_buttonBorderColor,0.0,simple_round_button);
float l9_8=clamp(length((varPackedTex.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_9;
if (l9_8<Port_Position1_N007)
{
l9_9=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_8/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_8<Port_Position2_N007)
{
l9_10=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_8-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_8<Port_Position3_N007)
{
l9_11=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_8-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_11=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_8-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_10=l9_11;
}
l9_9=l9_10;
}
vec3 l9_12=((vec4(Port_Import_N027)*l9_7).xyz+Port_Input1_N002)+l9_9.xyz;
vec4 l9_13=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_13.w=l9_9.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_9.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_9.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_16=clamp(l9_9.w*2.0,0.0,1.0);
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_13.xyz,vec3(l9_9.w)),0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_19=(1.0-dot(l9_13.xyz,vec3(0.33333001)))*l9_9.w;
}
#else
{
float l9_20;
...
{
l9_20=(1.0-clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0))*l9_9.w;
}
#else
{
float l9_21;
...
{
l9_21=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*l9_9.w;
}
#else
{
float l9_22;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_23=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*l9_9.w;
}
#else
{
float l9_24;
...
{
l9_24=dot(l9_13.xyz,vec3(0.33333001))*l9_9.w;
}
#else
{
float l9_25;
...
#endif
l9_29=sc_SampleView(sc_ScreenTextureDims.xy,l9_33,sc_ScreenTextureLayout,l9_34,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_35;
...
{
vec4 l9_36=l9_29;
l9_36.x=l9_29.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_35=l9_36;
}
#else
{
...
#endif
vec3 l9_37=mix(l9_35.xyz,definedBlend(l9_35.xyz,l9_13.xyz).xyz,vec3(l9_9.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_39=vec4(mix(vec3(1.0),l9_13.xyz,vec3(l9_9.w)),l9_9.w);
}
#else
{
vec4 l9_40;
...
#endif
l9_40=vec4(l9_13.xyz*l9_41,l9_41);
}
#else
{
l9_40=l9_13;
...
{
l9_44=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_44=vec4(0.0);
...
vec4 l9_46=outputMotionVectorsIfNeeded(varPos,max(l9_45,vec4(0.0)));
vec4 l9_47=clamp(l9_46,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_48=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_48-0.0039215689)),min(1.0,l9_48+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_49).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_50=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_49).xy);
float l9_51=packValue(l9_50);
int l9_58=int(l9_47.w*255.0);
float l9_59=packValue(l9_58);
sc_writeFragData0(vec4(packValue(l9_50),packValue(l9_50),packValue(l9_50),packValue(l9_50)));
sc_writeFragData1(vec4(l9_51,packValue(l9_50),packValue(l9_50),packValue(l9_50)));
sc_writeFragData2(vec4(l9_59,packValue(l9_58),packValue(l9_58),packValue(l9_58)));
...
if (l9_67==0)
{
l9_70=texture2D(sc_OITAlpha0,l9_62);
l9_69=texture2D(sc_OITDepthLow0,l9_62);
l9_68=texture2D(sc_OITDepthHigh0,l9_62);
}
else
{
l9_70=vec4(0.0);
...
if (l9_67==1)
{
l9_73=texture2D(sc_OITAlpha1,l9_62);
l9_72=texture2D(sc_OITDepthLow1,l9_62);
l9_71=texture2D(sc_OITDepthHigh1,l9_62);
}
else
{
l9_73=l9_70;
...
if (any(notEqual(l9_71,vec4(0.0)))||any(notEqual(l9_72,vec4(0.0))))
{
int l9_74[8]=l9_63;
unpackValues(l9_71.w,l9_67,l9_74);
unpackValues(l9_71.z,l9_67,l9_74);
unpackValues(l9_71.y,l9_67,l9_74);
unpackValues(l9_71.x,l9_67,l9_74);
unpackValues(l9_72.w,l9_67,l9_74);
unpackValues(l9_72.z,l9_67,l9_74);
unpackValues(l9_72.y,l9_67,l9_74);
unpackValues(l9_72.x,l9_67,l9_74);
int l9_83[8]=l9_64;
unpackValues(l9_73.w,l9_67,l9_83);
unpackValues(l9_73.z,l9_67,l9_83);
unpackValues(l9_73.y,l9_67,l9_83);
unpackValues(l9_73.x,l9_67,l9_83);
}
l9_67++;
continue;
}
...
vec4 l9_88=texture2D(sc_OITFilteredDepthBoundsTexture,l9_62);
vec2 l9_89=l9_88.xy;
int l9_90;
#if (sc_SkinBonesCount>0)
{
l9_90=encodeDepth(((1.0-l9_88.x)*1000.0)+getDepthOrderingEpsilon(),l9_89);
}
#else
{
l9_90=0;
...
#endif
int l9_91=encodeDepth(viewSpaceDepth(),l9_89);
vec4 l9_92;
l9_92=l9_47*l9_47.w;
vec4 l9_93;
int l9_94=0;
...
if (l9_94<8)
{
int l9_95=l9_63[l9_94];
int l9_96=l9_91-l9_90;
bool l9_97=l9_95<l9_96;
bool l9_98;
if (l9_97)
{
l9_98=l9_63[l9_94]>0;
...
if (l9_98)
{
vec3 l9_99=l9_92.xyz*(1.0-(float(l9_64[l9_94])/255.0));
l9_93=vec4(l9_99.x,l9_99.y,l9_99.z,l9_92.w);
}
else
{
l9_93=l9_92;
