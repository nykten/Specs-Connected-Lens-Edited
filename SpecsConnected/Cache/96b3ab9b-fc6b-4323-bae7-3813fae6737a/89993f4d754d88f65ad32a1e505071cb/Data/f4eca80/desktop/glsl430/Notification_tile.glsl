...
l9_28.w=Port_Value2_N014;
vec4 l9_29=l9_28*vec4(notification_tile_opacity);
float l9_30=l9_29.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_30<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_30<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_31,vec4(0.0)));
return;
}
vec4 l9_33;
...
{
l9_36=clamp(dot(l9_29.xyz,vec3(l9_30)),0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_38=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*l9_30;
}
#else
{
float l9_39;
...
{
l9_39=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*l9_30;
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_30;
}
#else
{
float l9_41;
#if (sc_BlendMode_Add)
{
l9_41=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_42=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_30;
}
#else
{
float l9_43;
...
{
l9_43=dot(l9_29.xyz,vec3(0.33333001))*l9_30;
}
#else
{
float l9_44;
#if (sc_BlendMode_Min)
{
l9_44=1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
#if (sc_BlendMode_Max)
{
l9_45=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_45=1.0;
...
#endif
l9_33=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_29.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_34);
}
#else
{
vec4 l9_46;
...
#if (sc_FramebufferFetch)
{
vec4 l9_49=sc_readFragData0_Platform();
vec4 l9_50;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_51=l9_49;
l9_51.x=l9_49.x+_sc_framebufferFetchMarker;
l9_50=l9_51;
}
#else
{
...
#else
{
vec2 l9_52=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_53;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_53=1-sc_GetStereoViewIndex();
}
#else
{
l9_53=sc_GetStereoViewIndex();
}
#endif
vec4 l9_54;
#if (sc_ScreenTextureLayout==2)
{
l9_54=sc_SampleView(sc_ScreenTextureDims.xy,l9_52,sc_ScreenTextureLayout,l9_53,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_54=sc_SampleView(sc_ScreenTextureDims.xy,l9_52,sc_ScreenTextureLayout,l9_53,0.0,sc_ScreenTexture);
}
#endif
l9_48=l9_54;
}
...
{
vec4 l9_56=l9_48;
l9_56.x=l9_48.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_55=l9_56;
}
#else
{
...
#endif
vec3 l9_57=mix(l9_55.xyz,definedBlend(l9_55.xyz,l9_29.xyz).xyz,vec3(l9_30));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_30)),l9_30);
}
#else
{
vec4 l9_60;
...
#endif
l9_60=vec4(l9_29.xyz*l9_61,l9_61);
}
#else
{
l9_60=l9_29;
...
{
l9_64=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_64=vec4(0.0);
...
vec4 l9_66=outputMotionVectorsIfNeeded(varPos,max(l9_65,vec4(0.0)));
vec4 l9_67=clamp(l9_66,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_68=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_68-0.0039215689)),min(1.0,l9_68+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_69=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_70=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_69).xy);
float l9_71=packValue(l9_70);
int l9_78=int(l9_67.w*255.0);
float l9_79=packValue(l9_78);
sc_writeFragData0(vec4(packValue(l9_70),packValue(l9_70),packValue(l9_70),packValue(l9_70)));
sc_writeFragData1(vec4(l9_71,packValue(l9_70),packValue(l9_70),packValue(l9_70)));
sc_writeFragData2(vec4(l9_79,packValue(l9_78),packValue(l9_78),packValue(l9_78)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_82=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_87==0)
{
l9_90=texture(sc_OITAlpha0,l9_82);
l9_89=texture(sc_OITDepthLow0,l9_82);
l9_88=texture(sc_OITDepthHigh0,l9_82);
}
else
{
l9_90=vec4(0.0);
...
if (l9_87==1)
{
l9_93=texture(sc_OITAlpha1,l9_82);
l9_92=texture(sc_OITDepthLow1,l9_82);
l9_91=texture(sc_OITDepthHigh1,l9_82);
}
else
{
l9_93=l9_90;
...
if (any(notEqual(l9_91,vec4(0.0)))||any(notEqual(l9_92,vec4(0.0))))
{
int l9_94[8]=l9_83;
unpackValues(l9_91.w,l9_87,l9_94);
unpackValues(l9_91.z,l9_87,l9_94);
unpackValues(l9_91.y,l9_87,l9_94);
unpackValues(l9_91.x,l9_87,l9_94);
unpackValues(l9_92.w,l9_87,l9_94);
unpackValues(l9_92.z,l9_87,l9_94);
unpackValues(l9_92.y,l9_87,l9_94);
unpackValues(l9_92.x,l9_87,l9_94);
int l9_103[8]=l9_84;
unpackValues(l9_93.w,l9_87,l9_103);
unpackValues(l9_93.z,l9_87,l9_103);
unpackValues(l9_93.y,l9_87,l9_103);
unpackValues(l9_93.x,l9_87,l9_103);
}
l9_87++;
continue;
}
...
vec4 l9_108=texture(sc_OITFilteredDepthBoundsTexture,l9_82);
vec2 l9_109=l9_108.xy;
int l9_110;
#if (sc_SkinBonesCount>0)
{
l9_110=encodeDepth(((1.0-l9_108.x)*1000.0)+getDepthOrderingEpsilon(),l9_109);
}
#else
{
l9_110=0;
...
#endif
int l9_111=encodeDepth(viewSpaceDepth(),l9_109);
vec4 l9_112;
l9_112=l9_67*l9_67.w;
vec4 l9_113;
int l9_114=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_114<8)
{
int l9_115=l9_83[l9_114];
int l9_116=l9_111-l9_110;
bool l9_117=l9_115<l9_116;
bool l9_118;
if (l9_117)
{
l9_118=l9_83[l9_114]>0;
}
else
{
l9_118=l9_117;
...
if (l9_118)
{
vec3 l9_119=l9_112.xyz*(1.0-(float(l9_84[l9_114])/255.0));
l9_113=vec4(l9_119.x,l9_119.y,l9_119.z,l9_112.w);
}
else
{
l9_113=l9_112;
