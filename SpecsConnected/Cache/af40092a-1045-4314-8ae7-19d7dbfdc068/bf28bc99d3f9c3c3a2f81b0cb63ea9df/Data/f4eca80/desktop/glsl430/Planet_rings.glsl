...
float l9_3=radians(Port_Rotation_N001);
vec2 l9_4=l9_1-Port_Center_N001;
vec2 l9_5=vec2(dot(vec2(cos(l9_3),sin(l9_3)),l9_4),0.0)+Port_Center_N001;
float l9_6=l9_5.x;
float l9_7=clamp(l9_6,0.0,1.0);
vec4 l9_8;
if (l9_7<Port_Position1_N000)
{
l9_8=mix(Port_Value0_N000,Port_Value1_N000,vec4(clamp(l9_7/Port_Position1_N000,0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_7<Port_Position2_N000)
{
l9_9=mix(Port_Value1_N000,Port_Value2_N000,vec4(clamp((l9_7-Port_Position1_N000)/(Port_Position2_N000-Port_Position1_N000),0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_7<Port_Position3_N000)
{
l9_10=mix(Port_Value2_N000,Port_Value3_N000,vec4(clamp((l9_7-Port_Position2_N000)/(Port_Position3_N000-Port_Position2_N000),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_7<Port_Position4_N000)
{
l9_11=mix(Port_Value3_N000,Port_Value4_N000,vec4(clamp((l9_7-Port_Position3_N000)/(Port_Position4_N000-Port_Position3_N000),0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_7<Port_Position5_N000)
{
l9_12=mix(Port_Value4_N000,Port_Value5_N000,vec4(clamp((l9_7-Port_Position4_N000)/(Port_Position5_N000-Port_Position4_N000),0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_7<Port_Position6_N000)
{
l9_13=mix(Port_Value5_N000,Port_Value6_N000,vec4(clamp((l9_7-Port_Position5_N000)/(Port_Position6_N000-Port_Position5_N000),0.0,1.0)));
}
else
{
l9_13=mix(Port_Value6_N000,Port_Value7_N000,vec4(clamp((l9_7-Port_Position6_N000)/(1.0-Port_Position6_N000),0.0,1.0)));
}
l9_12=l9_13;
}
l9_11=l9_12;
...
{
l9_17=PreviewVertexColor;
l9_16=l9_0;
}
float l9_19=fract(l9_6);
float l9_20;
if (l9_19<Port_Position1_N002)
{
l9_20=mix(Port_Value0_N002,Port_Value1_N002,clamp(l9_19/Port_Position1_N002,0.0,1.0));
}
else
{
float l9_21;
if (l9_19<Port_Position2_N002)
{
l9_21=mix(Port_Value1_N002,Port_Value2_N002,clamp((l9_19-Port_Position1_N002)/(Port_Position2_N002-Port_Position1_N002),0.0,1.0));
}
else
{
float l9_22;
if (l9_19<Port_Position3_N002)
{
l9_22=mix(Port_Value2_N002,Port_Value3_N002,clamp((l9_19-Port_Position2_N002)/(Port_Position3_N002-Port_Position2_N002),0.0,1.0));
}
else
{
float l9_23;
if (l9_19<Port_Position4_N002)
{
l9_23=mix(Port_Value3_N002,Port_Value4_N002,clamp((l9_19-Port_Position3_N002)/(Port_Position4_N002-Port_Position3_N002),0.0,1.0));
}
else
{
float l9_24;
if (l9_19<Port_Position5_N002)
{
l9_24=mix(Port_Value4_N002,Port_Value5_N002,clamp((l9_19-Port_Position4_N002)/(Port_Position5_N002-Port_Position4_N002),0.0,1.0));
}
else
{
float l9_25;
if (l9_19<Port_Position6_N002)
{
l9_25=mix(Port_Value5_N002,Port_Value6_N002,clamp((l9_19-Port_Position5_N002)/(Port_Position6_N002-Port_Position5_N002),0.0,1.0));
}
else
{
float l9_26;
if (l9_19<Port_Position7_N002)
{
l9_26=mix(Port_Value6_N002,Port_Value7_N002,clamp((l9_19-Port_Position6_N002)/(Port_Position7_N002-Port_Position6_N002),0.0,1.0));
}
else
{
float l9_27;
if (l9_19<Port_Position8_N002)
{
l9_27=mix(Port_Value7_N002,Port_Value8_N002,clamp((l9_19-Port_Position7_N002)/(Port_Position8_N002-Port_Position7_N002),0.0,1.0));
}
else
{
float l9_28;
if (l9_19<Port_Position9_N002)
{
l9_28=mix(Port_Value8_N002,Port_Value9_N002,clamp((l9_19-Port_Position8_N002)/(Port_Position9_N002-Port_Position8_N002),0.0,1.0));
}
else
{
float l9_29;
if (l9_19<Port_Position10_N002)
{
l9_29=mix(Port_Value9_N002,Port_Value10_N002,clamp((l9_19-Port_Position9_N002)/(Port_Position10_N002-Port_Position9_N002),0.0,1.0));
}
else
{
float l9_30;
if (l9_19<Port_Position11_N002)
{
l9_30=mix(Port_Value10_N002,Port_Value11_N002,clamp((l9_19-Port_Position10_N002)/(Port_Position11_N002-Port_Position10_N002),0.0,1.0));
}
else
{
float l9_31;
if (l9_19<Port_Position12_N002)
{
l9_31=mix(Port_Value11_N002,Port_Value12_N002,clamp((l9_19-Port_Position11_N002)/(Port_Position12_N002-Port_Position11_N002),0.0,1.0));
}
else
{
float l9_32;
if (l9_19<Port_Position13_N002)
{
l9_32=mix(Port_Value12_N002,Port_Value13_N002,clamp((l9_19-Port_Position12_N002)/(Port_Position13_N002-Port_Position12_N002),0.0,1.0));
}
else
{
float l9_33;
if (l9_19<Port_Position14_N002)
{
l9_33=mix(Port_Value13_N002,Port_Value14_N002,clamp((l9_19-Port_Position13_N002)/(Port_Position14_N002-Port_Position13_N002),0.0,1.0));
}
else
{
l9_33=mix(Port_Value14_N002,Port_Value15_N002,clamp((l9_19-Port_Position14_N002)/(1.0-Port_Position14_N002),0.0,1.0));
}
l9_32=l9_33;
}
l9_31=l9_32;
...
bool l9_35;
vec4 l9_36;
if (l9_34&&(2==PreviewNodeID))
{
vec4 l9_37=vec4(l9_20,l9_20,l9_20,1.0);
l9_37.w=1.0;
l9_36=l9_37;
l9_35=true;
}
...
vec4 l9_38=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_38.w=l9_20;
#if (sc_BlendMode_AlphaTest)
{
if (l9_20<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_20<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_44=clamp(dot(l9_38.xyz,vec3(l9_20)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*l9_20;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*l9_20;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_49;
#if (sc_BlendMode_Add)
{
l9_49=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_38.xyz,vec3(0.33333001))*l9_20;
}
#else
{
float l9_52;
#if (sc_BlendMode_Min)
{
l9_52=1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_Max)
{
l9_53=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_53=1.0;
...
#endif
l9_41=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_38.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_42);
}
#else
{
vec4 l9_54;
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_38.xyz).xyz,vec3(l9_20));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_20)),l9_20);
}
#else
{
vec4 l9_68;
...
#endif
l9_68=vec4(l9_38.xyz*l9_69,l9_69);
}
#else
{
l9_68=l9_38;
