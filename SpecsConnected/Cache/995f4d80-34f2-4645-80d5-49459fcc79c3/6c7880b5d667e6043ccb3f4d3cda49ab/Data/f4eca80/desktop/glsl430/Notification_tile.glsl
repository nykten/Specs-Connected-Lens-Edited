...
//sampler sampler notification_outline_maskSmpSC 2:22
...
//texture texture2D intensityTexture 2:3:2:21
//texture texture2D notification_outline_mask 2:4:2:22
...
//texture texture2DArray intensityTextureArrSC 2:32:2:21
//texture texture2DArray notification_outline_maskArrSC 2:33:2:22
...
uniform vec4 notification_outline_maskDims;
...
uniform float notification_tile_lightness;
uniform float notification_outline_lightness;
uniform vec4 notification_outline_maskSize;
uniform vec4 notification_outline_maskView;
uniform mat3 notification_outline_maskTransform;
uniform vec4 notification_outline_maskUvMinMax;
uniform vec4 notification_outline_maskBorderColor;
uniform float Tweak_N12;
uniform float notification_tile_opacity;
...
uniform vec2 Port_Offset_N003;
uniform float Port_Rotation_N007;
uniform vec2 Port_Center_N007;
uniform vec4 Port_Value0_N001;
uniform float Port_Position1_N001;
uniform vec4 Port_Value1_N001;
uniform float Port_Position2_N001;
uniform vec4 Port_Value2_N001;
uniform vec4 Port_Value3_N001;
uniform vec2 Port_Offset_N022;
uniform float Port_Rotation_N023;
uniform vec2 Port_Center_N023;
uniform vec3 Port_Value0_N000;
uniform float Port_Position1_N000;
uniform vec3 Port_Value1_N000;
uniform float Port_Position2_N000;
uniform vec3 Port_Value2_N000;
uniform vec3 Port_Value3_N000;
uniform vec4 Port_Import_N031;
uniform vec4 Port_Import_N032;
uniform float Port_Input0_N049;
...
uniform vec2 Port_Import_N036;
uniform vec2 Port_Center_N037;
uniform vec2 Port_Import_N040;
uniform vec2 Port_Import_N042;
uniform float Port_Input1_N048;
uniform float Port_Input2_N048;
uniform float Port_Mask_N030;
uniform float Port_Mask_N053;
...
#endif
#ifndef notification_outline_maskHasSwappedViews
#define notification_outline_maskHasSwappedViews 0
#elif notification_outline_maskHasSwappedViews==1
#undef notification_outline_maskHasSwappedViews
#define notification_outline_maskHasSwappedViews 1
#endif
#ifndef notification_outline_maskLayout
#define notification_outline_maskLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_notification_outline_mask
#define SC_USE_UV_TRANSFORM_notification_outline_mask 0
#elif SC_USE_UV_TRANSFORM_notification_outline_mask==1
#undef SC_USE_UV_TRANSFORM_notification_outline_mask
#define SC_USE_UV_TRANSFORM_notification_outline_mask 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask
#define SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask
#define SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask -1
#endif
#ifndef SC_USE_UV_MIN_MAX_notification_outline_mask
#define SC_USE_UV_MIN_MAX_notification_outline_mask 0
#elif SC_USE_UV_MIN_MAX_notification_outline_mask==1
#undef SC_USE_UV_MIN_MAX_notification_outline_mask
#define SC_USE_UV_MIN_MAX_notification_outline_mask 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_notification_outline_mask
#define SC_USE_CLAMP_TO_BORDER_notification_outline_mask 0
#elif SC_USE_CLAMP_TO_BORDER_notification_outline_mask==1
#undef SC_USE_CLAMP_TO_BORDER_notification_outline_mask
#define SC_USE_CLAMP_TO_BORDER_notification_outline_mask 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2D notification_outline_mask;
uniform sampler2DArray notification_outline_maskArrSC;
...
int notification_outline_maskGetStereoViewIndex()
{
int l9_0;
#if (notification_outline_maskHasSwappedViews)
{
...
l9_2=l9_3.uv0;
l9_1=(sc_ModelMatrixInverse*vec4(l9_3.positionWS,1.0)).xyz;
}
else
{
l9_2=varPackedTex.xy;
l9_1=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
}
vec2 l9_4=l9_2-vec2(Port_RangeMinA_N033);
vec2 l9_5=Port_Import_N060-Port_Import_N058;
float l9_6=radians(Port_Rotation_N007);
float l9_7=clamp((vec2(dot(vec2(cos(l9_6),sin(l9_6)),((vec4((l9_1.x*Port_Input1_N018)+Port_Input1_N021)+mix(Port_Import_N038,Port_Import_N039,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot(((((((l9_4/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Port_Import_N025)+Port_Center_N047)-Port_Import_N058,l9_5)/dot(l9_5,l9_5))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).xy+Port_Offset_N003)-Port_Center_N007),0.0)+Port_Center_N007).x,0.0,1.0);
vec4 l9_8;
if (l9_7<Port_Position1_N001)
{
l9_8=mix(Port_Value0_N001,Port_Value1_N001,vec4(clamp(l9_7/Port_Position1_N001,0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_7<Port_Position2_N001)
{
l9_9=mix(Port_Value1_N001,Port_Value2_N001,vec4(clamp((l9_7-Port_Position1_N001)/(Port_Position2_N001-Port_Position1_N001),0.0,1.0)));
}
else
{
l9_9=mix(Port_Value2_N001,Port_Value3_N001,vec4(clamp((l9_7-Port_Position2_N001)/(1.0-Port_Position2_N001),0.0,1.0)));
}
l9_8=l9_9;
}
bool l9_10=PreviewEnabled==1;
bool l9_11;
if (l9_10)
{
l9_11=!l9_0;
...
{
l9_13=PreviewVertexColor;
l9_12=l9_0;
}
vec4 l9_15=l9_8*vec4(notification_tile_lightness);
vec2 l9_16=l9_2+Port_Offset_N022;
float l9_17=radians(Port_Rotation_N023);
float l9_18=clamp((vec2(dot(vec2(cos(l9_17),sin(l9_17)),l9_16-Port_Center_N023),0.0)+Port_Center_N023).x,0.0,1.0);
vec3 l9_19;
if (l9_18<Port_Position1_N000)
{
l9_19=mix(Port_Value0_N000,Port_Value1_N000,vec3(clamp(l9_18/Port_Position1_N000,0.0,1.0)));
}
else
{
vec3 l9_20;
if (l9_18<Port_Position2_N000)
{
l9_20=mix(Port_Value1_N000,Port_Value2_N000,vec3(clamp((l9_18-Port_Position1_N000)/(Port_Position2_N000-Port_Position1_N000),0.0,1.0)));
}
else
{
l9_20=mix(Port_Value2_N000,Port_Value3_N000,vec3(clamp((l9_18-Port_Position2_N000)/(1.0-Port_Position2_N000),0.0,1.0)));
}
l9_19=l9_20;
}
bool l9_21;
...
bool l9_22;
vec4 l9_23;
if (l9_21&&(0==PreviewNodeID))
{
vec4 l9_24=vec4(l9_19,1.0);
l9_24.w=1.0;
l9_23=l9_24;
l9_22=true;
}
...
vec3 l9_25=l9_19*vec3(notification_outline_lightness);
vec4 l9_26;
#if (notification_outline_maskLayout==2)
{
l9_26=sc_SampleTextureBiasOrLevel(notification_outline_maskDims.xy,notification_outline_maskLayout,notification_outline_maskGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_notification_outline_mask)!=0),notification_outline_maskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask),(int(SC_USE_UV_MIN_MAX_notification_outline_mask)!=0),notification_outline_maskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0),notification_outline_maskBorderColor,0.0,notification_outline_maskArrSC);
}
#else
{
l9_26=sc_SampleTextureBiasOrLevel(notification_outline_maskDims.xy,notification_outline_maskLayout,notification_outline_maskGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_notification_outline_mask)!=0),notification_outline_maskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask),(int(SC_USE_UV_MIN_MAX_notification_outline_mask)!=0),notification_outline_maskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0),notification_outline_maskBorderColor,0.0,notification_outline_mask);
}
#endif
vec3 l9_27=mix(l9_15.xyz,l9_25,l9_26.xyz);
vec2 l9_28=l9_2-vec2(Port_RangeMinA_N035);
vec2 l9_29=Port_Import_N042-Port_Import_N040;
vec4 l9_30=mix(Port_Import_N031,Port_Import_N032,vec4(smoothstep(Port_Input0_N049,Port_Input1_N049,clamp((dot(((((((l9_28/vec2(Port_RangeMaxA_N035-Port_RangeMinA_N035))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+vec2(Port_RangeMinB_N035))-Port_Center_N037)*Port_Import_N036)+Port_Center_N037)-Port_Import_N040,l9_29)/dot(l9_29,l9_29))+0.001,Port_Input1_N048+0.001,Port_Input2_N048+0.001)-0.001)));
vec4 l9_31=l9_26*vec4(Tweak_N12);
vec3 l9_32=l9_31.xyz*l9_31.w;
vec3 l9_33=l9_30.xyz*l9_30.w;
vec4 l9_34=min(vec4(l9_33.x,l9_33.y,l9_33.z,l9_30.w)+min(vec4(l9_32.x,l9_32.y,l9_32.z,l9_31.w)+vec4(notification_tile_opacity),vec4(1.0)),vec4(1.0));
float l9_35=l9_34.x;
vec4 l9_36=vec4(l9_27.x,l9_27.y,l9_27.z,vec4(0.0).w);
l9_36.w=l9_35;
...
#endif
sc_writeFragData0(max(l9_37,vec4(0.0)));
return;
}
vec4 l9_39;
...
{
l9_42=clamp(dot(l9_36.xyz,vec3(l9_35)),0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_44=(1.0-dot(l9_36.xyz,vec3(0.33333001)))*l9_35;
}
#else
{
float l9_45;
...
{
l9_45=(1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0))*l9_35;
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_35;
}
#else
{
float l9_47;
#if (sc_BlendMode_Add)
{
l9_47=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_48;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_48=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_35;
}
#else
{
float l9_49;
...
{
l9_49=dot(l9_36.xyz,vec3(0.33333001))*l9_35;
}
#else
{
float l9_50;
#if (sc_BlendMode_Min)
{
l9_50=1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_Max)
{
l9_51=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_51=1.0;
...
#endif
l9_39=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_36.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_40);
}
#else
{
vec4 l9_52;
...
#if (sc_FramebufferFetch)
{
vec4 l9_55=sc_readFragData0_Platform();
vec4 l9_56;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_57=l9_55;
l9_57.x=l9_55.x+_sc_framebufferFetchMarker;
l9_56=l9_57;
}
#else
{
...
#else
{
vec2 l9_58=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_59;
...
{
l9_60=sc_SampleView(sc_ScreenTextureDims.xy,l9_58,sc_ScreenTextureLayout,l9_59,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_60=sc_SampleView(sc_ScreenTextureDims.xy,l9_58,sc_ScreenTextureLayout,l9_59,0.0,sc_ScreenTexture);
}
#endif
l9_54=l9_60;
}
...
{
vec4 l9_62=l9_54;
l9_62.x=l9_54.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_61=l9_62;
}
#else
{
...
#endif
vec3 l9_63=mix(l9_61.xyz,definedBlend(l9_61.xyz,l9_36.xyz).xyz,vec3(l9_35));
vec4 l9_64=vec4(l9_63.x,l9_63.y,l9_63.z,vec4(0.0).w);
l9_64.w=1.0;
l9_53=l9_64;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_66;
...
#endif
l9_66=vec4(l9_36.xyz*l9_67,l9_67);
}
#else
{
l9_66=l9_36;
...
{
l9_70=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_70=vec4(0.0);
...
vec4 l9_72=outputMotionVectorsIfNeeded(varPos,max(l9_71,vec4(0.0)));
vec4 l9_73=clamp(l9_72,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_74=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_74-0.0039215689)),min(1.0,l9_74+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_75=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_76=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_75).xy);
float l9_77=packValue(l9_76);
int l9_84=int(l9_73.w*255.0);
float l9_85=packValue(l9_84);
sc_writeFragData0(vec4(packValue(l9_76),packValue(l9_76),packValue(l9_76),packValue(l9_76)));
sc_writeFragData1(vec4(l9_77,packValue(l9_76),packValue(l9_76),packValue(l9_76)));
sc_writeFragData2(vec4(l9_85,packValue(l9_84),packValue(l9_84),packValue(l9_84)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_88=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_88).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_93==0)
{
l9_96=texture(sc_OITAlpha0,l9_88);
l9_95=texture(sc_OITDepthLow0,l9_88);
l9_94=texture(sc_OITDepthHigh0,l9_88);
}
else
{
l9_96=vec4(0.0);
...
if (l9_93==1)
{
l9_99=texture(sc_OITAlpha1,l9_88);
l9_98=texture(sc_OITDepthLow1,l9_88);
l9_97=texture(sc_OITDepthHigh1,l9_88);
}
else
{
l9_99=l9_96;
...
if (any(notEqual(l9_97,vec4(0.0)))||any(notEqual(l9_98,vec4(0.0))))
{
int l9_100[8]=l9_89;
unpackValues(l9_97.w,l9_93,l9_100);
unpackValues(l9_97.z,l9_93,l9_100);
unpackValues(l9_97.y,l9_93,l9_100);
unpackValues(l9_97.x,l9_93,l9_100);
unpackValues(l9_98.w,l9_93,l9_100);
unpackValues(l9_98.z,l9_93,l9_100);
unpackValues(l9_98.y,l9_93,l9_100);
unpackValues(l9_98.x,l9_93,l9_100);
int l9_109[8]=l9_90;
unpackValues(l9_99.w,l9_93,l9_109);
unpackValues(l9_99.z,l9_93,l9_109);
unpackValues(l9_99.y,l9_93,l9_109);
unpackValues(l9_99.x,l9_93,l9_109);
}
l9_93++;
continue;
}
...
vec4 l9_114=texture(sc_OITFilteredDepthBoundsTexture,l9_88);
vec2 l9_115=l9_114.xy;
int l9_116;
#if (sc_SkinBonesCount>0)
{
l9_116=encodeDepth(((1.0-l9_114.x)*1000.0)+getDepthOrderingEpsilon(),l9_115);
}
#else
{
l9_116=0;
...
#endif
int l9_117=encodeDepth(viewSpaceDepth(),l9_115);
vec4 l9_118;
l9_118=l9_73*l9_73.w;
vec4 l9_119;
int l9_120=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_120<8)
{
int l9_121=l9_89[l9_120];
int l9_122=l9_117-l9_116;
bool l9_123=l9_121<l9_122;
bool l9_124;
if (l9_123)
{
l9_124=l9_89[l9_120]>0;
}
else
{
l9_124=l9_123;
...
if (l9_124)
{
vec3 l9_125=l9_118.xyz*(1.0-(float(l9_90[l9_120])/255.0));
l9_119=vec4(l9_125.x,l9_125.y,l9_125.z,l9_118.w);
}
else
{
l9_119=l9_118;
...
sc_writeFragData0(l9_73);
}
#endif
}
#else
{
sc_writeFragData0(l9_72);
}
#endif
}
#endif
