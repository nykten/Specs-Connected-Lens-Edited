...
//sampler sampler notification_outline_maskSmpSC 2:17
...
//texture texture2D notification_outline_mask 2:1:2:17
...
vec2 l9_1=Port_Import_N060-Port_Import_N058;
float l9_2=radians(Port_Rotation_N007);
float l9_3=clamp((vec2(dot(vec2(cos(l9_2),sin(l9_2)),((vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).x*Port_Input1_N018)+Port_Input1_N021)+mix(Port_Import_N038,Port_Import_N039,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((varPackedTex.xy-vec2(Port_RangeMinA_N033))/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Port_Import_N025)+Port_Center_N047)-Port_Import_N058,l9_1)/dot(l9_1,l9_1))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).xy+Port_Offset_N003)-Port_Center_N007),0.0)+Port_Center_N007).x,0.0,1.0);
vec4 l9_4;
if (l9_3<Port_Position1_N001)
{
l9_4=mix(Port_Value0_N001,Port_Value1_N001,vec4(clamp(l9_3/Port_Position1_N001,0.0,1.0)));
}
else
{
vec4 l9_5;
if (l9_3<Port_Position2_N001)
{
l9_5=mix(Port_Value1_N001,Port_Value2_N001,vec4(clamp((l9_3-Port_Position1_N001)/(Port_Position2_N001-Port_Position1_N001),0.0,1.0)));
}
else
{
l9_5=mix(Port_Value2_N001,Port_Value3_N001,vec4(clamp((l9_3-Port_Position2_N001)/(1.0-Port_Position2_N001),0.0,1.0)));
}
l9_4=l9_5;
}
bool l9_6=PreviewEnabled==1;
bool l9_7;
if (l9_6)
{
l9_7=!l9_0;
...
{
l9_9=PreviewVertexColor;
l9_8=l9_0;
}
vec4 l9_11=l9_4*vec4(notification_tile_lightness);
float l9_12=radians(Port_Rotation_N023);
float l9_13=clamp((vec2(dot(vec2(cos(l9_12),sin(l9_12)),(varPackedTex.xy+Port_Offset_N022)-Port_Center_N023),0.0)+Port_Center_N023).x,0.0,1.0);
vec3 l9_14;
if (l9_13<Port_Position1_N000)
{
l9_14=mix(Port_Value0_N000,Port_Value1_N000,vec3(clamp(l9_13/Port_Position1_N000,0.0,1.0)));
}
else
{
vec3 l9_15;
if (l9_13<Port_Position2_N000)
{
l9_15=mix(Port_Value1_N000,Port_Value2_N000,vec3(clamp((l9_13-Port_Position1_N000)/(Port_Position2_N000-Port_Position1_N000),0.0,1.0)));
}
else
{
l9_15=mix(Port_Value2_N000,Port_Value3_N000,vec3(clamp((l9_13-Port_Position2_N000)/(1.0-Port_Position2_N000),0.0,1.0)));
}
l9_14=l9_15;
}
bool l9_16;
...
bool l9_17;
vec4 l9_18;
if (l9_16&&(0==PreviewNodeID))
{
vec4 l9_19=vec4(l9_14,1.0);
l9_19.w=1.0;
l9_18=l9_19;
l9_17=true;
}
...
vec3 l9_20=l9_14*vec3(notification_outline_lightness);
int l9_21;
...
#endif
vec4 l9_22=sc_SampleTextureBiasOrLevel(notification_outline_maskDims.xy,notification_outline_maskLayout,l9_21,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_notification_outline_mask)!=0),notification_outline_maskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask),(int(SC_USE_UV_MIN_MAX_notification_outline_mask)!=0),notification_outline_maskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0),notification_outline_maskBorderColor,0.0,notification_outline_mask);
vec3 l9_23=mix(l9_11.xyz,l9_20,l9_22.xyz);
vec2 l9_24=Port_Import_N042-Port_Import_N040;
vec4 l9_25=mix(Port_Import_N031,Port_Import_N032,vec4(smoothstep(Port_Input0_N049,Port_Input1_N049,clamp((dot((((((((varPackedTex.xy-vec2(Port_RangeMinA_N035))/vec2(Port_RangeMaxA_N035-Port_RangeMinA_N035))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+vec2(Port_RangeMinB_N035))-Port_Center_N037)*Port_Import_N036)+Port_Center_N037)-Port_Import_N040,l9_24)/dot(l9_24,l9_24))+0.001,Port_Input1_N048+0.001,Port_Input2_N048+0.001)-0.001)));
vec4 l9_26=l9_22*vec4(Tweak_N12);
vec3 l9_27=l9_26.xyz*l9_26.w;
vec3 l9_28=l9_25.xyz*l9_25.w;
vec4 l9_29=min(vec4(l9_28.x,l9_28.y,l9_28.z,l9_25.w)+min(vec4(l9_27.x,l9_27.y,l9_27.z,l9_26.w)+vec4(notification_tile_opacity),vec4(1.0)),vec4(1.0));
float l9_30=l9_29.x;
vec4 l9_31=vec4(l9_23.x,l9_23.y,l9_23.z,vec4(0.0).w);
l9_31.w=l9_30;
...
{
l9_35=clamp(dot(l9_31.xyz,vec3(l9_30)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*l9_30;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*l9_30;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_30;
}
#else
{
float l9_40;
#if (sc_BlendMode_Add)
{
l9_40=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_41;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_30;
}
#else
{
float l9_42;
...
{
l9_42=dot(l9_31.xyz,vec3(0.33333001))*l9_30;
}
#else
{
float l9_43;
#if (sc_BlendMode_Min)
{
l9_43=1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_Max)
{
l9_44=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_44=1.0;
...
#endif
l9_32=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_31.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_33);
}
#else
{
vec4 l9_45;
...
#if (sc_FramebufferFetch)
{
vec4 l9_48=sc_readFragData0_Platform();
vec4 l9_49;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_50=l9_48;
l9_50.x=l9_48.x+_sc_framebufferFetchMarker;
l9_49=l9_50;
}
#else
{
...
#else
{
vec2 l9_51=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_52;
...
#endif
l9_47=sc_SampleView(sc_ScreenTextureDims.xy,l9_51,sc_ScreenTextureLayout,l9_52,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_53;
...
{
vec4 l9_54=l9_47;
l9_54.x=l9_47.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_53=l9_54;
}
#else
{
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_31.xyz).xyz,vec3(l9_30));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_30)),l9_30);
}
#else
{
vec4 l9_58;
...
#endif
l9_58=vec4(l9_31.xyz*l9_59,l9_59);
}
#else
{
l9_58=l9_31;
...
{
l9_62=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_62=vec4(0.0);
...
vec4 l9_64=outputMotionVectorsIfNeeded(varPos,max(l9_63,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_67=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_67).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_68=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_67).xy);
...
sc_writeFragData1(vec4(l9_69,packValue(l9_68),packValue(l9_68),packValue(l9_68)));
sc_writeFragData2(vec4(l9_77,packValue(l9_76),packValue(l9_76),packValue(l9_76)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_80).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_85==0)
{
l9_88=texture2D(sc_OITAlpha0,l9_80);
l9_87=texture2D(sc_OITDepthLow0,l9_80);
l9_86=texture2D(sc_OITDepthHigh0,l9_80);
}
else
{
l9_88=vec4(0.0);
...
if (l9_85==1)
{
l9_91=texture2D(sc_OITAlpha1,l9_80);
l9_90=texture2D(sc_OITDepthLow1,l9_80);
l9_89=texture2D(sc_OITDepthHigh1,l9_80);
}
else
{
l9_91=l9_88;
...
vec4 l9_106=texture2D(sc_OITFilteredDepthBoundsTexture,l9_80);
