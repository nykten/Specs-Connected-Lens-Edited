...
//}
//ubo int UserUniforms 2:37:4928 {
...
//float4 Port_Value0_N007 4608
//float Port_Position1_N007 4624
//float4 Port_Value1_N007 4640
//float Port_Position2_N007 4656
//float4 Port_Value2_N007 4672
//float Port_Position3_N007 4688
//float4 Port_Value3_N007 4704
//float4 Port_Value4_N007 4720
//float2 Port_Input1_N028 4736
//float2 Port_Input2_N028 4744
//float4 Port_Value0_N031 4752
//float Port_Position1_N031 4768
//float4 Port_Value1_N031 4784
//float Port_Position2_N031 4800
//float4 Port_Value2_N031 4816
//float Port_Position3_N031 4832
//float4 Port_Value3_N031 4848
//float4 Port_Value4_N031 4864
//float Port_Value0_N011 4880
//float Port_Position1_N011 4884
//float Port_Value1_N011 4888
//float Port_Position2_N011 4892
//float Port_Value2_N011 4896
//float Port_Position3_N011 4900
//float Port_Value3_N011 4904
//float Port_Value4_N011 4908
//float depthRef 4912
//}
...
float Port_Value0_N011;
float Port_Position1_N011;
float Port_Value1_N011;
float Port_Position2_N011;
float Port_Value2_N011;
float Port_Position3_N011;
float Port_Value3_N011;
float Port_Value4_N011;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param_38=(*sc_set2.UserUniforms).Port_Value0_N007;
float param_39=(*sc_set2.UserUniforms).Port_Position1_N007;
float4 param_40=(*sc_set2.UserUniforms).Port_Value1_N007;
float param_41=(*sc_set2.UserUniforms).Port_Position2_N007;
float4 param_42=(*sc_set2.UserUniforms).Port_Value2_N007;
float param_43=(*sc_set2.UserUniforms).Port_Position3_N007;
float4 param_44=(*sc_set2.UserUniforms).Port_Value3_N007;
float4 param_45=(*sc_set2.UserUniforms).Port_Value4_N007;
...
Output_N28=(UVCoord_N17*(*sc_set2.UserUniforms).Port_Input1_N028)+(*sc_set2.UserUniforms).Port_Input2_N028;
float Output_N29=0.0;
Output_N29=length(Output_N28);
float4 Value_N31=float4(0.0);
float param_47=Output_N29;
float4 param_48=(*sc_set2.UserUniforms).Port_Value0_N031;
float param_49=(*sc_set2.UserUniforms).Port_Position1_N031;
float4 param_50=(*sc_set2.UserUniforms).Port_Value1_N031;
float param_51=(*sc_set2.UserUniforms).Port_Position2_N031;
float4 param_52=(*sc_set2.UserUniforms).Port_Value2_N031;
float param_53=(*sc_set2.UserUniforms).Port_Position3_N031;
float4 param_54=(*sc_set2.UserUniforms).Port_Value3_N031;
float4 param_55=(*sc_set2.UserUniforms).Port_Value4_N031;
param_47=fast::clamp(param_47,0.0,1.0);
float4 param_56;
if (param_47<param_49)
{
param_56=mix(param_48,param_50,float4(fast::clamp(param_47/param_49,0.0,1.0)));
}
else
{
if (param_47<param_51)
{
param_56=mix(param_50,param_52,float4(fast::clamp((param_47-param_49)/(param_51-param_49),0.0,1.0)));
}
else
{
if (param_47<param_53)
{
param_56=mix(param_52,param_54,float4(fast::clamp((param_47-param_51)/(param_53-param_51),0.0,1.0)));
}
else
{
param_56=mix(param_54,param_55,float4(fast::clamp((param_47-param_53)/(1.0-param_53),0.0,1.0)));
}
}
}
Value_N31=param_56;
float4 Output_N60=float4(0.0);
Output_N60=mix(Value_N7,Value_N31,Value_N31);
float Value_N11=0.0;
float param_57=Value_N7.x;
float param_58=(*sc_set2.UserUniforms).Port_Value0_N011;
float param_59=(*sc_set2.UserUniforms).Port_Position1_N011;
float param_60=(*sc_set2.UserUniforms).Port_Value1_N011;
float param_61=(*sc_set2.UserUniforms).Port_Position2_N011;
float param_62=(*sc_set2.UserUniforms).Port_Value2_N011;
float param_63=(*sc_set2.UserUniforms).Port_Position3_N011;
float param_64=(*sc_set2.UserUniforms).Port_Value3_N011;
float param_65=(*sc_set2.UserUniforms).Port_Value4_N011;
param_57=fast::clamp(param_57,0.0,1.0);
float param_66;
if (param_57<param_59)
{
param_66=mix(param_58,param_60,fast::clamp(param_57/param_59,0.0,1.0));
}
else
{
if (param_57<param_61)
{
param_66=mix(param_60,param_62,fast::clamp((param_57-param_59)/(param_61-param_59),0.0,1.0));
}
else
{
if (param_57<param_63)
{
param_66=mix(param_62,param_64,fast::clamp((param_57-param_61)/(param_63-param_61),0.0,1.0));
}
else
{
param_66=mix(param_64,param_65,fast::clamp((param_57-param_63)/(1.0-param_63),0.0,1.0));
}
}
}
Value_N11=param_66;
float4 Value_N12=float4(0.0);
Value_N12=float4(Output_N60.xyz.x,Output_N60.xyz.y,Output_N60.xyz.z,Value_N12.w);
Value_N12.w=Value_N11;
float4 Output_N100=float4(0.0);
Output_N100=Output_N2+Value_N12;
FinalColor=Output_N100;
float param_67=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_67<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
bool l9_260=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_260)
{
...
float4 l9_261=fast::max(param_68,float4(0.0));
float4 param_69=l9_261;
out.FragColor0=param_69;
return out;
}
float4 param_70=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_262=param_70;
...
{
l9_264=fast::clamp(l9_263.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_264=fast::clamp(dot(l9_263.xyz,float3(l9_263.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_264=(1.0-dot(l9_263.xyz,float3(0.33333001)))*l9_263.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_264=(1.0-fast::clamp(dot(l9_263.xyz,float3(1.0)),0.0,1.0))*l9_263.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_264=fast::clamp(dot(l9_263.xyz,float3(1.0)),0.0,1.0)*l9_263.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_264=fast::clamp(dot(l9_263.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_264=dot(l9_263.xyz,float3(0.33333001))*l9_263.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_264=1.0-fast::clamp(dot(l9_263.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_265=l9_264;
float l9_266=l9_265;
float l9_267=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_266;
float3 l9_268=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_262.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_269=float4(l9_268.x,l9_268.y,l9_268.z,l9_267);
param_70=l9_269;
}
else
{
...
{
param_70=float4(param_70.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_270=param_70;
float4 l9_271=float4(0.0);
float4 l9_272=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_273=out.FragColor0;
float4 l9_274=l9_273;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_274.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_277=(l9_276.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_282=l9_281;
int l9_283=l9_282;
float3 l9_284=float3(l9_278,0.0);
int l9_285=l9_280;
int l9_286=l9_283;
if (l9_285==1)
{
l9_284.y=((2.0*l9_284.y)+float(l9_286))-1.0;
}
float2 l9_287=l9_284.xy;
l9_279=l9_287;
}
else
{
...
int l9_298=l9_296;
float2 l9_299=l9_297;
int l9_300=l9_298;
float l9_301=0.0;
float4 l9_302=float4(0.0);
float2 l9_303=l9_299;
int l9_304=sc_ScreenTextureLayout_tmp;
int l9_305=l9_300;
float l9_306=l9_301;
float2 l9_307=l9_303;
int l9_308=l9_304;
...
float2 l9_313=l9_312.xy;
float l9_314=l9_306;
float4 l9_315=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_313,bias(l9_314));
float4 l9_316=l9_315;
l9_302=l9_316;
...
float4 l9_320=l9_272;
float4 l9_321=l9_320;
float3 l9_322=l9_321.xyz;
float3 l9_323=l9_322;
float3 l9_324=l9_270.xyz;
float3 l9_325=definedBlend(l9_323,l9_324,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_271=float4(l9_325.x,l9_325.y,l9_325.z,l9_271.w);
float3 l9_326=mix(l9_322,l9_271.xyz,float3(l9_270.w));
l9_271=float4(l9_326.x,l9_326.y,l9_326.z,l9_271.w);
l9_271.w=1.0;
float4 l9_327=l9_271;
param_70=l9_327;
}
else
{
float4 l9_328=param_70;
float4 l9_329=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_329=float4(mix(float3(1.0),l9_328.xyz,float3(l9_328.w)),l9_328.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_330=l9_328.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_330=fast::clamp(l9_330,0.0,1.0);
}
l9_329=float4(l9_328.xyz*l9_330,l9_330);
}
else
{
l9_329=l9_328;
...
float4 l9_331=l9_329;
param_70=l9_331;
}
}
}
float4 l9_332=param_70;
FinalColor=l9_332;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_333=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_333=float4(0.0);
...
float3 param_71=in.varPos;
float4 param_72=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_71,param_72,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_73=FinalColor;
float4 l9_335=param_73;
out.FragColor0=l9_335;
return out;
}
} // FRAGMENT SHADER
