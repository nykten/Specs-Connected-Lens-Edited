...
uniform vec4 Port_Value0_N031;
uniform float Port_Position1_N031;
uniform vec4 Port_Value1_N031;
uniform float Port_Position2_N031;
uniform vec4 Port_Value2_N031;
uniform float Port_Position3_N031;
uniform vec4 Port_Value3_N031;
uniform vec4 Port_Value4_N031;
uniform float Port_Value0_N011;
uniform float Port_Position1_N011;
uniform float Port_Value1_N011;
uniform float Port_Position2_N011;
uniform float Port_Value2_N011;
uniform float Port_Position3_N011;
uniform float Port_Value3_N011;
uniform float Port_Value4_N011;
...
vec3 l9_5=l9_4.normalWS;
vec4 l9_6=l9_4.tangentWS;
if (noEarlyZ)
{
...
l9_3=l9_4.uv0;
l9_2=l9_5;
l9_1=cross(l9_5,l9_7)*l9_6.w;
l9_0=l9_7;
}
else
{
vec3 l9_8=normalize(varTangent.xyz);
vec3 l9_9=normalize(varNormal);
l9_3=varPackedTex.xy;
l9_2=l9_9;
l9_1=cross(l9_9,l9_8)*varTangent.w;
l9_0=l9_8;
}
mat3 l9_10=mat3(l9_0,l9_1,l9_2);
vec3 l9_11=l9_10*Port_Import_N111;
...
#endif
vec4 l9_19=l9_17*l9_18;
vec3 l9_20=l9_10*Port_Import_N041;
...
vec3 l9_23=l9_20*l9_22;
vec3 l9_24=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_23,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
vec4 l9_25;
#if (capsule_btn_refl_tex_1Layout==2)
{
l9_25=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_24.xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1ArrSC);
}
#else
{
...
#endif
vec4 l9_26=vec4(Port_Import_N027)*l9_25;
float l9_27=clamp(l9_26.x,0.0,1.0);
vec4 l9_28;
if (l9_27<Port_Position1_N007)
{
l9_28=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_27/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_29;
if (l9_27<Port_Position2_N007)
{
l9_29=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_27-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_27<Port_Position3_N007)
{
l9_30=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_27-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_30=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_27-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_29=l9_30;
}
l9_28=l9_29;
}
vec2 l9_31=l9_3*Port_Input1_N028;
float l9_32=clamp(length(l9_31+Port_Input2_N028),0.0,1.0);
vec4 l9_33;
if (l9_32<Port_Position1_N031)
{
l9_33=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_32/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_34;
if (l9_32<Port_Position2_N031)
{
l9_34=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_32-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_35;
if (l9_32<Port_Position3_N031)
{
l9_35=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_32-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_35=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_32-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_34=l9_35;
}
l9_33=l9_34;
}
vec4 l9_36=mix(l9_28,l9_33,l9_33);
float l9_37=clamp(l9_28.x,0.0,1.0);
float l9_38;
if (l9_37<Port_Position1_N011)
{
l9_38=mix(Port_Value0_N011,Port_Value1_N011,clamp(l9_37/Port_Position1_N011,0.0,1.0));
}
else
{
float l9_39;
if (l9_37<Port_Position2_N011)
{
l9_39=mix(Port_Value1_N011,Port_Value2_N011,clamp((l9_37-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0));
}
else
{
float l9_40;
if (l9_37<Port_Position3_N011)
{
l9_40=mix(Port_Value2_N011,Port_Value3_N011,clamp((l9_37-Port_Position2_N011)/(Port_Position3_N011-Port_Position2_N011),0.0,1.0));
}
else
{
l9_40=mix(Port_Value3_N011,Port_Value4_N011,clamp((l9_37-Port_Position3_N011)/(1.0-Port_Position3_N011),0.0,1.0));
}
l9_39=l9_40;
}
l9_38=l9_39;
}
vec4 l9_41=vec4(l9_36.x,l9_36.y,l9_36.z,vec4(0.0).w);
l9_41.w=l9_38;
vec4 l9_42=l9_19+l9_41;
float l9_43=l9_42.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_43<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_43<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_44,vec4(0.0)));
return;
}
vec4 l9_46;
...
{
l9_49=clamp(dot(l9_42.xyz,vec3(l9_43)),0.0,1.0);
}
#else
{
float l9_50;
...
{
l9_51=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*l9_43;
}
#else
{
float l9_52;
...
{
l9_52=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*l9_43;
}
#else
{
float l9_53;
...
{
l9_53=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*l9_43;
}
#else
{
float l9_54;
#if (sc_BlendMode_Add)
{
l9_54=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_55;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_55=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*l9_43;
}
#else
{
float l9_56;
...
{
l9_56=dot(l9_42.xyz,vec3(0.33333001))*l9_43;
}
#else
{
float l9_57;
#if (sc_BlendMode_Min)
{
l9_57=1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
#if (sc_BlendMode_Max)
{
l9_58=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_58=1.0;
...
#endif
l9_46=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_42.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_47);
}
#else
{
vec4 l9_59;
...
#if (sc_FramebufferFetch)
{
vec4 l9_62=sc_readFragData0_Platform();
vec4 l9_63;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_64=l9_62;
l9_64.x=l9_62.x+_sc_framebufferFetchMarker;
l9_63=l9_64;
}
#else
{
...
#else
{
vec2 l9_65=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_66;
...
{
l9_67=sc_SampleView(sc_ScreenTextureDims.xy,l9_65,sc_ScreenTextureLayout,l9_66,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_67=sc_SampleView(sc_ScreenTextureDims.xy,l9_65,sc_ScreenTextureLayout,l9_66,0.0,sc_ScreenTexture);
}
#endif
l9_61=l9_67;
}
...
{
vec4 l9_69=l9_61;
l9_69.x=l9_61.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_68=l9_69;
}
#else
{
...
#endif
vec3 l9_70=mix(l9_68.xyz,definedBlend(l9_68.xyz,l9_42.xyz).xyz,vec3(l9_43));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_72=vec4(mix(vec3(1.0),l9_42.xyz,vec3(l9_43)),l9_43);
}
#else
{
vec4 l9_73;
...
#endif
l9_73=vec4(l9_42.xyz*l9_74,l9_74);
}
#else
{
l9_73=l9_42;
...
{
l9_77=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_77=vec4(0.0);
...
vec4 l9_79=outputMotionVectorsIfNeeded(varPos,max(l9_78,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_81-0.0039215689)),min(1.0,l9_81+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_83),packValue(l9_83),packValue(l9_83),packValue(l9_83)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_95=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
