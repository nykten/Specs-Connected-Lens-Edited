...
vec4 l9_18;
if (l9_17<Port_Position1_N007)
{
l9_18=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_17/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_19;
if (l9_17<Port_Position2_N007)
{
l9_19=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_17-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_17<Port_Position3_N007)
{
l9_20=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_17-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_20=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_17-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_19=l9_20;
}
l9_18=l9_19;
}
float l9_21=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_22;
if (l9_21<Port_Position1_N031)
{
l9_22=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_21/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_21<Port_Position2_N031)
{
l9_23=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_21-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_24;
if (l9_21<Port_Position3_N031)
{
l9_24=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_21-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_24=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_21-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_23=l9_24;
}
l9_22=l9_23;
}
vec4 l9_25=mix(l9_18,l9_22,l9_22);
float l9_26=clamp(l9_18.x,0.0,1.0);
float l9_27;
if (l9_26<Port_Position1_N011)
{
l9_27=mix(Port_Value0_N011,Port_Value1_N011,clamp(l9_26/Port_Position1_N011,0.0,1.0));
}
else
{
float l9_28;
if (l9_26<Port_Position2_N011)
{
l9_28=mix(Port_Value1_N011,Port_Value2_N011,clamp((l9_26-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0));
}
else
{
float l9_29;
if (l9_26<Port_Position3_N011)
{
l9_29=mix(Port_Value2_N011,Port_Value3_N011,clamp((l9_26-Port_Position2_N011)/(Port_Position3_N011-Port_Position2_N011),0.0,1.0));
}
else
{
l9_29=mix(Port_Value3_N011,Port_Value4_N011,clamp((l9_26-Port_Position3_N011)/(1.0-Port_Position3_N011),0.0,1.0));
}
l9_28=l9_29;
}
l9_27=l9_28;
}
vec4 l9_30=vec4(l9_25.x,l9_25.y,l9_25.z,vec4(0.0).w);
l9_30.w=l9_27;
vec4 l9_31=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_30;
float l9_32=l9_31.w;
...
{
l9_36=clamp(dot(l9_31.xyz,vec3(l9_32)),0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_38=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*l9_32;
}
#else
{
float l9_39;
...
{
l9_39=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*l9_32;
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_32;
}
#else
{
float l9_41;
#if (sc_BlendMode_Add)
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_42=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_32;
}
#else
{
float l9_43;
...
{
l9_43=dot(l9_31.xyz,vec3(0.33333001))*l9_32;
}
#else
{
float l9_44;
#if (sc_BlendMode_Min)
{
l9_44=1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
#if (sc_BlendMode_Max)
{
l9_45=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_45=1.0;
...
#endif
l9_33=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_31.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_34);
}
#else
{
vec4 l9_46;
...
#endif
l9_48=sc_SampleView(sc_ScreenTextureDims.xy,l9_52,sc_ScreenTextureLayout,l9_53,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_54;
...
{
vec4 l9_55=l9_48;
l9_55.x=l9_48.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_54=l9_55;
}
#else
{
...
#endif
vec3 l9_56=mix(l9_54.xyz,definedBlend(l9_54.xyz,l9_31.xyz).xyz,vec3(l9_32));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_32)),l9_32);
}
#else
{
vec4 l9_59;
...
#endif
l9_59=vec4(l9_31.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_31;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_68).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_69=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_68).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_81).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_86==0)
{
l9_89=texture2D(sc_OITAlpha0,l9_81);
l9_88=texture2D(sc_OITDepthLow0,l9_81);
l9_87=texture2D(sc_OITDepthHigh0,l9_81);
}
else
{
l9_89=vec4(0.0);
...
if (l9_86==1)
{
l9_92=texture2D(sc_OITAlpha1,l9_81);
l9_91=texture2D(sc_OITDepthLow1,l9_81);
l9_90=texture2D(sc_OITDepthHigh1,l9_81);
}
else
{
l9_92=l9_89;
...
vec4 l9_107=texture2D(sc_OITFilteredDepthBoundsTexture,l9_81);
