...
//float4 Tweak_N119 4144
//float Tweak_N1 4160
//float Tweak_N8 4164
//float alpha 4168
//float3 Port_Normal_N041 4176
//float depthRef 4192
//}
...
float4 param=(*sc_set2.UserUniforms).Tweak_N119;
Output_N119=param;
float Output_N1=0.0;
float param_1=(*sc_set2.UserUniforms).Tweak_N1;
Output_N1=param_1;
float Output_N8=0.0;
float param_2=(*sc_set2.UserUniforms).Tweak_N8;
Output_N8=param_2;
float Rim_N41=0.0;
float3 param_3=(*sc_set2.UserUniforms).Port_Normal_N041;
float param_4=Output_N1;
float param_5=Output_N8;
ssGlobals param_7=Globals;
param_3=float3x3(float3(param_7.VertexTangent_WorldSpace),float3(param_7.VertexBinormal_WorldSpace),float3(param_7.VertexNormal_WorldSpace))*param_3;
float l9_7=abs(dot(-param_7.ViewDirWS,param_3));
float param_6=pow(1.0-l9_7,param_4);
param_6=fast::max(param_6,0.0);
param_6*=param_5;
Rim_N41=param_6;
float4 Output_N99=float4(0.0);
Output_N99=Output_N119+float4(Rim_N41);
float Output_N126=0.0;
float param_8=(*sc_set2.UserUniforms).alpha;
Output_N126=param_8;
float4 Value_N127=float4(0.0);
Value_N127=float4(Output_N99.xyz.x,Output_N99.xyz.y,Output_N99.xyz.z,Value_N127.w);
...
float4 l9_12=fast::max(param_10,float4(0.0));
float4 param_11=l9_12;
