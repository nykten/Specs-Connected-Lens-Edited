...
vec4 l9_10=Tweak_N119+vec4(max(pow(1.0-abs(dot(-l9_0,mat3(l9_3,l9_1,l9_2)*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8);
vec4 l9_11=vec4(l9_10.x,l9_10.y,l9_10.z,vec4(0.0).w);
l9_11.w=alpha;
...
{
l9_17=clamp(dot(l9_11.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_19=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_20;
...
{
l9_20=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_21;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_23=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_24;
...
{
l9_24=dot(l9_11.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_25;
...
#endif
vec3 l9_38=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_11.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_11.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_41;
...
#endif
l9_41=vec4(l9_11.xyz*l9_42,l9_42);
}
#else
{
l9_41=l9_11;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_50).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_51=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_50).xy);
...
if (l9_68==0)
{
l9_71=texture(sc_OITAlpha0,l9_63);
l9_70=texture(sc_OITDepthLow0,l9_63);
l9_69=texture(sc_OITDepthHigh0,l9_63);
}
else
{
l9_71=vec4(0.0);
...
if (l9_68==1)
{
l9_74=texture(sc_OITAlpha1,l9_63);
l9_73=texture(sc_OITDepthLow1,l9_63);
l9_72=texture(sc_OITDepthHigh1,l9_63);
}
else
{
l9_74=l9_71;
...
vec4 l9_89=texture(sc_OITFilteredDepthBoundsTexture,l9_63);
vec2 l9_90=l9_89.xy;
int l9_91;
#if (sc_SkinBonesCount>0)
{
