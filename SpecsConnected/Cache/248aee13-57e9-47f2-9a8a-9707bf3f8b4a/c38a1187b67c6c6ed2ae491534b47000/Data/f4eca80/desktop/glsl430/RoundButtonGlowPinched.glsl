...
//sampler sampler glow_mapSmpSC 2:21
...
//texture texture2D glow_map 2:3:2:21
...
//texture texture2DArray glow_mapArrSC 2:32:2:21
...
uniform sampler2DArray glow_mapArrSC;
...
int glow_mapGetStereoViewIndex()
{
int l9_0;
...
#if (glow_mapLayout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(glow_mapDims.xy,glow_mapLayout,glow_mapGetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map),(int(SC_USE_UV_MIN_MAX_glow_map)!=0),glow_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0),glow_mapBorderColor,0.0,glow_mapArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(glow_mapDims.xy,glow_mapLayout,glow_mapGetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map),(int(SC_USE_UV_MIN_MAX_glow_map)!=0),glow_mapUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0),glow_mapBorderColor,0.0,glow_map);
}
#endif
float l9_5=clamp(l9_4.x,0.0,1.0);
vec4 l9_6;
if (l9_5<Port_Position1_N007)
{
l9_6=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_5/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_7;
if (l9_5<Port_Position2_N007)
{
l9_7=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_5-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_7=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_5-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_6=l9_7;
}
...
if (l9_6.x<float(l9_6.x<Port_Input1_N003))
{
discard;
}
...
#endif
sc_writeFragData0(max(l9_13,vec4(0.0)));
return;
}
vec4 l9_15;
...
{
l9_17=clamp(l9_6.w*2.0,0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_23;
#if (sc_BlendMode_Add)
{
l9_23=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_24=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_25;
...
{
l9_25=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_26;
#if (sc_BlendMode_Min)
{
l9_26=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_Max)
{
l9_27=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_27=1.0;
...
#endif
l9_15=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_16);
}
#else
{
vec4 l9_28;
...
{
l9_36=sc_SampleView(sc_ScreenTextureDims.xy,l9_34,sc_ScreenTextureLayout,l9_35,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_36=sc_SampleView(sc_ScreenTextureDims.xy,l9_34,sc_ScreenTextureLayout,l9_35,0.0,sc_ScreenTexture);
}
#endif
l9_30=l9_36;
}
...
{
vec4 l9_38=l9_30;
l9_38.x=l9_30.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_37=l9_38;
}
#else
{
...
#endif
vec3 l9_39=mix(l9_37.xyz,definedBlend(l9_37.xyz,l9_6.xyz).xyz,vec3(l9_6.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_41=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_6.w)),l9_6.w);
}
#else
{
vec4 l9_42;
...
#endif
l9_42=vec4(l9_6.xyz*l9_43,l9_43);
}
#else
{
l9_42=l9_6;
