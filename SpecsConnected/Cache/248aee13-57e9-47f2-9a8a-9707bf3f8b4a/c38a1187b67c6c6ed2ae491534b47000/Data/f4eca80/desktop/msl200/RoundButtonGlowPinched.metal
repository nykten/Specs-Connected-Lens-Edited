...
//sampler sampler glow_mapSmpSC 2:22
...
//texture texture2D glow_map 2:4:2:22
...
//}
//ubo int UserUniforms 2:33:4400 {
...
//float4 glow_mapSize 4144
//float4 glow_mapDims 4160
//float4 glow_mapView 4176
//float3x3 glow_mapTransform 4192
//float4 glow_mapUvMinMax 4240
//float4 glow_mapBorderColor 4256
//float2 Port_Offset_N009 4272
//float4 Port_Value0_N007 4288
//float Port_Position1_N007 4304
//float4 Port_Value1_N007 4320
//float Port_Position2_N007 4336
//float4 Port_Value2_N007 4352
//float4 Port_Value3_N007 4368
//float Port_Input1_N003 4384
//float depthRef 4388
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 1070
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1071
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 1072
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1073
//spec_const int glow_mapLayout 1074
...
constant bool SC_USE_CLAMP_TO_BORDER_glow_map [[function_constant(1031)]];
constant bool SC_USE_CLAMP_TO_BORDER_glow_map_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_glow_map) ? SC_USE_CLAMP_TO_BORDER_glow_map : false;
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture [[function_constant(1032)]];
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_intensityTexture) ? SC_USE_CLAMP_TO_BORDER_intensityTexture : false;
constant bool SC_USE_UV_MIN_MAX_glow_map [[function_constant(1033)]];
constant bool SC_USE_UV_MIN_MAX_glow_map_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_glow_map) ? SC_USE_UV_MIN_MAX_glow_map : false;
constant bool SC_USE_UV_MIN_MAX_intensityTexture [[function_constant(1034)]];
constant bool SC_USE_UV_MIN_MAX_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_intensityTexture) ? SC_USE_UV_MIN_MAX_intensityTexture : false;
constant bool SC_USE_UV_TRANSFORM_glow_map [[function_constant(1035)]];
constant bool SC_USE_UV_TRANSFORM_glow_map_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_glow_map) ? SC_USE_UV_TRANSFORM_glow_map : false;
...
constant bool glow_mapHasSwappedViews [[function_constant(1038)]];
constant bool glow_mapHasSwappedViews_tmp = is_function_constant_defined(glow_mapHasSwappedViews) ? glow_mapHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_glow_map [[function_constant(1070)]];
constant int SC_SOFTWARE_WRAP_MODE_U_glow_map_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_glow_map) ? SC_SOFTWARE_WRAP_MODE_U_glow_map : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture [[function_constant(1071)]];
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_U_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_glow_map [[function_constant(1072)]];
constant int SC_SOFTWARE_WRAP_MODE_V_glow_map_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_glow_map) ? SC_SOFTWARE_WRAP_MODE_V_glow_map : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(1073)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int glow_mapLayout [[function_constant(1074)]];
constant int glow_mapLayout_tmp = is_function_constant_defined(glow_mapLayout) ? glow_mapLayout : 0;
...
float4 glow_mapDims;
float4 glow_mapView;
float3x3 glow_mapTransform;
float4 glow_mapUvMinMax;
float4 glow_mapBorderColor;
float2 Port_Offset_N009;
...
float2 CoordsOut_N9=float2(0.0);
CoordsOut_N9=UVCoord_N12+(*sc_set2.UserUniforms).Port_Offset_N009;
float4 Color_N1=float4(0.0);
int l9_7=0;
if ((int(glow_mapHasSwappedViews_tmp)!=0))
{
int l9_8=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_12=l9_7;
int param=glow_mapLayout_tmp;
int param_1=l9_12;
float2 param_2=CoordsOut_N9;
bool param_3=(int(SC_USE_UV_TRANSFORM_glow_map_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).glow_mapTransform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_glow_map_tmp,SC_SOFTWARE_WRAP_MODE_V_glow_map_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_glow_map_tmp)!=0);
float4 param_7=(*sc_set2.UserUniforms).glow_mapUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_glow_map_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).glow_mapBorderColor;
float param_10=0.0;
bool l9_13=param_8&&(!param_6);
float l9_14=1.0;
float l9_15=param_2.x;
int l9_16=param_5.x;
if (l9_16==1)
{
l9_15=fract(l9_15);
...
float l9_27=param_2.x;
float l9_28=param_7.x;
float l9_29=param_7.z;
bool l9_30=l9_26;
float l9_31=l9_14;
...
float l9_36=param_2.y;
float l9_37=param_7.y;
float l9_38=param_7.w;
bool l9_39=l9_35;
float l9_40=l9_14;
...
float2 l9_43=param_2;
bool l9_44=param_3;
float3x3 l9_45=param_4;
if (l9_44)
{
...
param_2.y=l9_60;
l9_14=l9_63;
float2 l9_71=param_2;
int l9_72=param;
int l9_73=param_1;
float l9_74=param_10;
float2 l9_75=l9_71;
int l9_76=l9_72;
int l9_77=l9_73;
...
float l9_82=l9_74;
float4 l9_83=sc_set2.glow_map.sample(sc_set2.glow_mapSmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_8)
{
l9_85=mix(param_9,l9_85,float4(l9_14));
}
float4 l9_86=l9_85;
Color_N1=l9_86;
float4 Value_N7=float4(0.0);
float param_11=Color_N1.x;
float4 param_12=(*sc_set2.UserUniforms).Port_Value0_N007;
float param_13=(*sc_set2.UserUniforms).Port_Position1_N007;
float4 param_14=(*sc_set2.UserUniforms).Port_Value1_N007;
float param_15=(*sc_set2.UserUniforms).Port_Position2_N007;
float4 param_16=(*sc_set2.UserUniforms).Port_Value2_N007;
float4 param_17=(*sc_set2.UserUniforms).Port_Value3_N007;
param_11=fast::clamp(param_11,0.0,1.0);
float4 param_18;
if (param_11<param_13)
{
param_18=mix(param_12,param_14,float4(fast::clamp(param_11/param_13,0.0,1.0)));
}
else
{
if (param_11<param_15)
{
param_18=mix(param_14,param_16,float4(fast::clamp((param_11-param_13)/(param_15-param_13),0.0,1.0)));
}
else
{
param_18=mix(param_16,param_17,float4(fast::clamp((param_11-param_15)/(1.0-param_15),0.0,1.0)));
}
}
bool l9_87=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_88;
if (l9_87)
{
l9_88=!PreviewInfo.Saved;
}
else
{
l9_88=l9_87;
...
if (l9_88)
{
l9_89=7==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_89=l9_88;
...
PreviewInfo.Color=param_18;
PreviewInfo.Color.w=1.0;
}
Value_N7=param_18;
float4 Output_N3=float4(0.0);
Output_N3=float4(float(Value_N7.x<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N7.y<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N7.z<(*sc_set2.UserUniforms).Port_Input1_N003),float(Value_N7.w<(*sc_set2.UserUniforms).Port_Input1_N003));
float4 Output_N2=float4(0.0);
float4 param_19=Value_N7;
float param_20=Output_N3.x;
float4 param_21=param_19;
if (param_19.x<param_20)
{
discard_fragment();
}
Output_N2=param_21;
...
{
if (param_22<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_94=fast::max(param_23,float4(0.0));
float4 param_24=l9_94;
...
FinalColor=outputMotionVectorsIfNeeded(param_26,param_27,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_28=FinalColor;
float4 l9_168=param_28;
