...
//sampler sampler sc_EnvmapDiffuseSmpSC 2:16
//sampler sampler sc_EnvmapSpecularSmpSC 2:17
//sampler sampler sc_OITCommonSampler 2:18
//sampler sampler sc_SSAOTextureSmpSC 2:19
//sampler sampler sc_ScreenTextureSmpSC 2:20
//sampler sampler sc_ShadowTextureSmpSC 2:21
//texture texture2D intensityTexture 2:0:2:15
//texture texture2D sc_EnvmapDiffuse 2:1:2:16
//texture texture2D sc_EnvmapSpecular 2:2:2:17
...
//texture texture2D sc_SSAOTexture 2:11:2:19
//texture texture2D sc_ScreenTexture 2:12:2:20
//texture texture2D sc_ShadowTexture 2:13:2:21
//SG_REFLECTION_END
...
#endif
l9_74=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_75,sc_EnvmapDiffuseLayout,l9_76,-13.0,sc_EnvmapDiffuse);
}
#else
{
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_174-0.0039215689)),min(1.0,l9_174+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_175=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
sc_writeFragData0(vec4(packValue(l9_176),packValue(l9_176),packValue(l9_176),packValue(l9_176)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_188=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
