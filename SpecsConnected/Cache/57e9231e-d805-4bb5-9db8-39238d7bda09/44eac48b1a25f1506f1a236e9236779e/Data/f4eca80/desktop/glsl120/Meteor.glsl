...
{
l9_6=clamp(dot(l9_1.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_11;
#if (sc_BlendMode_Add)
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=dot(l9_1.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_14;
#if (sc_BlendMode_Min)
{
l9_14=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_Max)
{
l9_15=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_15=1.0;
...
#endif
l9_3=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_4);
}
#else
{
vec4 l9_16;
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_1.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_29;
...
#endif
l9_29=vec4(l9_1.xyz*l9_30,l9_30);
}
#else
{
l9_29=l9_1;
