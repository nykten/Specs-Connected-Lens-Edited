...
//}
//ubo int UserUniforms 2:33:4288 {
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 1070
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1071
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 1072
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1073
//spec_const int baseTexLayout 1074
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex [[function_constant(1070)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseTex [[function_constant(1072)]];
...
constant int baseTexLayout [[function_constant(1074)]];
...
int param_1=l9_12;
float2 param_2=UVCoord_N11;
bool param_3=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).baseTexTransform;
...
float4 param_7=(*sc_set2.UserUniforms).baseTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).baseTexBorderColor;
float param_10=0.0;
...
float4 l9_91=fast::max(param_12,float4(0.0));
float4 param_13=l9_91;
