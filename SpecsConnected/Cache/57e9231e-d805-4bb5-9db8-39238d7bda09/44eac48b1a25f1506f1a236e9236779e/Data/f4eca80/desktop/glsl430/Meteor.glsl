...
//sampler sampler baseTexSmpSC 2:21
...
//texture texture2D baseTex 2:3:2:21
...
//texture texture2DArray baseTexArrSC 2:32:2:21
...
#if (baseTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_2=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
{
if (l9_2.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_8=clamp(dot(l9_2.xyz,vec3(l9_2.w)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_2.w;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_2.w;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_2.xyz,vec3(0.33333001))*l9_2.w;
}
#else
{
float l9_16;
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_2.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_32;
