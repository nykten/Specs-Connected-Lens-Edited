...
vec4 l9_20=sc_SampleTextureLevel(renderTarget1Dims.xy,renderTarget1Layout,renderTarget1GetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_renderTarget1)!=0),renderTarget1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget1,SC_SOFTWARE_WRAP_MODE_V_renderTarget1),(int(SC_USE_UV_MIN_MAX_renderTarget1)!=0),renderTarget1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget1)!=0),renderTarget1BorderColor,0.0,renderTarget1);
vec4 l9_21=sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2);
vec4 l9_22=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3);
gParticle.Size=0.0+(((DecodeFloat16(vec2(l9_19.xy),true)-0.0)*(100.0-0.0))/(0.99998999-0.0));
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_19.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_20.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_20.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_21.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Mass=0.0+(((DecodeFloat16(vec2(l9_21.zw),true)-0.0)*(100.0-0.0))/(0.99998999-0.0));
gParticle.Color.x=0.0+(((DecodeFloat8(l9_22.x,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.y=0.0+(((DecodeFloat8(l9_22.y,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.z=0.0+(((DecodeFloat8(l9_22.z,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.w=0.0+(((DecodeFloat8(l9_22.w,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
vec2 l9_23=l9_12+vec2(0.0014648438,0.0);
...
vec3 l9_5=normalize(varNormal);
float l9_6=((((distance(varPos,sc_Camera.position)*Port_Input1_N017)-Port_RangeMinA_N018)/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_7;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_7=clamp(l9_6,Port_RangeMinB_N018,Port_RangeMaxB_N018);
}
else
{
l9_7=clamp(l9_6,Port_RangeMaxB_N018,Port_RangeMinB_N018);
}
float l9_8=((max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),mat3(l9_4,cross(l9_5,l9_4),l9_5)*Port_Normal_N002)),Port_Exponent_N002),0.0)*Port_Intensity_N002)*Port_Input1_N063)+l9_7;
float l9_9=clamp(Interp_Particle_Age/Interp_Particle_Life,0.0,1.0);
float l9_10=clamp(l9_9,0.0,1.0);
vec4 l9_11;
if (l9_10<Port_Position1_N068)
{
l9_11=mix(Port_Value0_N068,Port_Value1_N068,vec4(clamp(l9_10/Port_Position1_N068,0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_10<Port_Position2_N068)
{
l9_12=mix(Port_Value1_N068,Port_Value2_N068,vec4(clamp((l9_10-Port_Position1_N068)/(Port_Position2_N068-Port_Position1_N068),0.0,1.0)));
}
else
{
l9_12=mix(Port_Value2_N068,Port_Value3_N068,vec4(clamp((l9_10-Port_Position2_N068)/(1.0-Port_Position2_N068),0.0,1.0)));
}
l9_11=l9_12;
}
vec4 l9_13=mix(vec4(clamp((1.0-l9_8)+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001),Port_Input1_N066,vec4(l9_9))*l9_11;
float l9_14;
if (l9_9<=0.0)
{
l9_14=0.0;
...
{
l9_14=pow(l9_9,Port_Input1_N067);
}
float l9_15=clamp(l9_14,0.0,1.0);
vec4 l9_16;
if (l9_15<Port_Position1_N178)
{
l9_16=mix(Port_Value0_N178,Port_Value1_N178,vec4(clamp(l9_15/Port_Position1_N178,0.0,1.0)));
}
else
{
l9_16=mix(Port_Value1_N178,Port_Value2_N178,vec4(clamp((l9_15-Port_Position1_N178)/(1.0-Port_Position1_N178),0.0,1.0)));
}
vec4 l9_17=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_17.w=l9_16.x;
vec4 l9_18;
...
{
l9_20=clamp(l9_16.x*2.0,0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_21=clamp(dot(l9_17.xyz,vec3(l9_16.x)),0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_23=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*l9_16.x;
}
#else
{
float l9_24;
...
{
l9_24=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*l9_16.x;
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*l9_16.x;
}
#else
{
float l9_26;
#if (sc_BlendMode_Add)
{
l9_26=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_27=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*l9_16.x;
}
#else
{
float l9_28;
...
{
l9_28=dot(l9_17.xyz,vec3(0.33333001))*l9_16.x;
}
#else
{
float l9_29;
#if (sc_BlendMode_Min)
{
l9_29=1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_Max)
{
l9_30=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_30=1.0;
...
#endif
l9_18=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_17.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_19);
}
#else
{
vec4 l9_31;
...
#if (sc_FramebufferFetch)
{
vec4 l9_34=sc_readFragData0_Platform();
vec4 l9_35;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_36=l9_34;
l9_36.x=l9_34.x+_sc_framebufferFetchMarker;
l9_35=l9_36;
}
#else
{
...
#else
{
vec2 l9_37=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_38;
...
#endif
l9_33=sc_SampleView(sc_ScreenTextureDims.xy,l9_37,sc_ScreenTextureLayout,l9_38,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_39;
...
{
vec4 l9_40=l9_33;
l9_40.x=l9_33.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_39=l9_40;
}
#else
{
...
#endif
vec3 l9_41=mix(l9_39.xyz,definedBlend(l9_39.xyz,l9_17.xyz).xyz,vec3(l9_16.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_43=vec4(mix(vec3(1.0),l9_17.xyz,vec3(l9_16.x)),l9_16.x);
}
#else
{
vec4 l9_44;
...
#endif
l9_44=vec4(l9_17.xyz*l9_45,l9_45);
}
#else
{
l9_44=l9_17;
...
sc_writeFragData0(l9_47);
vec4 l9_48=clamp(l9_47,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_49=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_49-0.0039215689)),min(1.0,l9_49+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_50=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_51=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_50).xy);
float l9_52=packValue(l9_51);
int l9_59=int(l9_48.w*255.0);
float l9_60=packValue(l9_59);
sc_writeFragData0(vec4(packValue(l9_51),packValue(l9_51),packValue(l9_51),packValue(l9_51)));
sc_writeFragData1(vec4(l9_52,packValue(l9_51),packValue(l9_51),packValue(l9_51)));
sc_writeFragData2(vec4(l9_60,packValue(l9_59),packValue(l9_59),packValue(l9_59)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_63=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_63).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_68==0)
{
l9_71=texture2D(sc_OITAlpha0,l9_63);
l9_70=texture2D(sc_OITDepthLow0,l9_63);
l9_69=texture2D(sc_OITDepthHigh0,l9_63);
}
else
{
l9_71=vec4(0.0);
...
if (l9_68==1)
{
l9_74=texture2D(sc_OITAlpha1,l9_63);
l9_73=texture2D(sc_OITDepthLow1,l9_63);
l9_72=texture2D(sc_OITDepthHigh1,l9_63);
}
else
{
l9_74=l9_71;
...
if (any(notEqual(l9_72,vec4(0.0)))||any(notEqual(l9_73,vec4(0.0))))
{
int l9_75[8]=l9_64;
unpackValues(l9_72.w,l9_68,l9_75);
unpackValues(l9_72.z,l9_68,l9_75);
unpackValues(l9_72.y,l9_68,l9_75);
unpackValues(l9_72.x,l9_68,l9_75);
unpackValues(l9_73.w,l9_68,l9_75);
unpackValues(l9_73.z,l9_68,l9_75);
unpackValues(l9_73.y,l9_68,l9_75);
unpackValues(l9_73.x,l9_68,l9_75);
int l9_84[8]=l9_65;
unpackValues(l9_74.w,l9_68,l9_84);
unpackValues(l9_74.z,l9_68,l9_84);
unpackValues(l9_74.y,l9_68,l9_84);
unpackValues(l9_74.x,l9_68,l9_84);
}
l9_68++;
continue;
}
...
vec4 l9_89=texture2D(sc_OITFilteredDepthBoundsTexture,l9_63);
vec2 l9_90=l9_89.xy;
int l9_91;
#if (sc_SkinBonesCount>0)
{
l9_91=encodeDepth(((1.0-l9_89.x)*1000.0)+getDepthOrderingEpsilon(),l9_90);
}
#else
{
l9_91=0;
...
#endif
int l9_92=encodeDepth(viewSpaceDepth(),l9_90);
vec4 l9_93;
l9_93=l9_48*l9_48.w;
vec4 l9_94;
int l9_95=0;
...
if (l9_95<8)
{
int l9_96=l9_64[l9_95];
int l9_97=l9_92-l9_91;
bool l9_98=l9_96<l9_97;
bool l9_99;
if (l9_98)
{
l9_99=l9_64[l9_95]>0;
...
if (l9_99)
{
vec3 l9_100=l9_93.xyz*(1.0-(float(l9_65[l9_95])/255.0));
l9_94=vec4(l9_100.x,l9_100.y,l9_100.z,l9_93.w);
}
else
{
l9_94=l9_93;
