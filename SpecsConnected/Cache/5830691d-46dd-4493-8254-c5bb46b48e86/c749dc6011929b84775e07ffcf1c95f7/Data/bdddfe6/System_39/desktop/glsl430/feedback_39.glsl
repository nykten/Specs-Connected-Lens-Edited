...
//sampler sampler renderTarget0SmpSC 2:10
//sampler sampler renderTarget1SmpSC 2:11
//sampler sampler renderTarget2SmpSC 2:12
//sampler sampler renderTarget3SmpSC 2:13
//texture texture2D renderTarget0 2:0:2:10
//texture texture2D renderTarget1 2:1:2:11
//texture texture2D renderTarget2 2:2:2:12
//texture texture2D renderTarget3 2:3:2:13
//texture texture2DArray renderTarget0ArrSC 2:20:2:10
//texture texture2DArray renderTarget1ArrSC 2:21:2:11
//texture texture2DArray renderTarget2ArrSC 2:22:2:12
//texture texture2DArray renderTarget3ArrSC 2:23:2:13
//SG_REFLECTION_END
...
void main()
{
vec4 l9_0=vec4((texture0*2.0)-vec2(1.0),1.0,1.0);
...
{
float l9_1=dot(l9_0,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_1);
}
#else
{
varClipDistance=l9_1;
}
#endif
}
#endif
...
{
l9_4=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3ArrSC);
}
#else
{
l9_4=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3);
...
#endif
if (dot(((l9_1+l9_2)+l9_3)+l9_4,vec4(0.2542325))==0.34231836)
{
discard;
}
sc_writeFragData0(l9_1);
sc_writeFragData1(l9_2);
sc_writeFragData2(l9_3);
sc_writeFragData3(l9_4);
}
