...
#endif
vec4 l9_8=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,l9_7,l9_0,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3);
if (dot(((l9_2+l9_4)+l9_6)+l9_8,vec4(0.2542325))==0.34231836)
{
discard;
}
sc_writeFragData0(l9_2);
sc_writeFragData1(l9_4);
sc_writeFragData2(l9_6);
sc_writeFragData3(l9_8);
}
