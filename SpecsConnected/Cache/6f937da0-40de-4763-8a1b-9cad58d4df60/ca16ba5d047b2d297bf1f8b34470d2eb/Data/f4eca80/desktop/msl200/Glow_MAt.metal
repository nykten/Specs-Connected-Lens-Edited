...
//}
//ubo int UserUniforms 2:24:4208 {
...
//float glow_scale 3988
//float Port_Multiplier_N012 3992
//float2 Port_Scale_N013 4000
//float Port_RangeMinA_N015 4008
//float Port_RangeMaxA_N015 4012
//float Port_RangeMinB_N015 4016
//float Port_RangeMaxB_N015 4020
//float Port_Value1_N018 4024
//float4 Port_ValueIn_N035 4032
//float Port_RangeMinA_N035 4048
//float Port_RangeMaxA_N035 4052
//float Port_Input1_N021 4056
//float Port_Input1_N019 4060
//float Port_Input1_N020 4064
//float Port_Input1_N017 4068
//float Port_Value3_N018 4072
//float Port_Input0_N003 4076
//float Port_Input1_N003 4080
//float2 Port_Scale_N006 4088
//float2 Port_Center_N006 4096
//float2 Port_Input1_N000 4104
//float4 Port_Value0_N005 4112
//float Port_Position1_N005 4128
//float4 Port_Value1_N005 4144
//float4 Port_Value2_N005 4160
//float Port_Input0_N009 4176
//float Port_Input1_N009 4180
//float Port_Input0_N016 4184
//float Port_Input1_N016 4188
//float Port_Input0_N022 4192
//float Port_Input1_N022 4196
//}
...
//spec_const int SC_DEVICE_CLASS 1065
...
constant int SC_DEVICE_CLASS [[function_constant(1065)]];
...
float Time_N12=0.0;
Time_N12=Globals.gTimeElapsed*(*sc_set2.UserUniforms).Port_Multiplier_N012;
float Noise_N13=0.0;
float2 param_1=float2(Time_N12);
float2 param_2=(*sc_set2.UserUniforms).Port_Scale_N013;
param_1.x=floor(param_1.x*10000.0)*9.9999997e-05;
param_1.y=floor(param_1.y*10000.0)*9.9999997e-05;
param_1*=(param_2*0.5);
float2 l9_133=param_1;
float param_3=(snoise(l9_133)*0.5)+0.5;
param_3=floor(param_3*10000.0)*9.9999997e-05;
Noise_N13=param_3;
float ValueOut_N15=0.0;
ValueOut_N15=(((Noise_N13-(*sc_set2.UserUniforms).Port_RangeMinA_N015)/((*sc_set2.UserUniforms).Port_RangeMaxA_N015-(*sc_set2.UserUniforms).Port_RangeMinA_N015))*((*sc_set2.UserUniforms).Port_RangeMaxB_N015-(*sc_set2.UserUniforms).Port_RangeMinB_N015))+(*sc_set2.UserUniforms).Port_RangeMinB_N015;
float Output_N41=0.0;
float param_4=(*sc_set2.UserUniforms).glow_scale;
Output_N41=param_4;
float Output_N21=0.0;
Output_N21=Output_N41*(*sc_set2.UserUniforms).Port_Input1_N021;
float Output_N19=0.0;
Output_N19=Output_N21/((*sc_set2.UserUniforms).Port_Input1_N019+1.234e-06);
float Output_N20=0.0;
Output_N20=Output_N19+(*sc_set2.UserUniforms).Port_Input1_N020;
float Output_N17=0.0;
Output_N17=Output_N20+(*sc_set2.UserUniforms).Port_Input1_N017;
float4 ValueOut_N35=float4(0.0);
ValueOut_N35=((((*sc_set2.UserUniforms).Port_ValueIn_N035-float4((*sc_set2.UserUniforms).Port_RangeMinA_N035))/float4((*sc_set2.UserUniforms).Port_RangeMaxA_N035-(*sc_set2.UserUniforms).Port_RangeMinA_N035))*(Output_N17-Output_N20))+float4(Output_N20);
float3 Value_N18=float3(0.0);
Value_N18.x=(*sc_set2.UserUniforms).Port_Value1_N018;
Value_N18.y=ValueOut_N35.x;
Value_N18.z=(*sc_set2.UserUniforms).Port_Value3_N018;
float3 Output_N14=float3(0.0);
Output_N14=(Position_N7*float3(ValueOut_N15))*Value_N18;
float3 VectorOut_N8=float3(0.0);
VectorOut_N8=((*sc_set2.UserUniforms).sc_ModelMatrix*float4(Output_N14,1.0)).xyz;
...
out.varPos=param_6;
out.varNormal=normalize(param_7);
float3 l9_134=normalize(param_8);
out.varTangent=float4(l9_134.x,l9_134.y,l9_134.z,out.varTangent.w);
out.varTangent.w=in.tangent.w;
if ((int(UseViewSpaceDepthVariant_tmp)!=0)&&(((int(sc_OITDepthGatherPass_tmp)!=0)||(int(sc_OITCompositingPass_tmp)!=0))||(int(sc_OITDepthBoundsPass_tmp)!=0)))
{
float4 l9_135=param_5.position;
...
int l9_138=l9_137;
l9_136=(*sc_set2.UserUniforms).sc_ProjectionMatrixInverseArray[l9_138]*l9_135;
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_140=l9_139;
l9_136=(*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_140]*l9_135;
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_142=l9_141;
l9_136=(*sc_set2.UserUniforms).sc_ModelViewMatrixArray[l9_142]*l9_135;
}
else
{
l9_136=l9_135;
...
float4 l9_143=l9_136;
out.varViewSpaceDepth=-l9_143.z;
}
...
int l9_146=l9_145;
l9_144=((*sc_set2.UserUniforms).sc_ModelViewMatrixArray[l9_146]*param_5.position)*float4(1.0/(*sc_set2.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_148=l9_147;
l9_144=(*sc_set2.UserUniforms).sc_ViewProjectionMatrixArray[l9_148]*float4(out.varPos,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_150=l9_149;
l9_144=(*sc_set2.UserUniforms).sc_ViewProjectionMatrixArray[l9_150]*float4(out.varPos,1.0);
}
}
}
}
out.varPackedTex=float4(param_5.texture0,param_5.texture1);
if ((int(sc_ProjectiveShadowsReceiver_tmp)!=0))
{
float4 l9_151=param_5.position;
float4 l9_152=l9_151;
if (sc_RenderingSpace_tmp==1)
{
l9_152=(*sc_set2.UserUniforms).sc_ModelMatrix*l9_151;
}
float4 l9_153=(*sc_set2.UserUniforms).sc_ProjectorMatrix*l9_152;
float2 l9_154=((l9_153.xy/float2(l9_153.w))*0.5)+float2(0.5);
out.varShadowTex=l9_154;
}
float4 l9_155=l9_144;
...
int l9_157=l9_156;
if ((*sc_set2.UserUniforms).sc_ProjectionMatrixArray[l9_157][2].w!=0.0)
{
float l9_158=2.0/log2((*sc_set2.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_155.z=((log2(fast::max((*sc_set2.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_155.w))*l9_158)-1.0)*l9_155.w;
}
}
float4 l9_159=l9_155;
l9_144=l9_159;
float4 l9_160=l9_144;
...
CoordsOut_N6=((UVCoord_N1-(*sc_set2.UserUniforms).Port_Center_N006)*(*sc_set2.UserUniforms).Port_Scale_N006)+(*sc_set2.UserUniforms).Port_Center_N006;
float Output_N0=0.0;
Output_N0=distance(CoordsOut_N6,(*sc_set2.UserUniforms).Port_Input1_N000);
float Output_N3=0.0;
Output_N3=smoothstep((*sc_set2.UserUniforms).Port_Input0_N003,(*sc_set2.UserUniforms).Port_Input1_N003,Output_N0);
float4 Value_N5=float4(0.0);
float param=Output_N3;
float4 param_1=(*sc_set2.UserUniforms).Port_Value0_N005;
float param_2=(*sc_set2.UserUniforms).Port_Position1_N005;
float4 param_3=(*sc_set2.UserUniforms).Port_Value1_N005;
float4 param_4=(*sc_set2.UserUniforms).Port_Value2_N005;
...
if (l9_3)
{
l9_4=5==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_4=l9_3;
...
float Output_N9=0.0;
Output_N9=smoothstep((*sc_set2.UserUniforms).Port_Input0_N009,(*sc_set2.UserUniforms).Port_Input1_N009,Output_N10);
float Output_N16=0.0;
Output_N16=smoothstep((*sc_set2.UserUniforms).Port_Input0_N016,(*sc_set2.UserUniforms).Port_Input1_N016,Output_N10);
float4 Output_N11=float4(0.0);
Output_N11=(Value_N5*float4(Output_N9))*float4(Output_N16);
float Output_N41=0.0;
float param_6=(*sc_set2.UserUniforms).glow_scale;
Output_N41=param_6;
float Output_N21=0.0;
Output_N21=Output_N41*(*sc_set2.UserUniforms).Port_Input1_N021;
float Output_N22=0.0;
Output_N22=smoothstep((*sc_set2.UserUniforms).Port_Input0_N022,(*sc_set2.UserUniforms).Port_Input1_N022,Output_N21);
...
{
l9_10=fast::clamp(l9_9.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_10=fast::clamp(dot(l9_9.xyz,float3(l9_9.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_10=(1.0-dot(l9_9.xyz,float3(0.33333001)))*l9_9.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_10=(1.0-fast::clamp(dot(l9_9.xyz,float3(1.0)),0.0,1.0))*l9_9.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_10=fast::clamp(dot(l9_9.xyz,float3(1.0)),0.0,1.0)*l9_9.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_10=fast::clamp(dot(l9_9.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_10=dot(l9_9.xyz,float3(0.33333001))*l9_9.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_10=1.0-fast::clamp(dot(l9_9.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_11=l9_10;
float l9_12=l9_11;
float l9_13=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_12;
float3 l9_14=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_8.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_15=float4(l9_14.x,l9_14.y,l9_14.z,l9_13);
param_8=l9_15;
}
else
{
...
{
float4 l9_16=param_8;
float4 l9_17=float4(0.0);
float4 l9_18=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_19=out.FragColor0;
float4 l9_20=l9_19;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_20.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_21=l9_20;
l9_18=l9_21;
}
...
{
float4 l9_22=gl_FragCoord;
float2 l9_23=(l9_22.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_24=l9_23;
...
float2 l9_49=l9_45;
int l9_50=sc_ScreenTextureLayout_tmp;
int l9_51=l9_46;
float l9_52=l9_47;
float2 l9_53=l9_49;
int l9_54=l9_50;
...
if (l9_54==0)
{
l9_56=float3(l9_53,0.0);
}
else
{
if (l9_54==1)
{
l9_56=float3(l9_53.x,(l9_53.y*0.5)+(0.5-(float(l9_55)*0.5)),0.0);
}
else
{
l9_56=float3(l9_53,float(l9_55));
}
}
float3 l9_57=l9_56;
float3 l9_58=l9_57;
float2 l9_59=l9_58.xy;
float l9_60=l9_52;
float4 l9_61=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_59,bias(l9_60));
float4 l9_62=l9_61;
l9_48=l9_62;
float4 l9_63=l9_48;
float4 l9_64=l9_63;
...
float3 l9_69=l9_68;
float3 l9_70=l9_16.xyz;
float3 l9_71=definedBlend(l9_69,l9_70,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_17=float4(l9_71.x,l9_71.y,l9_71.z,l9_17.w);
float3 l9_72=mix(l9_68,l9_17.xyz,float3(l9_16.w));
l9_17=float4(l9_72.x,l9_72.y,l9_72.z,l9_17.w);
l9_17.w=1.0;
float4 l9_73=l9_17;
param_8=l9_73;
}
...
{
float4 l9_74=param_8;
float4 l9_75=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_75=float4(mix(float3(1.0),l9_74.xyz,float3(l9_74.w)),l9_74.w);
}
else
{
...
l9_75=float4(l9_74.xyz*l9_76,l9_76);
}
else
{
l9_75=l9_74;
...
{
l9_79=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_79=float4(0.0);
...
float4 l9_81=param_11;
out.FragColor0=l9_81;
return out;
}
} // FRAGMENT SHADER
