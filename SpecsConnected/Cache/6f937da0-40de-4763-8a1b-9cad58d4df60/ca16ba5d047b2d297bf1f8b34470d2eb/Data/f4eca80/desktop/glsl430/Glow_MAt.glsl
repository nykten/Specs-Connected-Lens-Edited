...
{
l9_32=sc_SampleView(sc_ScreenTextureDims.xy,l9_30,sc_ScreenTextureLayout,l9_31,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_32=sc_SampleView(sc_ScreenTextureDims.xy,l9_30,sc_ScreenTextureLayout,l9_31,0.0,sc_ScreenTexture);
}
#endif
l9_26=l9_32;
}
...
{
vec4 l9_34=l9_26;
l9_34.x=l9_26.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_33=l9_34;
}
#else
{
...
#endif
vec3 l9_35=mix(l9_33.xyz,definedBlend(l9_33.xyz,l9_10.xyz).xyz,vec3(l9_9));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_37=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_9)),l9_9);
}
#else
{
vec4 l9_38;
...
#endif
l9_38=vec4(l9_10.xyz*l9_39,l9_39);
}
#else
{
l9_38=l9_10;
