...
uniform vec2 Port_Scale_N013;
uniform float Port_RangeMinA_N015;
uniform float Port_RangeMaxA_N015;
uniform float Port_RangeMaxB_N015;
uniform float Port_RangeMinB_N015;
uniform float Port_Input1_N021;
uniform float Port_Input1_N019;
uniform float Port_Input1_N020;
uniform float Port_Input1_N017;
uniform vec4 Port_ValueIn_N035;
...
uniform vec2 Port_Scale_N006;
uniform vec2 Port_Center_N006;
uniform vec2 Port_Input1_N000;
...
uniform float Port_Input0_N016;
uniform float Port_Input1_N016;
uniform float Port_Input0_N022;
...
float l9_32=snoise(vec2(floor((l9_30*Port_Multiplier_N012)*10000.0)*9.9999997e-05)*(Port_Scale_N013*0.5));
float l9_33=((glow_scale*Port_Input1_N021)/(Port_Input1_N019+1.234e-06))+Port_Input1_N020;
vec3 l9_34;
vec3 l9_35;
vec3 l9_36;
if (l9_27)
{
l9_36=varTangent.xyz;
l9_35=varNormal;
l9_34=varPos;
}
else
...
l9_36=varTangent.xyz;
l9_35=l9_31;
l9_34=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(((((floor(((l9_32*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N015)/(Port_RangeMaxA_N015-Port_RangeMinA_N015))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015))*vec3(Port_Value1_N018,((((Port_ValueIn_N035-vec4(Port_RangeMinA_N035))/vec4(Port_RangeMaxA_N035-Port_RangeMinA_N035))*((l9_33+Port_Input1_N017)-l9_33))+vec4(l9_33)).x,Port_Value3_N018),1.0)).xyz;
}
varPos=l9_34;
varNormal=normalize(l9_35);
vec3 l9_37=normalize(l9_36);
varTangent=vec4(l9_37.x,l9_37.y,l9_37.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_38=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_39;
#if (sc_RenderingSpace==2)
{
l9_39=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_40;
#if (sc_RenderingSpace==1)
{
l9_40=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_40=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_42=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_43;
...
#endif
vec4 l9_46=sc_ProjectorMatrix*l9_45;
varShadowTex=((l9_46.xy/vec2(l9_46.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_47;
...
{
vec4 l9_49=l9_41;
l9_49.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_41.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_41.w;
l9_48=l9_49;
}
else
{
...
{
float l9_50=dot(l9_47,sc_StereoClipPlanes[sc_StereoViewID]);
...
float l9_1=clamp(smoothstep(Port_Input0_N003,Port_Input1_N003,distance(((varPackedTex.xy-Port_Center_N006)*Port_Scale_N006)+Port_Center_N006,Port_Input1_N000)),0.0,1.0);
vec4 l9_2;
if (l9_1<Port_Position1_N005)
{
l9_2=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_1/Port_Position1_N005,0.0,1.0)));
}
else
{
l9_2=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_1-Port_Position1_N005)/(1.0-Port_Position1_N005),0.0,1.0)));
}
...
{
l9_6=PreviewVertexColor;
l9_5=l9_0;
}
vec4 l9_8=(l9_2*vec4(smoothstep(Port_Input0_N009,Port_Input1_N009,varPackedTex.y)))*vec4(smoothstep(Port_Input0_N016,Port_Input1_N016,varPackedTex.y));
float l9_9=smoothstep(Port_Input0_N022,Port_Input1_N022,glow_scale*Port_Input1_N021);
vec4 l9_10=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_10.w=l9_9;
...
{
l9_14=clamp(dot(l9_10.xyz,vec3(l9_9)),0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_16=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*l9_9;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*l9_9;
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_9;
}
#else
{
float l9_19;
#if (sc_BlendMode_Add)
{
l9_19=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_9;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_10.xyz,vec3(0.33333001))*l9_9;
}
#else
{
float l9_22;
#if (sc_BlendMode_Min)
{
l9_22=1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_23;
#if (sc_BlendMode_Max)
{
l9_23=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_23=1.0;
...
#endif
l9_11=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_10.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_12);
}
#else
{
vec4 l9_24;
...
#if (sc_FramebufferFetch)
{
vec4 l9_27=sc_readFragData0_Platform();
vec4 l9_28;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_29=l9_27;
l9_29.x=l9_27.x+_sc_framebufferFetchMarker;
l9_28=l9_29;
}
#else
{
...
#else
{
vec2 l9_30=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_31;
...
#endif
l9_26=sc_SampleView(sc_ScreenTextureDims.xy,l9_30,sc_ScreenTextureLayout,l9_31,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_32;
...
{
vec4 l9_33=l9_26;
l9_33.x=l9_26.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_32=l9_33;
}
#else
{
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_10.xyz).xyz,vec3(l9_9));
vec4 l9_35=vec4(l9_34.x,l9_34.y,l9_34.z,vec4(0.0).w);
l9_35.w=1.0;
l9_25=l9_35;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_9)),l9_9);
}
#else
{
vec4 l9_37;
...
#endif
l9_37=vec4(l9_10.xyz*l9_38,l9_38);
}
#else
{
l9_37=l9_10;
...
{
l9_41=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_41=vec4(0.0);
...
vec4 l9_43=outputMotionVectorsIfNeeded(varPos,max(l9_42,vec4(0.0)));
vec4 l9_44=clamp(l9_43,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_45=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_45-0.0039215689)),min(1.0,l9_45+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_46=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_46).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_47=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_46).xy);
float l9_48=packValue(l9_47);
int l9_55=int(l9_44.w*255.0);
float l9_56=packValue(l9_55);
sc_writeFragData0(vec4(packValue(l9_47),packValue(l9_47),packValue(l9_47),packValue(l9_47)));
sc_writeFragData1(vec4(l9_48,packValue(l9_47),packValue(l9_47),packValue(l9_47)));
sc_writeFragData2(vec4(l9_56,packValue(l9_55),packValue(l9_55),packValue(l9_55)));
...
if (l9_64==0)
{
l9_67=texture2D(sc_OITAlpha0,l9_59);
l9_66=texture2D(sc_OITDepthLow0,l9_59);
l9_65=texture2D(sc_OITDepthHigh0,l9_59);
}
else
{
l9_67=vec4(0.0);
...
if (l9_64==1)
{
l9_70=texture2D(sc_OITAlpha1,l9_59);
l9_69=texture2D(sc_OITDepthLow1,l9_59);
l9_68=texture2D(sc_OITDepthHigh1,l9_59);
}
else
{
l9_70=l9_67;
...
if (any(notEqual(l9_68,vec4(0.0)))||any(notEqual(l9_69,vec4(0.0))))
{
int l9_71[8]=l9_60;
unpackValues(l9_68.w,l9_64,l9_71);
unpackValues(l9_68.z,l9_64,l9_71);
unpackValues(l9_68.y,l9_64,l9_71);
unpackValues(l9_68.x,l9_64,l9_71);
unpackValues(l9_69.w,l9_64,l9_71);
unpackValues(l9_69.z,l9_64,l9_71);
unpackValues(l9_69.y,l9_64,l9_71);
unpackValues(l9_69.x,l9_64,l9_71);
int l9_80[8]=l9_61;
unpackValues(l9_70.w,l9_64,l9_80);
unpackValues(l9_70.z,l9_64,l9_80);
unpackValues(l9_70.y,l9_64,l9_80);
unpackValues(l9_70.x,l9_64,l9_80);
}
l9_64++;
continue;
}
...
vec4 l9_85=texture2D(sc_OITFilteredDepthBoundsTexture,l9_59);
vec2 l9_86=l9_85.xy;
int l9_87;
#if (sc_SkinBonesCount>0)
{
l9_87=encodeDepth(((1.0-l9_85.x)*1000.0)+getDepthOrderingEpsilon(),l9_86);
}
#else
{
l9_87=0;
...
#endif
int l9_88=encodeDepth(viewSpaceDepth(),l9_86);
vec4 l9_89;
l9_89=l9_44*l9_44.w;
vec4 l9_90;
int l9_91=0;
...
if (l9_91<8)
{
int l9_92=l9_60[l9_91];
int l9_93=l9_88-l9_87;
bool l9_94=l9_92<l9_93;
bool l9_95;
if (l9_94)
{
l9_95=l9_60[l9_91]>0;
...
if (l9_95)
{
vec3 l9_96=l9_89.xyz*(1.0-(float(l9_61[l9_91])/255.0));
l9_90=vec4(l9_96.x,l9_96.y,l9_96.z,l9_89.w);
}
else
{
l9_90=l9_89;
