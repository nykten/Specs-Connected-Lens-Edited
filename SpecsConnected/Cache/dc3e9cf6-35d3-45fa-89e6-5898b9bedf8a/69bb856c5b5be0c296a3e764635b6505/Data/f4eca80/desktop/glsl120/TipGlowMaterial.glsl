...
//sampler sampler mainTexSmpSC 2:17
...
//texture texture2D mainTex 2:1:2:17
...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(mainTexDims.xy,mainTexLayout,l9_0,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex),(int(SC_USE_UV_MIN_MAX_mainTex)!=0),mainTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0),mainTexBorderColor,0.0,mainTex);
vec3 l9_2=vec3(tintColor.xyz)*vec3(l9_1.xyz);
float l9_3=((tintColor.w*l9_1.w)*brightness)*fadeLevel;
...
{
l9_8=clamp(dot(l9_4.xyz,vec3(l9_3)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_3;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_3;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_13;
#if (sc_BlendMode_Add)
{
l9_13=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_4.xyz,vec3(0.33333001))*l9_3;
}
#else
{
float l9_16;
#if (sc_BlendMode_Min)
{
l9_16=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_Max)
{
l9_17=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_17=1.0;
...
#endif
l9_5=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_6);
}
#else
{
vec4 l9_18;
...
#endif
l9_20=sc_SampleView(sc_ScreenTextureDims.xy,l9_24,sc_ScreenTextureLayout,l9_25,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_26;
...
{
vec4 l9_27=l9_20;
l9_27.x=l9_20.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_26=l9_27;
}
#else
{
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_4.xyz).xyz,vec3(l9_3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_3)),l9_3);
}
#else
{
vec4 l9_31;
...
#endif
l9_31=vec4(l9_4.xyz*l9_32,l9_32);
}
#else
{
l9_31=l9_4;
...
if (l9_58==0)
{
l9_61=texture2D(sc_OITAlpha0,l9_53);
l9_60=texture2D(sc_OITDepthLow0,l9_53);
l9_59=texture2D(sc_OITDepthHigh0,l9_53);
}
else
{
l9_61=vec4(0.0);
...
if (l9_58==1)
{
l9_64=texture2D(sc_OITAlpha1,l9_53);
l9_63=texture2D(sc_OITDepthLow1,l9_53);
l9_62=texture2D(sc_OITDepthHigh1,l9_53);
}
else
{
l9_64=l9_61;
...
vec4 l9_79=texture2D(sc_OITFilteredDepthBoundsTexture,l9_53);
vec2 l9_80=l9_79.xy;
int l9_81;
#if (sc_SkinBonesCount>0)
{
