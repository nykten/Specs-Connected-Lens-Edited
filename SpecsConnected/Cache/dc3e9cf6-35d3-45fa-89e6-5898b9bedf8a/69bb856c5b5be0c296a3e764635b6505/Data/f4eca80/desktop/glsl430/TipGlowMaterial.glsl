...
//sampler sampler mainTexSmpSC 2:22
...
//texture texture2D mainTex 2:4:2:22
...
//texture texture2DArray mainTexArrSC 2:33:2:22
...
uniform sampler2DArray mainTexArrSC;
...
#if (mainTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(mainTexDims.xy,mainTexLayout,mainTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex),(int(SC_USE_UV_MIN_MAX_mainTex)!=0),mainTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0),mainTexBorderColor,0.0,mainTexArrSC);
}
#else
{
...
#endif
vec3 l9_3=vec3(tintColor.xyz)*vec3(l9_2.xyz);
float l9_4=((tintColor.w*l9_2.w)*brightness)*fadeLevel;
vec4 l9_5=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_5.w=l9_4;
...
#endif
sc_writeFragData0(max(l9_6,vec4(0.0)));
return;
}
vec4 l9_8;
...
{
l9_11=clamp(dot(l9_5.xyz,vec3(l9_4)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_4;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_4;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_16;
#if (sc_BlendMode_Add)
{
l9_16=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_5.xyz,vec3(0.33333001))*l9_4;
}
#else
{
float l9_19;
#if (sc_BlendMode_Min)
{
l9_19=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_Max)
{
l9_20=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_20=1.0;
...
#endif
l9_8=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_9);
}
#else
{
vec4 l9_21;
...
#if (sc_FramebufferFetch)
{
vec4 l9_24=sc_readFragData0_Platform();
vec4 l9_25;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_26=l9_24;
l9_26.x=l9_24.x+_sc_framebufferFetchMarker;
l9_25=l9_26;
}
#else
{
...
#else
{
vec2 l9_27=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_28;
...
{
l9_29=sc_SampleView(sc_ScreenTextureDims.xy,l9_27,sc_ScreenTextureLayout,l9_28,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_29=sc_SampleView(sc_ScreenTextureDims.xy,l9_27,sc_ScreenTextureLayout,l9_28,0.0,sc_ScreenTexture);
}
#endif
l9_23=l9_29;
}
...
{
vec4 l9_31=l9_23;
l9_31.x=l9_23.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_30=l9_31;
}
#else
{
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_5.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_5.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_5;
