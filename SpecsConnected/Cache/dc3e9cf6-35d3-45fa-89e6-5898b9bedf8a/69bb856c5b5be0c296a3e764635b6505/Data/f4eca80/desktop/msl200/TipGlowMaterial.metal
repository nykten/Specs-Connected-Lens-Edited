...
//texture texture2D mainTex 2:5:2:23
...
//float4 tintColor 4144
//float4 mainTexSize 4160
//float4 mainTexDims 4176
//float4 mainTexView 4192
//float3x3 mainTexTransform 4208
//float4 mainTexUvMinMax 4256
//float4 mainTexBorderColor 4272
//float brightness 4288
//float fadeLevel 4292
//float depthRef 4296
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTex 1071
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1072
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTex 1073
//spec_const int intensityTextureLayout 1074
//spec_const int mainTexLayout 1075
...
constant bool SC_USE_CLAMP_TO_BORDER_mainTex [[function_constant(1032)]];
...
constant bool SC_USE_UV_MIN_MAX_mainTex [[function_constant(1034)]];
...
constant bool SC_USE_UV_TRANSFORM_mainTex [[function_constant(1036)]];
...
constant bool mainTexHasSwappedViews [[function_constant(1039)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_mainTex [[function_constant(1071)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_mainTex [[function_constant(1073)]];
...
constant int mainTexLayout [[function_constant(1075)]];
...
float4 param=(*sc_set2.UserUniforms).tintColor;
Output_N3=param;
float3 Output_N6=float3(0.0);
Output_N6=float3(Output_N3.x,Output_N3.y,Output_N3.z);
...
int l9_12=l9_7;
int param_1=mainTexLayout_tmp;
int param_2=l9_12;
float2 param_3=UVCoord_N2;
bool param_4=(int(SC_USE_UV_TRANSFORM_mainTex_tmp)!=0);
float3x3 param_5=(*sc_set2.UserUniforms).mainTexTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_mainTex_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTex_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_mainTex_tmp)!=0);
float4 param_8=(*sc_set2.UserUniforms).mainTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 param_10=(*sc_set2.UserUniforms).mainTexBorderColor;
float param_11=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set2.mainTex.sample(sc_set2.mainTexSmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_9)
{
...
Output_N5=float3(Color_N0.x,Color_N0.y,Color_N0.z);
float3 Output_N7=float3(0.0);
Output_N7=Output_N6*Output_N5;
float Output_N8=0.0;
Output_N8=Output_N3.w;
float Output_N9=0.0;
Output_N9=Color_N0.w;
float Output_N12=0.0;
float param_12=(*sc_set2.UserUniforms).brightness;
Output_N12=param_12;
float Output_N13=0.0;
float param_13=(*sc_set2.UserUniforms).fadeLevel;
Output_N13=param_13;
float Output_N10=0.0;
Output_N10=((Output_N8*Output_N9)*Output_N12)*Output_N13;
float4 Value_N11=float4(0.0);
Value_N11=float4(Output_N7.x,Output_N7.y,Output_N7.z,Value_N11.w);
Value_N11.w=Output_N10;
FinalColor=Value_N11;
float param_14=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_14<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_91=fast::max(param_15,float4(0.0));
float4 param_16=l9_91;
out.FragColor0=param_16;
return out;
}
float4 param_17=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_92=param_17;
float4 l9_93=l9_92;
float l9_94=1.0;
...
FinalColor=outputMotionVectorsIfNeeded(param_18,param_19,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_20=FinalColor;
float4 l9_165=param_20;
