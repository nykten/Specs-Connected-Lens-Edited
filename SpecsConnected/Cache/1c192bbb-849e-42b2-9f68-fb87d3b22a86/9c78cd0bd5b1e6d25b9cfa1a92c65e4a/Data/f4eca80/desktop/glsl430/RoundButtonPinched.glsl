...
#endif
vec4 l9_18=vec4(Port_Import_N027)*l9_17;
vec2 l9_19=l9_3*Port_Input1_N010;
float l9_20=clamp(length(l9_19+Port_Input2_N010),0.0,1.0);
vec4 l9_21;
if (l9_20<Port_Position1_N030)
{
l9_21=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_20/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_21=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_20-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec3 l9_22=-l9_4;
vec4 l9_23=mix(l9_21,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_22,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_24=l9_23.w;
vec3 l9_25=(l9_18.xyz+Port_Input1_N002)+l9_23.xyz;
...
#endif
sc_writeFragData0(max(l9_27,vec4(0.0)));
return;
}
vec4 l9_29;
...
{
l9_32=clamp(dot(l9_26.xyz,vec3(l9_24)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*l9_24;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*l9_24;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_37;
#if (sc_BlendMode_Add)
{
l9_37=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_38;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_26.xyz,vec3(0.33333001))*l9_24;
}
#else
{
float l9_40;
#if (sc_BlendMode_Min)
{
l9_40=1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_41;
#if (sc_BlendMode_Max)
{
l9_41=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_41=1.0;
...
#endif
l9_29=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_26.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_30);
}
#else
{
vec4 l9_42;
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_26.xyz).xyz,vec3(l9_24));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_26.xyz,vec3(l9_24)),l9_24);
}
#else
{
vec4 l9_56;
...
#endif
l9_56=vec4(l9_26.xyz*l9_57,l9_57);
}
#else
{
l9_56=l9_26;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_65).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_66=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_65).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_78).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_83==0)
{
l9_86=texture(sc_OITAlpha0,l9_78);
l9_85=texture(sc_OITDepthLow0,l9_78);
l9_84=texture(sc_OITDepthHigh0,l9_78);
}
else
{
l9_86=vec4(0.0);
...
if (l9_83==1)
{
l9_89=texture(sc_OITAlpha1,l9_78);
l9_88=texture(sc_OITDepthLow1,l9_78);
l9_87=texture(sc_OITDepthHigh1,l9_78);
}
else
{
l9_89=l9_86;
...
vec4 l9_104=texture(sc_OITFilteredDepthBoundsTexture,l9_78);
