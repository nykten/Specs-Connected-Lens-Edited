...
//float4 Port_Value0_N030 4352
//float Port_Position1_N030 4368
//float4 Port_Value1_N030 4384
//float4 Port_Value2_N030 4400
//float4 Port_Input1_N034 4416
//float3 Port_Normal_N031 4432
//float Port_Exponent_N031 4448
//float Port_Intensity_N031 4452
//float depthRef 4456
//}
...
float4 Port_Value0_N030;
float Port_Position1_N030;
float4 Port_Value1_N030;
float4 Port_Value2_N030;
...
float4 Value_N30=float4(0.0);
float param_13=Output_N14;
float4 param_14=(*sc_set2.UserUniforms).Port_Value0_N030;
float param_15=(*sc_set2.UserUniforms).Port_Position1_N030;
float4 param_16=(*sc_set2.UserUniforms).Port_Value1_N030;
float4 param_17=(*sc_set2.UserUniforms).Port_Value2_N030;
param_13=fast::clamp(param_13,0.0,1.0);
float4 param_18;
if (param_13<param_15)
{
param_18=mix(param_14,param_16,float4(fast::clamp(param_13/param_15,0.0,1.0)));
}
else
{
param_18=mix(param_16,param_17,float4(fast::clamp((param_13-param_15)/(1.0-param_15),0.0,1.0)));
}
Value_N30=param_18;
float Rim_N31=0.0;
float3 param_19=(*sc_set2.UserUniforms).Port_Normal_N031;
float param_20=(*sc_set2.UserUniforms).Port_Exponent_N031;
float param_21=(*sc_set2.UserUniforms).Port_Intensity_N031;
ssGlobals param_23=Globals;
param_19=float3x3(float3(param_23.VertexTangent_WorldSpace),float3(param_23.VertexBinormal_WorldSpace),float3(param_23.VertexNormal_WorldSpace))*param_19;
float l9_92=abs(dot(-param_23.ViewDirWS,param_19));
float param_22=pow(1.0-l9_92,param_20);
param_22=fast::max(param_22,0.0);
param_22*=param_21;
Rim_N31=param_22;
float4 Output_N34=float4(0.0);
Output_N34=mix(Value_N30,(*sc_set2.UserUniforms).Port_Input1_N034,float4(Rim_N31));
float3 Value1_N23=float3(0.0);
float Value2_N23=0.0;
float4 param_24=Output_N34;
float3 param_25=param_24.xyz;
float param_26=param_24.w;
Value1_N23=param_25;
Value2_N23=param_26;
...
float4 l9_97=fast::max(param_28,float4(0.0));
float4 param_29=l9_97;
