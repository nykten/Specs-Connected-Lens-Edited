...
vec4 l9_10;
if (l9_9<Port_Position1_N030)
{
l9_10=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_9/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_10=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_9-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec4 l9_11=mix(l9_10,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_12=l9_11.w;
vec3 l9_13=((vec4(Port_Import_N027)*l9_8).xyz+Port_Input1_N002)+l9_11.xyz;
vec4 l9_14=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_14.w=l9_12;
#if (sc_BlendMode_AlphaTest)
{
if (l9_12<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_12<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_18=clamp(dot(l9_14.xyz,vec3(l9_12)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*l9_12;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*l9_12;
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_12;
}
#else
{
float l9_23;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_24=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_12;
}
#else
{
float l9_25;
...
{
l9_25=dot(l9_14.xyz,vec3(0.33333001))*l9_12;
}
#else
{
float l9_26;
...
#endif
vec3 l9_38=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_14.xyz).xyz,vec3(l9_12));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_14.xyz,vec3(l9_12)),l9_12);
}
#else
{
vec4 l9_41;
