...
//float3 Port_Normal_N000 4144
//float Port_Exponent_N000 4160
//float Port_Intensity_N000 4164
//float depthRef 4168
//}
...
float3 Port_Normal_N000;
float Port_Exponent_N000;
float Port_Intensity_N000;
float depthRef;
};
struct sc_Bone_t
{
...
float Rim_N0=0.0;
float3 param=(*sc_set2.UserUniforms).Port_Normal_N000;
float param_1=(*sc_set2.UserUniforms).Port_Exponent_N000;
float param_2=(*sc_set2.UserUniforms).Port_Intensity_N000;
ssGlobals param_4=Globals;
param=float3x3(float3(param_4.VertexTangent_WorldSpace),float3(param_4.VertexBinormal_WorldSpace),float3(param_4.VertexNormal_WorldSpace))*param;
float l9_7=abs(dot(-param_4.ViewDirWS,param));
float param_3=pow(1.0-l9_7,param_1);
param_3=fast::max(param_3,0.0);
param_3*=param_2;
Rim_N0=param_3;
FinalColor=float4(Rim_N0);
...
float4 l9_12=fast::max(param_6,float4(0.0));
float4 param_7=l9_12;
