...
uniform vec3 Port_Normal_N000;
uniform float Port_Exponent_N000;
uniform float Port_Intensity_N000;
...
mat3 l9_10=mat3(l9_3,l9_1,l9_2);
vec3 l9_11=-l9_0;
float l9_12=max(pow(1.0-abs(dot(l9_11,l9_10*Port_Normal_N000)),Port_Exponent_N000),0.0)*Port_Intensity_N000;
vec4 l9_13=vec4(l9_12);
...
#endif
sc_writeFragData0(max(l9_14,vec4(0.0)));
return;
}
vec4 l9_16;
...
{
l9_19=clamp(dot(l9_13.xyz,vec3(l9_12)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_13.xyz,vec3(0.33333001)))*l9_12;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0))*l9_12;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*l9_12;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*l9_12;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_13.xyz,vec3(0.33333001))*l9_12;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_13.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
#if (sc_FramebufferFetch)
{
vec4 l9_32=sc_readFragData0_Platform();
vec4 l9_33;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_34=l9_32;
l9_34.x=l9_32.x+_sc_framebufferFetchMarker;
l9_33=l9_34;
}
#else
{
...
{
l9_37=sc_SampleView(sc_ScreenTextureDims.xy,l9_35,sc_ScreenTextureLayout,l9_36,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_37=sc_SampleView(sc_ScreenTextureDims.xy,l9_35,sc_ScreenTextureLayout,l9_36,0.0,sc_ScreenTexture);
}
#endif
l9_31=l9_37;
}
...
{
vec4 l9_39=l9_31;
l9_39.x=l9_31.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_38=l9_39;
}
#else
{
...
#endif
vec3 l9_40=mix(l9_38.xyz,definedBlend(l9_38.xyz,l9_13.xyz).xyz,vec3(l9_12));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_42=vec4(mix(vec3(1.0),l9_13.xyz,vec3(l9_12)),l9_12);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_13.xyz*l9_44,l9_44);
}
#else
{
l9_43=l9_13;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_52).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_53=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_52).xy);
...
if (l9_70==0)
{
l9_73=texture(sc_OITAlpha0,l9_65);
l9_72=texture(sc_OITDepthLow0,l9_65);
l9_71=texture(sc_OITDepthHigh0,l9_65);
}
else
{
l9_73=vec4(0.0);
...
if (l9_70==1)
{
l9_76=texture(sc_OITAlpha1,l9_65);
l9_75=texture(sc_OITDepthLow1,l9_65);
l9_74=texture(sc_OITDepthHigh1,l9_65);
}
else
{
l9_76=l9_73;
...
vec4 l9_91=texture(sc_OITFilteredDepthBoundsTexture,l9_65);
vec2 l9_92=l9_91.xy;
int l9_93;
#if (sc_SkinBonesCount>0)
{
