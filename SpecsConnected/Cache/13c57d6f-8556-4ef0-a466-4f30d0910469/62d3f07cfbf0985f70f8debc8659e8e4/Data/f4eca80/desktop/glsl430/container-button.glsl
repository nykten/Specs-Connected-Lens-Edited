...
uniform float Port_Input0_N038;
uniform vec4 Port_Input1_N043;
uniform vec4 Port_Input2_N043;
uniform float Port_Input1_N031;
uniform float Port_Input1_N028;
uniform float Port_Input2_N028;
uniform float Port_Input1_N022;
...
vec4 l9_6=vec4(l9_5.normalWS,0.0);
l9_4=(sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5.positionWS,1.0)).xyz;
l9_3=normalize((sc_ModelMatrixInverse*l9_6).xyz);
l9_2=l9_5.uv0;
l9_1=normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_6).xyz);
}
else
{
vec4 l9_7=vec4(normalize(varNormal),0.0);
l9_4=(sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0)).xyz;
l9_3=normalize((sc_ModelMatrixInverse*l9_7).xyz);
l9_2=varPackedTex.xy;
l9_1=normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_7).xyz);
}
vec3 l9_8=cross(normalize(l9_4),l9_1);
vec2 l9_9=l9_8.yx;
l9_9.x=l9_8.y*(-1.0);
vec2 l9_10=(l9_9*0.5)+vec2(0.5);
vec4 l9_11;
#if (additional_settings_btn_refl_texLayout==2)
{
l9_11=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_texArrSC);
}
#else
{
...
#endif
float l9_12=length((vec4(l9_3.xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_13=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_14=max(l9_13,Port_Input1_N019);
float l9_15=clamp(l9_12,0.0,1.0);
vec4 l9_16;
if (l9_15<Port_Position1_N007)
{
l9_16=mix(l9_13,l9_14,vec4(clamp(l9_15/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_17;
if (l9_15<Port_Position2_N007)
{
l9_17=mix(l9_14,Port_Value2_N007,vec4(clamp((l9_15-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_17=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_15-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_16=l9_17;
}
...
vec4 l9_23=l9_11+l9_16;
vec4 l9_24=baseColor*l9_16;
float l9_25=clamp((l9_12*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_26;
if (l9_25<=0.0)
{
l9_26=0.0;
...
{
l9_26=pow(l9_25,Port_Input1_N022);
}
float l9_27;
if (l9_26<=0.0)
{
...
{
l9_27=pow(l9_26,Port_Input1_N034);
}
float l9_28=l9_27*Port_Input1_N041;
vec2 l9_29=l9_2-Port_Center_N002;
vec2 l9_30=(l9_29*iconScale)+Port_Center_N002;
vec4 l9_31;
#if (iconLayout==2)
{
l9_31=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_30,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_31=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_30,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
vec4 l9_32=mix(mix(mix(baseColor*(l9_23*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_24)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_28)),vec4(l9_31.xyz,0.0),vec4(l9_31.w));
float l9_33=max(l9_26,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_34=max(l9_31.w,l9_33)*alpha;
vec4 l9_35=vec4(l9_32.x,l9_32.y,l9_32.z,vec4(0.0).w);
l9_35.w=l9_34;
#if (sc_BlendMode_AlphaTest)
{
if (l9_34<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_34<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_41=clamp(dot(l9_35.xyz,vec3(l9_34)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_35.xyz,vec3(0.33333001)))*l9_34;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0))*l9_34;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*l9_34;
}
#else
{
float l9_46;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*l9_34;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_35.xyz,vec3(0.33333001))*l9_34;
}
#else
{
float l9_49;
...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_35.xyz).xyz,vec3(l9_34));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_35.xyz,vec3(l9_34)),l9_34);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_35.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_35;
