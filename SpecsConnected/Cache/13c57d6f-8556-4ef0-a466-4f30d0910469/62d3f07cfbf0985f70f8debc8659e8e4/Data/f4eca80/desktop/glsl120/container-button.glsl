...
vec4 l9_1=vec4(normalize(varNormal),0.0);
vec3 l9_2=cross(normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0)).xyz),normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1).xyz));
vec2 l9_3=l9_2.yx;
l9_3.x=l9_2.y*(-1.0);
int l9_4;
...
{
l9_11=mix(l9_8,Port_Value2_N007,vec4(clamp((l9_9-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
...
vec4 l9_17=l9_5+l9_10;
vec4 l9_18=baseColor*l9_10;
float l9_19=clamp((l9_6*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_20;
if (l9_19<=0.0)
{
l9_20=0.0;
...
{
l9_20=pow(l9_19,Port_Input1_N022);
}
float l9_21;
if (l9_20<=0.0)
{
...
{
l9_21=pow(l9_20,Port_Input1_N034);
}
float l9_22=l9_21*Port_Input1_N041;
int l9_23;
...
#endif
vec4 l9_24=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,l9_23,((varPackedTex.xy-Port_Center_N002)*iconScale)+Port_Center_N002,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
float l9_25=l9_24.w;
vec4 l9_26=mix(mix(mix(baseColor*(l9_17*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_18)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_22)),vec4(l9_24.xyz,0.0),vec4(l9_25));
float l9_27=max(l9_20,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_28=max(l9_25,l9_27)*alpha;
vec4 l9_29=vec4(l9_26.x,l9_26.y,l9_26.z,vec4(0.0).w);
l9_29.w=l9_28;
...
{
l9_33=clamp(dot(l9_29.xyz,vec3(l9_28)),0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_35=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*l9_28;
}
#else
{
float l9_36;
...
{
l9_36=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*l9_28;
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_28;
}
#else
{
float l9_38;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_39=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_28;
}
#else
{
float l9_40;
...
{
l9_40=dot(l9_29.xyz,vec3(0.33333001))*l9_28;
}
#else
{
float l9_41;
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_29.xyz).xyz,vec3(l9_28));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_28)),l9_28);
}
#else
{
vec4 l9_56;
...
#endif
l9_56=vec4(l9_29.xyz*l9_57,l9_57);
}
#else
{
l9_56=l9_29;
