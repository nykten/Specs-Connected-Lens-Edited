...
//}
//ubo int UserUniforms 2:35:4720 {
...
//float triggered 4288
//float isToggle 4292
//float4 hoverColor 4304
//float hovered 4320
//float4 iconSize 4336
//float4 iconDims 4352
//float4 iconView 4368
//float3x3 iconTransform 4384
//float4 iconUvMinMax 4432
//float4 iconBorderColor 4448
//float2 iconScale 4464
//float alpha 4472
//float3 Port_Import_N054 4480
//float2 Port_Input1_N009 4496
//float2 Port_Input2_N009 4504
//float4 Port_Value_N026 4512
//float4 Port_Value_N027 4528
//float Port_Position1_N007 4544
//float4 Port_Input1_N019 4560
//float Port_Position2_N007 4576
//float4 Port_Value2_N007 4592
//float4 Port_Value3_N007 4608
//float Port_Input1_N014 4624
//float Port_Input0_N038 4628
//float4 Port_Input1_N043 4640
//float4 Port_Input2_N043 4656
//float Port_Input1_N031 4672
//float Port_Input1_N028 4676
//float Port_Input2_N028 4680
//float Port_Input1_N022 4684
//float Port_Input1_N034 4688
//float Port_Input1_N041 4692
//float2 Port_Center_N002 4696
//float Port_Input0_N018 4704
//float Port_Input1_N018 4708
//float depthRef 4712
//}
...
{
main_frag_out out={};
int N44_NormalSpace=0;
float3 N44_Normal=float3(0.0);
float2 N44_ReflectionUV=float2(0.0);
...
int l9_8=l9_7;
Globals.SurfacePosition_ViewSpace=((*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_8]*float4(rhp.positionWS,1.0)).xyz;
...
int l9_10=l9_9;
Globals.VertexNormal_ViewSpace=normalize(((*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_10]*float4(Globals.VertexNormal_WorldSpace,0.0)).xyz);
...
int l9_12=l9_11;
Globals.SurfacePosition_ViewSpace=((*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_12]*float4(in.varPos,1.0)).xyz;
...
int l9_14=l9_13;
Globals.VertexNormal_ViewSpace=normalize(((*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_14]*float4(Globals.VertexNormal_WorldSpace,0.0)).xyz);
Globals.VertexNormal_ObjectSpace=normalize(((*sc_set2.UserUniforms).sc_ModelMatrixInverse*float4(Globals.VertexNormal_WorldSpace,0.0)).xyz);
...
float Value_N42=0.0;
Value_N42=0.0;
float3 Normal_N6=float3(0.0);
Normal_N6=Globals.VertexNormal_ViewSpace;
float3 Value_N54=float3(0.0);
Value_N54=Normal_N6;
float2 ReflectionUV_N44=float2(0.0);
float param_1=Value_N42;
float3 param_2=Value_N54;
ssGlobals param_4=Globals;
ssGlobals tempGlobals=param_4;
float2 param_3=float2(0.0);
N44_NormalSpace=int(param_1);
N44_Normal=param_2;
float3 l9_15=N44_Normal;
if (N44_NormalSpace==2)
{
float3 l9_16=tempGlobals.VertexTangent_WorldSpace;
float3 l9_17=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_18=tempGlobals.VertexNormal_WorldSpace;
float3x3 l9_19=float3x3(float3(l9_16),float3(l9_17),float3(l9_18));
l9_15=normalize(l9_19*l9_15);
}
...
int l9_21=l9_20;
float4x4 l9_22=(*sc_set2.UserUniforms).sc_ViewMatrixArray[l9_21];
l9_15=float3x3(l9_22[0].xyz,l9_22[1].xyz,l9_22[2].xyz)*l9_15;
}
float3 l9_23=tempGlobals.SurfacePosition_ViewSpace;
N44_ReflectionUV=cross(normalize(l9_23),l9_15).yx;
N44_ReflectionUV.x*=(-1.0);
N44_ReflectionUV=(N44_ReflectionUV*0.5)+float2(0.5);
param_3=N44_ReflectionUV;
ReflectionUV_N44=param_3;
float4 Color_N53=float4(0.0);
int l9_24=0;
...
int l9_29=l9_24;
int param_5=additional_settings_btn_refl_texLayout_tmp;
int param_6=l9_29;
float2 param_7=ReflectionUV_N44;
bool param_8=(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex_tmp)!=0);
float3x3 param_9=(*sc_set2.UserUniforms).additional_settings_btn_refl_texTransform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex_tmp)!=0);
float4 param_12=(*sc_set2.UserUniforms).additional_settings_btn_refl_texUvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex_tmp)!=0);
float4 param_14=(*sc_set2.UserUniforms).additional_settings_btn_refl_texBorderColor;
float param_15=0.0;
bool l9_30=param_13&&(!param_11);
float l9_31=1.0;
float l9_32=param_7.x;
int l9_33=param_10.x;
if (l9_33==1)
{
l9_32=fract(l9_32);
}
...
param_7.x=l9_32;
float l9_37=param_7.y;
int l9_38=param_10.y;
if (l9_38==1)
{
l9_37=fract(l9_37);
}
...
float l9_44=param_7.x;
float l9_45=param_12.x;
float l9_46=param_12.z;
bool l9_47=l9_43;
float l9_48=l9_31;
...
float l9_53=param_7.y;
float l9_54=param_12.y;
float l9_55=param_12.w;
bool l9_56=l9_52;
float l9_57=l9_31;
...
float2 l9_60=param_7;
bool l9_61=param_8;
float3x3 l9_62=param_9;
if (l9_61)
{
...
float2 l9_65=l9_64;
param_7=l9_65;
float l9_66=param_7.x;
int l9_67=param_10.x;
bool l9_68=l9_30;
float l9_69=l9_31;
if ((l9_67==0)||(l9_67==3))
{
...
param_7.x=l9_66;
l9_31=l9_69;
float l9_77=param_7.y;
int l9_78=param_10.y;
bool l9_79=l9_30;
float l9_80=l9_31;
if ((l9_78==0)||(l9_78==3))
{
...
param_7.y=l9_77;
l9_31=l9_80;
float2 l9_88=param_7;
int l9_89=param_5;
int l9_90=param_6;
float l9_91=param_15;
float2 l9_92=l9_88;
int l9_93=l9_89;
int l9_94=l9_90;
...
float l9_99=l9_91;
float4 l9_100=sc_set2.additional_settings_btn_refl_tex.sample(sc_set2.additional_settings_btn_refl_texSmpSC,l9_98,bias(l9_99));
float4 l9_101=l9_100;
float4 l9_102=l9_101;
if (param_13)
{
l9_102=mix(param_14,l9_102,float4(l9_31));
}
float4 l9_103=l9_102;
Color_N53=l9_103;
float4 Export_N51=float4(0.0);
Export_N51=Color_N53;
float3 Normal_N8=float3(0.0);
Normal_N8=Globals.VertexNormal_ObjectSpace;
float2 Value1_N32=float2(0.0);
float4 param_16=float4(Normal_N8,0.0);
float2 param_17=param_16.xy;
Value1_N32=param_17;
float2 Output_N9=float2(0.0);
Output_N9=(Value1_N32*(*sc_set2.UserUniforms).Port_Input1_N009)+(*sc_set2.UserUniforms).Port_Input2_N009;
float Output_N10=0.0;
Output_N10=length(Output_N9);
float4 Output_N26=float4(0.0);
Output_N26=(*sc_set2.UserUniforms).Port_Value_N026;
float4 Output_N27=float4(0.0);
Output_N27=(*sc_set2.UserUniforms).Port_Value_N027;
float Output_N24=0.0;
float param_18=(*sc_set2.UserUniforms).triggered;
Output_N24=param_18;
float4 Output_N17=float4(0.0);
Output_N17=mix(Output_N26,Output_N27,float4(Output_N24));
float4 Output_N19=float4(0.0);
Output_N19=fast::max(Output_N17,(*sc_set2.UserUniforms).Port_Input1_N019);
float4 Value_N7=float4(0.0);
float param_19=Output_N10;
float4 param_20=Output_N17;
float param_21=(*sc_set2.UserUniforms).Port_Position1_N007;
float4 param_22=Output_N19;
float param_23=(*sc_set2.UserUniforms).Port_Position2_N007;
float4 param_24=(*sc_set2.UserUniforms).Port_Value2_N007;
float4 param_25=(*sc_set2.UserUniforms).Port_Value3_N007;
param_19=fast::clamp(param_19,0.0,1.0);
float4 param_26;
if (param_19<param_21)
{
param_26=mix(param_20,param_22,float4(fast::clamp(param_19/param_21,0.0,1.0)));
}
else
{
if (param_19<param_23)
{
param_26=mix(param_22,param_24,float4(fast::clamp((param_19-param_21)/(param_23-param_21),0.0,1.0)));
}
else
{
param_26=mix(param_24,param_25,float4(fast::clamp((param_19-param_23)/(1.0-param_23),0.0,1.0)));
}
}
bool l9_104=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_105;
if (l9_104)
{
l9_105=!PreviewInfo.Saved;
}
else
{
l9_105=l9_104;
...
if (l9_105)
{
l9_106=7==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_106=l9_105;
...
PreviewInfo.Color=param_26;
PreviewInfo.Color.w=1.0;
}
Value_N7=param_26;
float4 Output_N100=float4(0.0);
Output_N100=Export_N51+Value_N7;
float4 Output_N14=float4(0.0);
Output_N14=Output_N100*float4((*sc_set2.UserUniforms).Port_Input1_N014);
float4 Output_N15=float4(0.0);
Output_N15=Output_N5*Output_N14;
float4 Output_N39=float4(0.0);
Output_N39=Output_N5*Value_N7;
float4 Output_N38=float4(0.0);
Output_N38=float4((*sc_set2.UserUniforms).Port_Input0_N038)-Output_N39;
float4 Output_N43=float4(0.0);
Output_N43=fast::clamp(Output_N38+float4(0.001),(*sc_set2.UserUniforms).Port_Input1_N043+float4(0.001),(*sc_set2.UserUniforms).Port_Input2_N043+float4(0.001))-float4(0.001);
float Output_N40=0.0;
float param_27=(*sc_set2.UserUniforms).isToggle;
Output_N40=param_27;
float Output_N46=0.0;
Output_N46=Output_N40*Output_N24;
float4 Output_N45=float4(0.0);
Output_N45=mix(Output_N15,Output_N43,float4(Output_N46));
float4 Output_N33=float4(0.0);
float4 param_28=(*sc_set2.UserUniforms).hoverColor;
Output_N33=param_28;
float Output_N37=0.0;
float param_29=(*sc_set2.UserUniforms).hovered;
Output_N37=param_29;
float Output_N31=0.0;
Output_N31=Output_N10*(*sc_set2.UserUniforms).Port_Input1_N031;
float Output_N28=0.0;
Output_N28=fast::clamp(Output_N31+0.001,(*sc_set2.UserUniforms).Port_Input1_N028+0.001,(*sc_set2.UserUniforms).Port_Input2_N028+0.001)-0.001;
...
{
l9_107=pow(Output_N28,(*sc_set2.UserUniforms).Port_Input1_N022);
}
Output_N22=l9_107;
...
{
l9_108=pow(Output_N22,(*sc_set2.UserUniforms).Port_Input1_N034);
}
Output_N34=l9_108;
float Output_N41=0.0;
Output_N41=Output_N34*(*sc_set2.UserUniforms).Port_Input1_N041;
float Output_N36=0.0;
Output_N36=Output_N37*Output_N41;
float4 Output_N35=float4(0.0);
Output_N35=mix(Output_N45,Output_N33,float4(Output_N36));
float2 UVCoord_N12=float2(0.0);
UVCoord_N12=Globals.Surface_UVCoord0;
float2 Output_N16=float2(0.0);
float2 param_30=(*sc_set2.UserUniforms).iconScale;
Output_N16=param_30;
float2 CoordsOut_N2=float2(0.0);
CoordsOut_N2=((UVCoord_N12-(*sc_set2.UserUniforms).Port_Center_N002)*Output_N16)+(*sc_set2.UserUniforms).Port_Center_N002;
...
int l9_114=l9_109;
int param_31=iconLayout_tmp;
int param_32=l9_114;
float2 param_33=CoordsOut_N2;
bool param_34=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 param_35=(*sc_set2.UserUniforms).iconTransform;
int2 param_36=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool param_37=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 param_38=(*sc_set2.UserUniforms).iconUvMinMax;
bool param_39=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_40=(*sc_set2.UserUniforms).iconBorderColor;
float param_41=0.0;
bool l9_115=param_39&&(!param_37);
float l9_116=1.0;
float l9_117=param_33.x;
int l9_118=param_36.x;
if (l9_118==1)
{
l9_117=fract(l9_117);
}
...
param_33.x=l9_117;
float l9_122=param_33.y;
int l9_123=param_36.y;
if (l9_123==1)
{
l9_122=fract(l9_122);
}
...
float l9_129=param_33.x;
float l9_130=param_38.x;
float l9_131=param_38.z;
bool l9_132=l9_128;
float l9_133=l9_116;
...
float l9_138=param_33.y;
float l9_139=param_38.y;
float l9_140=param_38.w;
bool l9_141=l9_137;
float l9_142=l9_116;
...
float2 l9_145=param_33;
bool l9_146=param_34;
float3x3 l9_147=param_35;
if (l9_146)
{
...
param_33=l9_150;
float l9_151=param_33.x;
int l9_152=param_36.x;
bool l9_153=l9_115;
float l9_154=l9_116;
...
param_33.x=l9_151;
l9_116=l9_154;
float l9_162=param_33.y;
int l9_163=param_36.y;
bool l9_164=l9_115;
float l9_165=l9_116;
...
param_33.y=l9_162;
l9_116=l9_165;
float2 l9_173=param_33;
int l9_174=param_31;
int l9_175=param_32;
float l9_176=param_41;
...
float l9_184=l9_176;
float4 l9_185=sc_set2.icon.sample(sc_set2.iconSmpSC,l9_183,bias(l9_184));
float4 l9_186=l9_185;
float4 l9_187=l9_186;
if (param_39)
{
l9_187=mix(param_40,l9_187,float4(l9_116));
}
float4 l9_188=l9_187;
Color_N30=l9_188;
float3 Value1_N13=float3(0.0);
float Value2_N13=0.0;
float4 param_42=Color_N30;
float3 param_43=param_42.xyz;
float param_44=param_42.w;
Value1_N13=param_43;
Value2_N13=param_44;
float4 Output_N11=float4(0.0);
Output_N11=mix(Output_N35,float4(Value1_N13,0.0),float4(Value2_N13));
float Output_N18=0.0;
Output_N18=mix((*sc_set2.UserUniforms).Port_Input0_N018,(*sc_set2.UserUniforms).Port_Input1_N018,Output_N24);
float Output_N23=0.0;
Output_N23=fast::max(Output_N22,Output_N18);
float Output_N20=0.0;
Output_N20=fast::max(Value2_N13,Output_N23);
float Output_N1=0.0;
float param_45=(*sc_set2.UserUniforms).alpha;
Output_N1=param_45;
float Output_N21=0.0;
Output_N21=Output_N20*Output_N1;
float4 Value_N3=float4(0.0);
Value_N3=float4(Output_N11.xyz.x,Output_N11.xyz.y,Output_N11.xyz.z,Value_N3.w);
Value_N3.w=Output_N21;
FinalColor=Value_N3;
float param_46=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_46<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_189=gl_FragCoord;
float2 l9_190=floor(mod(l9_189.xy,float2(4.0)));
float l9_191=(mod(dot(l9_190,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_46<l9_191)
{
discard_fragment();
}
}
bool l9_192=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_192)
{
...
float4 l9_193=fast::max(param_47,float4(0.0));
float4 param_48=l9_193;
...
{
l9_196=fast::clamp(l9_195.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_196=fast::clamp(dot(l9_195.xyz,float3(l9_195.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_196=(1.0-dot(l9_195.xyz,float3(0.33333001)))*l9_195.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_196=(1.0-fast::clamp(dot(l9_195.xyz,float3(1.0)),0.0,1.0))*l9_195.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_196=fast::clamp(dot(l9_195.xyz,float3(1.0)),0.0,1.0)*l9_195.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_196=fast::clamp(dot(l9_195.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_196=dot(l9_195.xyz,float3(0.33333001))*l9_195.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_196=1.0-fast::clamp(dot(l9_195.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_197=l9_196;
float l9_198=l9_197;
float l9_199=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_198;
float3 l9_200=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_194.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_201=float4(l9_200.x,l9_200.y,l9_200.z,l9_199);
param_49=l9_201;
}
else
{
...
{
float4 l9_202=param_49;
float4 l9_203=float4(0.0);
float4 l9_204=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_205=out.FragColor0;
float4 l9_206=l9_205;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_206.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_208=gl_FragCoord;
float2 l9_209=(l9_208.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_214=l9_213;
int l9_215=l9_214;
float3 l9_216=float3(l9_210,0.0);
int l9_217=l9_212;
int l9_218=l9_215;
if (l9_217==1)
{
l9_216.y=((2.0*l9_216.y)+float(l9_218))-1.0;
}
float2 l9_219=l9_216.xy;
l9_211=l9_219;
}
else
{
...
int l9_228=l9_223;
float2 l9_229=l9_222;
int l9_230=l9_228;
float2 l9_231=l9_229;
int l9_232=l9_230;
float l9_233=0.0;
float4 l9_234=float4(0.0);
float2 l9_235=l9_231;
int l9_236=sc_ScreenTextureLayout_tmp;
int l9_237=l9_232;
float l9_238=l9_233;
...
float l9_246=l9_238;
float4 l9_247=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_245,bias(l9_246));
...
float4 l9_252=l9_204;
float4 l9_253=l9_252;
float3 l9_254=l9_253.xyz;
float3 l9_255=l9_254;
float3 l9_256=l9_202.xyz;
float3 l9_257=definedBlend(l9_255,l9_256,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_203=float4(l9_257.x,l9_257.y,l9_257.z,l9_203.w);
float3 l9_258=mix(l9_254,l9_203.xyz,float3(l9_202.w));
l9_203=float4(l9_258.x,l9_258.y,l9_258.z,l9_203.w);
l9_203.w=1.0;
float4 l9_259=l9_203;
param_49=l9_259;
}
else
{
float4 l9_260=param_49;
float4 l9_261=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_261=float4(mix(float3(1.0),l9_260.xyz,float3(l9_260.w)),l9_260.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_262=l9_260.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_262=fast::clamp(l9_262,0.0,1.0);
}
l9_261=float4(l9_260.xyz*l9_262,l9_262);
}
else
{
l9_261=l9_260;
...
float4 l9_263=l9_261;
param_49=l9_263;
}
}
}
float4 l9_264=param_49;
FinalColor=l9_264;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_265=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_265=float4(0.0);
...
float3 param_50=in.varPos;
float4 param_51=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_50,param_51,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_52=FinalColor;
float4 l9_267=param_52;
out.FragColor0=l9_267;
return out;
}
} // FRAGMENT SHADER
