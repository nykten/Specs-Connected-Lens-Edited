...
//}
//ubo int UserUniforms 2:35:4800 {
...
//float blur 4448
//float2 boxSize 4456
//float cornerRadius 4464
//float4 Port_Import_N384 4480
//float Port_Import_N307 4496
//float Port_Import_N201 4500
//float Port_Import_N010 4504
//float Port_Import_N007 4508
//float2 Port_Import_N008 4512
//float2 Port_Import_N009 4520
//float Port_Speed_N022 4528
//float Port_Import_N012 4532
//float2 Port_Import_N254 4536
//float Port_Import_N055 4544
//float Port_Import_N056 4548
//float2 Port_Import_N000 4552
//float2 Port_Import_N060 4560
//float2 Port_Import_N061 4568
//float Port_Speed_N063 4576
//float Port_Import_N065 4580
//float2 Port_Import_N255 4584
//float4 Port_Default_N369 4592
//float4 Port_Import_N166 4608
//float Port_Import_N206 4624
//float Port_Import_N043 4628
//float2 Port_Import_N151 4632
//float2 Port_Import_N155 4640
//float Port_Default_N204 4648
//float Port_Input1_N098 4652
//float2 Port_Input1_N085 4656
//float2 Port_Input1_N089 4664
//float Port_Input1_N094 4672
//float3 Port_Input0_N073 4688
//float3 Port_Input1_N073 4704
//float2 Port_Input0_N042 4720
//float2 Port_Input1_N046 4728
//float Port_Input1_N047 4736
//float Port_Multiplier_N054 4740
//float Port_Input1_N078 4744
//float Port_Input1_N080 4748
//float Port_Input1_N079 4752
//float Port_Input1_N057 4756
//float Port_Input1_N070 4760
//float2 Port_Scale_N081 4768
//float Port_Input2_N082 4776
//float Port_Input2_N045 4780
//float Port_Input1_N099 4784
//float depthRef 4788
//}
...
float2 Port_Input1_N085;
float2 Port_Input1_N089;
float Port_Input1_N094;
float3 Port_Input0_N073;
float3 Port_Input1_N073;
float2 Port_Input0_N042;
float2 Port_Input1_N046;
float Port_Input1_N047;
float Port_Multiplier_N054;
float Port_Input1_N078;
float Port_Input1_N080;
float Port_Input1_N079;
float Port_Input1_N057;
float Port_Input1_N070;
float2 Port_Scale_N081;
float Port_Input2_N082;
float Port_Input2_N045;
float Port_Input1_N099;
float depthRef;
};
struct sc_Bone_t
{
...
float param_9=(*sc_set2.UserUniforms).blur;
Output_N97=param_9;
float Output_N98=0.0;
Output_N98=Output_N97*(*sc_set2.UserUniforms).Port_Input1_N098;
float2 UVCoord_N84=float2(0.0);
UVCoord_N84=Globals.Surface_UVCoord0;
float2 Output_N85=float2(0.0);
Output_N85=UVCoord_N84-(*sc_set2.UserUniforms).Port_Input1_N085;
float2 Output_N86=float2(0.0);
Output_N86=abs(Output_N85);
float2 Output_N83=float2(0.0);
float2 param_10=(*sc_set2.UserUniforms).boxSize;
Output_N83=param_10;
float Output_N88=0.0;
float param_11=(*sc_set2.UserUniforms).cornerRadius;
Output_N88=param_11;
float2 Output_N87=float2(0.0);
Output_N87=Output_N83-float2(Output_N88);
float2 Output_N90=float2(0.0);
Output_N90=Output_N86-Output_N87;
float2 Output_N89=float2(0.0);
Output_N89=fast::max(Output_N90,(*sc_set2.UserUniforms).Port_Input1_N089);
float Output_N91=0.0;
Output_N91=length(Output_N89);
float Output_N92=0.0;
Output_N92=Output_N91-Output_N88;
float Output_N93=0.0;
Output_N93=smoothstep(Output_N97,Output_N98,Output_N92);
float Output_N94=0.0;
Output_N94=fast::max(Output_N93,(*sc_set2.UserUniforms).Port_Input1_N094);
float Output_N95=0.0;
Output_N95=Export_N158*Output_N94;
float4 Value_N1=float4(0.0);
Value_N1=float4(Export_N385.xyz.x,Export_N385.xyz.y,Export_N385.xyz.z,Value_N1.w);
Value_N1.w=Output_N95;
float2 UVCoord_N41=float2(0.0);
UVCoord_N41=Globals.Surface_UVCoord0;
float2 Output_N46=float2(0.0);
Output_N46=UVCoord_N41-(*sc_set2.UserUniforms).Port_Input1_N046;
float2 Output_N47=float2(0.0);
Output_N47=Output_N46*float2((*sc_set2.UserUniforms).Port_Input1_N047);
float Output_N42=0.0;
Output_N42=distance((*sc_set2.UserUniforms).Port_Input0_N042,Output_N47);
float3 Value_N44=float3(0.0);
Value_N44.x=Output_N42;
Value_N44.y=Output_N42;
Value_N44.z=Output_N42;
float3 Output_N73=float3(0.0);
Output_N73=smoothstep((*sc_set2.UserUniforms).Port_Input0_N073,(*sc_set2.UserUniforms).Port_Input1_N073,Value_N44);
float Time_N54=0.0;
Time_N54=Globals.gTimeElapsed*(*sc_set2.UserUniforms).Port_Multiplier_N054;
float Output_N76=0.0;
Output_N76=sin(Time_N54);
float Output_N78=0.0;
Output_N78=Output_N76*(*sc_set2.UserUniforms).Port_Input1_N078;
float Output_N75=0.0;
Output_N75=sin(Time_N54);
float Output_N77=0.0;
Output_N77=Output_N78*Output_N75;
float Output_N80=0.0;
Output_N80=Output_N77*(*sc_set2.UserUniforms).Port_Input1_N080;
float Output_N79=0.0;
Output_N79=fast::max(Output_N80,(*sc_set2.UserUniforms).Port_Input1_N079);
float Output_N57=0.0;
Output_N57=Output_N79*(*sc_set2.UserUniforms).Port_Input1_N057;
float Output_N70=0.0;
Output_N70=Output_N57+(*sc_set2.UserUniforms).Port_Input1_N070;
float3 Output_N48=float3(0.0);
float l9_627;
if (Output_N73.x<=0.0)
{
l9_627=0.0;
...
{
l9_627=pow(Output_N73.x,Output_N70);
}
float l9_628=l9_627;
float l9_629;
if (Output_N73.y<=0.0)
...
{
l9_629=pow(Output_N73.y,Output_N70);
}
float l9_630=l9_629;
float l9_631;
if (Output_N73.z<=0.0)
...
{
l9_631=pow(Output_N73.z,Output_N70);
}
Output_N48=float3(l9_628,l9_630,l9_631);
float2 UVCoord_N72=float2(0.0);
UVCoord_N72=Globals.Surface_UVCoord0;
float Random_N81=0.0;
float2 param_12=UVCoord_N72;
float2 param_13=(*sc_set2.UserUniforms).Port_Scale_N081;
param_12=floor(param_12*10000.0)*9.9999997e-05;
float param_14=dot(floor(param_12*param_13),float2(0.98000002,0.72000003));
param_14=floor(param_14*10000.0)*9.9999997e-05;
param_14=sin(param_14);
param_14*=437.58499;
param_14=fract(param_14);
param_14=floor(param_14*10000.0)*9.9999997e-05;
Random_N81=param_14;
float3 Output_N82=float3(0.0);
Output_N82=mix(Output_N48,float3(Random_N81),float3((*sc_set2.UserUniforms).Port_Input2_N082));
float4 Value_N74=float4(0.0);
Value_N74=float4(Output_N82.x,Output_N82.y,Output_N82.z,Value_N74.w);
Value_N74.w=Output_N95;
float4 Output_N45=float4(0.0);
Output_N45=mix(Value_N1,Value_N74,float4((*sc_set2.UserUniforms).Port_Input2_N045));
float Output_N99=0.0;
Output_N99=step(Output_N95,(*sc_set2.UserUniforms).Port_Input1_N099);
float4 Output_N96=float4(0.0);
float4 param_15=Output_N45;
float param_16=Output_N99;
float4 param_17=param_15;
if ((param_16*1.0)!=0.0)
{
discard_fragment();
}
...
{
float4 l9_632=gl_FragCoord;
float2 l9_633=floor(mod(l9_632.xy,float2(4.0)));
float l9_634=(mod(dot(l9_633,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_18<l9_634)
{
discard_fragment();
}
}
bool l9_635=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_635)
{
...
float4 l9_636=fast::max(param_19,float4(0.0));
float4 param_20=l9_636;
...
{
l9_639=fast::clamp(l9_638.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_639=fast::clamp(dot(l9_638.xyz,float3(l9_638.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_639=(1.0-dot(l9_638.xyz,float3(0.33333001)))*l9_638.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_639=(1.0-fast::clamp(dot(l9_638.xyz,float3(1.0)),0.0,1.0))*l9_638.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_639=fast::clamp(dot(l9_638.xyz,float3(1.0)),0.0,1.0)*l9_638.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_639=fast::clamp(dot(l9_638.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_639=dot(l9_638.xyz,float3(0.33333001))*l9_638.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_639=1.0-fast::clamp(dot(l9_638.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_640=l9_639;
float l9_641=l9_640;
float l9_642=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_641;
float3 l9_643=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_637.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_644=float4(l9_643.x,l9_643.y,l9_643.z,l9_642);
param_21=l9_644;
}
else
{
...
{
float4 l9_645=param_21;
float4 l9_646=float4(0.0);
float4 l9_647=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_648=out.FragColor0;
float4 l9_649=l9_648;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_649.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_651=gl_FragCoord;
float2 l9_652=(l9_651.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
{
l9_656=in.varStereoViewID;
}
int l9_657=l9_656;
int l9_658=l9_657;
float3 l9_659=float3(l9_653,0.0);
int l9_660=l9_655;
int l9_661=l9_658;
if (l9_660==1)
{
l9_659.y=((2.0*l9_659.y)+float(l9_661))-1.0;
}
float2 l9_662=l9_659.xy;
l9_654=l9_662;
}
else
{
...
{
l9_669=in.varStereoViewID;
}
int l9_670=l9_669;
l9_666=l9_670;
}
int l9_671=l9_666;
float2 l9_672=l9_665;
int l9_673=l9_671;
...
int l9_679=sc_ScreenTextureLayout_tmp;
int l9_680=l9_675;
float l9_681=l9_676;
...
float l9_689=l9_681;
float4 l9_690=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_688,bias(l9_689));
float4 l9_691=l9_690;
l9_677=l9_691;
float4 l9_692=l9_677;
float4 l9_693=l9_692;
float4 l9_694=l9_693;
l9_647=l9_694;
}
float4 l9_695=l9_647;
float4 l9_696=l9_695;
float3 l9_697=l9_696.xyz;
float3 l9_698=l9_697;
float3 l9_699=l9_645.xyz;
float3 l9_700=definedBlend(l9_698,l9_699,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_646=float4(l9_700.x,l9_700.y,l9_700.z,l9_646.w);
float3 l9_701=mix(l9_697,l9_646.xyz,float3(l9_645.w));
l9_646=float4(l9_701.x,l9_701.y,l9_701.z,l9_646.w);
l9_646.w=1.0;
float4 l9_702=l9_646;
param_21=l9_702;
}
else
{
float4 l9_703=param_21;
float4 l9_704=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_704=float4(mix(float3(1.0),l9_703.xyz,float3(l9_703.w)),l9_703.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_705=l9_703.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_705=fast::clamp(l9_705,0.0,1.0);
}
l9_704=float4(l9_703.xyz*l9_705,l9_705);
}
else
{
l9_704=l9_703;
...
float4 l9_706=l9_704;
param_21=l9_706;
}
}
}
float4 l9_707=param_21;
FinalColor=l9_707;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_708=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_708=float4(0.0);
...
float4 l9_710=param_24;
out.FragColor0=l9_710;
return out;
}
} // FRAGMENT SHADER
