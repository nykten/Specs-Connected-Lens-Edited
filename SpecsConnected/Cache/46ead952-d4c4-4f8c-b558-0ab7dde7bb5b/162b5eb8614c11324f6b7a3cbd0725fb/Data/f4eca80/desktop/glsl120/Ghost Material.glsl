...
float l9_28=l9_27*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(varPackedTex.xy-Port_Input1_N085)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_29=vec4(l9_16.x,l9_16.y,l9_16.z,vec4(0.0).w);
l9_29.w=l9_28;
vec3 l9_30=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,(varPackedTex.xy-Port_Input1_N046)*vec2(Port_Input1_N047))));
float l9_31=l9_1*Port_Multiplier_N054;
float l9_32=sin(l9_31);
float l9_33=(max(((l9_32*Port_Input1_N078)*l9_32)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
float l9_34=l9_30.x;
float l9_35;
if (l9_34<=0.0)
{
...
{
l9_39=pow(l9_38,l9_33);
}
vec3 l9_40=mix(vec3(l9_35,l9_37,l9_39),vec3(floor(fract(sin(floor(dot(floor((floor(varPackedTex.xy*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_41=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_41.w=l9_28;
vec4 l9_42=mix(l9_29,l9_41,vec4(Port_Input2_N045));
if ((step(l9_28,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
float l9_43=l9_42.w;
...
{
l9_47=clamp(dot(l9_42.xyz,vec3(l9_43)),0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_49=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*l9_43;
}
#else
{
float l9_50;
...
{
l9_50=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*l9_43;
}
#else
{
float l9_51;
...
{
l9_51=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*l9_43;
}
#else
{
float l9_52;
#if (sc_BlendMode_Add)
{
l9_52=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
...
{
l9_54=dot(l9_42.xyz,vec3(0.33333001))*l9_43;
}
#else
{
float l9_55;
#if (sc_BlendMode_Min)
{
l9_55=1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
#if (sc_BlendMode_Max)
{
l9_56=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_56=1.0;
...
#endif
l9_44=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_42.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_45);
}
#else
{
vec4 l9_57;
...
#else
{
vec2 l9_63=sc_ScreenCoordsGlobalToView(l9_3);
int l9_64;
...
#endif
l9_59=sc_SampleView(sc_ScreenTextureDims.xy,l9_63,sc_ScreenTextureLayout,l9_64,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_65;
...
{
vec4 l9_66=l9_59;
l9_66.x=l9_59.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_65=l9_66;
}
#else
{
...
#endif
vec3 l9_67=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_42.xyz).xyz,vec3(l9_43));
vec4 l9_68=vec4(l9_67.x,l9_67.y,l9_67.z,vec4(0.0).w);
l9_68.w=1.0;
l9_58=l9_68;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_69=vec4(mix(vec3(1.0),l9_42.xyz,vec3(l9_43)),l9_43);
}
#else
{
vec4 l9_70;
...
#endif
l9_70=vec4(l9_42.xyz*l9_71,l9_71);
}
#else
{
l9_70=l9_42;
...
{
l9_74=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_74=vec4(0.0);
...
vec4 l9_76=outputMotionVectorsIfNeeded(varPos,max(l9_75,vec4(0.0)));
vec4 l9_77=clamp(l9_76,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_78=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_78-0.0039215689)),min(1.0,l9_78+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_79=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_80=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_79).xy);
float l9_81=packValue(l9_80);
int l9_88=int(l9_77.w*255.0);
float l9_89=packValue(l9_88);
sc_writeFragData0(vec4(packValue(l9_80),packValue(l9_80),packValue(l9_80),packValue(l9_80)));
sc_writeFragData1(vec4(l9_81,packValue(l9_80),packValue(l9_80),packValue(l9_80)));
sc_writeFragData2(vec4(l9_89,packValue(l9_88),packValue(l9_88),packValue(l9_88)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_92=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_92).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_97==0)
{
l9_100=texture2D(sc_OITAlpha0,l9_92);
l9_99=texture2D(sc_OITDepthLow0,l9_92);
l9_98=texture2D(sc_OITDepthHigh0,l9_92);
}
else
{
l9_100=vec4(0.0);
...
if (l9_97==1)
{
l9_103=texture2D(sc_OITAlpha1,l9_92);
l9_102=texture2D(sc_OITDepthLow1,l9_92);
l9_101=texture2D(sc_OITDepthHigh1,l9_92);
}
else
{
l9_103=l9_100;
...
if (any(notEqual(l9_101,vec4(0.0)))||any(notEqual(l9_102,vec4(0.0))))
{
int l9_104[8]=l9_93;
unpackValues(l9_101.w,l9_97,l9_104);
unpackValues(l9_101.z,l9_97,l9_104);
unpackValues(l9_101.y,l9_97,l9_104);
unpackValues(l9_101.x,l9_97,l9_104);
unpackValues(l9_102.w,l9_97,l9_104);
unpackValues(l9_102.z,l9_97,l9_104);
unpackValues(l9_102.y,l9_97,l9_104);
unpackValues(l9_102.x,l9_97,l9_104);
int l9_113[8]=l9_94;
unpackValues(l9_103.w,l9_97,l9_113);
unpackValues(l9_103.z,l9_97,l9_113);
unpackValues(l9_103.y,l9_97,l9_113);
unpackValues(l9_103.x,l9_97,l9_113);
}
l9_97++;
continue;
}
...
vec4 l9_118=texture2D(sc_OITFilteredDepthBoundsTexture,l9_92);
vec2 l9_119=l9_118.xy;
int l9_120;
#if (sc_SkinBonesCount>0)
{
l9_120=encodeDepth(((1.0-l9_118.x)*1000.0)+getDepthOrderingEpsilon(),l9_119);
}
#else
{
l9_120=0;
...
#endif
int l9_121=encodeDepth(viewSpaceDepth(),l9_119);
vec4 l9_122;
l9_122=l9_77*l9_77.w;
vec4 l9_123;
int l9_124=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_124<8)
{
int l9_125=l9_93[l9_124];
int l9_126=l9_121-l9_120;
bool l9_127=l9_125<l9_126;
bool l9_128;
if (l9_127)
{
l9_128=l9_93[l9_124]>0;
}
else
{
l9_128=l9_127;
...
if (l9_128)
{
vec3 l9_129=l9_122.xyz*(1.0-(float(l9_94[l9_124])/255.0));
l9_123=vec4(l9_129.x,l9_129.y,l9_129.z,l9_122.w);
}
else
{
l9_123=l9_122;
