...
//texture texture2D baseTex 2:3:2:22
...
//texture texture2DArray baseTexArrSC 2:34:2:22
//texture texture2DArray intensityTextureArrSC 2:35:2:23
//texture texture2DArray opacityTexArrSC 2:36:2:24
...
uniform vec2 Port_Input1_N085;
uniform vec2 Port_Input1_N089;
uniform float Port_Input1_N094;
uniform vec3 Port_Input0_N073;
uniform vec3 Port_Input1_N073;
uniform vec2 Port_Input0_N042;
uniform vec2 Port_Input1_N046;
uniform float Port_Input1_N047;
uniform float Port_Multiplier_N054;
...
uniform float Port_Input2_N082;
...
vec4 l9_7=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6.positionWS,1.0);
l9_5=l9_6.uv0;
l9_4=l9_6.uv1;
l9_3=((l9_7.xy/vec2(l9_7.w))*0.5)+vec2(0.5);
}
else
{
l9_5=varPackedTex.xy;
l9_4=varPackedTex.zw;
l9_3=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
}
ssGlobals l9_8=ssGlobals(l9_1,l9_2,0.0,l9_5,l9_4,l9_3);
vec4 l9_9;
#if (ENABLE_BASE_TEX)
{
vec2 l9_10;
...
l9_12=mix(l9_5,l9_13,vec2(l9_14));
}
#else
{
vec2 l9_15;
...
l9_15=mix(l9_5,l9_16,vec2(l9_17));
}
#else
{
l9_15=l9_5;
...
#if (baseTexLayout==2)
{
l9_18=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_18=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
{
vec2 l9_24;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_24,l9_8);
float l9_25;
Node67_Bool_Parameter(l9_25,l9_8);
l9_23=mix(l9_5,l9_24,vec2(l9_25));
}
#else
{
vec2 l9_26;
...
{
vec2 l9_27;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_27,l9_8);
float l9_28;
Node11_Bool_Parameter(l9_28,l9_8);
l9_26=mix(l9_5,l9_27,vec2(l9_28));
}
#else
{
l9_26=l9_5;
...
{
l9_29=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_21,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
...
#else
{
l9_20=Port_Default_N204;
}
#endif
float l9_30=l9_19.w*l9_20;
vec2 l9_31=l9_5-Port_Input1_N085;
float l9_32=l9_30*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(l9_31)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_33=vec4(l9_19.x,l9_19.y,l9_19.z,vec4(0.0).w);
l9_33.w=l9_32;
vec2 l9_34=l9_5-Port_Input1_N046;
vec3 l9_35=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,l9_34*vec2(Port_Input1_N047))));
float l9_36=l9_1*Port_Multiplier_N054;
float l9_37=sin(l9_36);
float l9_38=(max(((l9_37*Port_Input1_N078)*l9_37)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
float l9_39=l9_35.x;
float l9_40;
if (l9_39<=0.0)
{
...
{
l9_44=pow(l9_43,l9_38);
}
vec3 l9_45=mix(vec3(l9_40,l9_42,l9_44),vec3(floor(fract(sin(floor(dot(floor((floor(l9_5*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_46=vec4(l9_45.x,l9_45.y,l9_45.z,vec4(0.0).w);
l9_46.w=l9_32;
vec4 l9_47=mix(l9_33,l9_46,vec4(Port_Input2_N045));
if ((step(l9_32,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
float l9_48=l9_47.w;
...
{
if (l9_48<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_49,vec4(0.0)));
return;
}
vec4 l9_51;
...
{
l9_54=clamp(dot(l9_47.xyz,vec3(l9_48)),0.0,1.0);
}
#else
{
float l9_55;
...
{
l9_56=(1.0-dot(l9_47.xyz,vec3(0.33333001)))*l9_48;
}
#else
{
float l9_57;
...
{
l9_57=(1.0-clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0))*l9_48;
}
#else
{
float l9_58;
...
{
l9_58=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0)*l9_48;
}
#else
{
float l9_59;
#if (sc_BlendMode_Add)
{
l9_59=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_60=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0)*l9_48;
}
#else
{
float l9_61;
...
{
l9_61=dot(l9_47.xyz,vec3(0.33333001))*l9_48;
}
#else
{
float l9_62;
#if (sc_BlendMode_Min)
{
l9_62=1.0-clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_63;
#if (sc_BlendMode_Max)
{
l9_63=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_63=1.0;
...
#endif
l9_51=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_47.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_52);
}
#else
{
vec4 l9_64;
...
#if (sc_FramebufferFetch)
{
vec4 l9_67=sc_readFragData0_Platform();
vec4 l9_68;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_69=l9_67;
l9_69.x=l9_67.x+_sc_framebufferFetchMarker;
l9_68=l9_69;
}
#else
{
...
{
l9_72=sc_SampleView(sc_ScreenTextureDims.xy,l9_70,sc_ScreenTextureLayout,l9_71,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_72=sc_SampleView(sc_ScreenTextureDims.xy,l9_70,sc_ScreenTextureLayout,l9_71,0.0,sc_ScreenTexture);
}
#endif
l9_66=l9_72;
}
...
{
vec4 l9_74=l9_66;
l9_74.x=l9_66.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_73=l9_74;
}
#else
{
...
#endif
vec3 l9_75=mix(l9_73.xyz,definedBlend(l9_73.xyz,l9_47.xyz).xyz,vec3(l9_48));
vec4 l9_76=vec4(l9_75.x,l9_75.y,l9_75.z,vec4(0.0).w);
l9_76.w=1.0;
l9_65=l9_76;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_77=vec4(mix(vec3(1.0),l9_47.xyz,vec3(l9_48)),l9_48);
}
#else
{
vec4 l9_78;
...
#endif
l9_78=vec4(l9_47.xyz*l9_79,l9_79);
}
#else
{
l9_78=l9_47;
...
{
l9_82=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_82=vec4(0.0);
...
vec4 l9_84=outputMotionVectorsIfNeeded(varPos,max(l9_83,vec4(0.0)));
vec4 l9_85=clamp(l9_84,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_86=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_86-0.0039215689)),min(1.0,l9_86+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_88=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_87).xy);
float l9_89=packValue(l9_88);
int l9_96=int(l9_85.w*255.0);
float l9_97=packValue(l9_96);
sc_writeFragData0(vec4(packValue(l9_88),packValue(l9_88),packValue(l9_88),packValue(l9_88)));
sc_writeFragData1(vec4(l9_89,packValue(l9_88),packValue(l9_88),packValue(l9_88)));
sc_writeFragData2(vec4(l9_97,packValue(l9_96),packValue(l9_96),packValue(l9_96)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_100=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_100).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_105==0)
{
l9_108=texture(sc_OITAlpha0,l9_100);
l9_107=texture(sc_OITDepthLow0,l9_100);
l9_106=texture(sc_OITDepthHigh0,l9_100);
}
else
{
l9_108=vec4(0.0);
...
if (l9_105==1)
{
l9_111=texture(sc_OITAlpha1,l9_100);
l9_110=texture(sc_OITDepthLow1,l9_100);
l9_109=texture(sc_OITDepthHigh1,l9_100);
}
else
{
l9_111=l9_108;
...
if (any(notEqual(l9_109,vec4(0.0)))||any(notEqual(l9_110,vec4(0.0))))
{
int l9_112[8]=l9_101;
unpackValues(l9_109.w,l9_105,l9_112);
unpackValues(l9_109.z,l9_105,l9_112);
unpackValues(l9_109.y,l9_105,l9_112);
unpackValues(l9_109.x,l9_105,l9_112);
unpackValues(l9_110.w,l9_105,l9_112);
unpackValues(l9_110.z,l9_105,l9_112);
unpackValues(l9_110.y,l9_105,l9_112);
unpackValues(l9_110.x,l9_105,l9_112);
int l9_121[8]=l9_102;
unpackValues(l9_111.w,l9_105,l9_121);
unpackValues(l9_111.z,l9_105,l9_121);
unpackValues(l9_111.y,l9_105,l9_121);
unpackValues(l9_111.x,l9_105,l9_121);
}
l9_105++;
continue;
}
...
vec4 l9_126=texture(sc_OITFilteredDepthBoundsTexture,l9_100);
vec2 l9_127=l9_126.xy;
int l9_128;
#if (sc_SkinBonesCount>0)
{
l9_128=encodeDepth(((1.0-l9_126.x)*1000.0)+getDepthOrderingEpsilon(),l9_127);
}
#else
{
l9_128=0;
...
#endif
int l9_129=encodeDepth(viewSpaceDepth(),l9_127);
vec4 l9_130;
l9_130=l9_85*l9_85.w;
vec4 l9_131;
int l9_132=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_132<8)
{
int l9_133=l9_101[l9_132];
int l9_134=l9_129-l9_128;
bool l9_135=l9_133<l9_134;
bool l9_136;
if (l9_135)
{
l9_136=l9_101[l9_132]>0;
}
else
{
l9_136=l9_135;
...
if (l9_136)
{
vec3 l9_137=l9_130.xyz*(1.0-(float(l9_102[l9_132])/255.0));
l9_131=vec4(l9_137.x,l9_137.y,l9_137.z,l9_130.w);
}
else
{
l9_131=l9_130;
