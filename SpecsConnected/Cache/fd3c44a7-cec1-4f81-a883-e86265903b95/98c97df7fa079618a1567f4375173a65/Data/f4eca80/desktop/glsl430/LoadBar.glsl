...
//sampler sampler Tweak_N3SmpSC 2:21
...
//texture texture2D Tweak_N3 2:3:2:21
...
//texture texture2DArray Tweak_N3ArrSC 2:32:2:21
...
uniform sampler2DArray Tweak_N3ArrSC;
...
int Tweak_N3GetStereoViewIndex()
{
int l9_0;
...
l9_3=l9_9;
l9_2=cross(l9_9,l9_8)*varTangent.w;
l9_1=l9_8;
l9_0=normalize(sc_Camera.position-varPos);
}
mat3 l9_10=mat3(l9_1,l9_2,l9_3);
vec3 l9_11=l9_10*Port_Import_N052;
...
vec3 l9_15=reflect(l9_0,l9_14);
vec3 l9_16=l9_15*Port_Input1_N058;
float l9_17=l9_16.x;
float l9_18=l9_16.y;
float l9_19=l9_16.z+Port_Input1_N070;
float l9_20=((l9_17*l9_17)+(l9_18*l9_18))+(l9_19*l9_19);
float l9_21;
if (l9_20<=0.0)
{
l9_21=0.0;
...
float l9_22=l9_21*Port_Input1_N075;
vec2 l9_23=(vec2(1.0)-((vec2(l9_17,l9_18)/vec2(l9_22))+Port_Input1_N083))+vec2(Port_Import_N059,Port_Import_N060);
vec4 l9_24;
#if (Tweak_N3Layout==2)
{
l9_24=sc_SampleTextureBiasOrLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_23,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,0.0,Tweak_N3ArrSC);
}
#else
{
l9_24=sc_SampleTextureBiasOrLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_23,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,0.0,Tweak_N3);
}
#endif
vec4 l9_25;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_25=vec4(pow(l9_24.x,2.2),pow(l9_24.y,2.2),pow(l9_24.z,2.2),0.0);
}
#else
{
l9_25=l9_24*l9_24;
...
#endif
vec3 l9_26=vec3(Tweak_N79)*l9_25.xyz;
vec3 l9_27;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_27=vec3(pow(l9_26.x,0.45454544),pow(l9_26.y,0.45454544),pow(l9_26.z,0.45454544));
}
#else
{
l9_27=sqrt(l9_26);
...
l9_28.w=Port_Value2_N006;
vec4 l9_29=l9_28*vec4(clamp(Port_Import_N096,0.0,5.0));
float l9_30=max(pow(1.0-abs(dot(-l9_0,l9_10*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8;
vec3 l9_31=mix(Port_Input0_N123,mix(vec4(dot(l9_29,Port_Input1_N119)),l9_29,vec4(clamp(Port_Import_N120,0.0,2.0))),vec4(clamp(Port_Import_N122,0.0,2.0))).xyz;
vec3 l9_32=mix(l9_31,(vec3(1.0)-((vec3(1.0)-l9_31)*(vec3(1.0)-vec4(l9_30).xyz))).xyz,vec3(l9_30));
...
{
l9_39=clamp(dot(l9_33.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_41=(1.0-dot(l9_33.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_42;
...
{
l9_42=(1.0-clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_43;
...
{
l9_43=clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_44;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_45=clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_46;
...
{
l9_46=dot(l9_33.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_47;
...
#endif
vec3 l9_60=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_33.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_62=vec4(mix(vec3(1.0),l9_33.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_63;
...
#endif
l9_63=vec4(l9_33.xyz*l9_64,l9_64);
}
#else
{
l9_63=l9_33;
