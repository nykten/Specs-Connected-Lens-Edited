...
//sampler sampler Tweak_N3SmpSC 2:16
...
//texture texture2D Tweak_N3 2:0:2:16
...
uniform float Tweak_N79;
uniform vec4 Tweak_N3Size;
uniform vec4 Tweak_N3View;
uniform mat3 Tweak_N3Transform;
uniform vec4 Tweak_N3UvMinMax;
uniform vec4 Tweak_N3BorderColor;
uniform float Tweak_N1;
uniform float Tweak_N8;
uniform float alpha;
uniform vec4 Port_Input0_N123;
uniform float Port_Import_N062;
uniform vec3 Port_Import_N052;
uniform vec3 Port_Input1_N058;
uniform vec3 Port_Import_N065;
uniform float Port_Input1_N070;
uniform float Port_Input1_N075;
uniform vec2 Port_Input1_N083;
...
#endif
#ifndef Tweak_N3HasSwappedViews
#define Tweak_N3HasSwappedViews 0
#elif Tweak_N3HasSwappedViews==1
#undef Tweak_N3HasSwappedViews
#define Tweak_N3HasSwappedViews 1
#endif
#ifndef Tweak_N3Layout
#define Tweak_N3Layout 0
#endif
#ifndef sc_DepthOnly
...
#ifndef SC_USE_UV_TRANSFORM_Tweak_N3
#define SC_USE_UV_TRANSFORM_Tweak_N3 0
#elif SC_USE_UV_TRANSFORM_Tweak_N3==1
#undef SC_USE_UV_TRANSFORM_Tweak_N3
#define SC_USE_UV_TRANSFORM_Tweak_N3 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N3
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N3
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N3
#define SC_USE_UV_MIN_MAX_Tweak_N3 0
#elif SC_USE_UV_MIN_MAX_Tweak_N3==1
#undef SC_USE_UV_MIN_MAX_Tweak_N3
#define SC_USE_UV_MIN_MAX_Tweak_N3 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N3
#define SC_USE_CLAMP_TO_BORDER_Tweak_N3 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N3==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N3
#define SC_USE_CLAMP_TO_BORDER_Tweak_N3 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
vec3 l9_4=l9_3*Port_Import_N052;
...
vec3 l9_7=l9_4*l9_6;
vec3 l9_8=reflect(l9_0,l9_7)*Port_Input1_N058;
float l9_9=l9_8.x;
float l9_10=l9_8.y;
float l9_11=l9_8.z+Port_Input1_N070;
float l9_12=((l9_9*l9_9)+(l9_10*l9_10))+(l9_11*l9_11);
float l9_13;
if (l9_12<=0.0)
{
l9_13=0.0;
...
float l9_14=l9_13*Port_Input1_N075;
int l9_15;
#if (Tweak_N3HasSwappedViews)
{
...
#endif
vec4 l9_16=sc_SampleTextureBiasOrLevel(Tweak_N3Dims.xy,Tweak_N3Layout,l9_15,(vec2(1.0)-((vec2(l9_9,l9_10)/vec2(l9_14))+Port_Input1_N083))+vec2(Port_Import_N059,Port_Import_N060),(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,0.0,Tweak_N3);
vec4 l9_17;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_17=vec4(pow(l9_16.x,2.2),pow(l9_16.y,2.2),pow(l9_16.z,2.2),0.0);
}
#else
{
l9_17=l9_16*l9_16;
...
#endif
vec3 l9_18=vec3(Tweak_N79)*l9_17.xyz;
vec3 l9_19;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_19=vec3(pow(l9_18.x,0.45454544),pow(l9_18.y,0.45454544),pow(l9_18.z,0.45454544));
}
#else
{
l9_19=sqrt(l9_18);
...
l9_20.w=Port_Value2_N006;
vec4 l9_21=l9_20*vec4(clamp(Port_Import_N096,0.0,5.0));
float l9_22=max(pow(1.0-abs(dot(-l9_0,l9_3*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8;
vec3 l9_23=mix(Port_Input0_N123,mix(vec4(dot(l9_21,Port_Input1_N119)),l9_21,vec4(clamp(Port_Import_N120,0.0,2.0))),vec4(clamp(Port_Import_N122,0.0,2.0))).xyz;
vec3 l9_24=mix(l9_23,(vec3(1.0)-((vec3(1.0)-l9_23)*(vec3(1.0)-vec4(l9_22).xyz))).xyz,vec3(l9_22));
vec4 l9_25=vec4(l9_24.x,l9_24.y,l9_24.z,vec4(0.0).w);
l9_25.w=alpha;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_34;
#if (sc_BlendMode_Add)
{
l9_34=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_35;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_37;
#if (sc_BlendMode_Min)
{
l9_37=1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_38;
#if (sc_BlendMode_Max)
{
l9_38=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_38=1.0;
...
#endif
l9_26=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_25.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_27);
}
#else
{
vec4 l9_39;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_52;
...
#endif
l9_52=vec4(l9_25.xyz*l9_53,l9_53);
}
#else
{
l9_52=l9_25;
