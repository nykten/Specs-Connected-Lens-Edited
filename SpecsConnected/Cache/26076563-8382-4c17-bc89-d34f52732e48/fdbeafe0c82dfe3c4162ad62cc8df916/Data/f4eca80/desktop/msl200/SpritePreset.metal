...
//float Port_Import_N029 4632
//float Port_Default_N204 4636
//float depthRef 4640
//}
...
l9_626=l9_534.x;
float l9_627=0.0;
float l9_628=(*sc_set2.UserUniforms).opacityMul;
l9_627=l9_628;
float l9_629=0.0;
l9_629=l9_627;
float l9_630=0.0;
l9_630=l9_626*l9_629;
param_5=l9_630;
param_7=param_5;
}
else
...
bool l9_634=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_634)
{
...
float4 l9_635=fast::max(param_10,float4(0.0));
float4 param_11=l9_635;
...
{
l9_638=fast::clamp(l9_637.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_638=fast::clamp(dot(l9_637.xyz,float3(l9_637.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_638=(1.0-dot(l9_637.xyz,float3(0.33333001)))*l9_637.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_638=(1.0-fast::clamp(dot(l9_637.xyz,float3(1.0)),0.0,1.0))*l9_637.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_638=fast::clamp(dot(l9_637.xyz,float3(1.0)),0.0,1.0)*l9_637.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_638=fast::clamp(dot(l9_637.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_638=dot(l9_637.xyz,float3(0.33333001))*l9_637.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_638=1.0-fast::clamp(dot(l9_637.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_639=l9_638;
float l9_640=l9_639;
float l9_641=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_640;
float3 l9_642=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_636.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_643=float4(l9_642.x,l9_642.y,l9_642.z,l9_641);
param_12=l9_643;
}
else
{
...
{
float4 l9_644=param_12;
float4 l9_645=float4(0.0);
float4 l9_646=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_647=out.FragColor0;
float4 l9_648=l9_647;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_648.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_651=(l9_650.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_678=sc_ScreenTextureLayout_tmp;
int l9_679=l9_674;
float l9_680=l9_675;
...
float l9_688=l9_680;
float4 l9_689=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_687,bias(l9_688));
float4 l9_690=l9_689;
l9_676=l9_690;
float4 l9_691=l9_676;
float4 l9_692=l9_691;
float4 l9_693=l9_692;
l9_646=l9_693;
}
float4 l9_694=l9_646;
float4 l9_695=l9_694;
float3 l9_696=l9_695.xyz;
float3 l9_697=l9_696;
float3 l9_698=l9_644.xyz;
float3 l9_699=definedBlend(l9_697,l9_698,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_645=float4(l9_699.x,l9_699.y,l9_699.z,l9_645.w);
float3 l9_700=mix(l9_696,l9_645.xyz,float3(l9_644.w));
l9_645=float4(l9_700.x,l9_700.y,l9_700.z,l9_645.w);
l9_645.w=1.0;
float4 l9_701=l9_645;
param_12=l9_701;
}
else
{
...
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_703=float4(mix(float3(1.0),l9_702.xyz,float3(l9_702.w)),l9_702.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_704=l9_702.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_704=fast::clamp(l9_704,0.0,1.0);
}
l9_703=float4(l9_702.xyz*l9_704,l9_704);
}
else
{
l9_703=l9_702;
...
float4 l9_705=l9_703;
param_12=l9_705;
}
}
}
float4 l9_706=param_12;
FinalColor=l9_706;
if ((*sc_set2.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_707=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_707=float4(0.0);
...
float4 l9_709=param_15;
out.FragColor0=l9_709;
return out;
}
} // FRAGMENT SHADER
