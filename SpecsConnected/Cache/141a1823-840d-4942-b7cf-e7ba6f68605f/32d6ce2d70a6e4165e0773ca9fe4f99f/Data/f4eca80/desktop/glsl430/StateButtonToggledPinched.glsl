...
vec3 l9_20=l9_12*Port_Import_N068;
...
vec3 l9_24=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_23,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_25;
#if (additional_settings_btn_refl_texLayout==2)
{
l9_25=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_24.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_texArrSC);
}
#else
{
l9_25=sc_SampleTextureBiasOrLevel(additional_settings_btn_refl_texDims.xy,additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex(),l9_24.xy,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex),(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texBorderColor,0.0,additional_settings_btn_refl_tex);
...
#endif
vec4 l9_26=vec4(Port_Import_N062)*l9_25;
vec2 l9_27=l9_4*Port_Input1_N009;
float l9_28=clamp(length(l9_27+Port_Input2_N009),0.0,1.0);
vec4 l9_29;
if (l9_28<Port_Position1_N003)
{
l9_29=mix(Port_Value0_N003,Port_Value1_N003,vec4(clamp(l9_28/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_28<Port_Position2_N003)
{
l9_30=mix(Port_Value1_N003,Port_Value2_N003,vec4(clamp((l9_28-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_28<Port_Position3_N003)
{
l9_31=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_28-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
l9_31=mix(Port_Value3_N003,Port_Value4_N003,vec4(clamp((l9_28-Port_Position3_N003)/(1.0-Port_Position3_N003),0.0,1.0)));
}
l9_30=l9_31;
}
l9_29=l9_30;
...
vec4 l9_37=mix(l9_19,l9_26,vec4(Port_Input2_N005))+l9_29;
vec2 l9_38=l9_5-Port_Center_N002;
vec2 l9_39=(l9_38*Port_Scale_N002)+Port_Center_N002;
vec4 l9_40;
#if (iconLayout==2)
{
l9_40=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_40=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
float l9_41;
...
#if (iconLayout==2)
{
l9_42=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,iconArrSC);
}
#else
{
l9_42=sc_SampleTextureBiasOrLevel(iconDims.xy,iconLayout,iconGetStereoViewIndex(),l9_39,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon),(int(SC_USE_UV_MIN_MAX_icon)!=0),iconUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0),iconBorderColor,0.0,icon);
}
#endif
l9_41=l9_42.w;
}
...
{
l9_41=Port_Input2_N007;
}
vec4 l9_43=vec4(l9_41);
vec4 l9_44=mix(l9_37,l9_40,l9_43);
float l9_45=l9_44.w;
