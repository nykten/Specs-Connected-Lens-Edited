...
//}
//ubo int UserUniforms 2:24:4400 {
...
//float Port_Input1_N070 4260
//float Port_Input1_N071 4264
//float4 Port_Value0_N068 4272
//float Port_Position1_N068 4288
//float4 Port_Value1_N068 4304
//float4 Port_Value2_N068 4320
//float Port_Input1_N072 4336
//float3 Port_Default_N066 4352
//float3 Port_Value1_N038 4368
//float3 Port_Default_N038 4384
//}
...
{
float l9_66=0.0;
float3 l9_67=(*sc_set2.UserUniforms).Port_Normal_N014;
float l9_68=(*sc_set2.UserUniforms).Port_Exponent_N014;
float l9_69=(*sc_set2.UserUniforms).Port_Intensity_N014;
ssGlobals l9_70=l9_10;
l9_67=float3x3(float3(l9_70.VertexTangent_WorldSpace),float3(l9_70.VertexBinormal_WorldSpace),float3(l9_70.VertexNormal_WorldSpace))*l9_67;
float l9_71=abs(dot(-l9_70.ViewDirWS,l9_67));
float l9_72=pow(1.0-l9_71,l9_68);
l9_72=fast::max(l9_72,0.0);
l9_72*=l9_69;
l9_66=l9_72;
float3 l9_73=float3(0.0);
l9_73=l9_10.SurfacePosition_WorldSpace;
float3 l9_74=float3(0.0);
l9_74=(*sc_set2.UserUniforms).sc_Camera.position;
float l9_75=0.0;
l9_75=distance(l9_73,l9_74);
float l9_76=0.0;
l9_76=l9_75*(*sc_set2.UserUniforms).Port_Input1_N097;
float l9_77=0.0;
float l9_78=l9_76;
float l9_79=(*sc_set2.UserUniforms).Port_RangeMinA_N103;
float l9_80=(*sc_set2.UserUniforms).Port_RangeMaxA_N103;
float l9_81=(*sc_set2.UserUniforms).Port_RangeMinB_N103;
float l9_82=(*sc_set2.UserUniforms).Port_RangeMaxB_N103;
float l9_83=(((l9_78-l9_79)/(l9_80-l9_79))*(l9_82-l9_81))+l9_81;
float l9_84;
if (l9_82>l9_81)
{
l9_84=fast::clamp(l9_83,l9_81,l9_82);
}
else
{
l9_84=fast::clamp(l9_83,l9_82,l9_81);
}
l9_83=l9_84;
l9_77=l9_83;
float l9_85=0.0;
l9_85=(l9_66*(*sc_set2.UserUniforms).Port_Input1_N017)+l9_77;
float l9_86=0.0;
l9_86=1.0-l9_85;
float l9_87=0.0;
l9_87=fast::clamp(l9_86+0.001,(*sc_set2.UserUniforms).Port_Input1_N069+0.001,(*sc_set2.UserUniforms).Port_Input2_N069+0.001)-0.001;
float3 l9_88=float3(0.0);
l9_88=l9_10.SurfacePosition_ObjectSpace;
float l9_89=0.0;
float l9_90=(*sc_set2.UserUniforms).height_gradient;
l9_89=l9_90;
float3 l9_91=float3(0.0);
l9_91.x=(*sc_set2.UserUniforms).Port_Value1_N076;
l9_91.y=l9_89;
l9_91.z=(*sc_set2.UserUniforms).Port_Value3_N076;
float l9_92=0.0;
l9_92=distance(l9_88,l9_91);
float l9_93=0.0;
float l9_94=(*sc_set2.UserUniforms).distance_gradient;
l9_93=l9_94;
float l9_95=0.0;
l9_95=1.0-l9_93;
float l9_96=0.0;
...
float l9_98=l9_96;
float4 l9_99=(*sc_set2.UserUniforms).Port_Value0_N077;
float l9_100=(*sc_set2.UserUniforms).Port_Position1_N077;
float4 l9_101=(*sc_set2.UserUniforms).Port_Value1_N077;
float l9_102=(*sc_set2.UserUniforms).Port_Position2_N077;
float4 l9_103=(*sc_set2.UserUniforms).Port_Value2_N077;
float l9_104=(*sc_set2.UserUniforms).Port_Position3_N077;
float4 l9_105=(*sc_set2.UserUniforms).Port_Value3_N077;
float4 l9_106=(*sc_set2.UserUniforms).Port_Value4_N077;
l9_98=fast::clamp(l9_98,0.0,1.0);
float4 l9_107;
if (l9_98<l9_100)
{
l9_107=mix(l9_99,l9_101,float4(fast::clamp(l9_98/l9_100,0.0,1.0)));
}
else
{
if (l9_98<l9_102)
{
l9_107=mix(l9_101,l9_103,float4(fast::clamp((l9_98-l9_100)/(l9_102-l9_100),0.0,1.0)));
}
else
{
if (l9_98<l9_104)
{
l9_107=mix(l9_103,l9_105,float4(fast::clamp((l9_98-l9_102)/(l9_104-l9_102),0.0,1.0)));
}
else
{
l9_107=mix(l9_105,l9_106,float4(fast::clamp((l9_98-l9_104)/(1.0-l9_104),0.0,1.0)));
}
}
}
bool l9_108=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_109;
if (l9_108)
{
l9_109=!PreviewInfo.Saved;
}
else
{
l9_109=l9_108;
...
if (l9_109)
{
l9_110=77==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_110=l9_109;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=l9_107;
PreviewInfo.Color.w=1.0;
}
l9_97=l9_107;
float4 l9_111=float4(0.0);
float4 l9_112=l9_97;
float l9_113=(*sc_set2.UserUniforms).Port_Amount_N080;
float l9_114=dot(l9_112.xyz,float3(0.29899999,0.58700001,0.114));
float4 l9_115=float4(mix(float3(l9_114),l9_112.xyz,float3(l9_113)),l9_112.w);
l9_111=l9_115;
float4 l9_116=float4(0.0);
l9_116=float4(l9_87)*l9_111;
float3 l9_117=float3(0.0);
l9_117=l9_10.SurfacePosition_ObjectSpace;
float l9_118=0.0;
l9_118=l9_117.y;
float l9_119=0.0;
l9_119=floor(l9_118*(*sc_set2.UserUniforms).Port_Input1_N070)/(*sc_set2.UserUniforms).Port_Input1_N070;
float l9_120=0.0;
float l9_121;
if (l9_119<=0.0)
{
...
{
l9_121=pow(l9_119,(*sc_set2.UserUniforms).Port_Input1_N071);
}
l9_120=l9_121;
float4 l9_122=float4(0.0);
float l9_123=l9_120;
float4 l9_124=(*sc_set2.UserUniforms).Port_Value0_N068;
float l9_125=(*sc_set2.UserUniforms).Port_Position1_N068;
float4 l9_126=(*sc_set2.UserUniforms).Port_Value1_N068;
float4 l9_127=(*sc_set2.UserUniforms).Port_Value2_N068;
...
bool l9_129=(*sc_set2.UserUniforms).PreviewEnabled==1;
bool l9_130;
if (l9_129)
{
...
if (l9_130)
{
l9_131=68==(*sc_set2.UserUniforms).PreviewNodeID;
}
else
{
l9_131=l9_130;
...
l9_132=l9_122*float4((*sc_set2.UserUniforms).Port_Input1_N072);
