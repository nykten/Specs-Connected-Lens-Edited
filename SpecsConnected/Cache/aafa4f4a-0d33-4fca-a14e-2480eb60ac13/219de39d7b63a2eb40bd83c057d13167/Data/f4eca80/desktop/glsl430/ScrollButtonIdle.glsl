...
vec2 l9_21=l9_3*Port_Input1_N028;
float l9_22=clamp(length(l9_21+Port_Input2_N028),0.0,1.0);
vec4 l9_23;
if (l9_22<Port_Position1_N031)
{
l9_23=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_22/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_24;
if (l9_22<Port_Position2_N031)
{
l9_24=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_22-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_25;
if (l9_22<Port_Position3_N031)
{
l9_25=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_22-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_25=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_22-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_24=l9_25;
}
l9_23=l9_24;
}
vec3 l9_26=l9_11*Port_Import_N041;
...
vec3 l9_29=l9_26*l9_28;
vec3 l9_30=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_29,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
vec4 l9_31;
#if (capsule_btn_refl_tex_1Layout==2)
{
l9_31=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_30.xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1ArrSC);
}
#else
{
...
#endif
vec4 l9_32=vec4(Port_Import_N027)*l9_31;
float l9_33=clamp(((l9_32.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_34;
if (l9_33<Port_Position1_N005)
{
l9_34=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_33/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_35;
if (l9_33<Port_Position2_N005)
{
l9_35=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_33-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_35=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_33-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_34=l9_35;
}
vec3 l9_36=-l9_4;
vec4 l9_37=mix(l9_34,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_36,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_38=l9_23+l9_37;
float l9_39;
if (l9_22<Port_Position1_N016)
{
l9_39=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_22/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_40;
if (l9_22<Port_Position2_N016)
{
l9_40=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_22-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_41;
if (l9_22<Port_Position3_N016)
{
l9_41=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_22-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_41=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_22-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_40=l9_41;
}
l9_39=l9_40;
}
vec4 l9_42=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_42.w=l9_39;
vec4 l9_43=l9_20+l9_42;
float l9_44=l9_43.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_44<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_44<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_45,vec4(0.0)));
return;
}
vec4 l9_47;
...
{
l9_50=clamp(dot(l9_43.xyz,vec3(l9_44)),0.0,1.0);
}
#else
{
float l9_51;
...
{
l9_52=(1.0-dot(l9_43.xyz,vec3(0.33333001)))*l9_44;
}
#else
{
float l9_53;
...
{
l9_53=(1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0))*l9_44;
}
#else
{
float l9_54;
...
{
l9_54=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*l9_44;
}
#else
{
float l9_55;
#if (sc_BlendMode_Add)
{
l9_55=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_56=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*l9_44;
}
#else
{
float l9_57;
...
{
l9_57=dot(l9_43.xyz,vec3(0.33333001))*l9_44;
}
#else
{
float l9_58;
#if (sc_BlendMode_Min)
{
l9_58=1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_59;
#if (sc_BlendMode_Max)
{
l9_59=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_59=1.0;
...
#endif
l9_47=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_43.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_48);
}
#else
{
vec4 l9_60;
...
#if (sc_FramebufferFetch)
{
vec4 l9_63=sc_readFragData0_Platform();
vec4 l9_64;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_65=l9_63;
l9_65.x=l9_63.x+_sc_framebufferFetchMarker;
l9_64=l9_65;
}
#else
{
...
{
l9_68=sc_SampleView(sc_ScreenTextureDims.xy,l9_66,sc_ScreenTextureLayout,l9_67,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_68=sc_SampleView(sc_ScreenTextureDims.xy,l9_66,sc_ScreenTextureLayout,l9_67,0.0,sc_ScreenTexture);
}
#endif
l9_62=l9_68;
}
...
{
vec4 l9_70=l9_62;
l9_70.x=l9_62.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_69=l9_70;
}
#else
{
...
#endif
vec3 l9_71=mix(l9_69.xyz,definedBlend(l9_69.xyz,l9_43.xyz).xyz,vec3(l9_44));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_73=vec4(mix(vec3(1.0),l9_43.xyz,vec3(l9_44)),l9_44);
}
#else
{
vec4 l9_74;
...
#endif
l9_74=vec4(l9_43.xyz*l9_75,l9_75);
}
#else
{
l9_74=l9_43;
...
#endif
int l9_84=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_83).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_96=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_96).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_101==0)
{
l9_104=texture(sc_OITAlpha0,l9_96);
l9_103=texture(sc_OITDepthLow0,l9_96);
l9_102=texture(sc_OITDepthHigh0,l9_96);
}
else
{
l9_104=vec4(0.0);
...
if (l9_101==1)
{
l9_107=texture(sc_OITAlpha1,l9_96);
l9_106=texture(sc_OITDepthLow1,l9_96);
l9_105=texture(sc_OITDepthHigh1,l9_96);
}
else
{
l9_107=l9_104;
...
vec4 l9_122=texture(sc_OITFilteredDepthBoundsTexture,l9_96);
