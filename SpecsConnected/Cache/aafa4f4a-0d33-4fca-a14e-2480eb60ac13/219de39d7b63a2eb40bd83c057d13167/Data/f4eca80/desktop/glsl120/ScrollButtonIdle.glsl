...
float l9_11=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_12;
if (l9_11<Port_Position1_N031)
{
l9_12=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_11/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_11<Port_Position2_N031)
{
l9_13=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_11-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_11<Port_Position3_N031)
{
l9_14=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_11-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_14=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_11-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_13=l9_14;
}
l9_12=l9_13;
}
vec3 l9_15=l9_2*Port_Import_N041;
...
#endif
vec4 l9_20=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,l9_19,(((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_18,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045)).xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1);
float l9_21=clamp((((vec4(Port_Import_N027)*l9_20).xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_22;
if (l9_21<Port_Position1_N005)
{
l9_22=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_21/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_21<Port_Position2_N005)
{
l9_23=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_21-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_23=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_21-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_22=l9_23;
}
vec4 l9_24=mix(l9_22,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_25=l9_12+l9_24;
float l9_26;
if (l9_11<Port_Position1_N016)
{
l9_26=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_11/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_27;
if (l9_11<Port_Position2_N016)
{
l9_27=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_11-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_28;
if (l9_11<Port_Position3_N016)
{
l9_28=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_11-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_28=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_11-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_27=l9_28;
}
l9_26=l9_27;
}
vec4 l9_29=vec4(l9_25.x,l9_25.y,l9_25.z,vec4(0.0).w);
l9_29.w=l9_26;
vec4 l9_30=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_29;
float l9_31=l9_30.w;
...
{
l9_35=clamp(dot(l9_30.xyz,vec3(l9_31)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_30.xyz,vec3(0.33333001)))*l9_31;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0))*l9_31;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*l9_31;
}
#else
{
float l9_40;
#if (sc_BlendMode_Add)
{
l9_40=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_42=dot(l9_30.xyz,vec3(0.33333001))*l9_31;
}
#else
{
float l9_43;
#if (sc_BlendMode_Min)
{
l9_43=1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_Max)
{
l9_44=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_44=1.0;
...
#endif
l9_32=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_30.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_33);
}
#else
{
vec4 l9_45;
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_30.xyz).xyz,vec3(l9_31));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_30.xyz,vec3(l9_31)),l9_31);
}
#else
{
vec4 l9_58;
...
#endif
l9_58=vec4(l9_30.xyz*l9_59,l9_59);
}
#else
{
l9_58=l9_30;
