...
//sampler sampler capsule_btn_refl_tex_1SmpSC 2:23
//sampler sampler capsule_btn_refl_tex_2SmpSC 2:24
//sampler sampler capsule_btn_refl_tex_3SmpSC 2:25
...
//texture texture2D capsule_btn_refl_tex_1 2:3:2:23
//texture texture2D capsule_btn_refl_tex_2 2:4:2:24
//texture texture2D capsule_btn_refl_tex_3 2:5:2:25
...
//texture texture2DArray capsule_btn_refl_tex_1ArrSC 2:36:2:23
//texture texture2DArray capsule_btn_refl_tex_2ArrSC 2:37:2:24
//texture texture2DArray capsule_btn_refl_tex_3ArrSC 2:38:2:25
...
uniform vec4 Port_Value0_N030;
uniform float Port_Position1_N030;
uniform vec4 Port_Value1_N030;
uniform float Port_Position2_N030;
uniform vec4 Port_Value2_N030;
uniform float Port_Position3_N030;
uniform vec4 Port_Value3_N030;
uniform float Port_Position4_N030;
uniform vec4 Port_Value4_N030;
uniform vec4 Port_Value5_N030;
uniform vec4 Port_Input1_N000;
uniform vec3 Port_Normal_N001;
uniform float Port_Exponent_N001;
uniform float Port_Intensity_N001;
...
l9_3=l9_5.uv0;
l9_2=l9_6;
l9_1=cross(l9_6,l9_8)*l9_7.w;
l9_0=l9_8;
}
else
{
vec3 l9_9=normalize(varTangent.xyz);
vec3 l9_10=normalize(varNormal);
l9_4=normalize(sc_Camera.position-varPos);
l9_3=varPackedTex.xy;
l9_2=l9_10;
l9_1=cross(l9_10,l9_9)*varTangent.w;
l9_0=l9_9;
}
mat3 l9_11=mat3(l9_0,l9_1,l9_2);
vec3 l9_12=l9_11*Port_Import_N111;
...
vec3 l9_16=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_15,0.0)).xyz*vec3(Port_Input1_N115))+vec3(Port_Input2_N115);
vec4 l9_17;
#if (capsule_btn_refl_tex_2Layout==2)
{
l9_17=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_2Dims.xy,capsule_btn_refl_tex_2Layout,capsule_btn_refl_tex_2GetStereoViewIndex(),l9_16.xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2)!=0),capsule_btn_refl_tex_2BorderColor,0.0,capsule_btn_refl_tex_2ArrSC);
}
#else
{
...
#endif
vec4 l9_18=vec4(Port_Import_N101)*l9_17;
vec4 l9_19;
#if (capsule_btn_refl_tex_3Layout==2)
{
l9_19=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_3Dims.xy,capsule_btn_refl_tex_3Layout,capsule_btn_refl_tex_3GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3)!=0),capsule_btn_refl_tex_3BorderColor,0.0,capsule_btn_refl_tex_3ArrSC);
}
#else
{
...
#endif
vec4 l9_20=l9_18*l9_19;
vec3 l9_21=l9_11*Port_Import_N041;
...
vec3 l9_25=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_24,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
vec4 l9_26;
#if (capsule_btn_refl_tex_1Layout==2)
{
l9_26=sc_SampleTextureBiasOrLevel(capsule_btn_refl_tex_1Dims.xy,capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex(),l9_25.xy,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1),(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1BorderColor,0.0,capsule_btn_refl_tex_1ArrSC);
}
#else
{
...
#endif
vec4 l9_27=vec4(Port_Import_N027)*l9_26;
float l9_28=clamp(l9_27.x,0.0,1.0);
vec4 l9_29;
if (l9_28<Port_Position1_N030)
{
l9_29=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_28/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_28<Port_Position2_N030)
{
l9_30=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_28-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_28<Port_Position3_N030)
{
l9_31=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_28-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_32;
if (l9_28<Port_Position4_N030)
{
l9_32=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_28-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_32=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_28-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_31=l9_32;
}
l9_30=l9_31;
...
vec3 l9_33=-l9_4;
vec4 l9_34=mix(l9_29,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(l9_33,l9_11*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_35=l9_20+l9_34;
float l9_36=l9_35.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_36<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_36<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_42=clamp(dot(l9_35.xyz,vec3(l9_36)),0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_44=(1.0-dot(l9_35.xyz,vec3(0.33333001)))*l9_36;
}
#else
{
float l9_45;
...
{
l9_45=(1.0-clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0))*l9_36;
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*l9_36;
}
#else
{
float l9_47;
#if (sc_BlendMode_Add)
{
l9_47=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_48;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_48=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*l9_36;
}
#else
{
float l9_49;
...
{
l9_49=dot(l9_35.xyz,vec3(0.33333001))*l9_36;
}
#else
{
float l9_50;
#if (sc_BlendMode_Min)
{
l9_50=1.0-clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_Max)
{
l9_51=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_51=1.0;
...
#endif
l9_39=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_35.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_40);
}
#else
{
vec4 l9_52;
...
#endif
vec3 l9_63=mix(l9_61.xyz,definedBlend(l9_61.xyz,l9_35.xyz).xyz,vec3(l9_36));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_35.xyz,vec3(l9_36)),l9_36);
}
#else
{
vec4 l9_66;
...
#endif
l9_66=vec4(l9_35.xyz*l9_67,l9_67);
}
#else
{
l9_66=l9_35;
