...
vec4 l9_18;
if (l9_17<Port_Position1_N030)
{
l9_18=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_17/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_19;
if (l9_17<Port_Position2_N030)
{
l9_19=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_17-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_17<Port_Position3_N030)
{
l9_20=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_17-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_21;
if (l9_17<Port_Position4_N030)
{
l9_21=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_17-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_21=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_17-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_20=l9_21;
}
l9_19=l9_20;
...
vec4 l9_22=mix(l9_18,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_23=((vec4(Port_Import_N101)*l9_8)*l9_10)+l9_22;
float l9_24=l9_23.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_24<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_24<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_28=clamp(dot(l9_23.xyz,vec3(l9_24)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=(1.0-dot(l9_23.xyz,vec3(0.33333001)))*l9_24;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0))*l9_24;
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_33;
#if (sc_BlendMode_Add)
{
l9_33=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_23.xyz,vec3(0.33333001))*l9_24;
}
#else
{
float l9_36;
#if (sc_BlendMode_Min)
{
l9_36=1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_37;
#if (sc_BlendMode_Max)
{
l9_37=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_37=1.0;
...
#endif
l9_25=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_23.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_26);
}
#else
{
vec4 l9_38;
...
#if (sc_FramebufferFetch)
{
vec4 l9_41=sc_readFragData0_Platform();
vec4 l9_42;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_43=l9_41;
l9_43.x=l9_41.x+_sc_framebufferFetchMarker;
l9_42=l9_43;
}
#else
{
...
#endif
l9_40=sc_SampleView(sc_ScreenTextureDims.xy,l9_44,sc_ScreenTextureLayout,l9_45,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_46;
...
{
vec4 l9_47=l9_40;
l9_47.x=l9_40.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_46=l9_47;
}
#else
{
...
#endif
vec3 l9_48=mix(l9_46.xyz,definedBlend(l9_46.xyz,l9_23.xyz).xyz,vec3(l9_24));
vec4 l9_49=vec4(l9_48.x,l9_48.y,l9_48.z,vec4(0.0).w);
l9_49.w=1.0;
l9_39=l9_49;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_50=vec4(mix(vec3(1.0),l9_23.xyz,vec3(l9_24)),l9_24);
}
#else
{
vec4 l9_51;
...
#endif
l9_51=vec4(l9_23.xyz*l9_52,l9_52);
}
#else
{
l9_51=l9_23;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_59-0.0039215689)),min(1.0,l9_59+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_61),packValue(l9_61),packValue(l9_61),packValue(l9_61)));
