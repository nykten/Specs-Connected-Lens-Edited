...
//}
//ubo int UserUniforms 2:37:4816 {
...
//float4 Port_Value0_N030 4608
//float Port_Position1_N030 4624
//float4 Port_Value1_N030 4640
//float Port_Position2_N030 4656
//float4 Port_Value2_N030 4672
//float Port_Position3_N030 4688
//float4 Port_Value3_N030 4704
//float Port_Position4_N030 4720
//float4 Port_Value4_N030 4736
//float4 Port_Value5_N030 4752
//float4 Port_Input1_N000 4768
//float3 Port_Normal_N001 4784
//float Port_Exponent_N001 4800
//float Port_Intensity_N001 4804
//float depthRef 4808
//}
...
float4 Port_Value3_N030;
float Port_Position4_N030;
float4 Port_Value4_N030;
float4 Port_Value5_N030;
float4 Port_Input1_N000;
float3 Port_Normal_N001;
float Port_Exponent_N001;
float Port_Intensity_N001;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param_38=(*sc_set2.UserUniforms).Port_Value0_N030;
float param_39=(*sc_set2.UserUniforms).Port_Position1_N030;
float4 param_40=(*sc_set2.UserUniforms).Port_Value1_N030;
float param_41=(*sc_set2.UserUniforms).Port_Position2_N030;
float4 param_42=(*sc_set2.UserUniforms).Port_Value2_N030;
float param_43=(*sc_set2.UserUniforms).Port_Position3_N030;
float4 param_44=(*sc_set2.UserUniforms).Port_Value3_N030;
float param_45=(*sc_set2.UserUniforms).Port_Position4_N030;
float4 param_46=(*sc_set2.UserUniforms).Port_Value4_N030;
float4 param_47=(*sc_set2.UserUniforms).Port_Value5_N030;
param_37=fast::clamp(param_37,0.0,1.0);
float4 param_48;
if (param_37<param_39)
{
param_48=mix(param_38,param_40,float4(fast::clamp(param_37/param_39,0.0,1.0)));
}
else
{
if (param_37<param_41)
{
param_48=mix(param_40,param_42,float4(fast::clamp((param_37-param_39)/(param_41-param_39),0.0,1.0)));
}
else
{
if (param_37<param_43)
{
param_48=mix(param_42,param_44,float4(fast::clamp((param_37-param_41)/(param_43-param_41),0.0,1.0)));
}
else
{
if (param_37<param_45)
{
param_48=mix(param_44,param_46,float4(fast::clamp((param_37-param_43)/(param_45-param_43),0.0,1.0)));
}
else
{
param_48=mix(param_46,param_47,float4(fast::clamp((param_37-param_45)/(1.0-param_45),0.0,1.0)));
}
}
}
}
Value_N30=param_48;
float Rim_N1=0.0;
float3 param_49=(*sc_set2.UserUniforms).Port_Normal_N001;
float param_50=(*sc_set2.UserUniforms).Port_Exponent_N001;
float param_51=(*sc_set2.UserUniforms).Port_Intensity_N001;
ssGlobals param_53=Globals;
param_49=float3x3(float3(param_53.VertexTangent_WorldSpace),float3(param_53.VertexBinormal_WorldSpace),float3(param_53.VertexNormal_WorldSpace))*param_49;
float l9_257=abs(dot(-param_53.ViewDirWS,param_49));
float param_52=pow(1.0-l9_257,param_50);
param_52=fast::max(param_52,0.0);
param_52*=param_51;
Rim_N1=param_52;
float4 Output_N0=float4(0.0);
Output_N0=mix(Value_N30,(*sc_set2.UserUniforms).Port_Input1_N000,float4(Rim_N1));
float4 Output_N100=float4(0.0);
Output_N100=Output_N2+Output_N0;
FinalColor=Output_N100;
float param_54=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_54<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_262=fast::max(param_55,float4(0.0));
float4 param_56=l9_262;
