...
//}
//ubo int UserUniforms 2:61:6352 {
...
//float3 emissiveFactor 4432
//float4 emissiveTextureSize 4448
//float4 emissiveTextureDims 4464
//float4 emissiveTextureView 4480
//float3x3 emissiveTextureTransform 4496
//float4 emissiveTextureUvMinMax 4544
//float4 emissiveTextureBorderColor 4560
//float normalTextureScale 4576
//float4 normalTextureSize 4592
//float4 normalTextureDims 4608
//float4 normalTextureView 4624
//float3x3 normalTextureTransform 4640
//float4 normalTextureUvMinMax 4688
//float4 normalTextureBorderColor 4704
//float metallicFactor 4720
//float roughnessFactor 4724
//float occlusionTextureStrength 4728
//float4 metallicRoughnessTextureSize 4736
//float4 metallicRoughnessTextureDims 4752
//float4 metallicRoughnessTextureView 4768
//float3x3 metallicRoughnessTextureTransform 4784
//float4 metallicRoughnessTextureUvMinMax 4832
//float4 metallicRoughnessTextureBorderColor 4848
//float transmissionFactor 4864
//float4 transmissionTextureSize 4880
//float4 transmissionTextureDims 4896
//float4 transmissionTextureView 4912
//float3x3 transmissionTextureTransform 4928
//float4 transmissionTextureUvMinMax 4976
//float4 transmissionTextureBorderColor 4992
//float4 screenTextureSize 5008
//float4 screenTextureDims 5024
//float4 screenTextureView 5040
//float3x3 screenTextureTransform 5056
//float4 screenTextureUvMinMax 5104
//float4 screenTextureBorderColor 5120
//float3 sheenColorFactor 5136
//float4 sheenColorTextureSize 5152
//float4 sheenColorTextureDims 5168
//float4 sheenColorTextureView 5184
//float3x3 sheenColorTextureTransform 5200
//float4 sheenColorTextureUvMinMax 5248
//float4 sheenColorTextureBorderColor 5264
//float sheenRoughnessFactor 5280
//float4 sheenRoughnessTextureSize 5296
//float4 sheenRoughnessTextureDims 5312
//float4 sheenRoughnessTextureView 5328
//float3x3 sheenRoughnessTextureTransform 5344
//float4 sheenRoughnessTextureUvMinMax 5392
//float4 sheenRoughnessTextureBorderColor 5408
//float clearcoatFactor 5424
//float4 clearcoatTextureSize 5440
//float4 clearcoatTextureDims 5456
//float4 clearcoatTextureView 5472
//float3x3 clearcoatTextureTransform 5488
//float4 clearcoatTextureUvMinMax 5536
//float4 clearcoatTextureBorderColor 5552
//float clearcoatRoughnessFactor 5568
//float4 clearcoatRoughnessTextureSize 5584
//float4 clearcoatRoughnessTextureDims 5600
//float4 clearcoatRoughnessTextureView 5616
//float3x3 clearcoatRoughnessTextureTransform 5632
//float4 clearcoatRoughnessTextureUvMinMax 5680
//float4 clearcoatRoughnessTextureBorderColor 5696
//float4 clearcoatNormalTextureSize 5712
//float4 clearcoatNormalTextureDims 5728
//float4 clearcoatNormalTextureView 5744
//float3x3 clearcoatNormalTextureTransform 5760
//float4 clearcoatNormalTextureUvMinMax 5808
//float4 clearcoatNormalTextureBorderColor 5824
//float4 baseColorTextureSize 5840
//float4 baseColorTextureDims 5856
//float4 baseColorTextureView 5872
//float3x3 baseColorTextureTransform 5888
//float4 baseColorTextureUvMinMax 5936
//float4 baseColorTextureBorderColor 5952
//float4 baseColorFactor 5968
//float2 baseColorTexture_offset 5984
//float2 baseColorTexture_scale 5992
//float baseColorTexture_rotation 6000
//float2 emissiveTexture_offset 6008
//float2 emissiveTexture_scale 6016
//float emissiveTexture_rotation 6024
//float2 normalTexture_offset 6032
//float2 normalTexture_scale 6040
//float normalTexture_rotation 6048
//float2 metallicRoughnessTexture_offset 6056
//float2 metallicRoughnessTexture_scale 6064
//float metallicRoughnessTexture_rotation 6072
//float2 transmissionTexture_offset 6080
//float2 transmissionTexture_scale 6088
//float transmissionTexture_rotation 6096
//float2 sheenColorTexture_offset 6104
//float2 sheenColorTexture_scale 6112
//float sheenColorTexture_rotation 6120
//float2 sheenRoughnessTexture_offset 6128
//float2 sheenRoughnessTexture_scale 6136
//float sheenRoughnessTexture_rotation 6144
//float2 clearcoatTexture_offset 6152
//float2 clearcoatTexture_scale 6160
//float clearcoatTexture_rotation 6168
//float2 clearcoatNormalTexture_offset 6176
//float2 clearcoatNormalTexture_scale 6184
//float clearcoatNormalTexture_rotation 6192
//float2 clearcoatRoughnessTexture_offset 6200
//float2 clearcoatRoughnessTexture_scale 6208
//float clearcoatRoughnessTexture_rotation 6216
//float colorMultiplier 6220
//float Port_DebugSheenEnvLightMult_N003 6224
//float Port_DebugSheenPunctualLightMult_N003 6228
//float Port_Input2_N043 6232
//float Port_Input2_N062 6236
//float3 Port_SpecularAO_N036 6240
//float3 Port_Albedo_N405 6256
//float Port_Opacity_N405 6272
//float3 Port_Emissive_N405 6288
//float Port_Metallic_N405 6304
//float3 Port_SpecularAO_N405 6320
//float depthRef 6336
//}
...
float3 l9_1116=(*sc_set2.UserUniforms).sc_Camera.position;
float3 l9_1117=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_1118=normalize(l9_1116-l9_1117);
float3 l9_1119=l9_1115;
float3 l9_1120=l9_1118;
float l9_1121=fast::clamp(dot(l9_1119,l9_1120),0.0,1.0);
float l9_1122=fast::max(l9_1121,9.9999997e-05);
float l9_1123=l9_886*l9_886;
float3 l9_1124=normalize(reflect(-l9_1118,l9_1115));
float l9_1125=l9_1122;
float3 l9_1126=l9_1124;
float l9_1127=l9_886;
float3 l9_1128=l9_885;
float l9_1129=l9_1127*4.0;
l9_1129=3.0+(((l9_1129-0.0)*2.0)/5.0);
float l9_1130=l9_1127*l9_1127;
float l9_1131;
if (l9_1127<0.25)
{
l9_1131=(((-339.20001)*l9_1130)+(161.39999*l9_1127))-25.9;
}
else
{
l9_1131=(((-8.4799995)*l9_1130)+(14.3*l9_1127))-9.9499998;
}
float l9_1132=l9_1131;
float l9_1133;
if (l9_1127<0.25)
{
l9_1133=((44.0*l9_1130)-(23.700001*l9_1127))+3.26;
}
else
{
l9_1133=((1.97*l9_1130)-(3.27*l9_1127))+0.72000003;
}
float l9_1134=l9_1133;
float l9_1135=l9_1132;
float l9_1136=l9_1125;
float l9_1137=l9_1134;
float l9_1138;
if (l9_1127<0.25)
{
l9_1138=0.0;
...
{
l9_1138=0.1*(l9_1127-0.25);
}
float l9_1139=exp((l9_1135*l9_1136)+l9_1137)+l9_1138;
float l9_1140=3.1415927;
l9_1139=fast::clamp(l9_1139*l9_1140,0.0,1.0);
float3 l9_1141=l9_1126;
float l9_1142=l9_1129;
float3 l9_1143=float3(0.0);
float3 l9_1144=l9_1141;
float l9_1145=l9_1142;
float3 l9_1146=l9_1144;
float l9_1147=l9_1145;
float4 l9_1148=float4(0.0);
float3 l9_1149=l9_1146;
float l9_1150=(*sc_set2.UserUniforms).sc_EnvmapRotation.y;
float2 l9_1151=float2(0.0);
float l9_1152=l9_1149.x;
float l9_1153=-l9_1149.z;
float l9_1154=(l9_1152<0.0) ? (-1.0) : 1.0;
float l9_1155=l9_1154*acos(fast::clamp(l9_1153/length(float2(l9_1152,l9_1153)),-1.0,1.0));
l9_1151.x=l9_1155-1.5707964;
l9_1151.y=acos(l9_1149.y);
l9_1151/=float2(6.2831855,3.1415927);
l9_1151.y=1.0-l9_1151.y;
l9_1151.x+=(l9_1150/360.0);
l9_1151.x=fract((l9_1151.x+floor(l9_1151.x))+1.0);
float2 l9_1156=l9_1151;
float2 l9_1157=l9_1156;
if (SC_DEVICE_CLASS_tmp>=2)
{
float l9_1158=floor(l9_1147);
float l9_1159=ceil(l9_1147);
float l9_1160=l9_1147-l9_1158;
float2 l9_1161=l9_1157;
float2 l9_1162=(*sc_set2.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1163=l9_1158;
float2 l9_1164=calcSeamlessPanoramicUvsForSampling(l9_1161,l9_1162,l9_1163);
float2 l9_1165=l9_1164;
float l9_1166=l9_1158;
float2 l9_1167=l9_1165;
float l9_1168=l9_1166;
int l9_1169=0;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1170=0;
...
int l9_1174=l9_1169;
float2 l9_1175=l9_1167;
int l9_1176=l9_1174;
float l9_1177=l9_1168;
float4 l9_1178=float4(0.0);
float2 l9_1179=l9_1175;
int l9_1180=sc_EnvmapSpecularLayout_tmp;
int l9_1181=l9_1176;
float l9_1182=l9_1177;
float2 l9_1183=l9_1179;
int l9_1184=l9_1180;
int l9_1185=l9_1181;
float3 l9_1186=float3(0.0);
if (l9_1184==0)
{
l9_1186=float3(l9_1183,0.0);
}
else
{
if (l9_1184==1)
{
l9_1186=float3(l9_1183.x,(l9_1183.y*0.5)+(0.5-(float(l9_1185)*0.5)),0.0);
}
else
{
l9_1186=float3(l9_1183,float(l9_1185));
}
}
float3 l9_1187=l9_1186;
float3 l9_1188=l9_1187;
float2 l9_1189=l9_1188.xy;
float l9_1190=l9_1182;
float4 l9_1191=sc_set2.sc_EnvmapSpecular.sample(sc_set2.sc_EnvmapSpecularSmpSC,l9_1189,level(l9_1190));
float4 l9_1192=l9_1191;
l9_1178=l9_1192;
float4 l9_1193=l9_1178;
float4 l9_1194=l9_1193;
float4 l9_1195=l9_1194;
float4 l9_1196=l9_1195;
float2 l9_1197=l9_1157;
float2 l9_1198=(*sc_set2.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1199=l9_1159;
float2 l9_1200=calcSeamlessPanoramicUvsForSampling(l9_1197,l9_1198,l9_1199);
float2 l9_1201=l9_1200;
float l9_1202=l9_1159;
float2 l9_1203=l9_1201;
float l9_1204=l9_1202;
int l9_1205=0;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1206=0;
...
{
l9_1208=in.varStereoViewID;
}
int l9_1209=l9_1208;
l9_1205=l9_1209;
}
int l9_1210=l9_1205;
float2 l9_1211=l9_1203;
int l9_1212=l9_1210;
float l9_1213=l9_1204;
float4 l9_1214=float4(0.0);
float2 l9_1215=l9_1211;
int l9_1216=sc_EnvmapSpecularLayout_tmp;
int l9_1217=l9_1212;
float l9_1218=l9_1213;
float2 l9_1219=l9_1215;
int l9_1220=l9_1216;
int l9_1221=l9_1217;
float3 l9_1222=float3(0.0);
if (l9_1220==0)
{
l9_1222=float3(l9_1219,0.0);
}
else
{
if (l9_1220==1)
{
l9_1222=float3(l9_1219.x,(l9_1219.y*0.5)+(0.5-(float(l9_1221)*0.5)),0.0);
}
else
{
l9_1222=float3(l9_1219,float(l9_1221));
}
}
float3 l9_1223=l9_1222;
float3 l9_1224=l9_1223;
float2 l9_1225=l9_1224.xy;
float l9_1226=l9_1218;
...
l9_1214=l9_1228;
float4 l9_1229=l9_1214;
float4 l9_1230=l9_1229;
float4 l9_1231=l9_1230;
float4 l9_1232=l9_1231;
l9_1148=mix(l9_1196,l9_1232,float4(l9_1160));
}
else
{
float2 l9_1233=l9_1157;
float l9_1234=l9_1147;
float2 l9_1235=l9_1233;
float l9_1236=l9_1234;
int l9_1237=0;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1238=0;
...
int l9_1242=l9_1237;
float2 l9_1243=l9_1235;
int l9_1244=l9_1242;
float l9_1245=l9_1236;
float4 l9_1246=float4(0.0);
float2 l9_1247=l9_1243;
int l9_1248=sc_EnvmapSpecularLayout_tmp;
int l9_1249=l9_1244;
float l9_1250=l9_1245;
...
if (l9_1252==0)
{
l9_1254=float3(l9_1251,0.0);
}
else
{
if (l9_1252==1)
{
l9_1254=float3(l9_1251.x,(l9_1251.y*0.5)+(0.5-(float(l9_1253)*0.5)),0.0);
}
else
{
l9_1254=float3(l9_1251,float(l9_1253));
}
}
float3 l9_1255=l9_1254;
float3 l9_1256=l9_1255;
float2 l9_1257=l9_1256.xy;
float l9_1258=l9_1250;
float4 l9_1259=sc_set2.sc_EnvmapSpecular.sample(sc_set2.sc_EnvmapSpecularSmpSC,l9_1257,level(l9_1258));
float4 l9_1260=l9_1259;
l9_1246=l9_1260;
float4 l9_1261=l9_1246;
float4 l9_1262=l9_1261;
float4 l9_1263=l9_1262;
l9_1148=l9_1263;
}
float4 l9_1264=l9_1148;
float3 l9_1265=l9_1264.xyz*(1.0/l9_1264.w);
float3 l9_1266=l9_1265;
float3 l9_1267=l9_1266*(*sc_set2.UserUniforms).sc_EnvmapExposure;
l9_1267+=float3(1e-06);
float3 l9_1268=l9_1267;
l9_1143=l9_1268;
float3 l9_1269=l9_1143;
float3 l9_1270=l9_1269;
float3 l9_1271=(l9_1270*l9_1128)*l9_1139;
float3 l9_1272=N3_SheenOut.xyz+l9_1271;
N3_SheenOut=float4(l9_1272.x,l9_1272.y,l9_1272.z,N3_SheenOut.w);
float3 l9_1273=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_884.xyz,float3(l9_884.w));
N3_SheenOut=float4(l9_1273.x,l9_1273.y,l9_1273.z,N3_SheenOut.w);
float3 l9_1274=l9_885;
float3 l9_1275=l9_1115;
float3 l9_1276=l9_1118;
float l9_1277=l9_1122;
float l9_1278=l9_1123;
float3 l9_1279=float3(0.0);
int l9_1280=0;
l9_1280=sc_DirectionalLightsCount_tmp;
int l9_1281=l9_1280;
if (l9_1281>0)
{
float l9_1282;
...
{
int l9_1284=0;
l9_1284=sc_DirectionalLightsCount_tmp;
int l9_1285=l9_1284;
if (l9_1283<l9_1285)
{
int l9_1286=l9_1283;
float3 l9_1287=float3(0.0);
if (l9_1286<sc_DirectionalLightsCount_tmp)
{
l9_1287=(*sc_set2.UserUniforms).sc_DirectionalLights[l9_1286].color.xyz;
}
float3 l9_1288=l9_1287;
float3 l9_1289=l9_1288;
int l9_1290=l9_1283;
float l9_1291=0.0;
if (l9_1290<sc_DirectionalLightsCount_tmp)
{
l9_1291=(*sc_set2.UserUniforms).sc_DirectionalLights[l9_1290].color.w;
}
float l9_1292=l9_1291;
float l9_1293=l9_1292;
l9_1289*=l9_1293;
l9_1289*=3.1415901;
int l9_1294=l9_1283;
float3 l9_1295=float3(0.0);
if (l9_1294<sc_DirectionalLightsCount_tmp)
{
l9_1295=-(*sc_set2.UserUniforms).sc_DirectionalLights[l9_1294].direction;
}
float3 l9_1296=l9_1295;
float3 l9_1297=normalize(-l9_1296);
float3 l9_1298=normalize(l9_1297+l9_1276);
float3 l9_1299=l9_1275;
float3 l9_1300=l9_1298;
float l9_1301=fast::clamp(dot(l9_1299,l9_1300),0.0,1.0);
float l9_1302=l9_1301;
float3 l9_1303=l9_1275;
float3 l9_1304=l9_1297;
float l9_1305=fast::clamp(dot(l9_1303,l9_1304),0.0,1.0);
float l9_1306=l9_1305;
float l9_1307=l9_1278;
float l9_1308=l9_1302;
float l9_1309=1.0/l9_1307;
float l9_1310=l9_1308*l9_1308;
float l9_1311=1.0-l9_1310;
float l9_1312=l9_1309;
float l9_1313=l9_1311;
float l9_1314=l9_1309*0.5;
if (l9_1313<=0.0)
{
l9_1282=0.0;
}
...
{
l9_1282=pow(l9_1313,l9_1314);
}
float l9_1315=l9_1282;
float l9_1316=3.1415927;
float l9_1317=((2.0+l9_1312)*l9_1315)/(2.0*l9_1316);
float l9_1318=l9_1317;
float l9_1319=l9_1277;
float l9_1320=l9_1306;
float l9_1321=1.0/(4.0*((l9_1320+l9_1319)-(l9_1320*l9_1319)));
float l9_1322=l9_1321;
l9_1279+=((((l9_1289*l9_1274)*l9_1318)*l9_1322)*l9_1306);
l9_1283++;
continue;
}
else
...
int l9_1323=0;
l9_1323=sc_PointLightsCount_tmp;
int l9_1324=l9_1323;
if (l9_1324>0)
{
float l9_1325;
...
{
int l9_1327=0;
l9_1327=sc_PointLightsCount_tmp;
int l9_1328=l9_1327;
if (l9_1326<l9_1328)
{
int l9_1329=l9_1326;
float3 l9_1330=float3(0.0);
if (l9_1329<sc_PointLightsCount_tmp)
{
l9_1330=(*sc_set2.UserUniforms).sc_PointLights[l9_1329].color.xyz;
}
float3 l9_1331=l9_1330;
float3 l9_1332=l9_1331;
int l9_1333=l9_1326;
float l9_1334=0.0;
if (l9_1333<sc_PointLightsCount_tmp)
{
l9_1334=(*sc_set2.UserUniforms).sc_PointLights[l9_1333].color.w;
}
...
if (l9_1337<sc_PointLightsCount_tmp)
{
l9_1338=(*sc_set2.UserUniforms).sc_PointLights[l9_1337].position;
}
float3 l9_1339=l9_1338;
float3 l9_1340=l9_1339;
float3 l9_1341=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_1342=normalize(l9_1340-l9_1341);
float3 l9_1343=normalize(l9_1342+l9_1276);
float3 l9_1344=l9_1275;
float3 l9_1345=l9_1343;
float l9_1346=fast::clamp(dot(l9_1344,l9_1345),0.0,1.0);
float l9_1347=l9_1346;
float3 l9_1348=l9_1275;
float3 l9_1349=l9_1342;
float l9_1350=fast::clamp(dot(l9_1348,l9_1349),0.0,1.0);
float l9_1351=l9_1350;
float l9_1352=l9_1278;
float l9_1353=l9_1347;
float l9_1354=1.0/l9_1352;
float l9_1355=l9_1353*l9_1353;
float l9_1356=1.0-l9_1355;
float l9_1357=l9_1354;
float l9_1358=l9_1356;
float l9_1359=l9_1354*0.5;
if (l9_1358<=0.0)
{
l9_1325=0.0;
}
...
{
l9_1325=pow(l9_1358,l9_1359);
}
float l9_1360=l9_1325;
float l9_1361=3.1415927;
float l9_1362=((2.0+l9_1357)*l9_1360)/(2.0*l9_1361);
float l9_1363=l9_1362;
float l9_1364=l9_1277;
float l9_1365=l9_1351;
float l9_1366=1.0/(4.0*((l9_1365+l9_1364)-(l9_1365*l9_1364)));
float l9_1367=l9_1366;
l9_1279+=((((l9_1332*l9_1274)*l9_1363)*l9_1367)*l9_1351);
l9_1326++;
continue;
}
else
...
int l9_1368=0;
l9_1368=sc_AmbientLightsCount_tmp;
int l9_1369=l9_1368;
if (l9_1369>0)
{
int l9_1370=0;
...
{
int l9_1371=0;
l9_1371=sc_AmbientLightsCount_tmp;
int l9_1372=l9_1371;
if (l9_1370<l9_1372)
{
int l9_1373=l9_1370;
float3 l9_1374=float3(0.0);
if (l9_1373<sc_AmbientLightsCount_tmp)
{
l9_1374=(*sc_set2.UserUniforms).sc_AmbientLights[l9_1373].color;
}
float3 l9_1375=l9_1374;
float3 l9_1376=l9_1375;
int l9_1377=l9_1370;
float l9_1378=0.0;
if (l9_1377<sc_AmbientLightsCount_tmp)
{
l9_1378=(*sc_set2.UserUniforms).sc_AmbientLights[l9_1377].intensity;
}
float l9_1379=l9_1378;
float l9_1380=l9_1379;
l9_1376*=l9_1380;
l9_1376/=float3(3.1415901);
l9_1279+=(l9_1376*l9_1274);
l9_1370++;
continue;
}
else
...
float3 l9_1381=l9_1279;
float3 l9_1382=N3_SheenOut.xyz+l9_1381;
N3_SheenOut=float4(l9_1382.x,l9_1382.y,l9_1382.z,N3_SheenOut.w);
float3 l9_1383=l9_885;
float3 l9_1384=l9_1383;
float l9_1385=fast::max(fast::max(l9_1384.x,l9_1384.y),l9_1384.z);
float l9_1386=1.0-(l9_1385*0.15700001);
N3_SheenOut.w=l9_1386;
}
...
{
int l9_1387=N3_ClearcoatTextureCoord;
float2 l9_1388=tempGlobals.Surface_UVCoord0;
float2 l9_1389=l9_1388;
if (l9_1387==0)
{
float2 l9_1390=tempGlobals.Surface_UVCoord0;
l9_1389=l9_1390;
}
if (l9_1387==1)
{
float2 l9_1391=tempGlobals.Surface_UVCoord1;
l9_1389=l9_1391;
}
...
float2 l9_1395=N3_ClearcoatTextureOffset;
float2 l9_1396=N3_ClearcoatTextureScale;
float l9_1397=N3_ClearcoatTextureRotation;
float l9_1398=radians(l9_1397);
float3x3 l9_1399=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1395.x,l9_1395.y,1.0));
float3x3 l9_1400=float3x3(float3(cos(l9_1398),sin(l9_1398),0.0),float3(-sin(l9_1398),cos(l9_1398),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1401=float3x3(float3(l9_1396.x,0.0,0.0),float3(0.0,l9_1396.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1402=(l9_1399*l9_1400)*l9_1401;
float2 l9_1403=(l9_1402*float3(l9_1394,1.0)).xy;
l9_1393=l9_1403;
}
float2 l9_1404=l9_1393;
...
int l9_1411=l9_1406;
int l9_1412=clearcoatTextureLayout_tmp;
int l9_1413=l9_1411;
float2 l9_1414=l9_1404;
bool l9_1415=(int(SC_USE_UV_TRANSFORM_clearcoatTexture_tmp)!=0);
float3x3 l9_1416=(*sc_set2.UserUniforms).clearcoatTextureTransform;
int2 l9_1417=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture_tmp);
bool l9_1418=(int(SC_USE_UV_MIN_MAX_clearcoatTexture_tmp)!=0);
float4 l9_1419=(*sc_set2.UserUniforms).clearcoatTextureUvMinMax;
bool l9_1420=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture_tmp)!=0);
float4 l9_1421=(*sc_set2.UserUniforms).clearcoatTextureBorderColor;
float l9_1422=0.0;
...
float2 l9_1458=l9_1457;
l9_1414=l9_1458;
float l9_1459=l9_1414.x;
int l9_1460=l9_1417.x;
bool l9_1461=l9_1423;
float l9_1462=l9_1424;
if ((l9_1460==0)||(l9_1460==3))
{
float l9_1463=l9_1459;
float l9_1464=0.0;
float l9_1465=1.0;
bool l9_1466=l9_1461;
float l9_1467=l9_1462;
...
l9_1414.x=l9_1459;
l9_1424=l9_1462;
float l9_1470=l9_1414.y;
int l9_1471=l9_1417.y;
bool l9_1472=l9_1423;
float l9_1473=l9_1424;
if ((l9_1471==0)||(l9_1471==3))
{
float l9_1474=l9_1470;
float l9_1475=0.0;
float l9_1476=1.0;
bool l9_1477=l9_1472;
float l9_1478=l9_1473;
...
l9_1414.y=l9_1470;
l9_1424=l9_1473;
float2 l9_1481=l9_1414;
int l9_1482=l9_1412;
int l9_1483=l9_1413;
float l9_1484=l9_1422;
float2 l9_1485=l9_1481;
int l9_1486=l9_1482;
int l9_1487=l9_1483;
float3 l9_1488=float3(0.0);
if (l9_1486==0)
{
l9_1488=float3(l9_1485,0.0);
}
else
{
if (l9_1486==1)
{
l9_1488=float3(l9_1485.x,(l9_1485.y*0.5)+(0.5-(float(l9_1487)*0.5)),0.0);
}
else
{
l9_1488=float3(l9_1485,float(l9_1487));
}
}
float3 l9_1489=l9_1488;
float3 l9_1490=l9_1489;
float2 l9_1491=l9_1490.xy;
float l9_1492=l9_1484;
float4 l9_1493=sc_set2.clearcoatTexture.sample(sc_set2.clearcoatTextureSmpSC,l9_1491,bias(l9_1492));
float4 l9_1494=l9_1493;
float4 l9_1495=l9_1494;
if (l9_1420)
{
l9_1495=mix(l9_1421,l9_1495,float4(l9_1424));
}
float4 l9_1496=l9_1495;
l9_1405=l9_1496;
float4 l9_1497=l9_1405;
float l9_1498=l9_1497.x;
float l9_1499;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1499=pow(l9_1498,2.2);
}
else
{
l9_1499=l9_1498*l9_1498;
}
float l9_1500=l9_1499;
N3_ClearcoatBase=l9_1500;
}
N3_ClearcoatBase*=N3_ClearcoatFactor;
if (N3_EnableClearCoatRoughnessTexture)
{
int l9_1501=N3_ClearcoatRoughnessTextureCoord;
float2 l9_1502=tempGlobals.Surface_UVCoord0;
float2 l9_1503=l9_1502;
if (l9_1501==0)
{
float2 l9_1504=tempGlobals.Surface_UVCoord0;
l9_1503=l9_1504;
}
if (l9_1501==1)
{
float2 l9_1505=tempGlobals.Surface_UVCoord1;
l9_1503=l9_1505;
}
...
{
float2 l9_1508=l9_1507;
float2 l9_1509=N3_ClearcoatRoughnessTextureOffset;
float2 l9_1510=N3_ClearcoatRoughnessTextureScale;
float l9_1511=N3_ClearcoatRoughnessTextureRotation;
float l9_1512=radians(l9_1511);
float3x3 l9_1513=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1509.x,l9_1509.y,1.0));
float3x3 l9_1514=float3x3(float3(cos(l9_1512),sin(l9_1512),0.0),float3(-sin(l9_1512),cos(l9_1512),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1515=float3x3(float3(l9_1510.x,0.0,0.0),float3(0.0,l9_1510.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1516=(l9_1513*l9_1514)*l9_1515;
float2 l9_1517=(l9_1516*float3(l9_1508,1.0)).xy;
l9_1507=l9_1517;
}
float2 l9_1518=l9_1507;
...
int l9_1525=l9_1520;
int l9_1526=clearcoatRoughnessTextureLayout_tmp;
int l9_1527=l9_1525;
float2 l9_1528=l9_1518;
bool l9_1529=(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture_tmp)!=0);
float3x3 l9_1530=(*sc_set2.UserUniforms).clearcoatRoughnessTextureTransform;
int2 l9_1531=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture_tmp);
bool l9_1532=(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_1533=(*sc_set2.UserUniforms).clearcoatRoughnessTextureUvMinMax;
bool l9_1534=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_1535=(*sc_set2.UserUniforms).clearcoatRoughnessTextureBorderColor;
float l9_1536=0.0;
...
float4 l9_1607=sc_set2.clearcoatRoughnessTexture.sample(sc_set2.clearcoatRoughnessTextureSmpSC,l9_1605,bias(l9_1606));
...
l9_1519=l9_1610;
float4 l9_1611=l9_1519;
float l9_1612=l9_1611.y;
float l9_1613;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1613=pow(l9_1612,2.2);
}
else
{
l9_1613=l9_1612*l9_1612;
}
float l9_1614=l9_1613;
N3_ClearcoatRoughness=l9_1614;
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
int l9_1615=N3_ClearcoatNormalMapCoord;
float2 l9_1616=tempGlobals.Surface_UVCoord0;
float2 l9_1617=l9_1616;
if (l9_1615==0)
{
float2 l9_1618=tempGlobals.Surface_UVCoord0;
l9_1617=l9_1618;
}
if (l9_1615==1)
{
float2 l9_1619=tempGlobals.Surface_UVCoord1;
l9_1617=l9_1619;
}
...
float2 l9_1623=N3_ClearcoatNormalTextureOffset;
float2 l9_1624=N3_ClearcoatNormalTextureScale;
float l9_1625=N3_ClearcoatNormalTextureRotation;
float l9_1626=radians(l9_1625);
float3x3 l9_1627=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1623.x,l9_1623.y,1.0));
float3x3 l9_1628=float3x3(float3(cos(l9_1626),sin(l9_1626),0.0),float3(-sin(l9_1626),cos(l9_1626),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1629=float3x3(float3(l9_1624.x,0.0,0.0),float3(0.0,l9_1624.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1630=(l9_1627*l9_1628)*l9_1629;
float2 l9_1631=(l9_1630*float3(l9_1622,1.0)).xy;
l9_1621=l9_1631;
}
float2 l9_1632=l9_1621;
...
{
l9_1637=in.varStereoViewID;
}
int l9_1638=l9_1637;
l9_1634=l9_1638;
}
int l9_1639=l9_1634;
int l9_1640=clearcoatNormalTextureLayout_tmp;
int l9_1641=l9_1639;
float2 l9_1642=l9_1632;
bool l9_1643=(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture_tmp)!=0);
float3x3 l9_1644=(*sc_set2.UserUniforms).clearcoatNormalTextureTransform;
int2 l9_1645=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture_tmp);
bool l9_1646=(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture_tmp)!=0);
float4 l9_1647=(*sc_set2.UserUniforms).clearcoatNormalTextureUvMinMax;
bool l9_1648=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture_tmp)!=0);
float4 l9_1649=(*sc_set2.UserUniforms).clearcoatNormalTextureBorderColor;
float l9_1650=0.0;
bool l9_1651=l9_1648&&(!l9_1646);
float l9_1652=1.0;
float l9_1653=l9_1642.x;
int l9_1654=l9_1645.x;
if (l9_1654==1)
{
l9_1653=fract(l9_1653);
}
else
{
if (l9_1654==2)
{
float l9_1655=fract(l9_1653);
float l9_1656=l9_1653-l9_1655;
float l9_1657=step(0.25,fract(l9_1656*0.5));
l9_1653=mix(l9_1655,1.0-l9_1655,fast::clamp(l9_1657,0.0,1.0));
}
}
l9_1642.x=l9_1653;
float l9_1658=l9_1642.y;
int l9_1659=l9_1645.y;
if (l9_1659==1)
{
...
float l9_1665=l9_1642.x;
float l9_1666=l9_1647.x;
float l9_1667=l9_1647.z;
bool l9_1668=l9_1664;
float l9_1669=l9_1652;
float l9_1670=fast::clamp(l9_1665,l9_1666,l9_1667);
float l9_1671=step(abs(l9_1665-l9_1670),9.9999997e-06);
l9_1669*=(l9_1671+((1.0-float(l9_1668))*(1.0-l9_1671)));
l9_1665=l9_1670;
l9_1642.x=l9_1665;
l9_1652=l9_1669;
bool l9_1672=l9_1648;
bool l9_1673;
if (l9_1672)
{
l9_1673=l9_1645.y==3;
...
float l9_1674=l9_1642.y;
float l9_1675=l9_1647.y;
float l9_1676=l9_1647.w;
bool l9_1677=l9_1673;
float l9_1678=l9_1652;
float l9_1679=fast::clamp(l9_1674,l9_1675,l9_1676);
float l9_1680=step(abs(l9_1674-l9_1679),9.9999997e-06);
l9_1678*=(l9_1680+((1.0-float(l9_1677))*(1.0-l9_1680)));
l9_1674=l9_1679;
l9_1642.y=l9_1674;
l9_1652=l9_1678;
}
float2 l9_1681=l9_1642;
bool l9_1682=l9_1643;
float3x3 l9_1683=l9_1644;
if (l9_1682)
{
l9_1681=float2((l9_1683*float3(l9_1681,1.0)).xy);
}
float2 l9_1684=l9_1681;
float2 l9_1685=l9_1684;
float2 l9_1686=l9_1685;
l9_1642=l9_1686;
float l9_1687=l9_1642.x;
int l9_1688=l9_1645.x;
bool l9_1689=l9_1651;
float l9_1690=l9_1652;
if ((l9_1688==0)||(l9_1688==3))
{
float l9_1691=l9_1687;
float l9_1692=0.0;
float l9_1693=1.0;
bool l9_1694=l9_1689;
float l9_1695=l9_1690;
...
l9_1642.x=l9_1687;
l9_1652=l9_1690;
float l9_1698=l9_1642.y;
int l9_1699=l9_1645.y;
bool l9_1700=l9_1651;
float l9_1701=l9_1652;
if ((l9_1699==0)||(l9_1699==3))
{
float l9_1702=l9_1698;
float l9_1703=0.0;
float l9_1704=1.0;
bool l9_1705=l9_1700;
float l9_1706=l9_1701;
float l9_1707=fast::clamp(l9_1702,l9_1703,l9_1704);
float l9_1708=step(abs(l9_1702-l9_1707),9.9999997e-06);
l9_1706*=(l9_1708+((1.0-float(l9_1705))*(1.0-l9_1708)));
l9_1702=l9_1707;
l9_1698=l9_1702;
l9_1701=l9_1706;
}
l9_1642.y=l9_1698;
l9_1652=l9_1701;
float2 l9_1709=l9_1642;
int l9_1710=l9_1640;
int l9_1711=l9_1641;
float l9_1712=l9_1650;
float2 l9_1713=l9_1709;
int l9_1714=l9_1710;
int l9_1715=l9_1711;
float3 l9_1716=float3(0.0);
if (l9_1714==0)
{
l9_1716=float3(l9_1713,0.0);
}
else
{
if (l9_1714==1)
{
l9_1716=float3(l9_1713.x,(l9_1713.y*0.5)+(0.5-(float(l9_1715)*0.5)),0.0);
}
else
{
l9_1716=float3(l9_1713,float(l9_1715));
}
}
float3 l9_1717=l9_1716;
float3 l9_1718=l9_1717;
float2 l9_1719=l9_1718.xy;
float l9_1720=l9_1712;
float4 l9_1721=sc_set2.clearcoatNormalTexture.sample(sc_set2.clearcoatNormalTextureSmpSC,l9_1719,bias(l9_1720));
float4 l9_1722=l9_1721;
float4 l9_1723=l9_1722;
if (l9_1648)
{
l9_1723=mix(l9_1649,l9_1723,float4(l9_1652));
}
float4 l9_1724=l9_1723;
l9_1633=l9_1724;
float4 l9_1725=l9_1633;
N3_ClearcoatNormal=l9_1725.xyz;
...
l9_251=l9_303;
l9_252=l9_304;
float4 l9_1726=float4(0.0);
float3 l9_1727=l9_241;
float l9_1728=l9_242;
float3 l9_1729=l9_243;
float3 l9_1730=l9_244;
float l9_1731=l9_245;
float l9_1732=l9_246;
float3 l9_1733=l9_247.xyz;
float3 l9_1734=(*sc_set2.UserUniforms).Port_SpecularAO_N036;
ssGlobals l9_1735=param_3;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1735.BumpedNormal=l9_1729;
}
l9_1728=fast::clamp(l9_1728,0.0,1.0);
float l9_1736=l9_1728;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_1736<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_1737=gl_FragCoord;
float2 l9_1738=floor(mod(l9_1737.xy,float2(4.0)));
float l9_1739=(mod(dot(l9_1738,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_1736<l9_1739)
{
discard_fragment();
}
}
l9_1727=fast::max(l9_1727,float3(0.0));
float4 l9_1740;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1740=float4(l9_1727,l9_1728);
}
else
{
l9_1730=fast::max(l9_1730,float3(0.0));
l9_1731=fast::clamp(l9_1731,0.0,1.0);
l9_1732=fast::clamp(l9_1732,0.0,1.0);
l9_1733=fast::clamp(l9_1733,float3(0.0),float3(1.0));
float3 l9_1741=l9_1727;
float l9_1742=l9_1728;
float3 l9_1743=l9_1735.BumpedNormal;
float3 l9_1744=l9_1735.PositionWS;
float3 l9_1745=l9_1735.ViewDirWS;
float3 l9_1746=l9_1730;
float l9_1747=l9_1731;
float l9_1748=l9_1732;
float3 l9_1749=l9_1733;
float3 l9_1750=l9_1734;
l9_1740=ngsCalculateLighting(l9_1741,l9_1742,l9_1743,l9_1744,l9_1745,l9_1746,l9_1747,l9_1748,l9_1749,l9_1750,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.sc_EnvmapDiffuse,sc_set2.sc_EnvmapDiffuseSmpSC,sc_set2.sc_EnvmapSpecular,sc_set2.sc_EnvmapSpecularSmpSC,sc_set2.sc_ScreenTexture,sc_set2.sc_ScreenTextureSmpSC,sc_set2.sc_ShadowTexture,sc_set2.sc_ShadowTextureSmpSC,sc_set2.sc_SSAOTexture,sc_set2.sc_SSAOTextureSmpSC,sc_set2.sc_RayTracedReflectionTexture,sc_set2.sc_RayTracedReflectionTextureSmpSC,sc_set2.sc_RayTracedShadowTexture,sc_set2.sc_RayTracedShadowTextureSmpSC,sc_set2.sc_RayTracedDiffIndTexture,sc_set2.sc_RayTracedDiffIndTextureSmpSC,sc_set2.sc_RayTracedAoTexture,sc_set2.sc_RayTracedAoTextureSmpSC,gl_FragCoord,in.varShadowTex,out.FragColor0);
}
l9_1740=fast::max(l9_1740,float4(0.0));
l9_1726=l9_1740;
float4 l9_1751=float4(0.0);
float3 l9_1752=(*sc_set2.UserUniforms).Port_Albedo_N405;
float l9_1753=(*sc_set2.UserUniforms).Port_Opacity_N405;
float3 l9_1754=l9_251;
float3 l9_1755=(*sc_set2.UserUniforms).Port_Emissive_N405;
float l9_1756=(*sc_set2.UserUniforms).Port_Metallic_N405;
float l9_1757=l9_252;
float3 l9_1758=(*sc_set2.UserUniforms).Port_SpecularAO_N405;
ssGlobals l9_1759=param_3;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1759.BumpedNormal=float3x3(float3(l9_1759.VertexTangent_WorldSpace),float3(l9_1759.VertexBinormal_WorldSpace),float3(l9_1759.VertexNormal_WorldSpace))*l9_1754;
}
float l9_1760=l9_1753;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_1760<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
if ((int(ENABLE_STIPPLE_PATTERN_TEST_tmp)!=0))
{
float4 l9_1761=gl_FragCoord;
float2 l9_1762=floor(mod(l9_1761.xy,float2(4.0)));
float l9_1763=(mod(dot(l9_1762,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_1760<l9_1763)
{
discard_fragment();
}
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1764=float4(l9_1752,l9_1753);
}
else
{
l9_1757=fast::clamp(l9_1757,0.0,1.0);
float3 l9_1765=float3(1.0);
float3 l9_1766=l9_1752;
float l9_1767=l9_1753;
float3 l9_1768=l9_1759.BumpedNormal;
float3 l9_1769=l9_1759.PositionWS;
float3 l9_1770=l9_1759.ViewDirWS;
float3 l9_1771=l9_1755;
float l9_1772=l9_1756;
float l9_1773=l9_1757;
float3 l9_1774=l9_1765;
float3 l9_1775=l9_1758;
l9_1764=ngsCalculateLighting(l9_1766,l9_1767,l9_1768,l9_1769,l9_1770,l9_1771,l9_1772,l9_1773,l9_1774,l9_1775,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.sc_EnvmapDiffuse,sc_set2.sc_EnvmapDiffuseSmpSC,sc_set2.sc_EnvmapSpecular,sc_set2.sc_EnvmapSpecularSmpSC,sc_set2.sc_ScreenTexture,sc_set2.sc_ScreenTextureSmpSC,sc_set2.sc_ShadowTexture,sc_set2.sc_ShadowTextureSmpSC,sc_set2.sc_SSAOTexture,sc_set2.sc_SSAOTextureSmpSC,sc_set2.sc_RayTracedReflectionTexture,sc_set2.sc_RayTracedReflectionTextureSmpSC,sc_set2.sc_RayTracedShadowTexture,sc_set2.sc_RayTracedShadowTextureSmpSC,sc_set2.sc_RayTracedDiffIndTexture,sc_set2.sc_RayTracedDiffIndTextureSmpSC,sc_set2.sc_RayTracedAoTexture,sc_set2.sc_RayTracedAoTextureSmpSC,gl_FragCoord,in.varShadowTex,out.FragColor0);
}
l9_1764=fast::max(l9_1764,float4(0.0));
l9_1751=l9_1764;
float4 l9_1776=float4(0.0);
float4 l9_1777=l9_1726;
float l9_1778=l9_242;
float3 l9_1779=l9_248;
float4 l9_1780=l9_249;
float l9_1781=l9_250;
float4 l9_1782=l9_1751;
ssGlobals l9_1783=param_3;
tempGlobals=l9_1783;
float4 l9_1784=float4(0.0);
N31_PbrIn=l9_1777;
N31_EnableTransmission=(int(ENABLE_TRANSMISSION_tmp)!=0);
N31_Opacity=l9_1778;
N31_Background=l9_1779;
N31_EnableSheen=(int(ENABLE_SHEEN_tmp)!=0);
N31_SheenColor=l9_1780;
N31_EnableClearcoat=(int(ENABLE_CLEARCOAT_tmp)!=0);
N31_ClearcoatBase=l9_1781;
N31_ClearcoatColor=l9_1782;
N31_Result=N31_PbrIn;
if ((N31_EnableSheen||N31_EnableTransmission)||N31_EnableClearcoat)
{
float4 l9_1785=N31_Result;
float4 l9_1786;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1786=float4(pow(l9_1785.x,2.2),pow(l9_1785.y,2.2),pow(l9_1785.z,2.2),pow(l9_1785.w,2.2));
}
else
{
l9_1786=l9_1785*l9_1785;
}
float4 l9_1787=l9_1786;
N31_Result=l9_1787;
if (N31_EnableSheen)
{
float l9_1788=N31_SheenColor.w;
float3 l9_1789=(N31_Result.xyz*l9_1788)+N31_SheenColor.xyz;
N31_Result=float4(l9_1789.x,l9_1789.y,l9_1789.z,N31_Result.w);
}
if (N31_EnableTransmission)
{
float4 l9_1790=N31_Result;
float l9_1791=N31_Opacity;
float l9_1792;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1792=pow(l9_1791,2.2);
}
else
{
l9_1792=l9_1791*l9_1791;
}
float l9_1793=l9_1792;
N31_Result=mix(float4(N31_Background,1.0),l9_1790,float4(l9_1793));
N31_Result.w=1.0;
}
if (N31_EnableClearcoat)
{
float l9_1794=N31_ClearcoatBase;
float4 l9_1795=N31_ClearcoatColor;
float4 l9_1796;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1796=float4(pow(l9_1795.x,2.2),pow(l9_1795.y,2.2),pow(l9_1795.z,2.2),pow(l9_1795.w,2.2));
}
else
{
l9_1796=l9_1795*l9_1795;
}
float4 l9_1797=l9_1796;
float4 l9_1798=l9_1797*l9_1794;
float3 l9_1799=N31_Result.xyz+l9_1798.xyz;
N31_Result=float4(l9_1799.x,l9_1799.y,l9_1799.z,N31_Result.w);
}
float4 l9_1800=N31_Result;
float4 l9_1801;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1801=float4(pow(l9_1800.x,0.45454544),pow(l9_1800.y,0.45454544),pow(l9_1800.z,0.45454544),pow(l9_1800.w,0.45454544));
}
else
{
l9_1801=sqrt(l9_1800);
}
...
{
float4 l9_1803=float4(0.0);
float4 l9_1804=(*sc_set2.UserUniforms).baseColorFactor;
l9_1803=l9_1804;
float2 l9_1805=float2(0.0);
float2 l9_1806=(*sc_set2.UserUniforms).baseColorTexture_offset;
l9_1805=l9_1806;
float2 l9_1807=float2(0.0);
float2 l9_1808=(*sc_set2.UserUniforms).baseColorTexture_scale;
l9_1807=l9_1808;
float l9_1809=0.0;
float l9_1810=(*sc_set2.UserUniforms).baseColorTexture_rotation;
l9_1809=l9_1810;
float4 l9_1811=float4(0.0);
float4 l9_1812=l9_1803;
float2 l9_1813=l9_1805;
float2 l9_1814=l9_1807;
float l9_1815=l9_1809;
ssGlobals l9_1816=param_3;
tempGlobals=l9_1816;
float4 l9_1817=float4(0.0);
N35_EnableVertexColor=(int(ENABLE_VERTEX_COLOR_BASE_tmp)!=0);
N35_EnableBaseTexture=(int(ENABLE_BASE_TEX_tmp)!=0);
N35_BaseColorTextureCoord=NODE_7_DROPLIST_ITEM_tmp;
N35_BaseColorFactor=l9_1812;
N35_EnableTextureTransform=(int(ENABLE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureTransform=(int(ENABLE_BASE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureOffset=l9_1813;
N35_BaseTextureScale=l9_1814;
N35_BaseTextureRotation=l9_1815;
float4 l9_1818=N35_BaseColorFactor;
if (N35_EnableBaseTexture)
{
int l9_1819=N35_BaseColorTextureCoord;
float2 l9_1820=tempGlobals.Surface_UVCoord0;
float2 l9_1821=l9_1820;
if (l9_1819==0)
{
float2 l9_1822=tempGlobals.Surface_UVCoord0;
l9_1821=l9_1822;
}
if (l9_1819==1)
{
float2 l9_1823=tempGlobals.Surface_UVCoord1;
l9_1821=l9_1823;
}
float2 l9_1824=l9_1821;
float2 l9_1825=l9_1824;
if (N35_EnableTextureTransform&&N35_BaseTextureTransform)
{
float2 l9_1826=l9_1825;
float2 l9_1827=N35_BaseTextureOffset;
float2 l9_1828=N35_BaseTextureScale;
float l9_1829=N35_BaseTextureRotation;
float3x3 l9_1830=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_1827.x,l9_1827.y,1.0));
float3x3 l9_1831=float3x3(float3(cos(l9_1829),sin(l9_1829),0.0),float3(-sin(l9_1829),cos(l9_1829),0.0),float3(0.0,0.0,1.0));
float3x3 l9_1832=float3x3(float3(l9_1828.x,0.0,0.0),float3(0.0,l9_1828.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_1833=(l9_1830*l9_1831)*l9_1832;
float2 l9_1834=(l9_1833*float3(l9_1826,1.0)).xy;
l9_1825=l9_1834;
}
float2 l9_1835=l9_1825;
...
{
l9_1840=in.varStereoViewID;
}
int l9_1841=l9_1840;
l9_1837=l9_1841;
}
int l9_1842=l9_1837;
int l9_1843=baseColorTextureLayout_tmp;
int l9_1844=l9_1842;
float2 l9_1845=l9_1835;
bool l9_1846=(int(SC_USE_UV_TRANSFORM_baseColorTexture_tmp)!=0);
float3x3 l9_1847=(*sc_set2.UserUniforms).baseColorTextureTransform;
int2 l9_1848=int2(SC_SOFTWARE_WRAP_MODE_U_baseColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseColorTexture_tmp);
bool l9_1849=(int(SC_USE_UV_MIN_MAX_baseColorTexture_tmp)!=0);
float4 l9_1850=(*sc_set2.UserUniforms).baseColorTextureUvMinMax;
bool l9_1851=(int(SC_USE_CLAMP_TO_BORDER_baseColorTexture_tmp)!=0);
float4 l9_1852=(*sc_set2.UserUniforms).baseColorTextureBorderColor;
float l9_1853=0.0;
bool l9_1854=l9_1851&&(!l9_1849);
float l9_1855=1.0;
float l9_1856=l9_1845.x;
int l9_1857=l9_1848.x;
if (l9_1857==1)
{
l9_1856=fract(l9_1856);
}
else
{
if (l9_1857==2)
{
float l9_1858=fract(l9_1856);
float l9_1859=l9_1856-l9_1858;
float l9_1860=step(0.25,fract(l9_1859*0.5));
l9_1856=mix(l9_1858,1.0-l9_1858,fast::clamp(l9_1860,0.0,1.0));
}
}
l9_1845.x=l9_1856;
float l9_1861=l9_1845.y;
int l9_1862=l9_1848.y;
if (l9_1862==1)
{
l9_1861=fract(l9_1861);
}
else
{
if (l9_1862==2)
{
float l9_1863=fract(l9_1861);
float l9_1864=l9_1861-l9_1863;
float l9_1865=step(0.25,fract(l9_1864*0.5));
l9_1861=mix(l9_1863,1.0-l9_1863,fast::clamp(l9_1865,0.0,1.0));
}
}
l9_1845.y=l9_1861;
if (l9_1849)
{
bool l9_1866=l9_1851;
bool l9_1867;
if (l9_1866)
{
l9_1867=l9_1848.x==3;
...
float l9_1868=l9_1845.x;
float l9_1869=l9_1850.x;
float l9_1870=l9_1850.z;
bool l9_1871=l9_1867;
float l9_1872=l9_1855;
...
float l9_1877=l9_1845.y;
float l9_1878=l9_1850.y;
float l9_1879=l9_1850.w;
bool l9_1880=l9_1876;
float l9_1881=l9_1855;
...
float2 l9_1884=l9_1845;
bool l9_1885=l9_1846;
float3x3 l9_1886=l9_1847;
if (l9_1885)
{
l9_1884=float2((l9_1886*float3(l9_1884,1.0)).xy);
}
float2 l9_1887=l9_1884;
float2 l9_1888=l9_1887;
float2 l9_1889=l9_1888;
l9_1845=l9_1889;
float l9_1890=l9_1845.x;
int l9_1891=l9_1848.x;
bool l9_1892=l9_1854;
float l9_1893=l9_1855;
if ((l9_1891==0)||(l9_1891==3))
{
float l9_1894=l9_1890;
float l9_1895=0.0;
float l9_1896=1.0;
bool l9_1897=l9_1892;
float l9_1898=l9_1893;
float l9_1899=fast::clamp(l9_1894,l9_1895,l9_1896);
float l9_1900=step(abs(l9_1894-l9_1899),9.9999997e-06);
l9_1898*=(l9_1900+((1.0-float(l9_1897))*(1.0-l9_1900)));
l9_1894=l9_1899;
l9_1890=l9_1894;
l9_1893=l9_1898;
}
l9_1845.x=l9_1890;
l9_1855=l9_1893;
float l9_1901=l9_1845.y;
int l9_1902=l9_1848.y;
bool l9_1903=l9_1854;
float l9_1904=l9_1855;
...
l9_1845.y=l9_1901;
l9_1855=l9_1904;
float2 l9_1912=l9_1845;
int l9_1913=l9_1843;
int l9_1914=l9_1844;
float l9_1915=l9_1853;
float2 l9_1916=l9_1912;
int l9_1917=l9_1913;
int l9_1918=l9_1914;
float3 l9_1919=float3(0.0);
if (l9_1917==0)
{
l9_1919=float3(l9_1916,0.0);
}
else
{
if (l9_1917==1)
{
l9_1919=float3(l9_1916.x,(l9_1916.y*0.5)+(0.5-(float(l9_1918)*0.5)),0.0);
}
else
{
l9_1919=float3(l9_1916,float(l9_1918));
}
}
float3 l9_1920=l9_1919;
float3 l9_1921=l9_1920;
float2 l9_1922=l9_1921.xy;
float l9_1923=l9_1915;
float4 l9_1924=sc_set2.baseColorTexture.sample(sc_set2.baseColorTextureSmpSC,l9_1922,bias(l9_1923));
float4 l9_1925=l9_1924;
float4 l9_1926=l9_1925;
if (l9_1851)
{
l9_1926=mix(l9_1852,l9_1926,float4(l9_1855));
}
float4 l9_1927=l9_1926;
l9_1836=l9_1927;
float4 l9_1928=l9_1836;
float4 l9_1929=l9_1928;
float4 l9_1930;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1930=float4(pow(l9_1929.x,2.2),pow(l9_1929.y,2.2),pow(l9_1929.z,2.2),pow(l9_1929.w,2.2));
}
else
{
l9_1930=l9_1929*l9_1929;
}
...
if (N35_EnableVertexColor)
{
float4 l9_1932=tempGlobals.VertexColor;
l9_1818*=l9_1932;
}
N35_BaseColor=l9_1818.xyz;
N35_Opacity=l9_1818.w;
float4 l9_1933=l9_1818;
float4 l9_1934;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1934=float4(pow(l9_1933.x,0.45454544),pow(l9_1933.y,0.45454544),pow(l9_1933.z,0.45454544),pow(l9_1933.w,0.45454544));
}
else
{
l9_1934=sqrt(l9_1933);
}
float4 l9_1935=l9_1934;
N35_UnlitColor=l9_1935;
l9_1817=N35_UnlitColor;
l9_1811=l9_1817;
param_1=l9_1811;
param_2=param_1;
}
...
float param_4=(*sc_set2.UserUniforms).colorMultiplier;
Output_N89=param_4;
...
bool l9_1936=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_1936)
{
...
float4 l9_1937=fast::max(param_7,float4(0.0));
float4 param_8=l9_1937;
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_1938=param_9;
float4 l9_1939=l9_1938;
float l9_1940=1.0;
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_1940=fast::clamp(l9_1939.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_1940=fast::clamp(dot(l9_1939.xyz,float3(l9_1939.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_1940=(1.0-dot(l9_1939.xyz,float3(0.33333001)))*l9_1939.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1940=(1.0-fast::clamp(dot(l9_1939.xyz,float3(1.0)),0.0,1.0))*l9_1939.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_1940=fast::clamp(dot(l9_1939.xyz,float3(1.0)),0.0,1.0)*l9_1939.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_1940=fast::clamp(dot(l9_1939.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_1940=dot(l9_1939.xyz,float3(0.33333001))*l9_1939.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_1940=1.0-fast::clamp(dot(l9_1939.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_1942=l9_1941;
float l9_1943=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_1942;
float3 l9_1944=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_1938.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_1945=float4(l9_1944.x,l9_1944.y,l9_1944.z,l9_1943);
param_9=l9_1945;
}
else
{
...
{
float4 l9_1946=param_9;
float4 l9_1947=float4(0.0);
float4 l9_1948=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1949=out.FragColor0;
float4 l9_1950=l9_1949;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_1950.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_1952=gl_FragCoord;
float2 l9_1953=(l9_1952.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_1954=l9_1953;
...
{
l9_1957=in.varStereoViewID;
}
int l9_1958=l9_1957;
int l9_1959=l9_1958;
float3 l9_1960=float3(l9_1954,0.0);
int l9_1961=l9_1956;
int l9_1962=l9_1959;
if (l9_1961==1)
{
l9_1960.y=((2.0*l9_1960.y)+float(l9_1962))-1.0;
}
float2 l9_1963=l9_1960.xy;
l9_1955=l9_1963;
}
else
{
...
{
l9_1970=in.varStereoViewID;
}
int l9_1971=l9_1970;
l9_1967=l9_1971;
}
int l9_1972=l9_1967;
float2 l9_1973=l9_1966;
int l9_1974=l9_1972;
float2 l9_1975=l9_1973;
int l9_1976=l9_1974;
float l9_1977=0.0;
float4 l9_1978=float4(0.0);
float2 l9_1979=l9_1975;
int l9_1980=sc_ScreenTextureLayout_tmp;
int l9_1981=l9_1976;
float l9_1982=l9_1977;
...
if (l9_1984==0)
{
l9_1986=float3(l9_1983,0.0);
}
else
{
if (l9_1984==1)
{
l9_1986=float3(l9_1983.x,(l9_1983.y*0.5)+(0.5-(float(l9_1985)*0.5)),0.0);
}
else
{
l9_1986=float3(l9_1983,float(l9_1985));
}
}
float3 l9_1987=l9_1986;
float3 l9_1988=l9_1987;
float2 l9_1989=l9_1988.xy;
float l9_1990=l9_1982;
float4 l9_1991=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_1989,bias(l9_1990));
float4 l9_1992=l9_1991;
l9_1978=l9_1992;
float4 l9_1993=l9_1978;
float4 l9_1994=l9_1993;
float4 l9_1995=l9_1994;
l9_1948=l9_1995;
}
float4 l9_1996=l9_1948;
float4 l9_1997=l9_1996;
float3 l9_1998=l9_1997.xyz;
float3 l9_1999=l9_1998;
float3 l9_2000=l9_1946.xyz;
float3 l9_2001=definedBlend(l9_1999,l9_2000,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_1947=float4(l9_2001.x,l9_2001.y,l9_2001.z,l9_1947.w);
float3 l9_2002=mix(l9_1998,l9_1947.xyz,float3(l9_1946.w));
l9_1947=float4(l9_2002.x,l9_2002.y,l9_2002.z,l9_1947.w);
l9_1947.w=1.0;
float4 l9_2003=l9_1947;
param_9=l9_2003;
}
else
{
float4 l9_2004=param_9;
float4 l9_2005=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2005=float4(mix(float3(1.0),l9_2004.xyz,float3(l9_2004.w)),l9_2004.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2006=l9_2004.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2006=fast::clamp(l9_2006,0.0,1.0);
}
l9_2005=float4(l9_2004.xyz*l9_2006,l9_2006);
}
else
{
l9_2005=l9_2004;
...
float4 l9_2009=float4(0.0);
if ((int(sc_ShaderComplexityAnalyzer_tmp)!=0))
{
l9_2009=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_2009=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_10,param_11,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_12=FinalColor;
float4 l9_2011=param_12;
out.FragColor0=l9_2011;
return out;
}
} // FRAGMENT SHADER
...
float3 l9_572=(*sc_set2.UserUniforms).sc_Camera.position;
float3 l9_573=tempGlobals.SurfacePosition_WorldSpace;
float3 l9_574=normalize(l9_572-l9_573);
float3 l9_575=normalize(reflect(-l9_574,l9_571));
float3 l9_576=l9_575;
float l9_577=l9_456;
float l9_578=l9_577*4.0;
l9_578=3.0+(((l9_578-0.0)*2.0)/5.0);
float3 l9_579=l9_576;
float l9_580=l9_578;
float3 l9_581=l9_579;
float l9_582=l9_580;
float3 l9_583=l9_581;
float l9_584=l9_582;
float3 l9_585=l9_583;
float l9_586=(*sc_set2.UserUniforms).sc_EnvmapRotation.y;
float2 l9_587=float2(0.0);
float l9_588=l9_585.x;
float l9_589=-l9_585.z;
float l9_590=(l9_588<0.0) ? (-1.0) : 1.0;
float l9_591=l9_590*acos(fast::clamp(l9_589/length(float2(l9_588,l9_589)),-1.0,1.0));
l9_587.x=l9_591-1.5707964;
l9_587.y=acos(l9_585.y);
l9_587/=float2(6.2831855,3.1415927);
l9_587.y=1.0-l9_587.y;
l9_587.x+=(l9_586/360.0);
l9_587.x=fract((l9_587.x+floor(l9_587.x))+1.0);
float2 l9_592=l9_587;
float2 l9_593=l9_592;
if (SC_DEVICE_CLASS_tmp>=2)
{
float l9_594=floor(l9_584);
float l9_595=ceil(l9_584);
float2 l9_596=l9_593;
float2 l9_597=(*sc_set2.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_598=l9_594;
float2 l9_599=l9_593;
float2 l9_600=(*sc_set2.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_601=l9_595;
}
else
{
...
if (N3_EnableClearCoatRoughnessTexture)
{
int l9_602=N3_ClearcoatRoughnessTextureCoord;
...
float2 l9_610=N3_ClearcoatRoughnessTextureOffset;
float2 l9_611=N3_ClearcoatRoughnessTextureScale;
float l9_612=N3_ClearcoatRoughnessTextureRotation;
...
int l9_626=l9_621;
int l9_627=clearcoatRoughnessTextureLayout_tmp;
int l9_628=l9_626;
float2 l9_629=l9_619;
bool l9_630=(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture_tmp)!=0);
float3x3 l9_631=(*sc_set2.UserUniforms).clearcoatRoughnessTextureTransform;
int2 l9_632=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture_tmp);
bool l9_633=(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_634=(*sc_set2.UserUniforms).clearcoatRoughnessTextureUvMinMax;
bool l9_635=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture_tmp)!=0);
float4 l9_636=(*sc_set2.UserUniforms).clearcoatRoughnessTextureBorderColor;
float l9_637=0.0;
...
float2 l9_706=l9_705.xy;
float l9_707=l9_699;
float4 l9_708=sc_set2.clearcoatRoughnessTexture.sample(sc_set2.clearcoatRoughnessTextureSmpSC,l9_706,bias(l9_707));
float4 l9_709=l9_708;
float4 l9_710=l9_709;
if (l9_635)
{
l9_710=mix(l9_636,l9_710,float4(l9_639));
}
float4 l9_711=l9_710;
l9_620=l9_711;
float4 l9_712=l9_620;
float l9_713=l9_712.y;
float l9_714;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_714=pow(l9_713,2.2);
}
else
{
l9_714=l9_713*l9_713;
}
float l9_715=l9_714;
N3_ClearcoatRoughness=l9_715;
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
int l9_716=N3_ClearcoatNormalMapCoord;
float2 l9_717=tempGlobals.Surface_UVCoord0;
float2 l9_718=l9_717;
if (l9_716==0)
{
float2 l9_719=tempGlobals.Surface_UVCoord0;
l9_718=l9_719;
}
if (l9_716==1)
{
float2 l9_720=tempGlobals.Surface_UVCoord1;
l9_718=l9_720;
}
...
float2 l9_724=N3_ClearcoatNormalTextureOffset;
float2 l9_725=N3_ClearcoatNormalTextureScale;
float l9_726=N3_ClearcoatNormalTextureRotation;
float l9_727=radians(l9_726);
float3x3 l9_728=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_724.x,l9_724.y,1.0));
float3x3 l9_729=float3x3(float3(cos(l9_727),sin(l9_727),0.0),float3(-sin(l9_727),cos(l9_727),0.0),float3(0.0,0.0,1.0));
float3x3 l9_730=float3x3(float3(l9_725.x,0.0,0.0),float3(0.0,l9_725.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_731=(l9_728*l9_729)*l9_730;
float2 l9_732=(l9_731*float3(l9_723,1.0)).xy;
l9_722=l9_732;
}
float2 l9_733=l9_722;
...
int l9_740=l9_735;
int l9_741=clearcoatNormalTextureLayout_tmp;
int l9_742=l9_740;
float2 l9_743=l9_733;
bool l9_744=(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture_tmp)!=0);
float3x3 l9_745=(*sc_set2.UserUniforms).clearcoatNormalTextureTransform;
int2 l9_746=int2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture_tmp);
bool l9_747=(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture_tmp)!=0);
float4 l9_748=(*sc_set2.UserUniforms).clearcoatNormalTextureUvMinMax;
bool l9_749=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture_tmp)!=0);
float4 l9_750=(*sc_set2.UserUniforms).clearcoatNormalTextureBorderColor;
float l9_751=0.0;
...
float l9_821=l9_813;
float4 l9_822=sc_set2.clearcoatNormalTexture.sample(sc_set2.clearcoatNormalTextureSmpSC,l9_820,bias(l9_821));
...
l9_193=l9_219;
float l9_827=l9_189;
float3 l9_828=l9_190;
float l9_829=l9_191;
ssGlobals l9_830=param;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_830.BumpedNormal=l9_828;
}
l9_827=fast::clamp(l9_827,0.0,1.0);
float l9_831=l9_827;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_831<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_833=floor(mod(l9_832.xy,float2(4.0)));
float l9_834=(mod(dot(l9_833,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_831<l9_834)
{
discard_fragment();
}
}
float3 l9_835=l9_830.PositionWS;
float3 l9_836=l9_830.BumpedNormal;
float l9_837=l9_829;
float3 l9_838=normalize((*sc_set2.UserUniforms).sc_Camera.position-l9_835);
if (dot(l9_838,l9_836)>=(-0.050000001))
{
uint3 l9_839=uint3(round((l9_835-(*sc_set2.UserUniforms).OriginNormalizationOffset)*(*sc_set2.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_839.x,l9_839.y,l9_839.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set2.UserUniforms).receiver_mask);
float3 l9_840=l9_836;
float l9_841=dot(abs(l9_840),float3(1.0));
l9_840/=float3(l9_841);
float l9_842=fast::clamp(-l9_840.z,0.0,1.0);
float2 l9_843=l9_840.xy;
float l9_844;
if (l9_840.x>=0.0)
{
l9_844=l9_842;
...
l9_843.y+=l9_845;
float2 l9_846=l9_843;
float2 l9_847=l9_846;
uint2 l9_848=uint2(as_type<uint>(half2(float2(l9_847.x,0.0))),as_type<uint>(half2(float2(l9_847.y,0.0))));
out.normal_and_more=uint4(l9_848.x,l9_848.y,out.normal_and_more.z,out.normal_and_more.w);
...
{
l9_849=uint(fast::clamp(l9_837,0.0,1.0)*1000.0);
}
uint l9_850=l9_849;
l9_850 |= uint(((*sc_set2.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_850;
}
else
{
...
float l9_851=(*sc_set2.UserUniforms).Port_Opacity_N405;
float3 l9_852=l9_192;
float l9_853=l9_193;
ssGlobals l9_854=param;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_854.BumpedNormal=float3x3(float3(l9_854.VertexTangent_WorldSpace),float3(l9_854.VertexBinormal_WorldSpace),float3(l9_854.VertexNormal_WorldSpace))*l9_852;
}
float l9_855=l9_851;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_855<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
if ((int(ENABLE_STIPPLE_PATTERN_TEST_tmp)!=0))
{
float4 l9_856=gl_FragCoord;
float2 l9_857=floor(mod(l9_856.xy,float2(4.0)));
float l9_858=(mod(dot(l9_857,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_855<l9_858)
{
discard_fragment();
}
}
float3 l9_859=l9_854.PositionWS;
float3 l9_860=l9_854.BumpedNormal;
float l9_861=l9_853;
float3 l9_862=normalize((*sc_set2.UserUniforms).sc_Camera.position-l9_859);
if (dot(l9_862,l9_860)>=(-0.050000001))
{
uint3 l9_863=uint3(round((l9_859-(*sc_set2.UserUniforms).OriginNormalizationOffset)*(*sc_set2.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_863.x,l9_863.y,l9_863.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set2.UserUniforms).receiver_mask);
float3 l9_864=l9_860;
float l9_865=dot(abs(l9_864),float3(1.0));
l9_864/=float3(l9_865);
float l9_866=fast::clamp(-l9_864.z,0.0,1.0);
float2 l9_867=l9_864.xy;
float l9_868;
if (l9_864.x>=0.0)
{
l9_868=l9_866;
...
l9_867.y+=l9_869;
float2 l9_870=l9_867;
float2 l9_871=l9_870;
uint2 l9_872=uint2(as_type<uint>(half2(float2(l9_871.x,0.0))),as_type<uint>(half2(float2(l9_871.y,0.0))));
out.normal_and_more=uint4(l9_872.x,l9_872.y,out.normal_and_more.z,out.normal_and_more.w);
out.normal_and_more.z=as_type<uint>(half2(float2(0.0)));
uint l9_873;
if (l9_861<0.0)
{
...
{
l9_873=uint(fast::clamp(l9_861,0.0,1.0)*1000.0);
}
uint l9_874=l9_873;
l9_874 |= uint(((*sc_set2.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_874;
}
else
{
out.position_and_mask=uint4(0u);
...
ssGlobals l9_875=param;
tempGlobals=l9_875;
}
else
{
float4 l9_876=float4(0.0);
float4 l9_877=(*sc_set2.UserUniforms).baseColorFactor;
l9_876=l9_877;
float2 l9_878=float2(0.0);
float2 l9_879=(*sc_set2.UserUniforms).baseColorTexture_offset;
l9_878=l9_879;
float2 l9_880=float2(0.0);
float2 l9_881=(*sc_set2.UserUniforms).baseColorTexture_scale;
l9_880=l9_881;
float l9_882=0.0;
float l9_883=(*sc_set2.UserUniforms).baseColorTexture_rotation;
l9_882=l9_883;
float4 l9_884=l9_876;
float2 l9_885=l9_878;
float2 l9_886=l9_880;
float l9_887=l9_882;
ssGlobals l9_888=param;
tempGlobals=l9_888;
N35_EnableVertexColor=(int(ENABLE_VERTEX_COLOR_BASE_tmp)!=0);
N35_EnableBaseTexture=(int(ENABLE_BASE_TEX_tmp)!=0);
N35_BaseColorTextureCoord=NODE_7_DROPLIST_ITEM_tmp;
N35_BaseColorFactor=l9_884;
N35_EnableTextureTransform=(int(ENABLE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureTransform=(int(ENABLE_BASE_TEXTURE_TRANSFORM_tmp)!=0);
N35_BaseTextureOffset=l9_885;
N35_BaseTextureScale=l9_886;
N35_BaseTextureRotation=l9_887;
float4 l9_889=N35_BaseColorFactor;
if (N35_EnableBaseTexture)
{
int l9_890=N35_BaseColorTextureCoord;
float2 l9_891=tempGlobals.Surface_UVCoord0;
float2 l9_892=l9_891;
if (l9_890==0)
{
float2 l9_893=tempGlobals.Surface_UVCoord0;
l9_892=l9_893;
}
if (l9_890==1)
{
float2 l9_894=tempGlobals.Surface_UVCoord1;
l9_892=l9_894;
}
float2 l9_895=l9_892;
float2 l9_896=l9_895;
if (N35_EnableTextureTransform&&N35_BaseTextureTransform)
{
float2 l9_897=l9_896;
float2 l9_898=N35_BaseTextureOffset;
float2 l9_899=N35_BaseTextureScale;
float l9_900=N35_BaseTextureRotation;
float3x3 l9_901=float3x3(float3(1.0,0.0,0.0),float3(0.0,1.0,0.0),float3(l9_898.x,l9_898.y,1.0));
float3x3 l9_902=float3x3(float3(cos(l9_900),sin(l9_900),0.0),float3(-sin(l9_900),cos(l9_900),0.0),float3(0.0,0.0,1.0));
float3x3 l9_903=float3x3(float3(l9_899.x,0.0,0.0),float3(0.0,l9_899.y,0.0),float3(0.0,0.0,1.0));
float3x3 l9_904=(l9_901*l9_902)*l9_903;
float2 l9_905=(l9_904*float3(l9_897,1.0)).xy;
l9_896=l9_905;
}
float2 l9_906=l9_896;
...
{
l9_911=in.varStereoViewID;
}
int l9_912=l9_911;
l9_908=l9_912;
}
int l9_913=l9_908;
int l9_914=baseColorTextureLayout_tmp;
int l9_915=l9_913;
float2 l9_916=l9_906;
bool l9_917=(int(SC_USE_UV_TRANSFORM_baseColorTexture_tmp)!=0);
float3x3 l9_918=(*sc_set2.UserUniforms).baseColorTextureTransform;
int2 l9_919=int2(SC_SOFTWARE_WRAP_MODE_U_baseColorTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseColorTexture_tmp);
bool l9_920=(int(SC_USE_UV_MIN_MAX_baseColorTexture_tmp)!=0);
float4 l9_921=(*sc_set2.UserUniforms).baseColorTextureUvMinMax;
bool l9_922=(int(SC_USE_CLAMP_TO_BORDER_baseColorTexture_tmp)!=0);
float4 l9_923=(*sc_set2.UserUniforms).baseColorTextureBorderColor;
float l9_924=0.0;
bool l9_925=l9_922&&(!l9_920);
float l9_926=1.0;
float l9_927=l9_916.x;
int l9_928=l9_919.x;
if (l9_928==1)
{
l9_927=fract(l9_927);
...
float l9_939=l9_916.x;
float l9_940=l9_921.x;
float l9_941=l9_921.z;
bool l9_942=l9_938;
float l9_943=l9_926;
...
float l9_948=l9_916.y;
float l9_949=l9_921.y;
float l9_950=l9_921.w;
bool l9_951=l9_947;
float l9_952=l9_926;
...
float2 l9_955=l9_916;
bool l9_956=l9_917;
float3x3 l9_957=l9_918;
if (l9_956)
{
l9_955=float2((l9_957*float3(l9_955,1.0)).xy);
}
float2 l9_958=l9_955;
float2 l9_959=l9_958;
float2 l9_960=l9_959;
l9_916=l9_960;
float l9_961=l9_916.x;
int l9_962=l9_919.x;
bool l9_963=l9_925;
float l9_964=l9_926;
...
l9_916.x=l9_961;
l9_926=l9_964;
float l9_972=l9_916.y;
int l9_973=l9_919.y;
bool l9_974=l9_925;
float l9_975=l9_926;
if ((l9_973==0)||(l9_973==3))
{
float l9_976=l9_972;
float l9_977=0.0;
float l9_978=1.0;
...
l9_916.y=l9_972;
l9_926=l9_975;
float2 l9_983=l9_916;
int l9_984=l9_914;
int l9_985=l9_915;
float l9_986=l9_924;
float2 l9_987=l9_983;
int l9_988=l9_984;
int l9_989=l9_985;
float3 l9_990=float3(0.0);
if (l9_988==0)
{
l9_990=float3(l9_987,0.0);
}
else
{
if (l9_988==1)
{
l9_990=float3(l9_987.x,(l9_987.y*0.5)+(0.5-(float(l9_989)*0.5)),0.0);
}
else
{
l9_990=float3(l9_987,float(l9_989));
}
}
float3 l9_991=l9_990;
float3 l9_992=l9_991;
float2 l9_993=l9_992.xy;
float l9_994=l9_986;
float4 l9_995=sc_set2.baseColorTexture.sample(sc_set2.baseColorTextureSmpSC,l9_993,bias(l9_994));
float4 l9_996=l9_995;
float4 l9_997=l9_996;
if (l9_922)
{
l9_997=mix(l9_923,l9_997,float4(l9_926));
}
float4 l9_998=l9_997;
l9_907=l9_998;
float4 l9_999=l9_907;
float4 l9_1000=l9_999;
float4 l9_1001;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1001=float4(pow(l9_1000.x,2.2),pow(l9_1000.y,2.2),pow(l9_1000.z,2.2),pow(l9_1000.w,2.2));
}
else
{
l9_1001=l9_1000*l9_1000;
}
...
if (N35_EnableVertexColor)
{
float4 l9_1003=tempGlobals.VertexColor;
l9_889*=l9_1003;
}
N35_Opacity=l9_889.w;
}
return out;
}
